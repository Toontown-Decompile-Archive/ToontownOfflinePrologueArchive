...
class DistributedCheckers(DistributedNode.DistributedNode):
    ...
    def enableExitButton(self):
        self.exitButton = DirectButton(relief=None, text=TTLocalizer.ChineseCheckersGetUpButton, text_fg=(1,
                                                                                                          1,
                                                                                                          0.65,
                                                                                                          1), text_pos=(0,
                                                                                                                        -0.23), text_scale=0.8, image=(self.upButton, self.downButton, self.rolloverButton), image_color=(1,
                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                          1), image_scale=(20,
                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                           11), pos=(0.92,
                                                                                                                                                                                                                                                     0,
                                                                                                                                                                                                                                                     0.4), scale=0.15, command=(lambda self=self: self.exitButtonPushed()))
        return
    ...
    def enableStartButton(self):
        self.startButton = DirectButton(relief=None, text=TTLocalizer.ChineseCheckersStartButton, text_fg=(1,
                                                                                                           1,
                                                                                                           0.65,
                                                                                                           1), text_pos=(0,
                                                                                                                         -0.23), text_scale=0.6, image=(self.upButton, self.downButton, self.rolloverButton), image_color=(1,
                                                                                                                                                                                                                           0,
                                                                                                                                                                                                                           0,
                                                                                                                                                                                                                           1), image_scale=(20,
                                                                                                                                                                                                                                            1,
                                                                                                                                                                                                                                            11), pos=(0.92,
                                                                                                                                                                                                                                                      0,
                                                                                                                                                                                                                                                      0.1), scale=0.15, command=(lambda self=self: self.startButtonPushed()))
        return

    def enableLeaveButton(self):
        self.leaveButton = DirectButton(relief=None, text=TTLocalizer.ChineseCheckersQuitButton, text_fg=(1,
                                                                                                          1,
                                                                                                          0.65,
                                                                                                          1), text_pos=(0,
                                                                                                                        -0.13), text_scale=0.5, image=(self.upButton, self.downButton, self.rolloverButton), image_color=(1,
                                                                                                                                                                                                                          0,
                                                                                                                                                                                                                          0,
                                                                                                                                                                                                                          1), image_scale=(20,
                                                                                                                                                                                                                                           1,
            ...
            for x in range(4):
                if self.board.squareList[index].getAdjacent()[x] != None and self.board.squareList[index].getJumps()[x] != None:
                    ...
                    if adj.getState() == 0:
                        ...
                        if adj.getState() == self.playerNum or adj.getState() == self.playerNum + 2:
                            pass
