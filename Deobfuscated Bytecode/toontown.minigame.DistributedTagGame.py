...
import TagGameGlobals, Trajectory
...
class DistributedTagGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.itText = OnscreenText.OnscreenText('itText', fg=(0.95, 0.95, 0.65, 1), scale=0.14, font=ToontownGlobals.getSignFont(), pos=(0.0,
                                                                                                                                         -0.8), wordwrap=15, mayChange=1)
        self.itText.hide()
