...
import math, random, GenericAnimatedProp
...
class InteractiveAnimatedProp(GenericAnimatedProp.GenericAnimatedProp, FSM.FSM):
    ...
    def createBattleCheerInterval(self):
        ...
        battleCheerTextIval = Sequence(Func(self.hpText.show), self.hpText.posInterval(duration=4.0, pos=Vec3(0, 0, 7), startPos=(0,
                                                                                                                                  0,
                                                                                                                                  3)), Func(self.hpText.hide))
