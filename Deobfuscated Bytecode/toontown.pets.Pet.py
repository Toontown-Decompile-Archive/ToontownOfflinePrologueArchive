...
import random, types
Component2IconDict = {'boredom': 'Bored', 'restlessness': None, 
   'playfulness': 'Play', 
   'loneliness': 'Lonely', 
   'sadness': 'Sad', 
   'fatigue': 'Sleepy', 
...
class Pet(Avatar.Avatar):
    ...
    InteractAnims = {Interactions.SCRATCH: ('toPet', 'pet', 'fromPet'), Interactions.BEG: ('toBeg', 'beg', 'fromBeg'), 
    ...
    def generatePet(self):
        ...
        self.loadAnims({'toBeg': 'phase_5/models/char/TT_pets-intoBeg', 'beg': 'phase_5/models/char/TT_pets-beg', 
