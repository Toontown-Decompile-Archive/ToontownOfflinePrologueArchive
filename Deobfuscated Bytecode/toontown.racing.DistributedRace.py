...
class DistributedRace(DistributedObject.DistributedObject):
    ...
    def goToSpeedway(self, avIds, reason=RaceGlobals.Exit_UserReq):
        ...
        if localAvatar.doId in avIds:
            ...
            out = {'loader': 'safeZoneLoader', 'where': 'playground', 
               'how': 'teleportIn', 
    ...
    def loadUrbanTrack(self):
        ...
        loader.loadDNAFile(self.dnaStore, 'phase_5/dna/storage_town.pdna')
        loader.loadDNAFile(self.dnaStore, 'phase_4/dna/storage_TT.pdna')
        loader.loadDNAFile(self.dnaStore, 'phase_5/dna/storage_TT_town.pdna')
        loader.loadDNAFile(self.dnaStore, 'phase_8/dna/storage_BR.pdna')
        loader.loadDNAFile(self.dnaStore, 'phase_8/dna/storage_BR_town.pdna')
    ...
    def setRaceZone(self, zoneId, trackId):
        ...
        self.doneBarrier('waitingForExit')
        self.sendUpdate('racerLeft', [localAvatar.doId])
        out = {'loader': 'racetrack', 'where': 'racetrack', 
           'hoodId': hoodId, 
           'zoneId': zoneId, 
           'trackId': trackId, 
           'shardId': None, 
