...
GlobalEntities = {1000: {'type': 'levelMgr', 'name': 'LevelMgr', 'comment': '', 
   ...
   0: {'type': 'zone', 'name': 'UberZone', 
       ...
       'description': '', 
       'visibility': []}, 
   100008: {'type': 'healBarrel', 'name': '<unnamed>', 
            'comment': '', 
            'parentEntId': 0, 
            ...
            'rewardPerGrab': 20, 
            'rewardPerGrabMax': 0}, 
   100000: {'type': 'model', 'name': '<unnamed>', 
            'comment': '', 
            'parentEntId': 100001, 
   ...
   100005: {'type': 'model', 'name': 'copy of <unnamed> (4)', 
            ...
            'loadType': 'loadModel', 
            'modelPath': 'phase_11/models/lawbotHQ/LB_CardBoardBoxX2'}, 
   100009: {'type': 'model', 'name': 'copy of <unnamed> (4)', 
            'comment': '', 
            'parentEntId': 100001, 
   ...
   100017: {'type': 'model', 'name': 'copy of <unnamed> (3)', 
            'comment': '', 
            'parentEntId': 100001, 
   ...
   100012: {'type': 'mover', 'name': 'mover', 
            ...
            'startOn': 1, 
            'switchId': 0}, 
   100001: {'type': 'nodepath', 'name': 'crateMaster', 
            'comment': '', 
            'parentEntId': 0, 
            'pos': Point3(0, 0, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': 1}, 
   100011: {'type': 'nodepath', 'name': 'spotlightMover', 
            'comment': '', 
            'parentEntId': 0, 
            'pos': Point3(29.8179, 0, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100013: {'type': 'nodepath', 'name': 'mover target', 
            'comment': '', 
            'parentEntId': 100011, 
            'pos': Point3(0, 10, 0), 
            'hpr': Point3(180, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100015: {'type': 'nodepath', 'name': 'lightTarget1', 
            'comment': '', 
            'parentEntId': 100011, 
            'pos': Point3(0, -10, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': 1}, 
   100016: {'type': 'nodepath', 'name': 'copy of lightTarget1', 
            'comment': '', 
            'parentEntId': 100011, 
            'pos': Point3(0, 10, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100010: {'type': 'platform', 'name': '<unnamed>', 
            'comment': '', 
            'parentEntId': 0, 
            ...
            'phaseShift': 0.0, 
            'waitPercent': 0.1}, 
   100014: {'type': 'securityCamera', 'name': '<unnamed>', 
            'comment': '', 
            'parentEntId': 100011, 
            'pos': Point3(0, 0, 0), 
            'hpr': Vec3(0, 0, 0), 
            ...
            'trackTarget2': 100016, 
            'trackTarget3': 0}, 
   100006: {'type': 'stomper', 'name': 'copy of <unnamed>', 
            'comment': '', 
            'parentEntId': 0, 
            ...
            'wantSmoke': 1, 
            'zOffset': 0}, 
   100007: {'type': 'stomper', 'name': 'copy of <unnamed>', 
            'comment': '', 
            'parentEntId': 0, 
            ...
            'wantSmoke': 1, 
            'zOffset': 0}, 
   100018: {'type': 'stomper', 'name': '<unnamed>', 
            'comment': '', 
            'parentEntId': 0, 
