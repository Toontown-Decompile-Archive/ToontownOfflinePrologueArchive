...
DisconnectReasons = {DisconnectUnknown: 'unknown', DisconnectBookExit: 'book exit', 
...
toonHeadScales = {'mouse': Point3(1.0), 'cat': Point3(1.0), 
   ...
   'scrooge': Point3(1.0), 
   'pig': Point3(1.0)}
legHeightDict = {'s': 1.5, 'm': 2.0, 
   'l': 2.75}
torsoHeightDict = {'s': 1.5, 'm': 1.75, 
   'l': 2.25, 
   'ss': 1.5, 
   'ms': 1.75, 
   'ls': 2.25, 
   ...
   'md': 1.75, 
   'ld': 2.25}
headHeightDict = {'dls': 0.75, 'dss': 0.5, 
   'dsl': 0.5, 
   'dll': 0.75, 
   'cls': 0.75, 
   'css': 0.5, 
