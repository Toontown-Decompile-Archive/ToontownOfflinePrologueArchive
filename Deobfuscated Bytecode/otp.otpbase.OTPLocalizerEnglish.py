...
LeaveToPay = 'Your account has been locked due to a violation of the Toontown Offline rules.'
LeaveToPayYes = 'Ok'
...
CRBootedReasons = {1: 'Yikes - An unexpected problem occured.  Your connection has been lost, but you should be able to connect again and go right back into Toontown.', 100: 'You have been disconnected because someone else just logged in using your account on another computer.', 
   120: 'You have been disconnected because of a problem with your authorization to use SpeedChat Plus.', 
   122: 'There was an issue getting you into Toontown.  If the problem persists, please contact Toontown Offline Support.', 
   124: 'Your installed files are out of date!  Use the launcher to download the newest version, or contact Toontown Offline Support if the problem persists.', 
   125: 'Your installed files appear to be invalid.  Use the launcher to download the newest version, or contact Toontown Offline Support if the problem persists.', 
   126: "You were automatically kicked because you tried to use administrative tools you don't have access to.", 
   127: "There appears to be a problem with your Toon.  Don't worry - we'll get it straightened out. Please contact Toontown Offline Support and referece Error Code 127.", 
   128: 'There appears to have been a hiccup in your connection to Toontown. You should be able to connect again and go right back into Toontown. If this keeps happening but you are able to go in-game, use SHIFT+F6, take a screenshot, and contact support.', 
   151: 'You were kicked out by one of the developers working on the servers.', 
   152: "You have been banned from the game for a reported violation of our Terms of Use connected to '%(name)s'. For more details, please check the Toontown Offline website.", 
   ...
   154: 'Toontown Offline is going down for an update. Check the Toontown Offline website for more information.', 
   155: "You've been warned for %(dc_reason)s. Try to behave next time!", 
   156: 'Thanks for playing Toontown Offline and contributing to the fight against the Cog menace! You really are Toon enough!', 
   ...
   666: "Most unexpectedly, an error. In time, we will fix this. Can you wait for the next version, please? Kool. Erase any memory of this error occuring. You don't need to report it."}
...
CRSystemMessages = {0: '%s', 
   1: 'ADMIN: %s', 
   2: 'Toon HQ: %s', 
   3: 'Loony Labs: %s', 
   4: 'Toon Council: %s', 
   5: 'SYSTEM: %s', 
   50: 'Toontown Offline will be closing for an update soon. Start wrapping things up!', 
   51: 'Toontown Offline will be closing for an update in %s minutes.', 
   52: 'Toontown Offline will be closing for an update in %s seconds.', 
   53: 'Toontown Offline will be closing for an update in just a moment. Hang tight!', 
   55: 'Toontown Offline will be closing for maintenance soon. Start wrapping things up!', 
   56: 'Toontown Offline will be closing for maintenance in %s minutes.', 
   57: 'Toontown Offline will be closing for maintenance in %s seconds.', 
   58: 'Toontown Offline will be closing for maintanance in just a moment.', 
...
if config.GetBool('want-tto-text', False):
    ...
    CREnteringToontown = 'Toontown Offline'
...
FriendSecretIntro = "If you are playing Toontown Offline with someone you know in the real world, you can become True Friends.  You can chat using the keyboard with your True Friends.  Other Toons won't understand what you're saying.\n\nYou do this by getting a True Friend Code.  Tell the True Friend Code to your friend, but not to anyone else.  When your friend types in your True Friend Code on his or her screen, you'll be True Friends in Toontown!"
...
FriendSecretDetermineSecretAccountRollover = 'A friend across the Toontown Offline network'
...
EmoteFuncDict = {'Wave': 0, 'Happy': 1, 
   ...
   'Sing Note F': 31, 
   'Sing Note G2': 32}
SuitBrushOffs = {'f': ["I'm late for a meeting."], 'p': [
       'Push off.'], 
   'ym': [
        'Yes Man says NO.'], 
   None: [
...
SuitFaceoffTaunts = {'b': ['Would you like to make a donation?', 
   ...
   'p': [
       ...
       "Let's get right to the point.'Get on with it already, I bore easily.", 
   ...
   'ds': [
        "You're going down, in a literal sense.", 
   ...
   'm1': [
        "You're worse than my programs.",
        'Get ready to witness the power of COG.VBS.',
        'I programmed these attacks in Batch.'], 
   'm2': [
        '10 PRINT "YOU\'RE DOOMED"\n20 GOTO PLAYGROUND',
        'This will only require BASIC strategy.',
        "You're just a BASIC enemy.",
        '10 PROMPT "ARE YOU SURE"; ANSWER$'], 
   'm3': [
        'This is a real grey area.',
        "I'll send you into the Grey.",
        "I'm going to cause some harm.",
        "You're going to hat me."], 
   'm4': [
        ...
        'Hear this, Toon.'], 
   'm5': [
        'from toontown.toon import Sadness',
        'toon.setHP(0)',
        'cog.victory = True',
        'return toPlayground'], 
   'm6': [
        'Console.WriteLine("You\'re going back to the playground.")',
        'I C your defeat.',
        'Not very sharp of you to fight me.'], 
   'm7': [
        "I'll take you down, nop problem.",
        'bra.s playground',
        'sub.w hp,137'], 
   'm8': [
        "I'm shutting you down.",
        'Boredom shall be administered.',
        'Administrative action will be taken.',
        'I am in control.']}
SpeedChatStaticTextCommon = {1: lYes, 2: lNo, 
   3: lOK, 
   4: 'SPEEDCHAT PLUS'}
SpeedChatStaticTextToontown = {100: 'Hi!', 101: 'Heya!', 
   102: 'Hello!', 
   103: 'Howdy!', 
   104: 'Hi there!', 
   105: 'Hi everybody!', 
   ...
   5400: 'Welcome to Toontown Offline!', 
   ...
   10110: 'Strong Toons make a strong town! Vote Oldman!', 
   10111: 'Crush the Cogs! Vote Oldman!', 
   10112: "I got some pies over at Flippy's stand!", 
   10113: 'Oh my Walt! I just talked to Flippy!', 
   10114: "I got some free Gags from Lil' Oldman!", 
   10115: "Let's have a pie fight!", 
   ...
   20400: SuitFaceoffTaunts['m1'][0], 
   20401: SuitFaceoffTaunts['m1'][1], 
   20402: SuitFaceoffTaunts['m1'][2], 
   20410: SuitFaceoffTaunts['m2'][0], 
   20411: SuitFaceoffTaunts['m2'][1], 
   20412: SuitFaceoffTaunts['m2'][2], 
   20413: SuitFaceoffTaunts['m2'][3], 
   20420: SuitFaceoffTaunts['m3'][0], 
   20421: SuitFaceoffTaunts['m3'][1], 
   20422: SuitFaceoffTaunts['m3'][2], 
   20423: SuitFaceoffTaunts['m3'][3], 
   20430: SuitFaceoffTaunts['m4'][0], 
   20431: SuitFaceoffTaunts['m4'][1], 
   20432: SuitFaceoffTaunts['m4'][2], 
   20433: SuitFaceoffTaunts['m4'][3], 
   20440: SuitFaceoffTaunts['m5'][0], 
   20441: SuitFaceoffTaunts['m5'][1], 
   20442: SuitFaceoffTaunts['m5'][2], 
   20443: SuitFaceoffTaunts['m5'][3], 
   20450: SuitFaceoffTaunts['m6'][0], 
   20451: SuitFaceoffTaunts['m6'][1], 
   20452: SuitFaceoffTaunts['m6'][2], 
   20460: SuitFaceoffTaunts['m7'][0], 
   20461: SuitFaceoffTaunts['m7'][1], 
   20462: SuitFaceoffTaunts['m7'][2], 
   20470: SuitFaceoffTaunts['m8'][0], 
   20471: SuitFaceoffTaunts['m8'][1], 
   20472: SuitFaceoffTaunts['m8'][2], 
   20473: SuitFaceoffTaunts['m8'][3], 
   21000: 'Here boy!', 
   21001: 'Here girl!', 
   21002: 'Stay.', 
   21003: 'Good boy!', 
...
SpeedChatStaticTextPirates = {50001: 'Aye', 50002: 'Nay', 
   50003: 'Yes', 
   50004: 'No', 
   50005: 'Ok', 
   50100: 'Gangway!', 
...
Emotes = (60505, 60506, 60509, 60510, 60511, 60516, 60519, 60520, 60521, 60522, 60523,
          60524, 60525, 60526, 60527, 60528, 60529, 60530, 60602, 60607, 60611, 60614,
          60615, 60622, 60627, 60629, 60632, 60636, 60638, 60640, 60644, 60652, 60654,
          60657, 60658, 60663, 60664, 60665, 60666, 60668, 60669, 60612, 60661, 60645,
          60629, 60641, 60654, 60630, 60670, 60633, 60676, 60677, 65000, 65001, 60517,
          60678, 60909)
SCFactoryMeetMenuIndexes = (1903, 1904, 1906, 1907, 1908, 1910, 1913, 1915, 1916, 1917,
                            1919, 1922, 1923, 1924, 1932, 1940, 1941)
CustomSCStrings = {10: 'Oh, well.', 20: 'Why not?', 
   30: 'Naturally!', 
...
SCMenuCustomCogIndices = {'bf': (20005, 20014), 'nc': (20015, 20024), 
   'ym': (20025, 20035), 
   'ms': (20036, 20046), 
   'bc': (20047, 20057), 
   'cc': (20058, 20069), 
...
CopyrightedNames = ('mickey', 'mickey mouse', 'mickeymouse', 'minnie', 'minnie mouse',
                    'minniemouse', 'donald', 'donald duck', 'donaldduck', 'pluto',
                    'goofy')
