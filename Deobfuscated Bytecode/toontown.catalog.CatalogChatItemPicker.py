...
class CatalogChatItemPicker(DirectObject.DirectObject):
    ...
    def __init__(self, callback, newMsg):
        ...
        self.panel = DirectFrame(relief=None, geom=DGG.getDefaultDialogGeom(), geom_color=ToontownGlobals.GlobalDialogColor, geom_scale=(1.4,
                                                                                                                                         1,
                                                                                                                                         1.6), text=TTLocalizer.MessagePickerTitle % OTPLocalizer.CustomSCStrings[newMsg], text_pos=(0,
                                                                                                                                                                                                                                     0.68), text_scale=0.05, text_wordwrap=24, pos=(0,
                                                                                                                                                                                                                                                                                    0,
                                                                                                                                                                                                                                                                                    0))
        msgStrings = []
        ...
        self.picker = DirectScrolledList(parent=self.panel, relief=None, pos=(0, 0,
         ...
         gui.find('**/FndsLst_ScrollUp')), incButton_relief=None, incButton_scale=(1.3,
                                                                                   ...
                                                                                   -1.3), incButton_pos=(0,
                                                                                                         0,
                                                                                                         -0.5), incButton_image3_color=Vec4(1, 1, 1, 0.2), decButton_image=(gui.find('**/FndsLst_ScrollUp'),
         gui.find('**/FndsLst_ScrollDN'),
         gui.find('**/FndsLst_ScrollUp_Rllvr'),
         gui.find('**/FndsLst_ScrollUp')), decButton_relief=None, decButton_scale=(1.3,
                                                                                   ...
                                                                                   1.3), decButton_pos=(0,
                                                                                                        0,
                                                                                                        0.5), decButton_image3_color=Vec4(1, 1, 1, 0.2), itemFrame_pos=(0,
                                                                                                                                                                        0,
                                                                                                                                                                        0.39), itemFrame_scale=1.0, itemFrame_relief=DGG.SUNKEN, itemFrame_frameSize=(-0.55,
                                                                                                                                                                                                                                                      0.55,
                                                                                                                                                                                                                                                      -0.85,
                                                                                                                                                                                                                                                      0.06), itemFrame_frameColor=(0.85,
                                                                                                                                                                                                                                                                                   0.95,
                                                                                                                                                                                                                                                                                   1,
                                                                                                                                                                                                                                                                                   1), itemFrame_borderWidth=(0.01,
                                                                                                                                                                                                                                                                                                              0.01), itemMakeFunction=self.makeMessageButton, itemMakeExtraArgs=[base.localAvatar.customMessages], numItemsVisible=NUM_ITEMS_SHOWN, items=msgStrings)
        ...
        exitButton = DirectButton(parent=self.panel, relief=None, pos=(0, 0, -0.7), text=TTLocalizer.MessagePickerCancel, text_scale=TTLocalizer.CCIPexitButton, text_pos=(-0.005,
                                                                                                                                                                           -0.01), text_fg=Vec4(1, 1, 1, 1), textMayChange=0, image=(upButton, downButton, rolloverButton), image_scale=1.1, image_color=(0,
                                                                                                                                                                                                                                                                                                          0.6,
                                                                                                                                                                                                                                                                                                          1,
                                                                                                                                                                                                                                                                                                          1), command=self.__handleCancel)
    ...
    def makeMessageButton(self, name, number, *extraArgs):
        ...
        return DirectButton(relief=None, text=OTPLocalizer.CustomSCStrings[msg], text_pos=(-0.5,
                                                                                           0,
                                                                                           0), text_scale=0.05, text_align=TextNode.ALeft, text1_bg=Vec4(1, 1, 0, 1), text2_bg=Vec4(0.5, 0.9, 1, 1), text3_fg=Vec4(0.4, 0.8, 0.4, 1), command=self.__handleDelete, extraArgs=[msg])
