...
class FactoryLevelMgr(LevelMgr):
    ...
    attribs = (
     ('cogLevel',
      0,
      'int',
      {'min': 0, 'max': 11}), ('wantDoors', 1, 'bool'), ('farPlaneDistance', 1500, 'float'))
...
class GagBarrel(BarrelBase):
    ...
    attribs = (
     ...
     ('gagTrack',
      0,
      'choice',
      {'choiceSet': ('heal', 'trap', 'lure', 'sound', 'throw', 'squirt', 'drop', 'random'), 'valueDict': {'heal': 0, 'trap': 1, 
                       'lure': 2, 
                       'sound': 3, 
                       'throw': 4, 
                       'squirt': 5, 
...
class Switch(Nodepath):
    ...
    attribs = (
     ('isOnEvent',
      0,
      'entId', {'output': 'bool'}), ('isOn', 0, 'bool'), ('secondsOn', 1, 'float'))
...
class Crate(Crushable):
    ...
    attribs = (
     ('modelType',
      0,
      'int',
      {'min': 0, 'max': 1}), ('scale', 0.92, 'float'), ('pushable', 1, 'bool'))
...
class LaserField(Nodepath):
    ...
    attribs = (('laserFactor', 3, 'float'),
     ...
     (
      'modelPath',
      0,
      'choice', {'choiceSet': ['square'], 'valueDict': {'square': 0}}),
     (
...
class ElevatorMarker(Nodepath):
    ...
    attribs = (
     ('modelPath',
      0,
      'choice', {'choiceSet': ['square'], 'valueDict': {'square': 0}}), ('pos', Point3(0, 0, 0), 'pos'), ('hpr', Vec3(0, 0, 0), 'hpr'))
...
class Stomper(Crusher):
    ...
    attribs = (('damage', 3, 'int'),
     (
      'style',
      'vertical',
      'choice', {'choiceSet': ['horizontal', 'vertical']}),
     ('period', 2.0, 'float'),
     (
      'phaseShift',
      0.0,
     ...
     (
      ...
      0,
      'choice',
      {'choiceSet': ['small', 'medium', 'large'], 'valueDict': {'small': 0, 'medium': 1, 
                       'large': 2}}),
     ('soundLen', 0, 'float'),
     ('zOffset', 0, 'float'),
     (
     ...
     (
      ...
      0,
      'choice',
      {'choiceSet': ['default', 'lawbot'], 'valueDict': {'default': 0, 'lawbot': 1}}),
...
class MintProduct(Nodepath):
    ...
    attribs = (
     ('mintId',
      12500,
      'choice',
      {'choiceSet': ('coin', 'dollar', 'bullion'), 'valueDict': {'coin': 12500, 'dollar': 12600, 
                       'bullion': 12700}}),)
...
class Rendering(Nodepath):
    ...
    attribs = (('pos', Point3(0, 0, 0), 'pos'),
     ...
     (
      'blending',
      'Normal',
      'choice', {'choiceSet': ['Normal', 'Additive', 'Alpha']}),
     ('fogOn', 0, 'bool'),
     (
      'renderBin',
      'default',
      'choice', {'choiceSet': ['default', 'fixed', 'transparent']}))
