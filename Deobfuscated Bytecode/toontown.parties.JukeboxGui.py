...
class JukeboxGui(DirectObject):
    ...
    def addToSongList(self, text, phase, filename, length):
        listItem = DirectScrolledListItem(relief=None, parent=self._songsList, text=text, text_align=TextNode.ALeft, text_pos=(0.0,
                                                                                                                               0.0,
                                                                                                                               0.0), text_scale=TTLocalizer.JGlistItem, text_fg=(0.0,
                                                                                                                                                                                 0.0,
                                                                                                                                                                                 0.0,
                                                                                                                                                                                 1.0), text1_fg=(1.0,
                                                                                                                                                                                                 1.0,
                                                                                                                                                                                                 ...
                                                                                                                                                                                                 1.0), text1_bg=(0.0,
                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                 1.0), text2_fg=(0.0,
                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                 1.0), text3_bg=(0.0,
                                                                                                                                                                                                                                                 0.8,
                                                                                                                                                                                                                                                 0.0,
                                                                                                                                                                                                                                                 1.0), command=self.__handleSongListItemSelect, extraArgs=[])
    ...
    def addSongToQueue(self, text, highlight=False, moveToTopButton=False):
        listItem = DirectLabel(relief=None, parent=self._queueList, text=text, text_align=TextNode.ALeft, text_pos=(0.0,
                                                                                                                    0.0,
                                                                                                                    0.0), text_scale=TTLocalizer.JGlistItem)
