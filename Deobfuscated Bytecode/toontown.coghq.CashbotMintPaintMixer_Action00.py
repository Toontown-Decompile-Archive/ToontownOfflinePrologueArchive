...
GlobalEntities = {1000: {'type': 'levelMgr', 'name': 'LevelMgr', 'comment': '', 
   ...
   0: {'type': 'zone', 'name': 'UberZone', 
       ...
       'description': '', 
       'visibility': []}, 
   10009: {'type': 'healBarrel', 'name': '<unnamed>', 
           'comment': '', 
           'parentEntId': 0, 
           ...
           'rewardPerGrab': 8, 
           'rewardPerGrabMax': 0}, 
   10010: {'type': 'healBarrel', 'name': 'copy of <unnamed>', 
           'comment': '', 
           'parentEntId': 10009, 
   ...
   10004: {'type': 'paintMixer', 'name': 'mixer0', 
           ...
           'shaftScale': 1, 
           'waitPercent': 0.1}, 
   10005: {'type': 'paintMixer', 'name': 'mixer1', 
           'comment': '', 
           'parentEntId': 10000, 
           ...
           'shaftScale': 1, 
           'waitPercent': 0.1}, 
   10006: {'type': 'paintMixer', 'name': 'mixer2', 
           'comment': '', 
           'parentEntId': 10000, 
