...
if not config.GetBool('want-new-anims', 1):
    HeadDict = {'dls': '/models/char/dogMM_Shorts-head-', 'dss': '/models/char/dogMM_Skirt-head-', 'dsl': '/models/char/dogSS_Shorts-head-', 
       ...
       'o': '/models/char/scrooge-heads-'}
else:
    HeadDict = {'dls': '/models/char/tt_a_chr_dgm_shorts_head_', 'dss': '/models/char/tt_a_chr_dgm_skirt_head_', 
       ...
       's': '/models/char/pig-heads-', 
       'o': '/models/char/scrooge-heads-'}
EyelashDict = {'d': '/models/char/dog-lashes', 'c': '/models/char/cat-lashes', 'h': '/models/char/horse-lashes', 
   ...
   'o': '/models/char/scrooge-lashes'}
DogMuzzleDict = {'dls': '/models/char/dogMM_Shorts-headMuzzles-', 'dss': '/models/char/dogMM_Skirt-headMuzzles-', 
...
class ToonHead(Actor.Actor):
    ...
    def __fixHeadLongShort(self, style, lodName=None, copy=1):
        ...
        if lodName == None:
            ...
            searchRoot = self.find('**/' + str(lodName))
        if animalType != 'duck' and animalType != 'horse' and animalType != 'scrooge':
