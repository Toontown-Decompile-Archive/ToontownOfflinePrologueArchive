    ...
    def createFrame(self, message, framePos=None, withStopping=True, ttDialog=False):
        ...
        if not ttDialog:
            self.frame = DirectFrame(relief=None, image=DGG.getDefaultDialogGeom(), image_color=ToontownGlobals.GlobalDialogColor, image_scale=(1.0,
                                                                                                                                                1.0,
                                                                                                                                                0.4), text=message, text_wordwrap=16, text_scale=0.06, text_pos=(-0.0,
                                                                                                                                                                                                                 0.1), pos=framePos)
        else:
        ...
        self.doneButton = DirectButton(parent=self.frame, relief=None, image=self.cancelImageList, command=self.handleButton, pos=(0,
                                                                                                                                   0,
                                                                                                                                   -0.14))
        if not withStopping:
