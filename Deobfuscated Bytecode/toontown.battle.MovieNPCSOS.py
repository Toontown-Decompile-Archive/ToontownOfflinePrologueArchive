...
soundFiles = ('AA_heal_tickle.ogg', 'AA_heal_telljoke.ogg', 'AA_heal_smooch.ogg', 'AA_heal_happydance.ogg',
              'AA_heal_pixiedust.ogg', 'AA_heal_juggle.ogg')
...
NPCSOSfn_dict = {ToontownBattleGlobals.NPC_COGS_MISS: __cogsMiss, ToontownBattleGlobals.NPC_TOONS_HIT: __toonsHit, 
...
def doNPCSOSs(NPCSOSs):
    if len(NPCSOSs) == 0:
        ...
        if camDuration > 0.0:
            ...
            camTrack = Sequence()
        return (
         track, Parallel(camTrack, textTrack))
