...
WallpaperTypes = {1000: ('phase_5.5/maps/flat_wallpaper1.jpg',
        ...
        180), 
   1100: (
        'phase_5.5/maps/big_stripes1.jpg',
        CTWhite,
        (0, 1010),
        180), 
   1110: (
   ...
   1120: (
        ...
        180), 
   1130: (
        'phase_5.5/maps/big_stripes4.jpg',
        CTWhite,
        (0, 1010),
        180), 
   1140: (
        ...
        180), 
   1150: (
        'phase_5.5/maps/big_stripes6.jpg',
        CTWhite,
        (0, 1020),
        180), 
   1200: (
        ...
        180), 
   1210: (
        'phase_5.5/maps/stripeB2.jpg',
        CTWhite,
        (0, 1000),
        180), 
   1220: (
        'phase_5.5/maps/stripeB3.jpg',
        CTWhite,
        (0, 1000),
        180), 
   1230: (
        'phase_5.5/maps/stripeB4.jpg',
        CTWhite,
        (0, 1000),
        180), 
   1240: (
   ...
   1430: (
        ...
        180), 
   1440: (
        'phase_5.5/maps/two_stripes2.jpg',
        CTWhite,
        (0, 1000),
        180), 
   1450: (
        'phase_5.5/maps/two_stripes3.jpg',
        CTWhite,
        (0, 1000),
        180), 
   1500: (
        'phase_5.5/maps/leaves1.jpg',
        CTWhite,
        (0, ),
        180), 
   1510: (
        'phase_5.5/maps/leaves2.jpg',
        CTWhite,
        (0, ),
        180), 
   1520: (
        'phase_5.5/maps/leaves3.jpg',
        CTWhite,
        (0, ),
        180), 
   1600: (
   ...
   1610: (
        ...
        180), 
   1620: (
        'phase_5.5/maps/diamonds3_cherry.jpg',
        CTWhite,
        (0, 1000),
        180), 
   1630: (
        'phase_5.5/maps/diamonds4_cherries.jpg',
        CTWhite,
        (0, 1000),
        180), 
   1640: (
        'phase_5.5/maps/diamonds4_cherry.jpg',
        CTWhite,
        (0, 1000),
        180), 
   1650: (
   ...
   1660: (
        ...
        180), 
   1700: (
        'phase_5.5/maps/moon1.jpg',
        CTWhite,
        (0, ),
        180), 
   1710: (
        'phase_5.5/maps/moon2.jpg',
        CTWhite,
        (0, ),
        180), 
   1720: (
        'phase_5.5/maps/moon3.jpg',
        CTWhite,
        (0, ),
        180), 
   1730: (
        'phase_5.5/maps/moon4.jpg',
        CTWhite,
        (0, ),
        180), 
   1740: (
        'phase_5.5/maps/moon5.jpg',
        CTWhite,
        (0, ),
        180), 
   1750: (
        'phase_5.5/maps/moon6.jpg',
        CTWhite,
        (0, ),
        180), 
   1760: (
        'phase_5.5/maps/moon7.jpg',
        CTWhite,
        (0, ),
        180), 
   1800: (
        'phase_5.5/maps/stars1.jpg',
        CTWhite,
        (0, ),
        180), 
   1810: (
        'phase_5.5/maps/stars2.jpg',
        (
   ...
   1820: (
        ...
        180), 
   1830: (
        'phase_5.5/maps/stars4.jpg',
        CTWhite,
        (0, ),
        180), 
   1840: (
        'phase_5.5/maps/stars5.jpg',
        CTWhite,
        (0, ),
        180), 
   1850: (
        'phase_5.5/maps/stars6.jpg',
        CTWhite,
        (0, ),
        180), 
   1860: (
        'phase_5.5/maps/stars7.jpg',
        (
         CT_BEIGE2, CT_WHITE),
        (0, ),
        180), 
   1900: (
        'phase_5.5/maps/wall_paper_flower1.jpg',
        CTWhite,
        (0, 1000),
        180), 
   1910: (
        'phase_5.5/maps/wall_paper_flower2.jpg',
        CTWhite,
        (0, 1000),
        180), 
   1920: (
        'phase_5.5/maps/wall_paper_flower3.jpg',
        CTWhite,
        (0, 1000),
        180), 
   1930: (
        'phase_5.5/maps/wall_paper_flower4.jpg',
        CTWhite,
        (0, 1000),
        180), 
   1940: (
        'phase_5.5/maps/wall_paper_flower5.jpg',
        CTWhite,
        (0, 1000),
        180), 
   1950: (
        'phase_5.5/maps/wall_paper_flower6.jpg',
        CTWhite,
        (0, 1000),
        180), 
   2000: (
   ...
   2140: (
        ...
        180), 
   2200: (
        'phase_5.5/maps/wall_paper_car.jpg',
        CTWhite,
        (0, 1000),
        180), 
   2210: (
        'phase_5.5/maps/wall_paper_car_neutral.jpg',
        CTFlatColor,
        (0, 1000),
        180), 
   2300: (
        ...
        180), 
   2400: (
        'phase_5.5/maps/wall_paper_clouds.jpg',
        CTWhite,
        (0, 1000),
        180), 
   2500: (
        ...
        180), 
   2600: (
        'phase_5.5/maps/basket.jpg',
        CTWhite,
        (0, 1000),
        180), 
   2610: (
        'phase_5.5/maps/basket_neutral.jpg',
        CTFlatColor,
        (0, 1000),
        180), 
   2700: (
        'phase_5.5/maps/doll.jpg',
        CTWhite,
        (0, 1000, 1110),
        180), 
   2710: (
        'phase_5.5/maps/doll_neutral.jpg',
        CTFlatColor,
        (0, 1100, 1110),
        180), 
   2800: (
        'phase_5.5/maps/littleFlowers.jpg',
        CTWhite,
        (0, 1000),
        180), 
   2810: (
        'phase_5.5/maps/littleFlowers_neutral.jpg',
        CTFlatColor,
        (0, 1000),
        180), 
   2900: (
        'phase_5.5/maps/UWwallPaperAngelFish.jpg',
        CTWhite,
        (0, 1120, 1160),
        180), 
   2910: (
        ...
        180), 
   2920: (
        'phase_5.5/maps/UWwallPaperBubbles.jpg',
        CTWhite,
        (0, 1120, 1160),
        180), 
   2930: (
        'phase_5.5/maps/UWwallPaperBubbles2.jpg',
        CTWhite,
        (0, 1120, 1160),
        180), 
   2940: (
        'phase_5.5/maps/UWwallPaperGreenFish.jpg',
        CTWhite,
        (0, 1120, 1160),
        180), 
   2950: (
        'phase_5.5/maps/UWwallPaperRedFish.jpg',
        CTWhite,
        (0, 1120, 1160),
        180), 
   2960: (
        'phase_5.5/maps/UWwallPaperSea_horse.jpg',
        CTWhite,
        (0, 1120, 1160),
        180), 
   2970: (
   ...
   3600: (
        ...
        180), 
   3700: (
        'phase_5.5/maps/WesternBootWallpaper1.jpg',
        CTWhite,
        (0, 1170, 1180),
        180), 
   3800: (
        'phase_5.5/maps/WesternCactusWallpaper1.jpg',
        CTWhite,
        (0, 1170, 1180),
        180), 
   3900: (
        'phase_5.5/maps/WesternHatWallpaper1.jpg',
        CTWhite,
        (0, 1170, 1180),
        180), 
   10100: (
         'phase_5.5/maps/cats1.jpg',
         CTWhite,
         (0, 10010, 10020),
         400), 
   10200: (
         'phase_5.5/maps/bats2.jpg',
         CTWhite,
         (0, 10010, 10020),
         400), 
   11000: (
         ...
         400), 
   11100: (
         'phase_5.5/maps/wall_paper_hollyleaf.jpg',
         CTWhite,
         (0, 11000, 11010),
         400), 
   11200: (
         'phase_5.5/maps/wall_paper_snowman.jpg',
         CTWhite,
         (0, 11000, 11010),
         400), 
   12000: (
         'phase_5.5/maps/VdayWall1.jpg',
         CTWhite,
         (0, 12000, 12010, 12020),
         400), 
   12100: (
         'phase_5.5/maps/VdayWall2.jpg',
         CTWhite,
         (0, 12000, 12010, 12020),
         400), 
   12200: (
         'phase_5.5/maps/VdayWall3.jpg',
         CTWhite,
         (0, 12000, 12010, 12020),
         400), 
   12300: (
         'phase_5.5/maps/VdayWall4.jpg',
         CTWhite,
         (0, 12000, 12010, 12020),
         400), 
   13000: (
         'phase_5.5/maps/StPatWallpaper1.jpg',
         CTWhite,
         (0, 13000),
         400), 
   13100: (
         'phase_5.5/maps/StPatWallpaper2.jpg',
         CTWhite,
         (0, 13000),
         400), 
   13200: (
         'phase_5.5/maps/StPatWallpaper3.jpg',
         CTWhite,
         (0, 13000),
         400), 
   13300: (
         'phase_5.5/maps/StPatWallpaper4.jpg',
         CTWhite,
         (0, 13000),
         400)}
WallpaperGroups = {1100: (1100, 1110, 1120, 1130, 1140, 1150), 
   ...
   2800: (2800, 2810), 
   2900: (2900, 2910)}
BorderTypes = {1000: ('phase_5.5/maps/bd_grey_border1.jpg', CTFlatColorDark), 1010: (
        'phase_5.5/maps/diamonds_border2.jpg', CTWhite), 
   1020: (
        'phase_5.5/maps/diamonds_border2ch.jpg', CTWhite), 
   1030: (
        'phase_5.5/maps/diamonds_border3ch.jpg', CTWhite), 
   1040: (
        'phase_5.5/maps/diamonds_border4ch.jpg', CTWhite), 
   1050: (
        'phase_5.5/maps/flower_border2.jpg', CTWhite), 
   1060: (
        'phase_5.5/maps/flower_border5.jpg', CTWhite), 
   1070: (
        'phase_5.5/maps/flower_border6.jpg', CTWhite), 
   1080: (
        'phase_5.5/maps/football_border_neutral.jpg', CTFlatColorDark), 
   1090: (
        'phase_5.5/maps/vine_border1.jpg', CTFlatColorDark), 
   1100: (
        'phase_5.5/maps/doll_board.jpg', CTWhite), 
   1110: (
        'phase_5.5/maps/doll_board_neutral.jpg', CTFlatColorDark), 
   1120: (
        'phase_5.5/maps/UWwallPaperPlantBorder.jpg', CTWhite), 
   1130: (
        'phase_5.5/maps/UWwallPaperSea_horseBorder.jpg', CTWhite), 
   1140: (
        'phase_5.5/maps/UWwallPaperShellBorder1.jpg', CTWhite), 
   1150: (
        'phase_5.5/maps/UWwallPaperShellBorder2.jpg', CTWhite), 
   1160: (
        'phase_5.5/maps/UWwallPaperWaveBorder.jpg', CTWhite), 
   1170: (
        'phase_5.5/maps/WesternSkullBorder.jpg', CTWhite), 
   1180: (
        'phase_5.5/maps/WesternStarBorder.jpg', CTWhite), 
   10010: (
         'phase_5.5/maps/border_ScarryMoon1.jpg', CTWhite), 
   10020: (
         'phase_5.5/maps/border_candy1.jpg', CTWhite), 
   11000: (
         'phase_5.5/maps/flakes_border.jpg', CTWhite), 
   11010: (
         'phase_5.5/maps/hollyleaf_border.jpg', CTWhite), 
   12000: (
         'phase_5.5/maps/Vborder1a.jpg', CTWhite), 
   12010: (
         'phase_5.5/maps/Vborder1b.jpg', CTWhite), 
   12020: (
         'phase_5.5/maps/Vborder2b.jpg', CTWhite), 
   13000: (
         'phase_5.5/maps/StPatBorder1.jpg', CTWhite)}
