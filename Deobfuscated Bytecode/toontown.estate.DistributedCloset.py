...
import ClosetGlobals, DistributedFurnitureItem
...
class DistributedCloset(DistributedFurnitureItem.DistributedFurnitureItem):
    ...
    def _popupTimeoutPanel(self):
        ...
        self.popupInfo = DirectFrame(parent=hidden, relief=None, state='normal', text=TTLocalizer.ClosetTimeoutMessage, frameSize=(-1,
                                                                                                                                   1,
                                                                                                                                   -1,
                                                                                                                                   1), geom=DGG.getDefaultDialogGeom(), geom_color=ToontownGlobals.GlobalDialogColor, geom_scale=(0.88,
                                                                                                                                                                                                                                  1,
                                                                                                                                                                                                                                  0.45), geom_pos=(0,
                                                                                                                                                                                                                                                   0,
        ...
        DirectButton(self.popupInfo, image=okButtonImage, relief=None, text=TTLocalizer.ClosetPopupOK, text_scale=0.05, text_pos=(0.0,
                                                                                                                                  -0.1), textMayChange=0, pos=(0.0,
                                                                                                                                                               0.0,
                                                                                                                                                               -0.16), command=self.__handleTimeoutMessageOK)
        buttons.removeNode()
    ...
    def __popupNotOwnerPanel(self):
        ...
        buttons = loader.loadModel('phase_3/models/gui/dialog_box_buttons_gui')
        okButtonImage = (buttons.find('**/ChtBx_OKBtn_UP'), buttons.find('**/ChtBx_OKBtn_DN'), buttons.find('**/ChtBx_OKBtn_Rllvr'))
        self.popupInfo = DirectFrame(parent=hidden, relief=None, state='normal', text=TTLocalizer.ClosetNotOwnerMessage, frameSize=(-1,
                                                                                                                                    1,
                                                                                                                                    -1,
    ...
    def __popupAreYouSurePanel(self):
        ...
        self.popupInfo = DirectFrame(parent=hidden, relief=None, state='normal', text=TTLocalizer.ClosetAreYouSureMessage, frameSize=(-1,
                                                                                                                                      1,
                                                                                                                                      -1,
                                                                                                                                      1), text_wordwrap=10, geom=DGG.getDefaultDialogGeom(), geom_color=ToontownGlobals.GlobalDialogColor, geom_scale=(0.88,
                                                                                                                                                                                                                                                       1,
