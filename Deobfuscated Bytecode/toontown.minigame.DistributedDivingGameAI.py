...
import DivingGameGlobals, random, random, types
...
class DistributedDivingGameAI(DistributedMinigameAI):
    ...
    fishProportions[5].append(([n, n],
     ...
     [
      0.6, 1]))
    difficultyPatternsAI = {ToontownGlobals.ToontownCentral: [3.5, fishProportions[0], 1.5], ToontownGlobals.DonaldsDock: [
