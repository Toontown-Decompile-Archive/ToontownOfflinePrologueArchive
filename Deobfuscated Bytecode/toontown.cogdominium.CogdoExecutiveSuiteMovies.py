...
class CogdoExecutiveSuiteIntro(CogdoGameMovie):
    ...
    def load(self):
        ...
        self.gameTitleText = DirectLabel(parent=self.frame, text=TTLocalizer.CogdoExecutiveSuiteTitle, scale=TTLocalizer.MRPgameTitleText * 0.8, text_align=TextNode.ACenter, text_font=getSignFont(), text_fg=(1.0,
                                                                                                                                                                                                                0.33,
                                                                                                                                                                                                                0.33,
