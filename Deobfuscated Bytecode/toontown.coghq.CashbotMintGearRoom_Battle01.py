...
GlobalEntities = {1000: {'type': 'levelMgr', 'name': 'LevelMgr', 'comment': '', 
   ...
   0: {'type': 'zone', 'name': 'UberZone', 
       ...
       'description': '', 
       'visibility': []}, 
   10015: {'type': 'gagBarrel', 'name': '<unnamed>', 
           'comment': '', 
           'parentEntId': 10009, 
   ...
   10007: {'type': 'gear', 'name': '<unnamed>', 
           ...
           'phaseShift': 0}, 
   10008: {'type': 'gear', 'name': 'copy of <unnamed>', 
           'comment': '', 
           'parentEntId': 10003, 
           ...
           'orientation': 'horizontal', 
           'phaseShift': 0.26}, 
   10016: {'type': 'healBarrel', 'name': '<unnamed>', 
           'comment': '', 
           'parentEntId': 10009, 
   ...
   10001: {'type': 'locator', 'name': '<unnamed>', 
           ...
           'parentEntId': 0, 
           'searchPath': '**/EXIT'}, 
   10012: {'type': 'mintProduct', 'name': '<unnamed>', 
           'comment': '', 
           'parentEntId': 10011, 
           ...
           'scale': Vec3(1.0, 1.0, 1.0), 
           'mintId': 12500}, 
   10013: {'type': 'mintProduct', 'name': 'copy of <unnamed>', 
           'comment': '', 
           'parentEntId': 10011, 
   ...
   10003: {'type': 'nodepath', 'name': 'props', 
           ...
           'hpr': Vec3(0.0, 0.0, 0.0), 
           'scale': 1}, 
   10009: {'type': 'nodepath', 'name': 'barrels', 
           'comment': '', 
           'parentEntId': 0, 
           'pos': Point3(39.311466217, 1.05693364143, 0.0), 
           'hpr': Point3(0.0, 0.0, 0.0), 
           'scale': Vec3(1.0, 1.0, 1.0)}, 
   10011: {'type': 'nodepath', 'name': 'product', 
           'comment': '', 
           'parentEntId': 10003, 
