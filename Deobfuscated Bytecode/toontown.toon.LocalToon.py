...
import random, math, time, re, zlib
...
import DistributedToon, Toon, LaffMeter
...
class LocalToon(DistributedToon.DistributedToon, LocalAvatar.LocalAvatar):
    ...
    def __init__(self, cr):
        try:
            ...
            if config.GetBool('want-tto-runsound', False):
                self.soundRun = base.loadSfx('phase_3.5/audio/sfx/AV_footstep_runloop_tto.ogg')
            else:
            ...
            self.soundSystemMessage = base.loadSfx('phase_4/audio/sfx/clock03.ogg')
            ...
            self.bFriendsList = DirectButton(image=(friendsButtonNormal, friendsButtonPressed, friendsButtonRollover), relief=None, pos=(-0.141,
                                                                                                                                         0,
                                                                                                                                         -0.125), parent=base.a2dTopRight, scale=newScale, text=('', TTLocalizer.FriendsListLabel, TTLocalizer.FriendsListLabel), text_scale=0.09, text_fg=Vec4(1, 1, 1, 1), text_shadow=Vec4(0, 0, 0, 1), text_pos=(0,
                                                                                                                                                                                                                                                                                                                                                     -0.18), text_font=ToontownGlobals.getInterfaceFont(), command=self.sendFriendsListEvent)
    ...
    def stopGlitchKiller(self):
        if __dev__ and hasattr(self, 'glitchMessage'):
            if self.glitchMessage == 'START GLITCH KILLER':
                ...
                if self.glitchMessage == 'GLITCH KILLER ENGAGED':
                    self.notify.debug('GLITCH KILLER DISENGAGED')
                else:
                    if self.glitchMessage == 'GLITCH KILLER GO!':
    ...
    def initInterface(self):
        ...
        self.wordPage.load()
        self.book.addPage(self.wordPage, pageName=TTLocalizer.WordPageTitle)
        ...
        if not base.cr.isPaid():
            ...
            self.purchaseButton = DirectButton(parent=aspect2d, relief=None, image=(guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale=0.9, text=TTLocalizer.OptionsPagePurchase, text_scale=0.05, text_pos=(0,
                                                                                                                                                                                                                                                                            -0.01), textMayChange=0, pos=(0.885,
                                                                                                                                                                                                                                                                                                          0,
                                                                                                                                                                                                                                                                                                          -0.94), sortOrder=100, command=self.__handlePurchase)
    ...
    def makePiePowerMeter(self):
        ...
        if self.__piePowerMeter == None:
            self.__piePowerMeter = DirectWaitBar(frameSize=(-0.2, 0.2, -0.03, 0.03), relief=DGG.SUNKEN, borderWidth=(0.005,
                                                                                                                     0.005), barColor=(0.4,
                                                                                                                                       0.6,
                                                                                                                                       1.0,
                                                                                                                                       1), pos=(0,
        ...
        if not haveButton and not wantButton:
            ...
            if self.__pieButton == None:
                ...
                if self.pieType >= len(inv.invModels[ToontownBattleGlobals.THROW_TRACK]):
                    ...
                    pieScale = 0.85
                self.__pieButton = DirectButton(image=(inv.upButton, inv.downButton, inv.rolloverButton), geom=pieGui, text='50', text_scale=0.04, text_align=TextNode.ARight, geom_scale=pieScale, geom_pos=(-0.01,
                                                                                                                                                                                                              0,
    ...
    def loadFurnitureGui(self):
        if self.__furnitureGui:
            ...
            self.__furnitureGui = DirectFrame(relief=None, parent=base.a2dTopLeft, pos=(0.115,
                                                                                        0.0,
                                                                                        -0.66), scale=0.04, image=guiModels.find('**/attic'))
            ...
            DirectButton(parent=self.__furnitureGui, relief=None, image=[bMoveStartUp,
             bMoveStartDown,
             bMoveStartRollover,
             bMoveStartUp], text=['', TTLocalizer.HDMoveFurnitureButton, TTLocalizer.HDMoveFurnitureButton], text_fg=(1,
                                                                                                                      1,
                                                                                                                      1,
                                                                                                                      1), text_shadow=(0,
                                                                                                                                       0,
                                                                                                                                       ...
                                                                                                                                       1), text_font=ToontownGlobals.getInterfaceFont(), pos=(-0.3,
                                                                                                                                                                                              0,
                                                                                                                                                                                              9.4), command=self.__startMoveFurniture)
    ...
    def loadClarabelleGui(self):
        if self.__clarabelleButton:
            ...
            self.__clarabelleButton = DirectButton(relief=None, image=circle, text='', text_fg=(1,
                                                                                                1,
                                                                                                1,
                                                                                                1), text_shadow=(0,
                                                                                                                 0,
                                                                                                                 0,
                                                                                                                 1), text_scale=0.1, text_pos=(-1.06,
                                                                                                                                               1.06), text_font=ToontownGlobals.getInterfaceFont(), pos=newPos, scale=newScale, command=self.__handleClarabelleButton)
    ...
    def showClarabelleGui(self, mailboxItems):
        ...
        if mailboxItems:
            self.__clarabelleButton['text'] = [
             '', TTLocalizer.CatalogNewDeliveryButton, TTLocalizer.CatalogNewDeliveryButton]
        else:
            self.__clarabelleButton['text'] = [
             '', TTLocalizer.CatalogNewCatalogButton, TTLocalizer.CatalogNewCatalogButton]
        if not self.mailboxNotify and not self.awardNotify and self.catalogNotify == ToontownGlobals.OldItems and (self.simpleMailNotify != ToontownGlobals.NoItems or self.inviteMailNotify != ToontownGlobals.NoItems):
            self.__clarabelleButton['text'] = [
             '', TTLocalizer.MailNewMailButton, TTLocalizer.MailNewMailButton]
        ...
        if self.friendsListButtonActive and self.friendsListButtonObscured <= 0:
            ...
            if self.clarabelleButtonObscured <= 0 and self.isTeleportAllowed():
                if self.catalogNotify == ToontownGlobals.NewItems or self.mailboxNotify == ToontownGlobals.NewItems or self.simpleMailNotify == ToontownGlobals.NewItems or self.inviteMailNotify == ToontownGlobals.NewItems or self.awardNotify == ToontownGlobals.NewItems:
                    showClarabelle = (not launcher or launcher.getPhaseComplete(5.5)) and not (base.config.GetBool('want-doomsday-reborn', False) or base.config.GetBool('want-doomsday', False))
            ...
            if self.mailboxNotify == ToontownGlobals.NoItems:
                if self.catalogNotify == ToontownGlobals.NewItems:
                    if self.catalogScheduleCurrentWeek == 1:
                        message = (
                         TTLocalizer.CatalogNotifyFirstCatalog, TTLocalizer.CatalogNotifyInstructions)
                    else:
                        message = (
                ...
                if self.catalogNotify == ToontownGlobals.NewItems:
                    message = (
                     TTLocalizer.CatalogNotifyNewCatalogNewDelivery % weekNumber,)
                else:
                    message = (
                     TTLocalizer.CatalogNotifyNewDelivery,)
            elif self.mailboxNotify == ToontownGlobals.OldItems:
                if self.catalogNotify == ToontownGlobals.NewItems:
                    message = (
                     TTLocalizer.CatalogNotifyNewCatalogOldDelivery % weekNumber,)
                else:
                    message = (
                     TTLocalizer.CatalogNotifyOldDelivery,)
    ...
    def loadGardeningGui(self):
        if self.__gardeningGui:
            ...
            self.__gardeningGui = DirectFrame(relief=None, parent=base.a2dTopLeft, geom=gardenGuiCard, geom_color=GlobalDialogColor, geom_scale=(0.17,
                                                                                                                                                 1.0,
                                                                                                                                                 0.3), pos=(0.1335,
                                                                                                                                                            0.0,
                                                                                                                                                            -0.5), scale=1.0)
            self.__gardeningGui.setName('gardeningFrame')
            self.__gardeningGuiFake = DirectFrame(relief=None, parent=base.a2dTopLeft, geom=None, geom_color=GlobalDialogColor, geom_scale=(0.17,
                                                                                                                                            1.0,
                                                                                                                                            0.3), pos=(0.1335,
                                                                                                                                                       0.0,
                                                                                                                                                       -0.5), scale=1.0)
            ...
            self.shovelText = ('',
             ...
             buttonText,
             '')
            self.__shovelButtonFake = DirectLabel(parent=self.__gardeningGuiFake, relief=None, text=self.shovelText, text_align=TextNode.ALeft, text_pos=(0.0,
                                                                                                                                                          -0.0), text_scale=0.07, text_fg=(1,
                                                                                                                                                                                           1,
                                                                                                                                                                                           1,
                                                                                                                                                                                           1), text_shadow=(0,
                                                                                                                                                                                                            0,
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            1), image_scale=(0.18,
                                                                                                                                                                                                                             1.0,
                                                                                                                                                                                                                             0.36), geom=None, geom_scale=iconScale, geom_color=iconColorWhite, pos=(0.15,
                                                                                                                                                                                                                                                                                                     0,
                                                                                                                                                                                                                                                                                                     0.2), scale=0.775)
            ...
            self.shovelText = ('',
             ...
             buttonText,
             '')
            self.__shovelButton = DirectButton(parent=self.__gardeningGui, relief=None, text=self.shovelText, text_align=TextNode.ACenter, text_pos=(0.0,
                                                                                                                                                     -0.0), text_scale=0.1, text_fg=(1,
                                                                                                                                                                                     1,
                                                                                                                                                                                     1,
                                                                                                                                                                                     1), text_shadow=(0,
                                                                                                                                                                                                      0,
             ...
             shovelCardY,
             shovelCardY,
             shovelCardY), image_scale=(0.18, 1.0, 0.36), geom=None, geom_scale=iconScale, geom_color=iconColorWhite, pos=(0,
                                                                                                                           0,
                                                                                                                           0.2), scale=0.775, command=self.__shovelButtonClicked)
            ...
            self.waterText = (buttonText,
             ...
             buttonText,
             '')
            self.__wateringCanButtonFake = DirectLabel(parent=self.__gardeningGuiFake, relief=None, text=self.waterText, text_align=TextNode.ALeft, text_pos=(0.0,
                                                                                                                                                              -0.0), text_scale=0.07, text_fg=(1,
                                                                                                                                                                                               1,
                                                                                                                                                                                               1,
                                                                                                                                                                                               1), text_shadow=(0,
            ...
            self.__wateringCanButton = DirectButton(parent=self.__gardeningGui, relief=None, text=self.waterText, text_align=TextNode.ACenter, text_pos=(0.0,
                                                                                                                                                         -0.0), text_scale=0.1, text_fg=(1,
                                                                                                                                                                                         1,
                                                                                                                                                                                         1,
                                                                                                                                                                                         1), text_shadow=(0,
                                                                                                                                                                                                          0,
                                                                                                                                                                                                          0,
                                                                                                                                                                                                          1), image=(wateringCanCardP,
             wateringCanCardY,
             wateringCanCardY,
             wateringCanCardY), image_scale=(0.18, 1.0, 0.36), geom=None, geom_scale=iconScale, geom_color=iconColorWhite, pos=(0,
                                                                                                                                0,
                                                                                                                                0.01), scale=0.775, command=self.__wateringCanButtonClicked)
            self.wateringCanButton = self.__wateringCanButton
            self.basketText = '%s / %s' % (self.numFlowers, self.maxFlowerBasket)
            self.basketButton = DirectLabel(parent=self.__gardeningGui, relief=None, text=self.basketText, text_align=TextNode.ALeft, text_pos=(0.82,
                                                                                                                                                -1.4), text_scale=0.2, text_fg=(1,
                                                                                                                                                                                1,
                                                                                                                                                                                1,
                                                                                                                                                                                1), text_shadow=(0,
                                                                                                                                                                                                 0,
                                                                                                                                                                                                 0,
                                                                                                                                                                                                 1), image=None, image_scale=iconScale, geom=None, geom_scale=iconScale, geom_color=iconColorWhite, pos=(-0.34,
                                                                                                                                                                                                                                                                                                         0,
                                                                                                                                                                                                                                                                                                         0.16), scale=0.3, textMayChange=1)
    ...
    def setShovelSkill(self, skillLevel):
        ...
        if hasattr(self, 'shovel'):
            ...
            if skillLevel >= GardenGlobals.ShovelAttributes[self.shovel]['skillPts']:
                ...
                if oldShovelSkill and oldShovelPower < newShovelPower:
    ...
    def promoteShovelSkill(self, shovelLevel, shovelSkill):
        ...
        doPartyBall = False
        message = TTLocalizer.GardenShovelSkillLevelUp % {'shovel': shovelName, 'oldbeans': oldShovelBeans, 
        ...
        if shovelBeans == GardenGlobals.getNumberOfShovelBoxes():
            if shovelSkill == GardenGlobals.ShovelAttributes[shovelLevel]['skillPts'] - 1:
                doPartyBall = True
                message = TTLocalizer.GardenShovelSkillMaxed % {'shovel': shovelName, 'oldbeans': oldShovelBeans, 
                   'newbeans': shovelBeans}
    ...
    def promoteShovel(self, shovelLevel=0):
        ...
        message = TTLocalizer.GardenShovelLevelUp % {'shovel': shovelName, 'oldbeans': shovelBeans - 1, 
           'newbeans': shovelBeans}
        messagePos = Vec2(0, 0.2)
        messageScale = 0.07
        image = loader.loadModel('phase_5.5/models/gui/planting_but_shovel_P')
