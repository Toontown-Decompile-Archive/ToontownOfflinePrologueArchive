...
import ArrowKeys, TargetGameGlobals
from toontown.toonbase import ToontownGlobals
from toontown.toonbase import TTLocalizer
import math
from math import *
import random, random, RubberBand, FogOverlay
...
class DistributedTargetGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.help = DirectLabel(parent=aspect2d, relief=None, pos=(-0.0, 0, -0.8), text=TTLocalizer.TargetGameCountdown, text_scale=0.08, text_fg=(1,
                                                                                                                                                   1,
                                                                                                                                                   1,
                                                                                                                                                   1))
        self.help.hide()
        self.fogOver = FogOverlay.FogOverlay(Point3(self.CLOUD_COLOR[0], self.CLOUD_COLOR[1], self.CLOUD_COLOR[2]))
        self.scoreboard = DirectFrame(parent=aspect2d, relief=None, geom=DGG.getDefaultDialogGeom(), geom_color=ToontownGlobals.GlobalDialogColor, geom_scale=(1.75,
                                                                                                                                                               1,
                                                                                                                                                               0.75), pos=(0,
                                                                                                                                                                           0,
                                                                                                                                                                           0.587))
        self.roundLabel = DirectLabel(parent=self.scoreboard, relief=None, pos=(0,
                                                                                0,
                                                                                0.28), text=TTLocalizer.TargetGameBoard % self.round, text_scale=0.08)
        ...
        score1Label = DirectLabel(parent=self.scoreboard, relief=None, pos=(0.8, 0,
                                                                            0.14), text_align=TextNode.ARight, text=' ', text_scale=0.08)
        score2Label = DirectLabel(parent=self.scoreboard, relief=None, pos=(0.8, 0,
                                                                            0.02), text_align=TextNode.ARight, text=' ', text_scale=0.08)
        score3Label = DirectLabel(parent=self.scoreboard, relief=None, pos=(0.8, 0,
                                                                            -0.1), text_align=TextNode.ARight, text=' ', text_scale=0.08)
        score4Label = DirectLabel(parent=self.scoreboard, relief=None, pos=(0.8, 0,
                                                                            -0.22), text_align=TextNode.ARight, text=' ', text_scale=0.08)
                                                                                                                   ...
                                                                                                                   0.2), borderWidth=(0.02,
                                                                                                                                      0.02), scale=0.25, range=100, sortOrder=50, frameColor=(0.5,
                                                                                                                                                                                              ...
                                                                                                                                                                                              0.5), barColor=(1.0,
                                                                                                                                                                                                              0.0,
                                                                                                                                                                                                              0.0,
                                                                                                                                                                                                              1.0), text='0%', text_scale=0.26, text_fg=(1,
                                                                                                                                                                                                                                                         1,
                                                                                                                                                                                                                                                         1,
    ...
    def __updateLocalToonTask(self, task):
        ...
        if stateName in ('fall', 'bouncing'):
            if self.distance < 15.0:
                self.distance = 15.0
        pos = [
         toonPos[0], self.distance, toonPos[2]]
