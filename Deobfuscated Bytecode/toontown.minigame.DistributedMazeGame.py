...
import MazeGameGlobals, MazeData, MazeTreasure, Trajectory, Maze, MinigameAvatarScorePanel, MinigameGlobals
...
class DistributedMazeGame(DistributedMinigame):
    ...
    def __defineConstants(self):
        ...
        self.slowerSuitPeriods = {2000: {4: [128, 76], 8: [
                    128,
                    99,
                    81,
                    68], 
           ...
           9000: {4: [71, 50], 8: [
                  ...
                  16: [
                     ...
                     47, 
                     45]}}
        self.slowerSuitPeriodsCurve = {2000: {4: [128, 65], 8: [
                    128,
                    78,
                    66,
                    64], 
           ...
           9000: {4: [71, 44], 8: [
                  ...
                  16: [
                     ...
                     44, 
                     44]}}
        self.fasterSuitPeriods = {2000: {4: [54, 42], 8: [
                    59,
                    52,
                    47,
                    42], 
           ...
           9000: {4: [39, 32], 8: [
                  ...
                  16: [
                     ...
                     33, 
                     32]}}
        self.fasterSuitPeriodsCurve = {2000: {4: [62, 42], 8: [
                    63,
                    61,
                    54,
                    42], 
