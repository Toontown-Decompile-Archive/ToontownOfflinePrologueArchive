...
NUM_GAG_TRACKS = 7
PropTypeToTrackBonus = {AnimPropTypes.Hydrant: SQUIRT_TRACK, AnimPropTypes.Mailbox: THROW_TRACK, 
   AnimPropTypes.Trashcan: HEAL_TRACK}
if config.GetBool('want-nerfs', False):
    Levels = [[0, 20, 200, 400, 800, 2400, 3500],
     [
      0, 20, 80, 400, 800, 2400, 3500],
     [
      0, 20, 80, 400, 800, 2400, 3500],
     [
      0, 20, 120, 450, 900, 2800, 3500],
     [
      0, 10, 50, 400, 800, 2400, 3500],
     [
      0, 10, 50, 400, 800, 2400, 3500],
     [
      0, 20, 60, 420, 800, 2400, 3500]]
    regMaxSkill = 3500
else:
    Levels = [
     [
...
AvPropsNew = (
 ...
 'inventory_pixiedust', 'inventory_juggling_cubes', 'inventory_ladder'),
...
def getMintCreditMultiplier(mintId):
    return {CashbotMintIntA: 2.0, CashbotMintIntB: 2.5, 
...
def getCountryClubCreditMultiplier(countryClubId):
    return {BossbotCountryClubIntA: 2.0, BossbotCountryClubIntB: 2.5, 
