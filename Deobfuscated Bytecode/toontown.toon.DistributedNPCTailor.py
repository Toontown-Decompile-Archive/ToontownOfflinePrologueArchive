...
class DistributedNPCTailor(DistributedNPCToonBase):
        ...
        if mode == NPCToons.PURCHASE_MOVIE_CLEAR:
            ...
            if mode == NPCToons.PURCHASE_MOVIE_TIMEOUT:
                ...
                if mode == NPCToons.PURCHASE_MOVIE_START:
                    ...
                    if mode == NPCToons.PURCHASE_MOVIE_START_BROWSE or mode == NPCToons.PURCHASE_MOVIE_START_BROWSE_JBS:
                        self.browsing = 1
                        self.roomAvailable = 1
    ...
    def __enterConfirmLoss(self, finished, which):
        if self.popupInfo == None:
            ...
            self.popupInfo = DirectFrame(parent=hidden, relief=None, state='normal', text=TTLocalizer.STOREOWNER_CONFIRM_LOSS, text_wordwrap=10, textMayChange=0, frameSize=(-1,
                                                                                                                                                                             1,
                                                                                                                                                                             -1,
                                                                                                                                                                             1), text_pos=(0,
                                                                                                                                                                                           -0.05), geom=DGG.getDefaultDialogGeom(), geom_color=ToontownGlobals.GlobalDialogColor, geom_scale=(0.88,
                                                                                                                                                                                                                                                                                              1,
                                                                                                                                                                                                                                                                                              0.55), geom_pos=(0,
                                                                                                                                                                                                                                                                                                               0,
                                                                                                                                                                                                                                                                                                               -0.18), text_scale=0.08)
            DirectButton(self.popupInfo, image=okButtonImage, relief=None, text=TTLocalizer.STOREOWNER_OK, text_scale=0.05, text_pos=(0.0,
                                                                                                                                      -0.1), textMayChange=0, pos=(-0.08,
                                                                                                                                                                   0.0,
                                                                                                                                                                   -0.31), command=self.__handleConfirmLossOK, extraArgs=[
             finished, which])
            DirectButton(self.popupInfo, image=cancelButtonImage, relief=None, text=TTLocalizer.STOREOWNER_CANCEL, text_scale=0.05, text_pos=(0.0,
                                                                                                                                              -0.1), textMayChange=0, pos=(0.08,
                                                                                                                                                                           0.0,
                                                                                                                                                                           -0.31), command=self.__handleConfirmLossCancel)
            buttons.removeNode()
