...
class FNAFBase(FSM):
    ...
    def enterMenu(self):
        self.bgFrame = DirectFrame(parent=render2d, frameSize=(-1, 1, -1, 1), frameColor=(0,
                                                                                          0,
                                                                                          0,
                                                                                          1))
        self.title = OnscreenText(text='Five Nights at the Factory', pos=(0, 0.8), font=base.cogFont, fg=(1,
                                                                                                          1,
                                                                                                          1,
                                                                                                          1), scale=0.15, wordwrap=1.6 / 0.15)
        self.newGameButton = DirectButton(text='NEW GAME', pos=(0, 0, -0.2), text_font=base.pixelFont, relief=None, scale=0.2, text_fg=(1,
                                                                                                                                        1,
                                                                                                                                        0,
                                                                                                                                        1), command=self.demand, extraArgs=['Game'])
        self.continueButton = DirectButton(text='CONTINUE', pos=(0, 0, -0.6), text_font=base.pixelFont, relief=None, scale=0.2, text_fg=(1,
                                                                                                                                         1,
                                                                                                                                         0,
                                                                                                                                         1), command=self.__continue)
        return
