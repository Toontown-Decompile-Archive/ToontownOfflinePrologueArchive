...
# Embedded file name: toontown.fnaf.Timer
...
class EnergyBar(DirectFrame):
    ...
    def __init__(self, parent):
        _pos = (0.5, 0, 0.075)
        DirectFrame.__init__(self, pos=_pos, frameColor=(0, 0, 0, 1), frameSize=(-0.3,
                                                                                 0.125,
                                                                                 0,
                                                                                 0.075), parent=parent)
        self.initialiseoptions(EnergyBar)
        self.overlappingFrame = DirectFrame(pos=_pos, frameColor=(1, 0, 0, 1), frameSize=(-0.3,
                                                                                          0.125,
                                                                                          0,
                                                                                          0.075), parent=parent)
        self.text = OnscreenText(text='Energy', fg=(1, 1, 1, 1), parent=self.overlappingFrame, font=base.cogFont, scale=0.035, pos=(-0.085,
                                                                                                                                    0.025))
        self.hide()

    def setValue(self, value):
        x = -0.3 + 0.425 * value
        self.overlappingFrame['frameSize'] = (-0.3, x, 0, 0.075)
...
class Timer:
    secondsPerHour = 60
    endHour = 6
    totalEnergy = int(secondsPerHour * endHour * 1.75)

    def __init__(self):
        self.infoText = OnscreenText(text='12 AM\nNight 1', align=TextNode.ARight, pos=(-0.1,
                                                                                        -0.1), parent=base.a2dTopRight, fg=(1,
                                                                                                                            1,
                                                                                                                            1,
                                                                                                                            1), font=base.cogFont)
