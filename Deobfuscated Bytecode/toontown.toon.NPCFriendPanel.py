...
import NPCToons, ToonHead, ToonDNA
...
class NPCFriendCard(DirectFrame):
    ...
    def __init__(self, parent=aspect2dp, rotateCard=False, **kw):
        ...
        if rotateCard:
            ...
            self.back.component('image0').configure(hpr=(0, 0, -90), scale=(-1.35,
                                                                            1.35,
                                                                            1.35))
            callButtonPosZ = -2.1
            textWordWrap = 7.0
        ...
        self.sosCallButton = DirectButton(parent=self.front, relief=None, text=TTLocalizer.NPCCallButtonLabel, text_fg=self.normalTextColor, text_scale=0.28, text_align=TextNode.ACenter, image=(upButton,
         downButton,
         rolloverButton,
         upButton), image_color=(1.0, 0.2, 0.2, 1), image0_color=Vec4(1.0, 0.4, 0.4, 1), image3_color=Vec4(1.0, 0.4, 0.4, 0.4), image_scale=(4.4,
                                                                                                                                             1,
                                                                                                                                             3.6), image_pos=Vec3(0, 0, 0.08), pos=(-1.15, 0, callButtonPosZ), scale=1.25, command=self.__chooseNPCFriend)
        self.sosCallButton.hide()
        self.sosCountInfo = DirectLabel(parent=self.front, relief=None, text='', text_fg=self.normalTextColor, text_scale=0.75, text_align=TextNode.ALeft, textMayChange=1, pos=(0.0,
                                                                                                                                                                                 0,
                                                                                                                                                                                 -1.0))
