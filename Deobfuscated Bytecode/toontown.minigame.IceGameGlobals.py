...
NumTreasures = {ToontownGlobals.ToontownCentral: 2, ToontownGlobals.DonaldsDock: 2, 
...
NumPenalties = {ToontownGlobals.ToontownCentral: 0, ToontownGlobals.DonaldsDock: 1, 
...
Obstacles = {ToontownGlobals.ToontownCentral: (), ToontownGlobals.DonaldsDock: ((0, 0), ), 
   ToontownGlobals.DaisyGardens: (
                                (
                                 MinWall[0] / 2, 0), (MaxWall[0] / 2, 0)), 
   ToontownGlobals.MinniesMelodyland: (
                                     (
                                      0, MinWall[1] / 2), (0, MaxWall[1] / 2)), 
