...
class DistributedRaceGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.waitingChoicesLabel = DirectLabel(text=TTLocalizer.RaceGameWaitingChoices, text_fg=VBase4(1, 1, 1, 1), relief=None, pos=(-0.6,
                                                                                                                                      0,
                                                                                                                                      -0.75), scale=0.075)
        ...
        self.chanceCardText = OnscreenText('', fg=(1.0, 0, 0, 1), scale=0.14, font=ToontownGlobals.getSignFont(), wordwrap=14, pos=(0.0,
                                                                                                                                    0.2), mayChange=1)
