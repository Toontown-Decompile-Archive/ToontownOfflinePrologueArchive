...
SCRATCH_TIME = 8.042
CALL_TIME = 8.0 / 3
FEED_DIST = {'long': 4.0, 'medium': 4.0, 
   'short': 4.0}
FEED_AMOUNT = 1
SCRATCH_DIST = {'long': 2.0, 'medium': 1.5, 
   'short': 1.0}
TELEPORT_IN_DURATION = 2.34
TELEPORT_OUT_DURATION = 4.5
ZoneToCostRange = {ToontownGlobals.ToontownCentral: (100, 500), ToontownGlobals.DonaldsDock: (600, 1700), 
