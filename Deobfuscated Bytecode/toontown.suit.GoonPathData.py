...
taskZoneId2pathId = {ToontownGlobals.SellbotFactoryInt: 'sellbotFactory', ToontownGlobals.CashbotMintIntA: 'cashbotMint', ToontownGlobals.CashbotMintIntB: 'cashbotMint', 
...
Paths = {'sellbotFactory': {0: [Vec3(10.0, 0.0, 0.0),
                        ...
                        Vec3(-10.0, 0.0, 0.0)], 
                      1: [
                        Vec3(10.0, 5.0, 0.0), Vec3(10.0, 0.0, 0.0), Vec3(-10.0, -5.0, 0.0)], 
                      2: [
                        Vec3(-48.31, -0.001, 0),
                        Vec3(-48.0, -3.709, 0),
                        Vec3(35.041, -3.27, 0),
                      ...
                      5: [
                        ...
                        Vec3(-3.549, 57.295, 0)], 
                      6: [
                        Vec3(31.627, 2.093, 0.0), Vec3(4, 43, 0)], 
                      7: [
                        Vec3(34.627, 2.093, 0.0), Vec3(32, 43, 0)], 
                      8: [
                        Vec3(64.0, 43.0, 0.0), Vec3(59.5, 1.8, 0.0)], 
                      9: [
                        Vec3(84.0, 43.0, 0.0), Vec3(93.0, 25.0, 0.0), Vec3(66.0, 2.0, 0.0)], 
                      10: [
                         Vec3(85.0, 43.0, 0.0),
                         Vec3(66.0, 47.0, 0.0),
                         Vec3(53.0, 49.0, 0.0),
                         Vec3(71.0, 22.0, 0.0)], 
                      11: [
                         Vec3(63.0, 43.0, 0.0), Vec3(33.0, 47.0, 0.0)], 
                      12: [
                         Vec3(10.5139980316, 73.4393844604, 0.0), Vec3(-10.0053958893, 72.9239883423, 0.0), Vec3(5.55112314224, 90.2847213745, 0.0)], 
                      13: [
                         Vec3(-2.62728261948, 50.5329399109, 0.0), Vec3(-2.21770620346, 3.07684659958, 0.0)], 
                      14: [
                      ...
                      15: [
                         Vec3(-25.7975006104, 18.4752807617, 0.0), Vec3(12.6321563721, 19.1084594727, 0.0), Vec3(24.8442764282, -4.62582397461, 0.0)], 
                      16: [
                      ...
                      24: [
                         Vec3(-12.7202939987, 15.884016037, 0.0), Vec3(16.7396354675, -14.0337085724, 0.0)], 
                      25: [
                         Vec3(-17.7801113129, -8.74084472656, 0.0), Vec3(-13.1200618744, -9.26202392578, -0.0)], 
                      26: [
                         Vec3(8.624584198, -10.9699707031, 0.0), Vec3(3.29245567322, -2.59405517578, 0.0)], 
                      27: [
                         Vec3(12.3031358719, 7.98439788818, 0.0), Vec3(-13.3801307678, 7.98439788818, 0.0)], 
                      28: [
                      ...
                      31: [
                         Vec3(25.8017997742, 73.792678833, 0.0), Vec3(11.0946779251, 51.4213256836, 0.0), Vec3(31.6651115417, 43.7239074707, 0.0)], 
                      32: [
                      ...
                      34: [
                         Point3(2.75689697266, -21.3427124023, 0.0), Point3(2.78796386719, 37.0751342773, 0.000232696533203)], 
                      35: [
                         Point3(7.67395019531, 40.565612793, -0.000492095947266), Point3(78.0889282227, 39.3659667969, -0.00810623168945)], 
                      36: [
                      ...
                      40: [
                         Point3(1.67153930664, 18.4436645508, 0.025), Point3(-7.59463500977, 18.5286254883, 0.025)], 
                      41: [
   ...
   'cashbotMint': {28: [Vec3(-32.1953697205, -85.9077148438, 0.0),
                   ...
                   0: [
                     ...
                     Vec3(5.0, 0.0, 0.0)], 
                   1: [
                     Vec3(0.0, 0.0, 0.0), Vec3(-5.77, 10.0, 0.0), Vec3(5.77, 10.0, 0.0)], 
                   2: [
                     Vec3(-5.77, 10.0, 0.0),
                     Vec3(5.77, 10.0, 0.0),
                     Vec3(-5.77, -10.0, 0.0),
