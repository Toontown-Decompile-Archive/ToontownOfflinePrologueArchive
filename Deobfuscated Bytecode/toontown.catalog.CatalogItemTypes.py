...
import CatalogFurnitureItem, CatalogChatItem, CatalogClothingItem, CatalogEmoteItem, CatalogWallpaperItem, CatalogFlooringItem, CatalogWainscotingItem, CatalogMouldingItem, CatalogWindowItem, CatalogPoleItem, CatalogPetTrickItem, CatalogBeanItem, CatalogGardenItem, CatalogInvalidItem, CatalogRentalItem, CatalogGardenStarterItem, CatalogNametagItem, CatalogToonStatueItem, CatalogAnimatedFurnitureItem, CatalogAccessoryItem
INVALID_ITEM = 0
FURNITURE_ITEM = 1
CHAT_ITEM = 2
CLOTHING_ITEM = 3
...
CatalogItemType2multipleAllowed = {INVALID_ITEM: False, FURNITURE_ITEM: True, 
   CHAT_ITEM: False, 
   CLOTHING_ITEM: False, 
   EMOTE_ITEM: False, 
   WALLPAPER_ITEM: True, 
