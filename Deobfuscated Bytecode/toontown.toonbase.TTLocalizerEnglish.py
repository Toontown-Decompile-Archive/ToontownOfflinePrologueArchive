...
lOldDaisyGardens = 'Daisy Gardens - 2003'
lScroogeBank = ''
...
lSewer = 'Cog Nation Sewer'
lCogNationCentral = 'Cog Nation Central'
GlobalStreetNames = {20000: ('to', 'on', 'Tutorial Terrace'), 1000: (
        'to the', 'in the', 'Playground'), 
   1100: (
        'to', 'on', 'Barnacle Boulevard'), 
   1200: (
        'to', 'on', 'Seaweed Street'), 
   1300: (
        'to', 'on', 'Lighthouse Lane'), 
   2000: (
        'to the', 'in the', 'Playground'), 
   2100: (
        'to', 'on', 'Silly Street'), 
   ...
   9200: (
        'to', 'on', 'Pajama Place'), 
   10000: (
         'to', 'in', 'Bossbot HQ Country Club'), 
   10100: (
         'to the', 'in the', 'Bossbot HQ Lobby'), 
   10200: (
         'to the', 'in the', 'The Clubhouse'), 
   10500: (
         'to the', 'in the', 'The Front Three'), 
   10600: (
         'to the', 'in the', 'The Middle Six'), 
   10700: (
         'to the', 'in the', 'The Back Nine'), 
   11000: (
         'to the', 'in the', 'Sellbot HQ Courtyard'), 
   11100: (
         'to the', 'in the', 'Sellbot HQ Lobby'), 
   11200: (
         'to the', 'in the', 'Sellbot Factory'), 
   11500: (
         'to the', 'in the', 'Sellbot Factory'), 
   12000: (
         'to', 'in', 'Cashbot Train Yard'), 
   12100: (
         'to the', 'in the', 'Cashbot HQ Lobby'), 
   12500: (
         'to the', 'in the', 'Cashbot Coin Mint'), 
   12600: (
         'to the', 'in the', 'Cashbot Dollar Mint'), 
   12700: (
         'to the', 'in the', 'Cashbot Bullion Mint'), 
   13000: (
         'to', 'in', 'Lawbot HQ Courtyard'), 
   13100: (
         'to the', 'in the', 'Courthouse Lobby'), 
   13200: (
         'to the', 'in the', "DA's Office Lobby"), 
   13300: (
         'to the', 'in the', 'Lawbot A Office'), 
   13400: (
         'to the', 'in the', 'Lawbot B Office'), 
   13500: (
         'to the', 'in the', 'Lawbot C Office'), 
   13600: (
         'to the', 'in the', 'Lawbot D Office'), 
   14000: (
         'to the', 'in the', 'Sewer Entrance'), 
   14100: (
         'to the', 'in the', 'Sewer to Toontown Central'), 
   19000: (
         'to', 'in', 'Courtyard'), 
   19100: (
...
OldDaisyGardens = ('to', 'in', lOldDaisyGardens)
Prologue = ('to the', 'in the', 'Prologue')
ScroogeBank = ('', '', '')
OutdoorZone = ('to', 'in', lOutdoorZone)
ToonFest = ('to', 'at', 'ToonFest')
...
Sewer = ('to the', 'in the', lSewer)
CogNationCentral = ('to', 'in', lCogNationCentral)
Factory = 'Factory'
Headquarters = 'Headquarters'
SellbotFrontEntrance = 'Front Entrance'
SellbotSideEntrance = 'Side Entrance'
Office = 'Office'
FactoryNames = {0: 'Factory Mockup', 11500: 'Sellbot Cog Factory', 
...
QuestsItemDict = {1: ['Pair of Glasses', 'Pairs of Glasses', 'a '], 2: [
     'Key', 'Keys', 'a '], 
   3: [
     'Blackboard', 'Blackboards', 'a '], 
   4: [
     'Book', 'Books', 'a '], 
   5: [
     'Candy Bar', 'Candy Bars', 'a '], 
   6: [
     'Piece of Chalk', 'Pieces of Chalk', 'a '], 
   7: [
     'Recipe', 'Recipes', 'a '], 
   8: [
     'Note', 'Notes', 'a '], 
   9: [
     'Adding machine', 'Adding machines', 'an '], 
   10: [
      'Clown car tire', 'Clown car tires', 'a '], 
   11: [
      'Air pump', 'Air pumps', 'an '], 
   12: [
      'Octopus ink', 'Octopus inks', 'some '], 
   13: [
      'Package', 'Package', 'a '], 
   14: [
      'Goldfish receipt', 'Goldfish receipts', 'a '], 
   15: [
      'Goldfish', 'Goldfish', 'a '], 
   16: [
      'Oil', 'Oils', 'some '], 
   ...
   18: [
      'Water', 'Waters', 'some '], 
   19: [
      'Gear report', 'Gear reports', 'a '], 
   20: [
      'Blackboard Eraser', 'Blackboard Erasers', 'a '], 
   110: [
       'TIP Clothing Ticket', 'Clothing Tickets', 'a '], 
   1000: [
        'Clothing Ticket', 'Clothing Tickets', 'a '], 
   2001: [
        'Inner Tube', 'Inner Tubes', 'an '], 
   2002: [
        'Monocle Prescription', 'Monocle Prescriptions', 'a '], 
   2003: [
        'Eyeglass Frames', 'Eyeglass Frames', 'some '], 
   2004: [
        'Monocle', 'Monocles', 'a '], 
   2005: [
        'Big White Wig', 'Big White Wigs', 'a '], 
   2006: [
        'Bushel of Ballast', 'Bushels of Ballast', 'a '], 
   2007: [
        'Cog Gear', 'Cog Gears', 'a '], 
   2008: [
        'Sea Chart', 'Sea Charts', 'a '], 
   2009: [
        'Cruddy Clovis', 'Cruddy Clovi', 'a '], 
   2010: [
        'Clean Clovis', 'Clean Clovi', 'a '], 
   2011: [
        'Clock Spring', 'Clock Springs', 'a '], 
   2012: [
        'Counter Weight', 'Counter Weights', 'a '], 
   4001: [
        "Tina's Inventory", "Tina's Inventories", ''], 
   4002: [
        "Yuki's Inventory", "Yuki's Inventories", ''], 
   4003: [
        'Inventory Form', 'Inventory Forms', 'an '], 
   4004: [
        "Fifi's Inventory", "Fifi's Inventories", ''], 
   4005: [
        "Lumber Jack's Ticket", "Lumber Jack's Tickets", ''], 
   4006: [
        "Tabitha's Ticket", "Tabitha's Tickets", ''], 
   4007: [
        "Barry's Ticket", "Barry's Tickets", ''], 
   4008: [
        'Cloudy Castanet', 'Cloudy Castanets', ''], 
   4009: [
        'Blue Squid Ink', 'Blue Squid Ink', 'some '], 
   4010: [
        'Clear Castanet', 'Clear Castanets', 'a '], 
   4011: [
        "Leo's Lyrics", "Leo's Lyrics", ''], 
   5001: [
        'Silk necktie', 'Silk neckties', 'a '], 
   5002: [
        'Pinstripe Suit', 'Pinstripe Suits', 'a '], 
   5003: [
        'Pair of Scissors', 'Pairs of Scissors', 'a '], 
   5004: [
   ...
   5007: [
        'Notepad', 'Notepads', 'a '], 
   5008: [
        'Office Lockbox', 'Office Lockboxes', 'an '], 
   5009: [
        'Bag of Bird Seed', 'Bags of Bird Seed', 'a '], 
   5010: [
        'Sprocket', 'Sprockets', 'a '], 
   5011: [
        'Salad', 'Salads', 'a '], 
   5012: [
        'Key to ' + lDaisyGardens, 'Keys to ' + lDaisyGardens, 'a '], 
   5013: [
        lSellbotHQ + ' Blueprints', lSellbotHQ + ' HQ Blueprints', 'some '], 
   5014: [
        lSellbotHQ + ' Memo', lSellbotHQ + ' Memos', 'a '], 
   5015: [
        lSellbotHQ + ' Memo', lSellbotHQ + ' Memos', 'a '], 
   5016: [
        lSellbotHQ + ' Memo', lSellbotHQ + ' Memos', 'a '], 
   5017: [
        lSellbotHQ + ' Memo', lSellbotHQ + ' Memos', 'a '], 
   3001: [
        'Soccer ball', 'Soccer balls', 'a '], 
   3002: [
        'Toboggan', 'Toboggans', 'a '], 
   3003: [
        'Ice cube', 'Ice cubes', 'an '], 
   3004: [
        'Love letter', 'Love letters', 'a '], 
   3005: [
        'Wiener dog', 'Wiener dogs', 'a '], 
   3006: [
        'Engagement ring', 'Engagement rings', 'an '], 
   3007: [
        'Sardine whiskers', 'Sardine whiskers', 'some '], 
   3008: [
        'Calming potion', 'Calming potion', 'a '], 
   3009: [
        'Broken tooth', 'Broken teeth', 'a '], 
   3010: [
        'Gold tooth', 'Gold teeth', 'a '], 
   3011: [
        'Pine cone bread', 'Pine cone breads', 'a '], 
   3012: [
        'Lumpy cheese', 'Lumpy cheeses', 'some '], 
   3013: [
        'Simple spoon', 'Simple spoons', 'a '], 
   3014: [
        'Talking toad', 'Talking toad', 'a '], 
   3015: [
        'Ice cream cone', 'Ice cream cones', 'an '], 
   3016: [
        'Wig powder', 'Wig powders', 'some '], 
   3017: [
        'Rubber ducky', 'Rubber duckies', 'a '], 
   3018: [
        'Fuzzy dice', 'Fuzzy dice', 'some '], 
   3019: [
        'Microphone', 'Microphones', 'a '], 
   3020: [
        'Electric keyboard', 'Electric keyboards', 'an '], 
   3021: [
        'Platform shoes', 'Platform shoes', 'some '], 
   3022: [
        'Caviar', 'Caviar', 'some '], 
   3023: [
        'Make-up powder', 'Make-up powders', 'some '], 
   3024: [
        'Yarn', 'Yarn', 'some '], 
   3025: [
        'Knitting Needle', 'Knitting Needles', 'a '], 
   3026: [
        'Alibi', 'Alibis', 'an '], 
   3027: [
        'External Temperature Sensor', 'External Temperature Sensors', 'an '], 
   6001: [
        'Cashbot HQ Plans', 'Cashbot HQ Plans', 'some '], 
   6002: [
        'Rod', 'Rods', 'a '], 
   6003: [
        'Drive Belt', 'Drive Belts', 'a '], 
   6004: [
        'Pair of Pincers', 'Pairs of Pincers', 'a '], 
   6005: [
        'Reading Lamp', 'Reading Lamps', 'a '], 
   6006: [
        'Zither', 'Zithers', 'a '], 
   6007: [
        'Zamboni', 'Zambonis', 'a '], 
   6008: [
        'Zebra Zabuton', 'Zebra Zabutons', 'a '], 
   6009: [
        'Zinnias', 'Zinnias', 'some '], 
   6010: [
        'Zydeco Records', 'Zydeco Records', 'some '], 
   6011: [
        'Zucchini', 'Zucchinis', 'a '], 
   6012: [
        'Zoot Suit', 'Zoot Suits', 'a '], 
   7001: [
        'Plain Bed', 'Plain Beds', 'a '], 
   7002: [
        'Fancy Bed', 'Fancy Beds', 'a '], 
   7003: [
        'Blue Bedspread', 'Blue Bedspreads', 'a '], 
   7004: [
        'Paisley Bedspread', 'Paisley Bedspreads', 'a '], 
   7005: [
        'Pillows', 'Pillows', 'some '], 
   7006: [
        'Hard Pillows', 'Hard Pillows', 'some '], 
   7007: [
        'Pajamas', 'Pajamas', 'a pair of '], 
   7008: [
        'Footie Pajamas', 'Footie Pajamas', 'a pair of '], 
   7009: [
        'Puce Footie Pajamas', 'Puce Footie Pajamas', 'a pair of '], 
   7010: [
        'Fuchsia Footie Pajamas', 'Fuchsia Footie Pajamas', 'a pair of '], 
   7011: [
        'Cauliflower Coral', 'Cauliflower Coral', 'some '], 
   7012: [
        'Slimy Kelp', 'Slimy Kelp', 'some '], 
   7013: [
        'Pestle', 'Pestles', 'a '], 
   7014: [
        'Jar of Wrinkle Cream', 'Jars of Wrinkle Cream', 'a ']}
...
COMPLETE = 5
LEAVING = 6
TheBrrrghTrackQuestDict = {GREETING: '', QUEST: 'Now you are ready.\x07Go out and walk the earth until you know which track you would like to choose.\x07Choose wisely, because this is your final track.\x07When you are certain, return to me.', 
...
QuestDialogDict = {160: {GREETING: '', QUEST: "Ok, now I think you are ready for something more rewarding.\x07If you can defeat 3 Bossbots I'll give you a little bonus.", 
   ...
   161: {GREETING: '', QUEST: "Ok, now I think you are ready for something more rewarding.\x07Come back after you defeat 3 Lawbots and I'll have a little something for you.", 
         INCOMPLETE_PROGRESS: TheCogs + ' are out in the streets, through the tunnels.', 
         INCOMPLETE_WRONG_NPC: 'Good job defeating those Cogs. Now go to the Toon Headquarters for your next step!', 
         COMPLETE: QuestsDefaultComplete, 
         LEAVING: QuestsDefaultLeaving}, 
   162: {GREETING: '', QUEST: 'Ok, now I think you are ready for something more rewarding.\x07Defeat 3 Cashbots and come back here to claim the bounty.', 
         INCOMPLETE_PROGRESS: TheCogs + ' are out in the streets, through the tunnels.', 
         INCOMPLETE_WRONG_NPC: 'Good job defeating those Cogs. Now go to the Toon Headquarters for your next step!', 
         COMPLETE: QuestsDefaultComplete, 
         LEAVING: QuestsDefaultLeaving}, 
   163: {GREETING: '', QUEST: "Ok, now I think you are ready for something more rewarding.\x07Come see us after you defeat 3 Sellbots and we'll hook you up.", 
         INCOMPLETE_PROGRESS: TheCogs + ' are out in the streets, through the tunnels.', 
         INCOMPLETE_WRONG_NPC: 'Good job defeating those Cogs. Now go to the Toon Headquarters for your next step!', 
         COMPLETE: QuestsDefaultComplete, 
         LEAVING: QuestsDefaultLeaving}, 
   164: {QUEST: 'Phew, tired yet?\x07You know... You look like you could use some new gags.\x07Go see %s, maybe he can help you out._where_' % Flippy}, 165: {QUEST: "Heya! I remember seeing you in the streets earlier.\x07I don't believe I formerly introduced myself...\x07I'm Flippy, President of the Toon Council here in Toontown.\x07Hopefully we'll be seeing each other a lot more often!\x07It looks like you need to practice training your gags.\x07You see, every time you hit a Cog with one of your gags it increases your experience.\x07When you get enough experience, you'll be able to buy an even better gag.\x07Why not try it out?\x07To get some practice in, try defeating 4 of those Cogs on the streets."}, 166: {QUEST: "Oooh, nice work! Got a new gag yet?\x07You know, the Cogs come in four different types.\x07There are Sellbots for marketing...\x07Cashbots for accounting...\x07Lawbots for legal advice...\nAnd Bossbots to keep them all in line.\x07They all wear different suits and nametags, so you'll be able to see the difference easily.\x07Check your Shticker Book if you need some help identifying them.\x07Here, let's practice. Go defeat 4 of those Bossbots I talked about!"}, 167: {QUEST: "Oooh, nice work! Got a new gag yet?\x07You know, the Cogs come in four different types.\x07There are Sellbots for marketing...\x07Cashbots for accounting...\x07Lawbots for legal advice...\nAnd Bossbots to keep them all in line.\x07They all wear different suits and nametags, so you'll be able to see the difference easily.\x07Check your Shticker Book if you need some help identifying them.\x07Here, let's practice. Go defeat 4 of those Lawbots I talked about!"}, 168: {QUEST: "Oooh, nice work! Got a new gag yet?\x07You know, the Cogs come in four different types.\x07There are Sellbots for marketing...\x07Cashbots for accounting...\x07Lawbots for legal advice...\nAnd Bossbots to keep them all in line.\x07They all wear different suits and nametags, so you'll be able to see the difference easily.\x07Check your Shticker Book if you need some help identifying them.\x07Here, let's practice. Go defeat 4 of those Sellbots I talked about!"}, 169: {QUEST: "Oooh, nice work! Got a new gag yet?\x07You know, the Cogs come in four different types.\x07There are Sellbots for marketing...\x07Cashbots for accounting...\x07Lawbots for legal advice...\nAnd Bossbots to keep them all in line.\x07They all wear different suits and nametags, so you'll be able to see the difference easily.\x07Check your Shticker Book if you need some help identifying them.\x07Here, let's practice. Go defeat 4 of those Cashbots I talked about!"}, 170: {QUEST: "Oh good, you're back. I was getting worried that you got lost!\x07Do you understand the difference between the 4 Cogs now?\x07I think that you're ready to go ahead and start training for a new gag track.\x07_toNpcName_ is an expert on gags. He can give you some expert advice on your next track._where_"}, 171: {QUEST: "Oh good, you're back. I was getting worried that you got lost!\x07Do you understand the difference between the 4 Cogs now?\x07I think that you're ready to go ahead and start training for a new gag track.\x07_toNpcName_ is an expert on gags. He can give you some expert advice on your next track._where_"}, 172: {QUEST: "Oh good, you're back. I was getting worried that you got lost!\x07Do you understand the difference between the 4 Cogs now?\x07I think that you're ready to go ahead and start training for a new gag track.\x07_toNpcName_ is an expert on gags. She can give you some expert advice on your next track._where_"}, 175: {GREETING: '', QUEST: "Say, did you know that you own an Estate, your very own neighborhood?\x07Every toon on your Pick-a-Toon Panel has their own house there, including you!\x07Clarabelle Cow runs a phone-in Cattlelog where you can order furniture to decorate your house.\x07You can also buy SpeedChat phrases, clothing, and other fun things!\x07I'll phone Clarabelle to send you your first catalog now.\x07After this first issue, she'll send you a new one every week!\x07There, your Cattlelog should be on it's way. Go home and check it out!", 
         ...
         LEAVING: QuestsDefaultLeaving}, 
   400: {GREETING: '', QUEST: "Throw and Squirt are great, but you're going to need more gags to fight those higher level Cogs.\x07If you could team up with other Toons against the Cogs, you could combine your gags for even more giggles!\x07Try different combinations of gags to see what works best.\x07To start you off, you can choose between Sound and Toon-Up.\x07Sound is special: When it hits, it damages all Cogs rather than a single one.\x07Toon-Up hits all of your targets too -- but they aren't Cogs!\x07Instead of hitting the Cogs, you can heal yourself by making yourself laugh. It won't hurt the Cogs, but it will help you last longer in battle!\x07I understand it's a tough decision, so take your time to choose wisely.\x07You may want to ask a few friends what they think so you can plan strategies together.\x07When you are ready to decide, come back here and take your pick.", 
   ...
   1039: {QUEST: 'Visit _toNpcName_ if you want to get around town more easily._where_'}, 1040: {QUEST: 'Visit _toNpcName_ if you want to get around town more easily._where_'}, 1041: {QUEST: 'Hi!  What brings you here?\x07Everybody uses their portable hole to travel around Toontown.\x07Why, you can teleport to your friends using the Friends List, or to any neighborhood using the map in the Shticker Book.\x07Of course, you have to earn that!\x07Say, I can turn on your teleport access to ' + lToontownCentral + ' if you help out a friend of mine.\x07Seems the Cogs are causing trouble over on Loopy Lane.  Go visit _toNpcName_._where_'}, 1042: {QUEST: 'Hi!  What brings you here?\x07Everybody uses their portable hole to travel around Toontown.\x07Why, you can teleport to your friends using the Friends List, or to any neighborhood using the map in the Shticker Book.\x07Of course, you have to earn that!\x07Say, I can turn on your teleport access to ' + lToontownCentral + ' if you help out a friend of mine.\x07Seems the Cogs are causing trouble over on Loopy Lane.  Go visit _toNpcName_._where_'}, 1043: {QUEST: 'Hi!  What brings you here?\x07Everybody uses their portable hole to travel around Toontown.\x07Why, you can teleport to your friends using the Friends List, or to any neighborhood using the map in the Shticker Book.\x07Of course, you have to earn that!\x07Say, I can turn on your teleport access to ' + lToontownCentral + ' if you help out a friend of mine.\x07Seems the Cogs are causing trouble over on Loopy Lane.  Go visit _toNpcName_._where_'}, 1044: {QUEST: 'Oh, thanks for stopping by.  I really need some help.\x07As you can see, I have no customers.\x07My secret recipe book is lost and nobody comes to my restaurant anymore.\x07I last saw it just before those Cogs took over my building.\x07Can you help me by recovering four of my famous recipes?', LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Any luck finding my recipes?'}, 
   1045: {QUEST: 'Thank you so much!\x07Before long I will have the entire collection and can reopen my restaurant.\x07Oh, I have a note here for you - something about teleport access?\x07It says thanks for helping my friend and to deliver this to Toon Headquarters.\x07Well, thanks indeed - bye!', LEAVING: '', 
   ...
   1046: {QUEST: 'The Cashbots have really been bothering the Funny Money Savings and Loan.\x07Stop by there and see if there is anything you can do._where_'}, 1047: {QUEST: 'Cashbots have been sneaking into the bank and stealing our machines.\x07Please recover 5 adding machines from Cashbots.\x07To save you from running back and forth, just bring them all back at once.', LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Still looking for adding machines?'}, 
   1048: {QUEST: 'Wow!  Thanks for finding our adding machines.\x07Hm... They look a little damaged.\x07Say, could you take them over to _toNpcName_ over at her shop, "Tickle Machines" on this street?\x07See if she can fix them.', LEAVING: ''}, 
   1049: {QUEST: "What's that?  Broken adding machines?\x07Cashbots you say?\x07Well, let's have a look see...\x07Yep, gears are stripped, but I'm out of that part...\x07You know what might work - some Cog gears, large ones, from larger Cogs...\x07Level 3 Cog gears should do the trick.  I'll need 2 for each machine, so 10 total.\x07Bring them back all at once and I'll fix em up!", LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Remember, I need 10 gears to fix the machines.'}, 
   1053: {QUEST: "Ah yes, that should do the trick indeedy.\x07All fixed now, free of charge.\x07Take these back to Funny Money, and tell 'im I said howdy.", LEAVING: '', 
          COMPLETE: "Adding machines all fixed up?\x07Nice work.  I'm sure I've got something around here to reward you with..."}, 
   1054: {QUEST: '_toNpcName_ needs some help with his clown cars._where_'}, 1055: {QUEST: "Yowza!  I can't find the tires to this here clown car anywhere...\x07Do ya think you could help me out?\x07Loopy Bob must have tossed them in that creek in the " + lToontownCentral + ' playground.\x07If you stand on one of the docks there you can try to fish out without getting too muddy.', GREETING: 'Woohoo!', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Havin\' trouble fishing them out? Like I said, check that pond in " + lToontownCentral'}, 
   1056: {QUEST: "Fan-flying-tastic!  Now I can get this ol' clown car on the road again.\x07Hrmmph, I swear I had an air pump around here to get these tires a-poppin'...\x07Maybe _toNpcName_ borrowed it. Mind gettin' it for me?_where_", LEAVING: ''}, 
   1057: {QUEST: "Hi there. What can I do for you?\x07A tire pump you say? Huh.\x07I'll tell you what - clear out the street of some of those high-level Cogs...\x07And I'll let you have the pump.", LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Is that the best you can do?'}, 
   1058: {QUEST: "Ha, I knew you could do it.\x07Here's the pump - I found it in the back of my shop just now.\x07I'm sure _toNpcName_ will be glad to get it back...\x07But tell him I'm still waiting for him to return my monkeywrench!", LEAVING: '', 
          GREETING: '', 
          COMPLETE: "Yeeeeehaw!  Now I'm good to go.\x07A monkeywrench?  Bah, that can wait.\x07By the way, thanks for helping me out.\x07Here, take this for your troubles."}, 
   1059: {QUEST: '_toNpcName_ is running low on supplies.  Maybe you can give him a hand?_where_'}, 1060: {QUEST: "Thanks for stopping by!\x07Those Cogs have been stealing my ink, so I'm running very low.\x07Could you fish some octopus ink out of the pond for me?\x07Just stand on a dock near the pond to fish.", LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Are you having trouble fishing?'}, 
   1061: {QUEST: "Great - thanks for the ink!\x07You know what, maybe if you cleared away some of those Pencil Pushers...\x07I wouldn't run out of ink again so quickly.\x07Defeat 6 Pencil Pushers in " + lToontownCentral + ' for your reward.', LEAVING: '', 
          COMPLETE: 'Thanks!  Let me reward you for your help.', 
          INCOMPLETE_PROGRESS: 'I just saw some more Pencil Pushers.'}, 
   1062: {QUEST: "Great - thanks for the ink!\x07You know what, maybe if you cleared away some of those Bloodsuckers...\x07I wouldn't run out of ink again so quickly.\x07Defeat 6 Bloodsuckers in " + lToontownCentral + ' for your reward.', LEAVING: '', 
          COMPLETE: 'Thanks!  Let me reward you for your help.', 
          INCOMPLETE_PROGRESS: 'I just saw some more Bloodsuckers.'}, 
   900: {QUEST: 'I hear _toNpcName_ needs help with a package._where_'}, 1063: {QUEST: 'Hi - thanks for coming in.\x07A Cog stole a very important package from right under my nose.\x07Please see if you can get it back.  I think he was a level 3...\x07So, defeat level 3 Cogs until you find my package.', LEAVING: '', 
          INCOMPLETE_PROGRESS: 'No luck finding the package, huh?'}, 
   1067: {QUEST: "That's it, all right!\x07Hey, the address is smudged...\x07All I can read is that it's for a Dr. - the rest is all blurry.\x07Maybe it's for _toNpcName_?  Could you take it to him?_where_", LEAVING: ''}, 
   1068: {QUEST: "I wasn't expecting a package.  Maybe it's for Dr. I.M. Euphoric?\x07My assistant was going over there today anyway, so I'll have him check for you.\x07In the meantime, would you mind getting rid of some of the Cogs on my street?\x07Defeat 10 Cogs in " + lToontownCentral + '.', LEAVING: '', 
          INCOMPLETE_PROGRESS: "My assistant isn't back yet."}, 
   1069: {QUEST: "Dr. Euphoric says he wasn't expecting a package either.\x07Unfortunately, a Cashbot stole it from my assistant on the way back.\x07Could you try and get it back?", LEAVING: '', 
          INCOMPLETE_PROGRESS: 'No luck finding the package, huh?'}, 
   1070: {QUEST: "Dr. Euphoric says he wasn't expecting a package either.\x07Unfortunately, a Sellbot stole the package from my assistant on the way back.\x07I'm sorry, but you'll have to find that Sellbot and get it back.", LEAVING: '', 
          INCOMPLETE_PROGRESS: 'No luck finding the package, huh?'}, 
   1071: {QUEST: "Dr. Euphoric says he wasn't expecting a package either.\x07Unfortunately, a Bossbot stole it from my assistant on the way back.\x07Could you try and get it back?", LEAVING: '', 
          INCOMPLETE_PROGRESS: 'No luck finding the package, huh?'}, 
   1072: {QUEST: 'Great - you got it back!\x07Maybe you should try _toNpcName_, it could be for him._where_', LEAVING: ''}, 
   1073: {QUEST: 'Oh, thanks for bringing me my packages.\x07Wait a second, I was expecting two.  Could you check with _toNpcName_ and see if he has the other one?', INCOMPLETE: 'Were you able to find my other package?', 
          LEAVING: ''}, 
   1074: {QUEST: 'He said there was another package?  Maybe the Cogs stole it too.\x07Defeat Cogs until you find the second package.', LEAVING: '', 
          INCOMPLETE_PROGRESS: 'No luck finding the other package, huh?'}, 
   1075: {QUEST: 'I guess there was a second package after all!\x07Hurry and take it over to _toNpcName_ with my apologies.', COMPLETE: 'Hey, my package is here!\x07Since you seem to be such a helpful Toon, this should come in handy.', 
          LEAVING: ''}, 
   1076: {QUEST: "There's been some trouble over at 14 Karat Goldfish.\x07_toNpcName_ could probably use a hand._where_"}, 1077: {QUEST: "Thanks for coming - the Cogs stole all my goldfish.\x07I think the Cogs want to sell them to make a quick buck.\x07Those 5 fish have been my only companions in this tiny store for so many years...\x07If you could get them back for me I'd really appreciate it.\x07I'm sure one of the Cogs has my fish.\x07Defeat Cogs until you find my goldfish.", LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Please return my goldfish to me.'}, 
   1078: {QUEST: "Oh, you have my fish!\x07Huh?  What's this - a receipt?\x07Sigh, I guess they are Cogs, after all.\x07I can't make heads or tails out of this receipt.  Could you take it to _toNpcName_ and see if he can read it?_where_", INCOMPLETE: 'What did _toNpcName_ have to say about the receipt?', 
          LEAVING: ''}, 
   1079: {QUEST: "Mmm, let me see that receipt.\x07...Ah Yes, it says that 1 goldfish was sold to a Flunky.\x07It doesn't seem to mention what happened to the other 4 fish.\x07Maybe you should try and find that Flunky.", LEAVING: '', 
          INCOMPLETE_PROGRESS: "I don't think there's anything else I can help you with.\x07Why don't you try and find that goldfish?"}, 
   1092: {QUEST: "Mmm, let me see that receipt.\x07...Ah Yes, it says that 1 goldfish was sold to a Short Change.\x07It doesn't seem to mention what happened to the other 4 fish.\x07Maybe you should try and find that Short Change.", LEAVING: '', 
          INCOMPLETE_PROGRESS: "I don't think there's anything else I can help you with.\x07Why don't you try and find that goldfish?"}, 
   1080: {QUEST: "Oh thank heavens!  You found Oscar - he's my favorite, but don't tell the others.\x07What's that, Oscar?  Uh huh... they did? ... THEY ARE?\x07Well, what are we waiting for?\x07Oscar says the other 4 escaped into the pond in the playground.\x07Could you go round them up for me?\x07Just fish them out of the pond.", LEAVING: '', 
   ...
   1081: {QUEST: "_toNpcName_ appears to be in a sticky situation...\x07If you help him out, he says he'll be glad to give you a big boost._where_"}, 1082: {QUEST: "I spilled some Blue Glue and I'm stuck - stuck cold!\x07If there were a way out, I sure would be sold.\x07That gives me an idea, if you are feeling loyal.\x07Defeat a few Sellbots and bring back some oil.", LEAVING: '', 
          GREETING: '', 
          INCOMPLETE_PROGRESS: "Have you found the oil?  I'm beginning to boil!"}, 
   1083: {QUEST: "The oil helped a little, but I still cannot budge.\x07What else would help?  It's too hard to judge.\x07That gives me an idea; it's worth a try at least...\x07Defeat those Lawbots and bring back some grease.", LEAVING: '', 
          GREETING: '', 
          INCOMPLETE_PROGRESS: 'Have you got any grease?  I need to pay the lease!'}, 
   1084: {QUEST: "Nope, that didn't help.  This is really not funny.\x07I put the grease right there on the money!\x07That gives me an idea! Now before I forget it...\x07Defeat some Cashbots; bring back water to wet it.", LEAVING: '', 
          GREETING: '', 
   ...
   401: {GREETING: '', QUEST: 'Now you get to choose the next gag track you want to learn.\x07Take your time deciding, and come back here when you are ready to choose.', 
         ...
         LEAVING: QuestsDefaultLeaving}, 
   2201: {QUEST: 'Those sneaky Cogs are at it again.\x07_toNpcName_ has reported another missing item. Stop by and see if you can straighten it out._where_'}, 2202: {QUEST: "Hi, _avName_. Thank goodness you're here. A mean looking Penny Pincher was just in here and he made off with an inner tube.\x07I fear they may use it for their vile purposes.\x07Please see if you can find him and bring it back.", LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Any luck finding my inner tube?', 
          COMPLETE: 'You found my inner tube! You ARE good. Here, take your reward...'}, 
   2203: {QUEST: TheCogs + ' are wreaking havoc over at the bank.\x07Go see Captain Carl and see what you can do._where_'}, 2204: {QUEST: "Welcome aboard, matey.\x07Argh! Those rapscallion Cogs smashed my monocle and I can't sort me change without it.\x07Be a good landlubber and take this prescription to _toNpcName_ and fetch me a new one._where_", GREETING: '', 
          LEAVING: ''}, 
   2205: {QUEST: "What's this?\x07Oh, I'd love to fill this prescription but the Cogs have been pilfering my supplies.\x07If you can get me the eyeglass frames off a flunky I can probably help you out.", LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Sorry. No flunky frames, no monocle.'}, 
   2206: {QUEST: 'Excellent!\x07Just a second...\x07Your prescription is filled. Please take this monocle straight to Captain Carl._where_', GREETING: '', 
          LEAVING: '', 
          COMPLETE: "Avast Ye!\x07You're gonna earn your sea legs after all.\x07Here ye be."}, 
   2207: {QUEST: "Barnacle Barbara has a Cog in her shop!\x07You'd better get over there pronto._where_"}, 2208: {QUEST: "Gosh! You just missed him, sweetie.\x07There was a Back Stabber in here. He took my big white wig.\x07He said it was for his boss and something about 'legal precedent.'\x07If you can get it back I'd be forever grateful.", LEAVING: '', 
          GREETING: '', 
   ...
   2209: {QUEST: 'Melville is preparing for an important voyage.\x07Pop in and see what you can do to help sort him out._where_'}, 2210: {QUEST: "I can use your help.\x07I've been asked by Toon HQ to take a voyage and see if I can find where the Cogs are coming from.\x07I'll need a few things for my ship but I don't have many jellybeans.\x07Stop by and pick up some ballast from Alice. You'll have to do a favor for her to get it._where_", GREETING: 'Howdy, _avName_', 
          LEAVING: ''}, 
   2211: {QUEST: "So Melville wants ballast, does he?\x07He still owes me for the last bushel.\x07I'll give it to you if you can clear five Micromanagers off my street.", INCOMPLETE_PROGRESS: 'No, silly! I said FIVE micromanagers...', 
          GREETING: 'What can I do for you?', 
          LEAVING: ''}, 
   2212: {QUEST: "A deal's a deal.\x07Here's your ballast for that cheapskate Melville._where_", GREETING: 'Well, look what the cat dragged in...', 
          LEAVING: ''}, 
   2213: {QUEST: "Excellent work. I knew she'd be reasonable.\x07Next I'll need a sailing chart from Art.\x07I don't think my credit is good there either so you'll have to work something out with him._where_", GREETING: '', 
          LEAVING: ''}, 
   2214: {QUEST: "Yes, I have the sea chart Melville wants.\x07And if you're willing to work for it I'll let you have it.\x07I'm trying to build an astrolabe to navigate by the stars.\x07I could use three Cog gears to build it.\x07Come back when you've found them.", INCOMPLETE_PROGRESS: "How's it coming with those Cog gears?", 
          GREETING: 'Welcome!', 
          LEAVING: 'Good luck!'}, 
   2215: {QUEST: "Ooh! These gears will do rather nicely.\x07Here's the chart. Give it to Melville with my compliments._where_", GREETING: '', 
          LEAVING: '', 
   ...
   4001: {GREETING: '', QUEST: 'Now you get to choose the next gag track you want to learn.\x07Take your time deciding, and come back here when you are ready to choose.', 
          INCOMPLETE_PROGRESS: 'Think about your decision before choosing.', 
          INCOMPLETE_WRONG_NPC: 'Think about your decision before choosing.', 
          COMPLETE: 'A wise decision...', 
          LEAVING: QuestsDefaultLeaving}, 
   4002: {GREETING: '', QUEST: 'Now you get to choose the next gag track you want to learn.\x07Take your time deciding, and come back here when you are ready to choose.', 
          INCOMPLETE_PROGRESS: 'Think about your decision before choosing.', 
          INCOMPLETE_WRONG_NPC: 'Think about your decision before choosing.', 
          COMPLETE: 'A wise decision...', 
          LEAVING: QuestsDefaultLeaving}, 
   4200: {QUEST: "I bet Tom could use some help with some research he's doing._where_"}, 4201: {GREETING: 'Howdy!', QUEST: "I'm very concerned about a rash of musical instrument theft.\x07I'm conducting a survey among my fellow merchants.\x07Perhaps I can find a pattern to help me crack this case.\x07Stop by and ask Tina for a concertina inventory._where_"}, 
   4202: {QUEST: 'Yes, I talked to Tom this morning.\x07I have the inventory right here.\x07Bring it right back to him, ok?_where_'}, 4203: {QUEST: "Great! One down...\x07Now swing by and get Yuki's._where_"}, 4204: {QUEST: 'Oh! The inventory!\x07I forgot all about it.\x07I bet I can have it done by the time you defeat 10 Cogs.\x07Stop in after that and I promise it will be ready.', INCOMPLETE_PROGRESS: '31, 32... DOH!\x07You made me lose count!', 
          GREETING: ''}, 
   4205: {QUEST: 'Ah, there you are.\x07Thanks for giving me some time.\x07Take this to Tom and tell him I said Hello._where_'}, 4206: {QUEST: "Hmmm, very interesting.\x07Now we are getting somewhere.\x07Ok, the last inventory is Fifi's._where_"}, 4207: {QUEST: "Inventory?\x07How can I do an inventory if I don't have the form?\x07Go see Cleff and see if he has one for me._where_", INCOMPLETE_PROGRESS: 'Any sign of that form yet?'}, 
   4208: {QUEST: "Sure I got an inventory form, mon!\x07But dey ain't free, you know.\x07I'll tell you woht. I trade you for a whole cream pie.", GREETING: 'Hey, mon!', 
          LEAVING: 'Cool runnings...', 
          INCOMPLETE_PROGRESS: "A slice won't do.\x07I be hungry, mon. I need de WHOLE pie."}, 
   4209: {GREETING: '', QUEST: 'Mmmm...\x07Dem mighty nice!\x07Here be your form for Fifi._where_'}, 
   4210: {GREETING: '', QUEST: "Thank you. That's a big help.\x07Let's see...Fiddles: 2\x07All done! Off you go!_where_", 
   ...
   4215: {QUEST: "Anna desperately needs someone to help her.\x07Why don't you drop in and see what you can do._where_"}, 4216: {QUEST: "Thanks for coming so quickly!\x07Seems like the Cogs have made off with several of my customers' cruise tickets.\x07Yuki said she saw a Glad Hander leaving here with his glad hands full of them.\x07See if you can get Lumber Jack's ticket to Alaska back.", INCOMPLETE_PROGRESS: 'Those Glad Handers could be anywhere now...'}, 
   4217: {QUEST: "Oh, great. You found it!\x07Now be a trooper and run in by Jack's for me, would you?_where_"}, 4218: {QUEST: "Great Googely Moogely!\x07Alaska here I come!\x07I can't take these infernal Cogs anymore.\x07Say, I think Anna needs you again._where_"}, 4219: {QUEST: "Yup, you guessed it.\x07I need you to shake down those pesky Glad Handers for Tabitha's ticket to Jazzfest.\x07You know the procedure...", INCOMPLETE_PROGRESS: "There's more out there somewhere..."}, 
   4220: {QUEST: 'Sweet!\x07Could you swing this one by his place for me too?_where_'}, 4221: {GREETING: '', LEAVING: 'Be cool...', 
          QUEST: "Cool, daddio!\x07Now I'm in fat city, _avName_.\x07Before you split, you better go check out Anna Banana again..._where_"}, 
   4222: {QUEST: "This is the last one, I promise!\x07Now you are looking for Barry's ticket to the big singing contest.", INCOMPLETE_PROGRESS: "C'mon, _avName_.\x07Barry is counting on you."}, 
   4223: {QUEST: "This should put a smile on Barry's face._where_"}, 4224: {GREETING: '', LEAVING: '', 
   ...
   902: {QUEST: 'Go see Leo.\x07He needs someone to deliver a message for him._where_'}, 4903: {QUEST: 'Dude!\x07My castanets are all cloudy and I have a big show tonight.\x07Take them to Carlos and see if he can polish them up._where_'}, 4904: {QUEST: 'Jes, I tink I can polish dees.\x07But I need soma de blue ink from de squid.', GREETING: 'Hola!', 
          LEAVING: 'Adios!', 
          INCOMPLETE_PROGRESS: "Juo can find de squid wherever dere's a fishing pier"}, 
   4905: {QUEST: "Jes! Dat's it!\x07Now I need a leetle time to polish dees.\x07Why don juo go takeover a one story beelding while I work?", GREETING: 'Hola!', 
          LEAVING: 'Adios!', 
          INCOMPLETE_PROGRESS: 'Jest anodder minute...'}, 
   4906: {QUEST: 'Bery good!\x07Here are de castanets for Leo._where_'}, 4907: {GREETING: '', QUEST: "Cool, dude!\x07They look awesome!\x07Now I need you to get a copy of the lyrics to 'A Beat Christmas' from Hedy._where_"}, 
   4908: {QUEST: "Hello there!\x07Hmmm, I don't have a copy of that song handy.\x07If you give me a little while I could transcribe it from memory.\x07Why don't you run along and reclaim a two story building while I write?"}, 4909: {QUEST: "I'm sorry.\x07My memory is getting a little fuzzy.\x07If you go reclaim a three story building I'm sure I'll be done when you get back..."}, 4910: {QUEST: 'All done!\x07Sorry it took so long.\x07Take this back to Leo._where_', GREETING: '', 
          COMPLETE: 'Awesome, dude!\x07My concert is gonna rock!\x07Speaking of rock, you can rock some Cogs with this...'}, 
   5247: {QUEST: "This neighborhood is pretty tough...\x07You might want to learn some new tricks.\x07Lil' Oldman taught me everything I know, but he's busy with the Election.\x07_toNpcName_ can probably help, though._where_"}, 5248: {GREETING: 'Hello, hello!', LEAVING: '', 
          INCOMPLETE_PROGRESS: "Stuck? Look in Cog Buildings, Cog HQs, or Donald's Dreamland.", 
          QUEST: "I am Weird Renecival, mayor of Dunetown.\x07Lil' Oldman has appointed me the Blizzard Wizard Pro Tempore while he's preparing for the Interim Elections.\x07Before you can train for your final Gag track, a small demonstration is necessary.\x07Go defeat ten Cogs, at least level 8."}, 
   5249: {GREETING: 'Hello, hello!', QUEST: 'Excellent work!\x07Fishing is an important skill to get jellybeans.\x07Go fishing for three fuzzy dice that I totally did not drop in the pond on accident.', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Having a hard time? Try waiting a bit before you recast-- a fish might swim to your bait.'}, 
   5250: {GREETING: 'Hello, hello!', LEAVING: '', 
          QUEST: 'Supreme work!\x07Now, you need to show your survival skills.\x07Go defeat a 5 story... hmm... Lawbot building.', 
          INCOMPLETE_PROGRESS: 'Try looking in Polar Place for Lawbot buildings.'}, 
   5258: {GREETING: '', LEAVING: '', 
          QUEST: 'Supreme work!\x07Now, you need to show your survival skills.\x07Go defeat a 5 story... hmm... Bossbot building.', 
          INCOMPLETE_PROGRESS: 'Try looking in this street for Bossbot buildings.'}, 
   5259: {GREETING: '', LEAVING: '', 
          QUEST: 'Supreme work!\x07Now, you need to show your survival skills.\x07Go defeat a 5 story... hmm... Cashbot building.', 
          INCOMPLETE_PROGRESS: 'Try looking in Sleet Street for Cashbot buildings.'}, 
   5260: {GREETING: '', LEAVING: '', 
          QUEST: 'Supreme work!\x07Now, you need to show your survival skills.\x07Go defeat a 5 story... hmm... Sellbot building.', 
          INCOMPLETE_PROGRESS: 'Try looking in Sleet Street for Sellbot buildings.'}, 
   5200: {QUEST: 'Those sneaky Cogs are at it again.\x07_toNpcName_ has reported another missing item. Stop by and see if you can straighten it out._where_'}, 5201: {GREETING: '', QUEST: 'Hi, _avName_.  I reckon I should thank you for coming.\x07A group of those Head Hunters came in and stole my soccer ball.\x07The leader told me that I had to make some cutbacks and just grabbed it away from me!\x07Can you get my ball back?', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Any luck finding my soccer ball?', 
          COMPLETE: 'Yeehaw! You found it!\x07 Here, take your reward...'}, 
   5261: {GREETING: '', QUEST: 'Hi, _avName_.  I reckon I should thank you for coming.\x07A group of those Two-Faces came in and stole my soccer ball.\x07The leader told me that I had to make some cutbacks and just grabbed it away from me!\x07Can you get my ball back?', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Any luck finding my soccer ball?', 
          COMPLETE: 'Yeehaw! You found it!\x07 Here, take your reward...'}, 
   5262: {GREETING: '', QUEST: 'Hi, _avName_.  I reckon I should thank you for coming.\x07A group of those Money Bags came in and stole my soccer ball.\x07The leader told me that I had to make some cutbacks and just grabbed it away from me!\x07Can you get my ball back?', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Any luck finding my soccer ball?', 
          COMPLETE: 'Yeehaw! You found it!\x07 Here, take your reward...'}, 
   5263: {GREETING: '', QUEST: 'Hi, _avName_.  I reckon I should thank you for coming.\x07A group of those Spin Doctors came in and stole my soccer ball.\x07The leader told me that I had to make some cutbacks and just grabbed it away from me!\x07Can you get my ball back?', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Any luck finding my soccer ball?', 
          COMPLETE: 'Yeehaw! You found it!\x07 Here, take your reward...'}, 
   5202: {QUEST: lTheBrrrgh + " has been overrun with some of the toughest Cogs we've seen yet.\x07You will probably want to carry more gags around here.\x07I hear _toNpcName_ may have a large bag you can use to carry more gags._where_"}, 5203: {GREETING: 'Huh?  Are you on my sledding team?', QUEST: "What's that?  You want a bag?\x07I had one somewhere around here... maybe it's in my toboggan?\x07Only... I haven't seen my toboggan since the big race!\x07Maybe one of those Cogs took it?", 
          LEAVING: 'Have you seen my toboggan?', 
          INCOMPLETE_PROGRESS: "Who are you again?  Sorry, I'm a little woozy from the crash."}, 
   5204: {GREETING: '', LEAVING: '', 
          QUEST: "Is that my toboggan?  I don't see any bag here.\x07I think Bumpy Noggin was on the team... maybe he has it?_where_"}, 
   5205: {GREETING: 'Ohhh, my head!', LEAVING: '', 
   ...
   5208: {GREETING: '', LEAVING: 'Eeeek!', 
          QUEST: 'Ooooh!  Me like you!\x07Go to Ski Clinic. Bag there.'}, 
   5209: {GREETING: 'Dude!', LEAVING: 'Later!', 
   ...
   5210: {QUEST: '_toNpcName_ is secretly in love with someone in the neighborhood.\x07If you help her, she may reward you handsomely._where_'}, 5211: {GREETING: 'Boo hoo.', QUEST: 'I spent all last night writing a letter to the dog I love.\x07But before I could deliver it, one of those nasty Cogs with a beak came in and took it.\x07Can you get it back for me?', 
          LEAVING: 'Boo hoo.', 
          INCOMPLETE_PROGRESS: 'Please find my letter.'}, 
   5264: {GREETING: 'Boo hoo.', QUEST: 'I spent all last night writing a letter to the dog I love.\x07But before I could deliver it, one of those nasty Cogs with a fin came in and took it.\x07Can you get it back for me?', 
          LEAVING: 'Boo hoo.', 
          INCOMPLETE_PROGRESS: 'Please find my letter.'}, 
   5265: {GREETING: 'Boo hoo.', QUEST: 'I spent all last night writing a letter to the dog I love.\x07But before I could deliver it, one of those nasty Mingler Cogs came in and took it.\x07Can you get it back for me?', 
          LEAVING: 'Boo hoo.', 
          INCOMPLETE_PROGRESS: 'Please find my letter.'}, 
   5266: {GREETING: 'Boo hoo.', QUEST: 'I spent all last night writing a letter to the dog I love.\x07But before I could deliver it, one of those nasty Corporate Raiders came in and took it.\x07Can you get it back for me?', 
          LEAVING: 'Boo hoo.', 
          INCOMPLETE_PROGRESS: 'Please find my letter.'}, 
   5212: {QUEST: 'Oh, thank you for finding my letter!\x07Please, please, please could you deliver it to the most handsome dog in the neighborhood?', GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "You didn't deliver my letter, did you?"}, 
   5213: {GREETING: "Charmed, I'm sure.", QUEST: "I can't be bothered with your letter, you see.\x07All my doggies have been taken from me!\x07If you bring them back, maybe we can talk then.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'My poor little doggies!'}, 
   5214: {GREETING: '', LEAVING: 'Toodleloo!', 
   ...
   5215: {GREETING: 'Heh, heh...', LEAVING: 'Come back, yes, yes.', 
   ...
   5216: {QUEST: 'We told you we would helps you.\x07So take this ring to the girl.', GREETING: '', 
          LEAVING: '', 
   ...
   5217: {QUEST: 'It sounds like _toNpcName_ could use some help._where_'}, 5218: {GREETING: '', LEAVING: '', 
   ...
   5222: {LEAVING: '', QUEST: "Oh, that Harry, he sure is a card!\x07I'll whip up something that will fix him right up!\x07Oh, I appear to be out of sardine whiskers...\x07Be a dear and run down to the pond and catch some for me.", 
          INCOMPLETE_PROGRESS: 'Got those whiskers for me yet?'}, 
   5223: {QUEST: 'Okay.  Thanks, hon.\x07Here, now take this to Harry.  It should calm him right down.', GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Go on now, take the potion to Harry.'}, 
   5224: {GREETING: '', LEAVING: '', 
   ...
   5225: {QUEST: 'Ever since the incident with the turnip bread, Grumpy Phil has been mad at _toNpcName_.\x07Maybe you could help Gus fix things between them?_where_'}, 5226: {QUEST: 'Yeah, you probably heard Grumpy Phil is mad at me...\x07I was just trying to be nice with that turnip bread.\x07Maybe you can help cheer him up.\x07Phil really hates those Cashbot Cogs, especially their buildings.\x07If you reclaim some Cashbot buildings, it might help.', LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Maybe a few more buildings?'}, 
   5227: {QUEST: "That's terrific!  Go tell Phil what you've done._where_"}, 5228: {QUEST: 'Oh he did, did he?\x07That Gus thinks he can get off so easy, does he?\x07Only broke my tooth, he did, with that turnip bread of his!\x07Maybe if you took my tooth to Dr. Mumbleface for me he could fix it.', GREETING: 'Mmmmrrphh.', 
          LEAVING: 'Grumble, grumble.', 
          INCOMPLETE_PROGRESS: 'You again?  I thought you were going to get my tooth fixed for me.'}, 
   5229: {GREETING: '', LEAVING: '', 
   ...
   5230: {GREETING: '', QUEST: "I'm glad you're back!\x07I gave up trying to fix that old tooth, and made a new gold tooth for Phil instead.\x07Unfortunately a Robber Baron came in and took it from me.\x07Maybe you can catch him if you hurry.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Did you find that tooth yet?'}, 
   5270: {GREETING: '', QUEST: "I'm glad you're back!\x07I gave up trying to fix that old tooth, and made a new gold tooth for Phil instead.\x07Unfortunately a Big Cheese came in and took it from me.\x07Maybe you can catch him if you hurry.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Did you find that tooth yet?'}, 
   5271: {GREETING: '', QUEST: "I'm glad you're back!\x07I gave up trying to fix that old tooth, and made a new gold tooth for Phil instead.\x07Unfortunately Mr. Hollywood came in and took it from me.\x07Maybe you can catch him if you hurry.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Did you find that tooth yet?'}, 
   5272: {GREETING: '', QUEST: "I'm glad you're back!\x07I gave up trying to fix that old tooth, and made a new gold tooth for Phil instead.\x07Unfortunately a Big Wig came in and took it from me.\x07Maybe you can catch him if you hurry.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Did you find that tooth yet?'}, 
   5231: {QUEST: "Great, that's the tooth alrighty!\x07Why don't you just run it over to Phil for me?", GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'I bet Phil would like to see his new tooth.'}, 
   5232: {QUEST: "Oh, thanks.\x07Mmmrrrphhhh\x07How's that look, huh?\x07Okay, you can tell Gus that I forgive him.", LEAVING: '', 
          GREETING: ''}, 
   5233: {QUEST: "Oh, that's great to hear.\x07I figured old Phil couldn't stay mad at me.\x07As a gesture of goodwill, I baked him this Pine cone bread.\x07Could you run it over to him for me?", GREETING: '', 
          LEAVING: '', 
   ...
   903: {QUEST: 'You may be ready to see _toNpcName_ the Blizzard Wizard Pro Tempore for your final test._where_'}, 5234: {GREETING: 'Hello, hello!', QUEST: "Finally back? Took you a while!\x07I'm so hungry, I could eat a hors... erm...\x07Cheese? Yes, yes, get some cheese for me, please.\x07You should be able to get some from a The Big Cheese.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Lost? You can find some The Big Cheeses in Bossbot buildings or Bossbot HQ.'}, 
   5278: {GREETING: 'Hello, hello!', QUEST: "Finally back? Took you a while!\x07I'm so hungry, I could eat a hors... erm...\x07Fish... eggs...? Ah, yes, yes, get some caviar for me, please.\x07Mr. Hollywoods usually carry some in case they need to set up an impromptu fancy dinner.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Lost? You can find Mr. Hollywoods in Sellbot buildings and at Sellbot Towers.'}, 
   5235: {GREETING: 'Hello, hello!', QUEST: "Now to eat!\x07Oh no! I lost my spoon!\x07Can you go find it? It's very simple looking.\x07I would think a Robber Baron took it.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'I simply must have my spoon! Look for Robber Barons in Cashbot buildings or Cashbot HQ.'}, 
   5279: {GREETING: 'Hello, hello!', QUEST: "Now to eat!\x07Oh no! I lost my spoon!\x07Can you go find it? It's very simple looking.\x07I would think a Big Wig took it.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'I simply must have my spoon! Look for Big Wig in Lawbot buildings or Lawbot HQ.'}, 
   5236: {GREETING: 'Hello, hello!', QUEST: "Thanks a million!\x07Now, you must find a talking toad. Don't ask me why, I really don't know!\x07It's all here on the Task.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Check the Fishing Ponds for the Talking Toad.'}, 
   5237: {GREETING: '', LEAVING: '', 
          INCOMPLETE_PROGRESS: 'You have not yet obtained dessert.', 
          QUEST: "It's a toad, but does it talk?\x07...yes it does! Now, I've finished my food, now I need dessert.\x07_toNpcName_ sells ice cream, I heard.\x07The toad likes red bean flavored ice cream for some reason._where_"}, 
   5238: {GREETING: '', QUEST: "So Weird sent you.  I'm sad to say we're fresh out of red bean ice cream cones.\x07You see, a bunch of Cogs came in and just took them.\x07They said they were for Mr. Hollywood, or some such nonsense.\x07I'd sure appreciate if you could round them back up for me.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Have you found all my ice cream cones yet?'}, 
   5280: {GREETING: '', QUEST: "So Weird sent you.  I'm sad to say we're fresh out of red bean ice cream cones.\x07You see, a bunch of Cogs came in and just took them.\x07They said they were for The Big Cheese, or some such nonsense.\x07I'd sure appreciate if you could round them back up for me.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Have you found all my ice cream cones yet?'}, 
   5239: {QUEST: "Thanks for bringing back my ice cream cones!\x07Here's one for Weird.", GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'You better bring that ice cream to Weird before it melts.'}, 
   5240: {GREETING: '', QUEST: "Very good! You're almost done now.\x07If you can just bring me some powder to dry my hands, you'd be golden.\x07I think those Big Wig Cogs sometimes have powder from their wigs.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Did you find any powder?'}, 
   5281: {GREETING: '', QUEST: "Very good! You're almost done now.\x07If you can just bring me some powder to dry my hands, you'd be golden.\x07I think those Mr. Hollywood Cogs sometimes keep powder for their noses.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Did you find any powder?'}, 
   5241: {QUEST: "You know what's coming up.\x07Defeat 20 4+ story Cog buildings.", LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Keep going...'}, 
   5242: {GREETING: '', QUEST: 'One last ToonTask in the stack! Go fishing for another talking toad.', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Look in the ponds for another toad.', 
          COMPLETE: "Congratulations! You've earned your final Gag Track!"}, 
   5243: {QUEST: 'Sweaty Pete is starting to stink up the street.\x07Can you talk him into taking a shower or something?_where_'}, 5244: {GREETING: '', QUEST: "Yeah, I guess I do work up quite a sweat in here.\x07Mmmm, maybe if I could fix that leaky pipe in my shower...\x07I figure a gear from one of those tiny Cogs would do the trick.\x07Go find a gear from a Micromanager and we'll try it.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Where's that gear you were going to get?"}, 
   5245: {GREETING: '', QUEST: 'Yup, that seemed to do the trick.\x07But I get lonely when I shower...\x07Could you go fish me up a rubber ducky to keep me company?', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Any luck with that duck?'}, 
   5246: {QUEST: "The ducky's great, but...\x07All those buildings around here make me nervous.\x07I'd feel a lot more relaxed if there were fewer buildings around.", LEAVING: '', 
          COMPLETE: "Okay, I'll shower up now.  And here's something for you too.", 
          INCOMPLETE_PROGRESS: "I'm still worried about buildings."}, 
   5251: {QUEST: 'Lounge Lassard is supposed to be playing a gig tonight.\x07I hear he might be having some trouble with his equipment._where_'}, 5252: {GREETING: '', QUEST: 'Oh yeah!  I could sure use some help.\x07Those Cogs came in and swiped all my gear while I was unloading the van.\x07Can you give me a hand and get back my microphone?', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Hey man, I can't sing without my microphone."}, 
   5253: {GREETING: '', QUEST: "Yeah, that's my microphone all right.\x07Thanks for getting it for me, but...\x07I really need my keyboard so I can tickle the ivories.\x07I think one of those Corporate Raiders got my keyboard.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'No luck finding my keboard?'}, 
   5273: {GREETING: '', QUEST: "Yeah, that's my microphone all right.\x07Thanks for getting it for me, but...\x07I really need my keyboard so I can tickle the ivories.\x07I think one of those Minglers got my keyboard.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'No luck finding my keboard?'}, 
   5274: {GREETING: '', QUEST: "Yeah, that's my microphone all right.\x07Thanks for getting it for me, but...\x07I really need my keyboard so I can tickle the ivories.\x07I think one of those Loan Sharks got my keyboard.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'No luck finding my keboard?'}, 
   5275: {GREETING: '', QUEST: "Yeah, that's my microphone all right.\x07Thanks for getting it for me, but...\x07I really need my keyboard so I can tickle the ivories.\x07I think one of those Legal Eagles got my keyboard.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'No luck finding my keboard?'}, 
   5254: {GREETING: '', QUEST: "All right!  Now I'm in business.\x07If only they hadn't taken my platform shoes...\x07Those shoes probably ended up with a Mr. Hollywood, if I had to guess.", 
          LEAVING: '', 
   ...
   5282: {GREETING: '', QUEST: "All right!  Now I'm in business.\x07If only they hadn't taken my platform shoes...\x07Those shoes probably ended up with a Big Cheese, if I had to guess.", 
          LEAVING: '', 
          COMPLETE: "Allright!!  I'm ready now.\x07Hello Brrrgh!!!\x07Huh?  Where is everyone?\x07Okay, take this and round me up some fans, huh?", 
          INCOMPLETE_PROGRESS: "I can't perform barefoot, can I?"}, 
   5283: {GREETING: '', QUEST: "All right!  Now I'm in business.\x07If only they hadn't taken my platform shoes...\x07Those shoes probably ended up with a Robber Baron, if I had to guess.", 
          LEAVING: '', 
          COMPLETE: "Allright!!  I'm ready now.\x07Hello Brrrgh!!!\x07Huh?  Where is everyone?\x07Okay, take this and round me up some fans, huh?", 
          INCOMPLETE_PROGRESS: "I can't perform barefoot, can I?"}, 
   5284: {GREETING: '', QUEST: "All right!  Now I'm in business.\x07If only they hadn't taken my platform shoes...\x07Those shoes probably ended up with a Big Wig, if I had to guess.", 
          LEAVING: '', 
          COMPLETE: "Allright!!  I'm ready now.\x07Hello Brrrgh!!!\x07Huh?  Where is everyone?\x07Okay, take this and round me up some fans, huh?", 
          INCOMPLETE_PROGRESS: "I can't perform barefoot, can I?"}, 
   5255: {QUEST: 'You look like you could use more Laff points.\x07Maybe _toNpcName_ could sort you out._where_'}, 5256: {GREETING: '', LEAVING: '', 
   ...
   5301: {QUEST: "I can't help you with Laff points, but maybe _toNpcName_ will cut you a deal.\x07He's a little on tempermental side though..._where_"}, 5302: {GREETING: '', LEAVING: '', 
   ...
   5303: {QUEST: lTheBrrrgh + " is teeming with very dangerous Cogs.\x07If I were you, I'd carry more gags around here.\x07I hear _toNpcName_ can make you a large bag if you are willing to do the legwork._where_"}, 5304: {GREETING: '', LEAVING: '', 
   ...
   5307: {GREETING: '', LEAVING: 'Much obliged!', 
   ...
   6201: {QUEST: 'Powers Erge needs some help. Could you drop by and lend her a hand?_where_'}, 6202: {GREETING: '', LEAVING: '', 
   ...
   6206: {QUEST: "Well, _avName_, I don't have anything for you right now.\x07Wait! I think Susan Siesta was looking for help. Why don't you go see her?_where_"}, 6207: {GREETING: '', LEAVING: '', 
   ...
   6211: {QUEST: 'Hey _avName_! I heard Lawful Linda was looking for you.\x07You should stop by and pay her a visit._where_'}, 6212: {GREETING: '', LEAVING: '', 
   ...
   6221: {QUEST: 'I heard Rocco was looking for help. See what you can do for him._where_'}, 6222: {GREETING: '', LEAVING: '', 
   ...
   6231: {QUEST: 'Nat over on Pajama Place heard rumors about a Cashbot Headquarters.\x07Head over there and see if you can help him out._where_'}, 6232: {GREETING: '', LEAVING: '', 
   ...
   6241: {QUEST: "The Countess has been looking everywhere for you! Please pay her a visit so she'll stop calling._where_"}, 6242: {GREETING: '', LEAVING: '', 
   ...
   6251: {QUEST: "Poor Zari broke her zipper and now she can't make deliveries to her customers. She could sure use your help._where_"}, 6252: {GREETING: '', LEAVING: '', 
   ...
   6271: {QUEST: "Drowsy Dave is having some trouble that you might be able to help with. Why don't you stop by his shop?_where_"}, 6272: {GREETING: '', LEAVING: '', 
   ...
   6281: {QUEST: "Head over and call on Teddy Blair. He's got a job for you._where_"}, 6282: {GREETING: '', LEAVING: '', 
   ...
   7209: {QUEST: 'Go see Honey Moon. She needs some help._where_'}, 7210: {GREETING: '', LEAVING: '', 
   ...
   7218: {QUEST: 'Dreamy Daphne could use a hand._where_'}, 7219: {GREETING: '', LEAVING: '', 
   ...
   7226: {QUEST: "Drop by to see Sandy Sandman. She's lost her pajamas._where_"}, 7227: {GREETING: '', LEAVING: '', 
   ...
   7239: {QUEST: "Go see Smudgy Mascara. She's been looking for some help._where_"}, 7240: {GREETING: '', LEAVING: '', 
   ...
   11012: {GREETING: '', LEAVING: '', 
           QUEST: 'You know the drill._where_'}, 
   11013: {GREETING: '', LEAVING: '', 
   ...
   11022: {GREETING: '', LEAVING: '', 
           QUEST: 'I hate to say it, but..._where_'}, 
   11023: {GREETING: '', LEAVING: '', 
   ...
   12006: {GREETING: '', LEAVING: '', 
           QUEST: '_toNpcName_ has more parts for you...'}, 
   12007: {GREETING: '', LEAVING: '', 
   ...
   12008: {GREETING: '', LEAVING: '', 
           QUEST: 'Head on over to..._where_'}, 
   12009: {GREETING: '', LEAVING: '', 
   ...
   12012: {GREETING: '', LEAVING: '', 
           QUEST: '_toNpcName_ needs more Bossbots.'}, 
   12013: {GREETING: '', LEAVING: '', 
   ...
   12016: {GREETING: '', LEAVING: '', 
           QUEST: '_toNpcName_ was looking for you...'}, 
   12017: {GREETING: '', LEAVING: '', 
   ...
   12018: {GREETING: '', LEAVING: '', 
           QUEST: 'Could you swing by..._where_'}, 
   12019: {GREETING: '', LEAVING: '', 
...
ChatGarblerScrooge = ['quack', 'quackity', 'quacky', 'money', 'savings']
...
CashbotS = 'a Cashbot'
SellbotS = 'a Sellbot'
HackerbotS = 'a Hackerbot'
BossbotP = 'Bossbots'
LawbotP = 'Lawbots'
CashbotP = 'Cashbots'
SellbotP = 'Sellbots'
HackerbotP = 'Hackerbot'
...
ReportPanelConfirmations = ('You are about to report that %s has used obscene, bigoted or sexually explicit language.',
 ...
 'You are about to report that %s has created a name that does not follow the Toontown Offline rules.',
...
ReportPanelRemovedPlayerFriend = 'We have automatically removed %s as a Player friend so as such you will not see them as your friend in any Toontown Offline product.'
...
PetTrickStrings = {0: 'Jump', 1: 'Beg', 
   2: 'Play dead', 
   3: 'Rollover', 
   4: 'Backflip', 
   5: 'Dance', 
   6: 'Speak'}
PetMoodAdjectives = {'neutral': 'neutral', 'hunger': 'hungry', 
   'boredom': 'bored', 
   'excitement': 'excited', 
   'sadness': 'sad', 
...
SpokenMoods = {'neutral': 'neutral', 'hunger': [
            "I'm tired of JellyBeans! How'bout giving me a slice of pie?", "How'bout a Red JellyBean? I'm tired of the Green ones!", "Oh, those JellyBeans were for planting?!! But I'm hungry!"], 
   'boredom': [
             "I'm dying of boredom over here!", "You didn't think I understood you, huh?", 'Could we, like, DO something already?'], 
   'excitement': [
   ...
   'sadness': [
             "Don't go, Don't go, Don't go, Don't go, Don't go, Don't go, Don't go, Don't go, Don't go, Don't go, Don't go...", "I'll be good, I promise!", "I don't know WHY I'm sad, I just am!!!"], 
   'restlessness': [
                  "I'm sooo restless!!!"], 
   'playfulness': [
                 "Let's play, Let's play, Let's play, Let's play, Let's play, Let's play, Let's play, Let's play, Let's play...", 'Play with me or I dig up some flowers!', 'Lets run around and  around and around and around and around and around...'], 
   'loneliness': [
                'Where have you been?', 'Wanna cuddle?', 'I want to go with you when you fight Cogs!'], 
   'fatigue': [
             'That swim in the pond really tired me out!', 'Being a Doodle is exhausting!', 'I gotta get to Dreamland!'], 
   'confusion': [
               'Where am I? Who are you again?', "What's a Toon-up again?", "Whoa, I'm standing between you and the Cogs! Run away!"], 
   'anger': [
           '... and you wonder why I never give you a Toon-up?!!!', 'You always leave me behind!', 'You love your gags more than you love me!'], 
   'surprise': [
              'Of course Doodles can talk!', 'Toons can talk?!!', 'Whoa, where did you come from?'], 
   'affection': [
               "You're the best Toon EVER!!!!!!!!!!", 'Do you even KNOW how great you are?!?', 'I am SO lucky to be with you!!!']}
DialogQuestion = '?'
...
TeleportPanelFullShard = 'Sorry, only one Toon per district.'
...
SuitBigWig = 'Big Wig'
SuitM1 = 'Script Kiddie'
SuitM2 = 'BASIC Master'
SuitM3 = 'Grey-Hat'
SuitM4 = 'Wiretapper'
SuitM5 = 'Python Charmer'
SuitM6 = 'Sharp Seer'
SuitM7 = 'Assembly Assassin'
SuitM8 = 'Sysadmin'
SuitChairman = 'Chairman'
...
SuitM1S = 'a Script Kiddie'
SuitM2S = 'a BASIC Master'
SuitM3S = 'a Grey-Hat'
SuitM4S = 'a Wiretapper'
SuitM5S = 'a Python Charmer'
SuitM6S = 'a Sharp Seer'
SuitM7S = 'a Assembly Assassin'
SuitM8S = 'a Sysadmin'
SuitChairmanS = 'the Chairman'
...
SuitM1P = 'Script Kiddies'
SuitM2P = 'BASIC Masters'
SuitM3P = 'Grey-Hats'
SuitM4P = 'Wiretappers'
SuitM5P = 'Python Charmers'
SuitM6P = 'Sharp Seers'
SuitM7P = 'Assembly Assassins'
SuitM8P = 'Sysadmins'
SuitChairmanP = 'the Chairman'
SuitFaceoffDefaultTaunts = ['Boo!']
SuitAttackDefaultTaunts = ['Take that!', 'Take a memo on this!']
SuitAttackNames = {'Audit': 'Audit!', 'Bite': 'Bite!', 
...
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.", 
   ...
   'GuiltTrip': [
               ...
               "I'd never forgive you in a million years!", 
   ...
   'Legalese': [
              ...
              'The opinions expressed in this attack are not those of Toontown Offline.', 
...
BuildingWaitingForVictors = ('Please wait...',)
...
FADoorCodes_HB_DISGUISE_INCOMPLETE = "You'll get caught going in there as a Toon! Perhaps there is some other type of Cog Disguise you'll need?"
KnockKnockDoorNames = {44: DoorNametag, 2: 'Furr Elise', 
   ...
   61: 'Macca', 
   29: 'PicklesJesse2'}
KnockKnockContestJokes = {2100: {44: ['Wally', "Wally's not looking, hit him with a pie!"], 2: [
            'Mirror', 'Mirror who?'], 
          1: [
            'Act', "No, we're starting from act one."], 
          3: [
            'Insane', "I don't know, but you're the one talking to a door."], 
          4: [
            'Candy', 'Candy have some jellybeans?'], 
          5: [
            'Santa', 'I santa you the key, now let me out!'], 
          6: [
            'Sensor', 'Sensor not doing anything, mind opening the door?'], 
          7: [
            'Donald', 'Donald your tasks yet?'], 
          49: [
             'Eureka', 'Eureka something weird!'], 
          60: [
             'Anomaly', "Anomaly don't say this, but have you seen my spaceship?"], 
          10: [
             'Toboggan', 'I hate toboggan with you, but will you open this door?'], 
          11: [
             'Goshi', 'Goshi wonder if I won an alpha key.'], 
          63: [
             'Shelly', "Shelly compare thee to a summer's day?"], 
          62: [
             'Were', 'No, Werewolf! Owoooooo!'], 
          16: [
             'Stan', "Stan back, or I'll throw this pie!"], 
          18: [
             'Snow', "Snow way I'm telling you!"], 
          66: [
             'Big Cheese', 'Big Cheese pizza delivery here, open up!'], 
          21: [
             'Telemarketer', "Telemarketer I'm not buying his offer."], 
          65: [
             'June', 'Juneau how to get out of this fountain?'], 
          24: [
             'Mickey', 'Mickey is stuck! Help'], 
          26: [
             'Guess', 'Does he have a mustache?'], 
          25: [
             'Usain', 'Usain you forgot me?'], 
          67: [
             'Wayt', 'Wayt, you forgot my name?'], 
          61: [
             'Fuchsia', 'Fuchsia stop talking to doors and go finish that ToonTask!'], 
          29: [
             'Vincent', 'Vincent, where did my Van Gogh?']}, 
   2200: {28: ['Biscuit', 'Biscuit out of here the Cogs are coming!'], 41: [
   ...
   3300: {10: ['Aladdin', 'Aladdin HQ wants a word with you.'], 6: [
...
WinterDaisyCChatter = (['Welcome to the only garden that grows in the winter!', 'Happy Winter Holiday!', 'Happy Winter Holiday, %!'],
...
WinterDaisyDChatter = (['Welcome to the only garden that grows in the winter!', 'Happy Winter Holiday!', 'Happy Winter Holiday, %!'],
 ['My garden needs more mistletoe!', 
  'I need to plant holly for next year!', 
  "I'm going to ask Goofy to build me a gingerbread house!", 
  'Those lights on the lamps are lovely!', 
...
ChipChatter = (
 ['Welcome to %s!' % lOutdoorZone,
  ...
  'We are Chip and Dale!'], ['I like golf.', 'We have the best acorns in Toontown.', 'The golf holes with volcanoes are the most challenging for me.'],
 ["We're going to the " + lTheBrrrgh + ' and play with %s.' % Pluto,
  "We'll visit %s and fix him." % Donald,
  "I think I'll go swimming at " + lDonaldsDock + '.',
  "Oh, I'm a little sleepy. I think I'll go to Dreamland."])
ValentinesChipChatter = (["I'm Chip!", "Happy ValenToon's Day!", "Happy ValenToon's Day, %!"],
...
WinterChipChatter = (['Happy Winter Holiday!', 'Dressed as chipmunks!', 'Happy Winter Holiday, %!'],
...
HalloweenChipChatter = (['Play some MiniGhoul... I mean Golf!', 'Happy Halloween!', 'Happy Halloween, %!'],
...
DaleChatter = (
 ["It's so nice to see you %!",
  ...
  "Hi I'm " + Chip + '.',
  'Welcome to %s!' % lOutdoorZone,
  'We are Chip and Dale!'], ['I like picnics.', 'Acorns are tasty, try some.', 'Those windmills can be hard too.'],
 ['Hihihi ' + Pluto + ' is fun to play with.',
  "Yeah, let's fix %s." % Donald,
  'A swim sounds refreshing.',
  "I'm getting tired and could use a nap."])
ValentinesDaleChatter = (["I'm Dale!", "Happy ValenToon's Day!", "Happy ValenToon's Day, %!"],
...
HalloweenDaleChatter = (['Happy Halloween, %!', 'Play some MiniGhoul... I mean Golf!', 'Happy Halloween!'],
 ["We're nuts about Halloween!", 
  ...
  'Candy corns are sweeter than acorns.', 
  'I hope you are enjoying our Halloween fun!'], ['%, watch out for Bloodsucker Cogs!'])
GoofyChatter = (['Welcome to ' + lDaisyGardens + '.', 'Hi, my name is ' + Goofy + ". What's yours?", "Gawrsh, it's nice to see you %!"],
...
GoofySpeedwayChatter = (['Welcome to ' + lGoofySpeedway + '.', 'Hi, my name is ' + Goofy + ". What's yours?", "Gawrsh, it's nice to see you %!"],
...
WesternPlutoChatter = (["Boo! Don't be scared, it's just me ... Pluto!", 'Happy Halloween, pardner!', 'Happy Halloween, %!'],
...
WinterPlutoDChatter = (
 ...
 ['I chewed on an icicle and got frost-bite!', 
  ...
  'Arf! Arf! I need a scarf!', 
  "At least my nose isn't red and glowing!"], ['Have a fun Winter Holiday!', 'Come back any time you want snow!', 'Mickey is taking me caroling!'])
AFMickeyChatter = (["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
...
AFMinnieChatter = (["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
...
AFGoofySpeedwayChatter = (["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
...
AFDonaldChatter = (["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
...
AFDonaldDockChatter = (["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
...
AFPlutoChatter = (["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
...
AFChipChatter = (["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
 ["Hi, I'm " + Dale + '!',
...
AFDaleChatter = (["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
 ["Hi, I'm " + Chip + '!',
...
toontownDialogues = {BoringTopic: {(1, 2018): ['Hello Albert', 'It looks like the sillyness levels are rising', 'Yes and dont forget April Toons!'], (2, 2019): [
                           'Hello Newton', 'Yes I wonder how much the parties are contributing to all this'], 
                 (3, 2020): [
                           'Why hello there Albert and Newton', 'Halloween was pretty silly too!']}, 
   ...
   AprilToonsPhaseTopTopic: {(1, 2020): ['The Silly Meter has hit the top!',
                                       ...
                                       'HAPPY APRIL TOONS!']}, 
   AprilToonsExtPhaseTopTopic: {(1, 2020): ['The Silly Meter has hit the top!', 'Doodles are talking, Estates are bouncy!']}, AprilToonsPhasePostTopTopic: {(1, 2020): ['April Toons is over!',
...
FriendInviterPlayerFriendInfo = 'A friend across the Toontown Offline network'
...
TeaserOtherHoods = "Sorry, you can't go here"
TeaserTypeAName = 'Type in your favorite name for your Toon!'
TeaserSixToons = "Sorry, you can't choose this Toon"
TeaserClothing = "Sorry, but you can't buy this item"
TeaserCogHQ = "Sorry, but you can't go in this HQ"
TeaserSecretChat = "Sorry, you can't\nuse True Friends chat"
TeaserSpecies = "Sorry, but you can't\nmake this type of Toon"
TeaserFishing = "Sorry, but you can't fish here"
TeaserGolf = "Sorry, but you can't play Minigolf"
TeaserParties = "Sorry, but you can't plan a party"
TeaserSubscribe = ':('
TeaserContinue = 'Return To Game'
TeaserEmotions = "Sorry, but you can't buy this emotion"
TeaserKarting = "Sorry, but you can't join this race"
TeaserKartingAccessories = "Sorry, but you can't\nbuy this accessory"
TeaserGardening = "Sorry, but you can't garden"
...
TeaserPrologue = "Sorry, you can't play the prologue"
...
LauncherPhaseNames = {0: 'Initialization', 1: 'Panda', 
   2: 'Engine', 
   3: 'Make-A-Toon', 
   3.5: 'Toontorial', 
   4: 'Playground', 
...
LauncherStartingMessage = 'Starting Toontown Offline... '
...
LauncherConnectProxyAttempt = 'Connecting to Toontown Offline: %s (proxy: %s) attempt: %s'
LauncherConnectAttempt = 'Connecting to Toontown Offline: %s attempt %s'
LauncherDownloadServerFileList = 'Updating Toontown Offline...'
LauncherCreatingDownloadDb = 'Updating Toontown Offline...'
LauncherDownloadClientFileList = 'Updating Toontown Offline...'
LauncherFinishedDownloadDb = 'Updating Toontown Offline... '
LauncherStartingGame = 'Starting Toontown Offline...'
LauncherRecoverFiles = 'Updating Toontown Offline. Recovering files...'
LauncherCheckUpdates = 'Checking for updates for ' + LauncherProgress
LauncherVerifyPhase = 'Updating Toontown Offline...'
LauncherLoggingIn = 'Entering Toontown...'
LauncherServerError = 'Something went wrong and the game was not loaded properly. Please reboot the game and try again. (EC:001)'
LauncherAuthError = 'Something went wrong and the game was not loaded properly. Please reboot the game and try again. (EC:002)'
LoadingDownloadWatcherUpdate = 'Loading %s'
AvatarChoiceMakeAToon = 'Make A\nToon'
AvatarChoicePlayThisToon = 'Play\nThis Toon'
AvatarChoiceSubscribersOnly = 'Locked'
...
AvatarChooserPrologue = 'Prologue'
...
MusicMgTravel = 'Make Some Tracks'
MusicMgTugOWar = 'Tug-of-War'
MusicMgVine = 'The Jungle Swing'
MusicMgIcegame = 'Slippery Situation'
MusicMgToontag = "You're It!"
MusicMMatchBg2 = 'Jazzy Minnie'
MusicMgTarget = "Soarin' Over Toontown"
MusicFfSafezone = 'The Funny Farm'
MusicTrolleySong = 'The Jolly Trolley'
MusicFireworkMusic = '1812 Cannon Overture'
MusicNewYearsFireworksMusic = 'Happy Winter Holiday!'
MusicParty1 = 'Fireworks are a blast!'
MusicParty2 = 'I love these Fireworks!'
MusicAuldLangSyne = 'Auld Lang Syne'
MusicSummer = 'Celebratory Fireworks'
...
MusicToonFest = 'ToonFest'
MusicToonFestFinale = 'The Grand Finale'
MusicEncntrGeneralBgIndoor = 'Building Excitement'
MusicTtElevator = 'Going Up?'
MusicEncntrToonWinningIndoor = 'Toons on Break'
...
MusicEncntrSuitHqNbrhood = "The Cogs' Domain"
MusicChqFactBg = 'Cog Factory'
MusicCoghqFinale = 'Triumph of the Toons'
MusicEncntrToonWinning = 'After that Boss!'
MusicEncntrSuitWinning = 'A Tough Battle'
MusicEncntrHeadSuitTheme = 'The Big Boss'
MusicFNaFEnd = 'The Head is Off'
MusicLbJurybg = 'Jury Selection'
MusicLbCourtyard = 'Balancing Act'
MusicBossbotFactoryV1 = 'Cog Waltz'
MusicBossbotFactoryV2 = 'Great Depression'
MusicBossbotFactoryV3 = 'Imposing Golf Courses'
MusicBossbotEntryV1 = 'Sinister Bossbots'
MusicBossbotEntryV2 = 'Creepy Cogs'
MusicBossbotEntryV3 = 'The Golf Club'
MusicBossbotCeoV1 = 'Bossing You Around'
MusicBossbotCeoV2 = 'The Bossbot Boss'
...
MusicDoomsday = 'Doomsday'
MusicEndingTheIntroduction = 'UNITE!'
MusicCountersStop = 'Counter Malfunction'
MusicHereWeGoAgain = 'Doomsday Orchestrated'
MusicSeNbrhood = 'The Cog Cages'
MusicSeSz = 'Deep Underground'
JukeboxAddSong = 'Add\nSong'
...
PartyActivityNameDict = {0: {'generic': 'Jukebox', 'invite': 'a Jukebox', 
       'editor': 'Jukebox', 
       'description': 'Listen to music with your own jukebox!'}, 
   1: {'generic': 'Party Cannons', 'invite': 'Party Cannons', 
       'editor': 'Cannons', 
       'description': 'Fire yourself out of the cannons and into fun!'}, 
   2: {'generic': 'Trampoline', 'invite': 'Trampoline', 
       'editor': 'Trampoline', 
       'description': 'Collect jellybeans and bounce the highest!'}, 
   3: {'generic': 'Party Catch', 'invite': 'Party Catch', 
       'editor': 'Party Catch', 
       'description': 'Catch fruit to win beans! Dodge those anvils!'}, 
   4: {'generic': 'Dance Floor\n10 moves', 'invite': 'a 10 move Dance Floor', 
       'editor': 'Dance Floor - 10', 
       'description': 'Show off all 10 of your moves, toon style!'}, 
   5: {'generic': 'Party Tug-of-War', 'invite': 'Party Tug-of-War', 
       'editor': 'Tug-of-War', 
       'description': 'Up to 4 on 4 toon tugging craziness!'}, 
   6: {'generic': 'Party Fireworks', 'invite': 'Party Fireworks', 
       'editor': 'Fireworks', 
       'description': 'Launch your very own fireworks show!'}, 
   7: {'generic': 'Party Clock', 'invite': 'a Party Clock', 
       'editor': 'Party Clock', 
       'description': 'Counts down the time left in your party.'}, 
   8: {'generic': 'Deluxe Jukebox', 'invite': 'a deluxe jukebox', 
       'editor': 'Deluxe Jukebox', 
       'description': 'Your own deluxe jukebox with loads of tunes!'}, 
   9: {'generic': 'Dance Floor\n20 moves', 'invite': 'a 20 move Dance Floor', 
       'editor': 'Dance Floor - 20', 
       'description': 'Show off all 20 of your moves, toon style!'}, 
   10: {'generic': 'Cog-O-War', 'invite': 'Cog-O-War', 
        'editor': 'Cog-O-War', 
        'description': 'The team vs. team game of Cog splatting!'}, 
   11: {'generic': 'Cog Trampoline', 'invite': 'Cog Trampoline', 
        'editor': 'Cog Trampoline', 
        'description': "Jump on a Cog's face!"}, 
   12: {'generic': 'Present Catch', 'invite': 'Present Catch', 
        'editor': 'Present Catch', 
        'description': 'Catch presents to win beans! Dodge those anvils!'}, 
   13: {'generic': 'Holiday Trampoline', 'invite': 'Holiday Trampoline', 
        'editor': 'Holiday Trampoline', 
        'description': 'Jump if you love Winter Holidays!'}, 
   14: {'generic': 'Holiday Cog-O-War', 'invite': 'Holiday Cog-O-War', 
        'editor': 'Holiday Cog-O-War', 
        'description': 'The team vs. team game of Cog splattering!'}, 
   15: {'generic': 'Dance Floor\n10 moves', 'invite': 'a 10 move ValenToons Dance Floor', 
        'editor': 'Dance Floor - 10', 
        'description': 'Get your ValenToon Groove On!'}, 
   16: {'generic': 'Dance Floor\n20 moves', 'invite': 'a 20 move ValenToons Dance Floor', 
        'editor': 'Dance Floor - 20', 
        'description': 'Get your ValenToon Groove On!'}, 
   17: {'generic': 'Jukebox\n20 songs', 'invite': 'a 20 song Valentoons Jukebox', 
        'editor': 'Jukebox - 20', 
        'description': 'Nothing sets the mood like music!'}, 
   18: {'generic': 'Jukebox\n40 songs', 'invite': 'a 40 song Valentoons jukebox', 
        'editor': 'Jukebox - 40', 
        'description': 'Nothing sets the mood like music!'}, 
   19: {'generic': 'Trampoline', 'invite': 'ValenToons Trampoline', 
        'editor': 'Trampoline', 
        'description': "Jump to your heart's content!"}}
PartyDecorationNameDict = {0: {'editor': 'Balloon Anvil', 'description': 'Try to keep the fun from floating away!'}, 
   1: {'editor': 'Party Stage', 'description': 'Balloons, stars, what else could you want?'}, 
   ...
   10: {'editor': 'Gag Globe', 'description': "Olivea's famous Goo-Suspended-\nGags Globe!"}, 
   11: {'editor': 'Bean Banner', 'description': 'Cassidy made this to recycle old jellybeans!'}, 
   12: {'editor': 'Gag Cake', 'description': 'Felicia made this tasty cake for all to enjoy!'}, 
   13: {'editor': "Cupid's Heart", 'description': 'Ready...Aim...\nValenToons!'}, 
   14: {'editor': 'Candy Hearts\n Banner', 'description': "Who doesn't love candy hearts?"}, 
   15: {'editor': 'Flying Heart', 'description': 'This heart is getting carried away!'}, 
   16: {'editor': 'Victory Bandstand', 'description': 'All our new friends are ready to dance!'}, 
   17: {'editor': 'Victory Banner', 'description': 'Not just a normal banner!'}, 
   18: {'editor': 'Confetti Cannons', 'description': "For when Toon cannons aren't enough!"}, 
   19: {'editor': 'Cog & Doodle', 'description': "Ouch! That's gotta hurt."}, 
   20: {'editor': 'Cog Flappy Man', 'description': 'A Cog full of hot air, what a shock!'}, 
   21: {'editor': 'Cog Ice Cream', 'description': 'A Cog looking his best.'}, 
   22: {'editor': 'CogCicle', 'description': 'A Cog looking his holiday best.'}, 
   23: {'editor': 'Holiday Bandstand', 'description': 'Everyone loves a Holiday Party!'}, 
   ...
   27: {'editor': 'ValenToons Anvil', 'description': "We've got your heart on a string!"}}
...
PartyActivityWaitingForOtherPlayers = 'Please wait...'
...
FireworksActivityBeginning = 'The fireworks are about to start! Enjoy the show!'
...
OptionsPageTextToSpeechOnLabel = 'Text to Speech is on.'
OptionsPageTextToSpeechOffLabel = 'Text to Speech is off.'
OptionsPageTextToSpeechNotAvailableMacLabel = 'Text to Speech is not available on Mac.'
OptionsPageTextToSpeechNotInstalledLabel = 'Text to Speech requires eSpeak.\n(You may have to restart Toontown)'
OptionsPageGetEspeak = 'Download'
...
WordPageTitle = 'Magic Words'
WordPageHelp = 'This page contains a list of all of the Magic Words that can be used in-game. These are executed using SpeedChat+.'
...
UnknownFish = '???'
FishingRod = '%s Rod'
FishingRodNameDict = {0: 'Twig', 1: 'Bamboo', 
   2: 'Hardwood', 
   3: 'Steel', 
   4: 'Gold'}
FishTrophyNameDict = {0: 'Guppy', 1: 'Minnow', 
   2: 'Fish', 
   3: 'Flying Fish', 
   4: 'Shark', 
   5: 'Swordfish', 
...
TrackChoiceGuiHEAL = 'Toonup lets you heal yourself in battle.'
...
InventoryAffectsOneToon = 'Affects: Yourself'
InventoryAffectsAllToons = 'Affects: Yourself'
...
MinigameWaitingForOtherPlayers = 'Please wait...'
...
PatternGameWaitingOtherPlayers = 'Please wait...'
...
RaceGameWaitingChoices = 'Please wait...'
...
GagShopWaitingOtherPlayers = 'Please wait...'
...
NameShopContinueSubmission = 'Continue'
NameShopChooseAnother = 'Choose Another Name'
NameShopToonCouncil = 'The name you\nsubmitted has been\napproved.  ' + 'Your new\nname will show up\nnext time you\nlog into the game.\nUntil then, your\nname will be\n '
PleaseTypeName = 'Please type your name:'
AllNewNames = 'All names are approved\nautomatically by the Toon Council.'
...
NumToColor = ['White', 
 ...
 'Plum', 
 'Black']
AnimalToSpecies = {'dog': 'Dog', 'cat': 'Cat', 
   'mouse': 'Mouse', 
   'horse': 'Horse', 
   'rabbit': 'Rabbit', 
   'duck': 'Duck', 
...
QuestScriptTutorialBlocker_5 = 'Very good!\x07Where you are going, however, there are not many Toons to talk to.'
QuestScriptTutorialBlocker_6 = "However, where you are going, you have the freedom to do anything! In which case, you'll need this..."
QuestScriptTutorialBlocker_7 = "It's called the SpeedChat Plus button. This will be useful for executing Magic Word commands!"
...
BossCogWelcomeToons = 'Welcome, new Cog!'
BossCogPromoteToons = 'You are hereby promoted to full-fledged %s.  Congratu--'
CagedToonInterruptBoss = 'Hey! Hiya! Hey over there!'
CagedToonRescueQuery = 'So, did you come to rescue me?'
BossCogDiscoverToons = 'Huh?  A Toon!  In disguise!'
...
CagedToonBattleThree = {10: 'Nice jump, %(toon)s.  Here are some pies!', 11: 'Hi, %(toon)s!  Have some pies!', 
...
CashbotBossHadEnough = "That's it.  I've had enough of you, pesky Toon!"
...
CashbotBossDiscoverToons2 = 'I thought I smelled something a little toony in here!  An imposter!'
...
ResistanceToonCraneInstructions3 = "Use disabled Goons to damage the CFO. When he's seeing stars, hit him with a safe!"
ResistanceToonCraneInstructions4 = "If he puts on a helmet, you won't be able to hit him. Use another safe to knock the helmet off."
...
CatalogItemTypeNames = {0: 'INVALID_ITEM', 1: FurnitureTypeName, 
   2: ChatTypeName, 
   3: ClothingTypeName, 
   4: EmoteTypeName, 
   5: 'WALLPAPER', 
...
HatStylesDescriptions = {'hbb1': 'Green Baseball Cap', 'hbb2': 'Blue Baseball Cap', 
...
GlassesStylesDescriptions = {'grd1': 'Round Glasses', 'gmb1': 'White Mini Blinds', 
...
BackpackStylesDescriptions = {'bpb1': 'Blue Backpack', 'bpb2': 'Orange Backpack', 
...
ShoesStylesDescriptions = {'sat1': 'Green Athletic Shoes', 'sat2': 'Red Athletic Shoes', 
   ...
   'shw1': 'Pirate Shoes', 
   'shw2': 'Toonosaur Feet'}
AccessoryNamePrefix = {0: 'hat unisex ', 1: 'glasses unisex ', 
   2: 'backpack unisex ', 
   3: 'shoes unisex ', 
   4: 'hat boy ', 
   5: 'glasses boy ', 
...
ShirtStylesDescriptions = {'bss1': 'solid', 'bss2': 'single stripe', 
   'bss3': 'collar', 
   'bss4': 'double stripe', 
   ...
   'ttr_a_fl': 'Alpha Attire: Flippy', 
   'ttr_a_sl': 'Alpha Attire: Slappy', 
   'toonfest': 'Toonfest T...: Shirt', 
   'beta': 'Beta Bughunt Shirt', 
   'playtime': 'Squirt Shirt'}
BottomStylesDescriptions = {'bbs1': 'plain w/ pockets', 'bbs2': 'belt', 
   'bbs3': 'cargo', 
   'bbs4': 'hawaiian', 
   ...
   'toonfest_b': 'Toonfest T...: Pants male', 
   'toonfest_g': 'Toonfest T...: Pants female', 
   'beta_b': 'Beta Bughunt Pants male', 
   'beta_g': 'Beta Bughunt Pants female', 
   'playtime_b': 'Squirt Pants male', 
   'playtime_g': 'Patience Pays Pants female', 
   'tt2': 'Sequel Shorts'}
AwardMgrBoy = 'boy'
AwardMgrGirl = 'girl'
...
AwardMgrSkirt = 'skirt'
AwardMgrShirt = 'shirt'
SpecialEventMailboxStrings = {1: 'A special item from the Toon Council just for you!', 2: "Here is your Melville's Fishing Tournament prize! Congratulations!", 
...
TrunkShoesGUI = 'Shoes'
ChatItemQuotes = '"%s"'
FurnitureNames = {100: 'Armchair', 105: 'Armchair', 
   110: 'Chair', 
   120: 'Desk Chair', 
   130: 'Log Chair', 
   140: 'Lobster Chair', 
   ...
   10020: 'Winter Tree', 
   10030: 'Winter Wreath'}
AwardManagerFurnitureNames = {100: 'Armchair A - Series 1', 105: 'Armchair A - Series 7', 
   110: 'Chair - Series 1', 
...
ClothingArticleNames = ('Shirt',
 ...
 'Skirt',
 'Shorts')
ClothingTypeNames = {1001: 'Ghost Shirt', 1002: 'Pumpkin Shirt', 
   1112: 'Bee Shirt', 
   1113: 'Pirate Shirt', 
...
SurfaceNames = ('Wallpaper',
 ...
 'Wainscoting',
 'Border')
WallpaperNames = {1000: 'Parchment', 1100: 'Milan', 
   1200: 'Dover', 
   1300: 'Victoria', 
   1400: 'Newport', 
   1500: 'Pastoral', 
   ...
   13200: 'Rainbow', 
   13300: 'Shamrock'}
FlooringNames = {1000: 'Hardwood Floor', 1010: 'Carpet', 
   1020: 'Diamond Tile', 
   1030: 'Diamond Tile', 
   1040: 'Grass', 
   1050: 'Beige Bricks', 
   ...
   11000: 'Shamrock', 
   11010: 'Shamrock'}
MouldingNames = {1000: 'Knotty', 1010: 'Painted', 
   1020: 'Dental', 
   1030: 'Flowers', 
   1040: 'Flowers', 
   1050: 'Ladybug', 
...
WainscotingNames = {1000: 'Painted', 1010: 'Wood Panel', 
   1020: 'Wood', 
   1030: 'ValenToons', 
   1040: 'Underwater'}
WindowViewNames = {10: 'Large Garden', 20: 'Wild Garden', 
   30: 'Greek Garden', 
   40: 'Cityscape', 
   50: 'Wild West', 
   60: 'Under the Sea', 
   ...
   120: 'Native Camp', 
   130: 'Main Street'}
SpecialEventNames = {1: 'Generic Award', 2: "Melville's Fishing Tournament", 
...
HDHelpDict = {'DoneMoving': 'Finish room decorating.', 'Attic': 'Show list of items in attic. The attic stores items that are not in your room.', 
...
NPCToonNames = {20000: 'Tutorial Tom', 999: 'Toon Tailor', 
   1000: lToonHQ, 
   20001: Flippy, 
   2001: Flippy, 
   2002: 'Banker Bob', 
   ...
   7008: 'Ima Cagedtoon', 
   7009: 'Jimmy Thelock', 
   14001: 'RESISTANCE RANGER Rocky', 
   14002: 'RESISTANCE RANGER Ruth', 
   14003: 'RESISTANCE RANGER Reg', 
   14004: 'RESISTANCE RANGER Randolph', 
   14005: 'RESISTANCE RANGER Ridley', 
   14006: 'Logano', 
   14007: 'Sparky', 
   14008: 'Weird', 
   14009: 'Ned', 
   ...
   14014: 'Bear E. Funny', 
   14015: 'RESISTANCE RANGER Ripley', 
   14016: 'RESISTANCE RANGER Randy', 
   14017: 'RESISTANCE RANGER Rupert', 
   14018: 'RESISTANCE RANGER Roy', 
   14019: 'RESISTANCE RANGER Rhett', 
   14020: 'RESISTANCE RANGER Raven', 
   14021: 'RESISTANCE RANGER Ralph', 
   14022: 'Doctor Surlee (2003)', 
   14024: 'Doctor Surlee (2008)', 
   14026: 'Doctor Surlee (2013)', 
   14029: 'Scrooge McDuck', 
   91913: 'Shockley', 
   91914: 'Sir Max', 
   91915: 'McQuack', 
   91916: 'Hawkheart'}
...
if config.GetBool('want-doomsday', False):
    ...
    startFireworksResponse = "Usage: startFireworksShow ['num']\n 'num' = %s - New Years\n %s - Party Summer \n %s - 4th of July"
    FireworksJuly4Beginning = lToonHQ + ": It's Independence Day! Enjoy the show!"
...
TipDict = {TIP_NONE: ('',), TIP_GENERAL: (
               ...
               'Press the "F9" key to take a screenshot, which will be saved in your Toontown Offline folder on your computer.',
               ...
               'You never need to save your Toontown progress. All necessary information is saved on the fly.',
               ...
               'Think before you act! Super-powered Cogs do not benefit Toontown.',
               'Who dug the sewers in the Cog HQs?',
               'More than two of yourself in the same room can be catastrophic.',
               'Will you be the first to find Cog Nation?',
   ...
   TIP_STREET: (
              ...
              'The Toon-Up Gag Track lets you heal yourself in battle.',
              ...
              'Traps are only useful if you coordinate using Lure in battle.',
              ...
              'When you defeat a Cog building you are rewarded with a portrait inside the rescued Toon Building.',
              ...
              'The two most difficult Cogs of each type are only found in buildings, except during invasions.',
   ...
   TIP_MINIGAME: (
                ...
                'In the Maze Game, you can use the Flunkies to bounce from a treasureless area to a treasure-filled area.',
                'In the game Cog Thief, stop all the Cogs from stealing our gags!',
                'In the game Toon Escape, try to reach the end of the level while collecting Cog badges for points!',
                'In the game Toon Escape, the amount of points you get from Cog badges depends on the rank of the badge.',
   ...
   TIP_COGHQ: (
             ...
             'Defeating the Sellbot V.P. by yourself can be challenging. Stock up on SOS cards, unites, fires and strong gags!',
             'Defeating the Cashbot C.F.O. by yourself can be challenging. Stock up on SOS cards, unites, fires and strong gags!',
             'Defeating the Lawbot Chief Justice by yourself can be challenging. Stock up on SOS cards, unites, fires and strong gags!',
             'Defeating the Bossbot C.E.O. by yourself can be challenging. Stock up on SOS cards, unites, fires and strong gags!',
   ...
   TIP_ESTATE: (
              ...
              'Doodles love company. Play with your doodle often!',
              ...
              'Estates have a day and night cycle. Keep an eye out for the moon!',
   ...
   TIP_KARTING: (
               ...
               'Try to beat your best racing time in time trials!',
               'You can leave a race by using the ~leaveRace Magic Word!',
   ...
   TIP_GOLF: (
            'Press the Tab key to see a top view of the golf course.', 'Press the Up Arrow key to point yourself towards the golf hole.', 'Swinging the club is just like throwing a pie.')}
FishGenusNames = {0: 'Balloon Fish', 2: 'Cat Fish', 
   4: 'Clown Fish', 
   6: 'Frozen Fish', 
   8: 'Star Fish', 
   10: 'Holey Mackerel', 
...
KartRace_TrackNames = {RaceGlobals.RT_Speedway_1: 'Screwball Stadium', RaceGlobals.RT_Speedway_1_rev: 'Screwball Stadium' + KartRace_Reverse, 
...
KartDNA_KartNames = {0: 'Cruiser', 1: 'Roadster', 
   2: 'Toon Utility Vehicle'}
KartDNA_AccNames = {1000: 'Air Cleaner', 1001: 'Four Barrel', 
   1002: 'Flying Eagle', 
   1003: 'Steer Horns', 
   1004: 'Straight Six', 
   1005: 'Small Scoop', 
...
KartRace_TrackInfo = {RaceGlobals.RT_Speedway_1: KartRace_SSInfo + KartRace_GeneralInfo, RaceGlobals.RT_Speedway_1_rev: KartRace_SSInfo + KartRace_GeneralInfo, 
...
KartRecordStrings = {RaceGlobals.Daily: 'daily', RaceGlobals.Weekly: 'weekly', 
...
LawbotBossTempIntro3 = 'And here is the public defender.'
LawbotBossTempIntro4 = "Wait a minute... you're a Toon!"
...
LawbotBossDefenseWins2 = 'No. I declare a mistrial! A new trial will be scheduled.'
...
LawbotBossTaunts = ['%s, I find you in contempt of court!', 
 ...
 'Order in the court!']
LawbotBossAreaAttackTaunt = "I've had enough out of you!"
...
WitnessToonOneJuror = 'Neat! There is 1 Toon in the jury!'
...
WitnessToonJuryWeightBonusSingular = {6: 'This is a tough case. You seated %d Toon juror, so your evidence has a bonus weight of %d.', 7: 'This is a very tough case. You seated %d Toon juror, so your evidence has a bonus weight of %d.', 
   8: 'This is the toughest case. You seated %d Toon juror, so your evidence has a bonus weight of %d.'}
WitnessToonJuryWeightBonusPlural = {6: 'This is a tough case. You seated %d Toon jurors, so your evidence has a bonus weight of %d.', 7: 'This is a very tough case. You seated %d Toon jurors, so your evidence has a bonus weight of %d.', 
...
StatuaryLeakingFountain = 'Leaking Fountain'
FlowerColorStrings = ['Red', 
 ...
 'White', 
 'Green']
FlowerSpeciesNames = {49: 'Daisy', 50: 'Tulip', 
   51: 'Carnation', 
   52: 'Lily', 
   53: 'Daffodil', 
   54: 'Pansy', 
...
ShovelNameDict = {0: 'Tin', 1: 'Bronze', 
   2: 'Silver', 
   3: 'Gold'}
WateringCanNameDict = {0: 'Small', 1: 'Medium', 
   2: 'Large', 
   3: 'Huge'}
...
GardenTrophyNameDict = {0: 'Wheelbarrow', 1: 'Shovels', 
   2: 'Flower', 
   3: 'Watering Can', 
   4: 'Shark', 
   5: 'Swordfish', 
...
TravelGameWaitingChoices = 'Please wait...'
...
GolfCourseNames = {0: 'Walk In The Par', 1: 'Hole Some Fun', 
   2: 'The Hole Kit And Caboodle'}
GolfHoleNames = {0: 'Whole In Won', 1: 'No Putts About It', 
   2: 'Down The Hatch', 
   3: 'Seeing Green', 
   4: 'Hot Links', 
   5: 'Peanut Putter', 
...
GolfShotDesc = {-4: GolfCondor, -3: GolfAlbatross, 
   -2: GolfEagle, 
   -1: GolfBirdie, 
   0: GolfPar, 
   1: GolfBogey, 
...
BossbotRTWelcome = 'You will need different disguises.'
BossbotRTRemoveSuit = 'First take off your cog suit...'
...
BossbotRTServeFood2 = 'If you serve a cog some food, it will explode.'
BossbotResistanceToonName = "Good ol' Gil Giggles"
BossbotPhase3Speech1 = "What's happening here?!"
BossbotPhase3Speech2 = "That waiter's a Toon!"
...
BossbotRTPhase4Speech1 = 'Good job! Now squirt the C.E.O. with the seltzer on the tables...'
...
IceGameWaitingForPlayersToFinishMove = 'Please wait...'
IceGameWaitingForAISync = 'Please wait...'
...
DayNamesAbbrev = ('MON',
 ...
 'SAT',
 'SUN')
HolidayNamesInCalendar = {1: ('Independence Day Fireworks', 'Celebrate independence with a fireworks show every hour in each playground!'), 2: (
     'New Year Fireworks', 'Happy New Year! Enjoy a fireworks show every hour in each playground!'), 
   3: (
     'Bloodsucker Invasion', 'Help defend Toontown from the Bloodsucker invasion!'), 
   4: (
     'Winter Holiday', 'Celebrate the Winter Holiday with Toontastic decorations, party and Cattlelog items, and more!'), 
   5: (
   ...
   16: (
      'Grand Prix Weekend', 'Free and Paid players compete in circuit races at Goofy Speedway!'), 
   17: (
      'Trolley Tracks', 'Trolley Tracks Thursday! Board any Trolley with two or more Toons to play.'), 
   19: (
      'Silly Saturdays', 'Saturdays are silly with Fish Bingo and Grand Prix throughout the day!'), 
   24: (
      'Ides of March', 'Beware the Ides of March! Stop the Back Stabber Cogs from invading Toontown!'), 
   26: (
      'Halloween Decor', 'Celebrate Halloween as spooky trees and streetlights transform Toontown!'), 
   28: (
      'Winter Invasion', 'The sellbots are on the loose spreading their cold sales tactics!'), 
   29: (
      "April Toons' Week", "Celebrate April Toons' Week - a holiday built by Toons for Toons!"), 
   33: (
      'Sellbot Surprise 1', 'Sellbot Surprise! Stop the Cold Caller Cogs from invading Toontown!'), 
   34: (
      'Sellbot Surprise 2', 'Sellbot Surprise! Stop the Name Dropper Cogs from invading Toontown!'), 
   35: (
      'Sellbot Surprise 3', 'Sellbot Surprise! Stop the Two-Face Cogs from invading Toontown!'), 
   36: (
      'Sellbot Surprise 4', 'Sellbot Surprise! Stop the Mr. Hollywood Cogs from invading Toontown!'), 
   37: (
      'A Cashbot Conundrum 1', 'A Cashbot Conundrum! Stop the Tightwad Cogs from invading Toontown!'), 
   38: (
      'A Cashbot Conundrum 2', 'A Cashbot Conundrum! Stop the Bean Counter Cogs from invading Toontown!'), 
   39: (
      'A Cashbot Conundrum 3', 'A Cashbot Conundrum! Stop the Loan Shark Cogs from invading Toontown!'), 
   40: (
      'A Cashbot Conundrum 4', 'A Cashbot Conundrum! Stop the Robber Baron Cogs from invading Toontown!'), 
   41: (
      'The Lawbot Gambit 1', 'The Lawbot Gambit! Stop the Ambulance Chaser Cogs from invading Toontown!'), 
   42: (
      'The Lawbot Gambit 2', 'The Lawbot Gambit! Stop the Back Stabber Cogs from invading Toontown!'), 
   43: (
      'The Lawbot Gambit 3', 'The Lawbot Gambit! Stop the Spin Doctor Cogs from invading Toontown!'), 
   44: (
      'The Lawbot Gambit 4', 'The Lawbot Gambit! Stop the Legal Eagle Cogs from invading Toontown!'), 
   45: (
      'The Trouble With Bossbots 1', 'The Trouble with Bossbots! Stop the Pencil Pusher Cogs from invading Toontown!'), 
   46: (
      'The Trouble With Bossbots 2', 'The Trouble with Bossbots! Stop the Yesman Cogs from invading Toontown!'), 
   47: (
      'The Trouble With Bossbots 3', 'The Trouble with Bossbots! Stop the Micromanager Cogs from invading Toontown!'), 
   48: (
      'The Trouble With Bossbots 4', 'The Trouble with Bossbots! Stop the The Big Cheese Cogs from invading Toontown!'), 
   49: (
      'Jellybean Day', 'Celebrate Jellybean Day with double Jellybean rewards at parties!'), 
   53: (
      'Cold Caller Invasion', 'Stop the Cold Caller Cogs from invading Toontown!'), 
   54: (
      'Bean Counter Invasion', 'Stop the Bean Counter Cogs from invading Toontown!'), 
   55: (
      'Double Talker Invasion', 'Stop the Double Talker Cogs from invading Toontown!'), 
   56: (
      'Downsizer Invasion', 'Stop the Downsizer Cogs from invading Toontown!'), 
   57: (
      'Caroling', 'Sing for your Snowman Head! See the Blog for details!'), 
   59: (
      "ValenToon's Day", "Celebrate ValenToon's Day from Feb 09 to Feb 16!"), 
   72: (
      'Yes Men Invasion', 'Stop the Yes Men Cogs from invading Toontown!'), 
   73: (
      'Tightwad Invasion', 'Stop the Tightwad Cogs from invading Toontown!'), 
   74: (
      'Telemarketers Invasion', 'Stop the Telemarketer Cogs from invading Toontown!'), 
   75: (
      'Head Hunter Invasion', 'Stop the Head Hunter Cogs from invading Toontown!'), 
   76: (
      'Spin Doctor Invasion', 'Stop the Spin Doctor Cogs from invading Toontown!'), 
   77: (
      'Moneybags Invasion', 'Stop the Moneybags from invading Toontown!'), 
   78: (
      'Two-faces Invasion', 'Stop the Two-faces from invading Toontown!'), 
   79: (
      'Mingler Invasion', 'Stop the Mingler Cogs from invading Toontown!'), 
   80: (
      'Loan Shark Invasion', 'Stop the Loanshark Cogs from invading Toontown!'), 
   81: (
      'Corporate Raider Invasion', 'Stop the Corporate Raider Cogs from invading Toontown!'), 
   82: (
      'Robber Baron Invasion', 'Stop the Robber Baron Cogs from invading Toontown!'), 
   83: (
      'Legal Eagle Invasion', 'Stop the Legal Eagle Cogs from invading Toontown!'), 
   84: (
      'Big Wig Invasion', 'Stop the Big Wig Cogs from invading Toontown!'), 
   85: (
      'Big Cheese Invasion', 'Stop the Big Cheese from invading Toontown!'), 
   86: (
      'Downsizer Invasion', 'Stop the Downsizer Cogs from invading Toontown!'), 
   87: (
      'Mover And Shaker Invasion', 'Stop the Mover and Shaker Cogs from invading Toontown!'), 
   88: (
      'Double Talker Invasion', 'Stop the Double Talkers Cogs from invading Toontown!'), 
   89: (
      'Penny Pincher Invasion', 'Stop the Penny Pinchers Cogs from invading Toontown!'), 
   90: (
      'Name Dropper Invasion', 'Stop the Name Dropper Cogs from invading Toontown!'), 
   91: (
      'Ambulance Chaser Invasion', 'Stop the Ambulance Chaser Cogs from invading Toontown!'), 
   92: (
      'Micro Manager Invasion', 'Stop the Micro Manager Cogs from invading Toontown!'), 
   93: (
      'Number Cruncher Invasion', 'Stop the Number Cruncher Cogs from invading Toontown!'), 
   95: (
      'Victory Parties', 'Celebrate our historic triumph against the Cogs!'), 
   96: (
      'Operation: Storm Sellbot', "Sellbot HQ is open to everyone. Let's go fight the VP!"), 
   97: (
      'Double Bean Days - Trolley Games', ''), 
   98: (
      'Double Bean Days - Fishing', ''), 
   99: (
      'Jellybean Week', 'Celebrate Jellybean Week with double Jellybean rewards!'), 
   101: (
       "Top Toons New Year's Day Marathon", "Chances to win every hour! See the What's New Blog for details!"), 
   105: (
       'Toons go GREEN!', 'Toons make a green scene at Green Bean Jeans on Oak Street in Daisy Gardens!')}
...
CogdoFlyingGameInvasionTargeting = '%s has noticed you!'
...
SillySurgeTerms = {1: 'Amusing Ascent!', 2: 'Silly Surge!', 
   3: 'Ridiculous Rise!', 
   4: 'Giggle Growth!', 
   5: 'Funny Fueling!', 
   6: 'Batty Boost!', 
   ...
   12: 'Cracked-Uptick!', 
   13: 'Unexpected Upheaval!'}
InteractivePropTrackBonusTerms = {0: 'Super Toon-Up!', 1: '', 
   2: '', 
   3: '', 
   4: 'Super Throw!', 
   5: 'Super Squirt!', 
...
MagicWordTp = '~tp'
MagicWordTpDesc = 'Usage: ~tp [initials]\n\nDescription: Teleports toon to specified playground.\n\nExample: ~tp ttc - Teleports to Toontown Central'
MagicWordReborn = '~reborn Event'
MagicWordRebornDesc = 'Usage: ~reborn Event\n\nDescription: Starts Interim Election event.'
MagicWordMax = '~maxToon'
MagicWordMaxDesc = 'Usage: ~maxToon CONFIRM\n\nDescription: Sets toon progress to end-game.'
MagicWordHp = '~setHp'
MagicWordHpDesc = "Usage: ~setHp [laff]\n\nDescription: Sets toon's laff to provided value between -1 and 137.\n\nExample: ~setHp 137 - Sets laff to 137."
MagicWordMaxHp = '~setMaxHp'
MagicWordMaxHpDesc = "Usage: ~setMaxHp [laff]\n\nDescription: Sets toon's max laff to provided value between 15 and 137.\n\nExample: ~setMaxHp 137 - Sets max laff to 137."
MagicWordFires = '~pinkslips'
MagicWordFiresDesc = 'Usage: ~pinkslips [value]\n\nDescription: Sets amount of available pink slips between 0 and 255.\n\nExample: ~pinkslips 255 - Gives toon 255 pink slips.'
MagicWordSewer = '~sewerEv Event'
MagicWordSewerDesc = 'Usage: ~sewerEv Event\n\nDescription: Starts Sewer event.'
MagicWordObstacleCourse = '~sewerMg Event'
MagicWordObstacleCourseDesc = 'Usage: ~sewerMg Event\n\nDescription: Starts Sewer minigame event.'
MagicWordTrees = '~growTrees'
MagicWordTreesDesc = 'TODO'
MagicWordHarvest = '~pickTrees'
MagicWordHarvestDesc = 'TODO'
MagicWordHouseType = '~houseType'
MagicWordHouseTypeDesc = 'TODO'
MagicWordElection = '~election Event'
MagicWordElectionDesc = 'Usage: ~election Event\n\nDescription: Starts Election event.'
MagicWordStartHoliday = '~startHoliday'
MagicWordStartHolidayDesc = 'TODO'
MagicWordEndHoliday = '~endHoliday'
MagicWordEndHolidayDesc = 'TODO'
MagicWordGiveFish = '~gibFish'
MagicWordGiveFishDesc = 'TODO'
MagicWordRemoveFishRequest = '~noGibFish'
MagicWordRemoveFishRequestDesc = 'TODO'