...
class MailboxScreen(DirectObject.DirectObject):
    ...
    def load(self):
        ...
        self.frame = DirectFrame(scale=1.1, relief=DGG.FLAT, frameSize=(-0.5, 0.5,
                                                                        -0.45, -0.05), frameColor=(0.737,
                                                                                                   0.573,
                                                                                                   0.345,
                                                                                                   1.0))
        self.background = DirectFrame(self.frame, image=background, image_scale=0.05, relief=None, pos=(0,
                                                                                                        1,
                                                                                                        0))
        self.itemBoard = DirectFrame(parent=self.frame, image=itemBoard, image_scale=0.05, image_color=(0.922,
                                                                                                        0.922,
                                                                                                        0.753,
                                                                                                        1), relief=None, pos=(0,
                                                                                                                              1,
                                                                                                                              0))
        self.itemCountLabel = DirectLabel(parent=self.frame, relief=None, text=self.__getNumberOfItemsText(), text_wordwrap=16, pos=(0.0,
                                                                                                                                     0.0,
                                                                                                                                     0.7), scale=0.09)
        ...
        self.quitButton = DirectButton(parent=self.frame, relief=None, image=(gui2.find('**/QuitBtn_UP'), gui2.find('**/QuitBtn_DN'), gui2.find('**/QuitBtn_RLVR')), pos=(0.5,
                                                                                                                                                                          1.0,
                                                                                                                                                                          -0.42), scale=0.9, text=TTLocalizer.MailboxExitButton, text_font=ToontownGlobals.getSignFont(), text0_fg=(0.152,
                                                                                                                                                                                                                                                                                    0.75,
                                                                                                                                                                                                                                                                                    0.258,
                                                                                                                                                                                                                                                                                    1), text1_fg=(0.152,
                                                                                                                                                                                                                                                                                                  0.75,
                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                  1), text2_fg=(0.977,
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                1), text_scale=0.045, text_pos=(0,
                                                                                                                                                                                                                                                                                                                                                -0.01), command=self.__handleExit)
        self.gettingText = DirectLabel(parent=self.frame, relief=None, text='', text_wordwrap=10, pos=(0.0,
                                                                                                       0.0,
                                                                                                       0.32), scale=0.09)
        self.gettingText.hide()
        self.giftTagPanel = DirectLabel(parent=self.frame, relief=None, text='Gift TAG!!', text_wordwrap=16, pos=(0.0,
                                                                                                                  0.0,
                                                                                                                  0.01), scale=0.06)
        self.giftTagPanel.hide()
        self.itemText = DirectLabel(parent=self.frame, relief=None, text='', text_wordwrap=16, pos=(0.0,
                                                                                                    0.0,
                                                                                                    -0.022), scale=0.07)
        self.itemText.hide()
        ...
        self.nextButton = DirectButton(parent=self.frame, relief=None, image=(nextUp,
         ...
         TTLocalizer.MailboxItemNext,
         ''), text_scale=1, text_pos=(-0.2, 0.3), text_fg=(1, 1, 1, 1), text_shadow=(0,
                                                                                     0,
                                                                                     0,
                                                                                     1), textMayChange=0, command=self.__nextItem, state=DGG.DISABLED)
        ...
        self.prevButton = DirectButton(parent=self.frame, relief=None, image=(prevUp,
         ...
         TTLocalizer.MailboxItemPrev,
         ''), text_scale=1, text_pos=(0, 0.3), text_fg=(1, 1, 1, 1), text_shadow=(0,
                                                                                  0,
                                                                                  0,
                                                                                  1), textMayChange=0, command=self.__prevItem, state=DGG.DISABLED)
            ...
            if isinstance(item, CatalogItem.CatalogItem):
                ...
                if item.isAward():
                    ...
                    if item.giftCode == ToontownGlobals.GIFT_RAT:
                        ...
                        if item.giftCode == ToontownGlobals.GIFT_partyrefund:
