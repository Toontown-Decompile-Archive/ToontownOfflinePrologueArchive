...
import sys, os, math, tempfile, shutil, atexit
...
import otp.ai.DiagnosticMagicWords, time
...
class ToonBase(OTPBase.OTPBase, FNAFBase.FNAFBase):
    ...
    def __init__(self):
        ...
        FNAFBase.FNAFBase.__init__(self)
    ...
    def takeScreenShot(self):
        ...
        if self.glitchCount > 10 and self.walking:
            ...
            self.flashTrack = Sequence(Func(base.playSfx, self.snapshotSfx), Func(self.transitions.fadeOut, 0.15), Wait(0.2), Func(self.transitions.fadeIn, 0.8), Wait(1.0), Func(self.transitions.setFadeColor, 0, 0, 0))
    ...
    def __killSpeedHacker(self):
        ...
        self.cr.bootedText = 'Toon tripped speed-hack check.'
