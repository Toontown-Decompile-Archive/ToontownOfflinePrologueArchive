...
import CatchGameToonSD, Trajectory, math
...
class DistributedCatchGame(DistributedMinigame):
    ...
    DropObjectPlurals = {'apple': TTLocalizer.CatchGameApples, 'orange': TTLocalizer.CatchGameOranges, 
    ...
    def getInstructions(self):
        return TTLocalizer.CatchGameInstructions % {'fruit': self.DropObjectPlurals[self.fruitName], 'badThing': self.DropObjectPlurals['anvil']}
    ...
    def load(self):
        ...
        for objType in DropObjectTypes:
            ...
            modelScales = {'apple': 0.7, 'orange': 0.7, 
               'pear': 0.5, 
               'coconut': 0.7, 
               'watermelon': 0.6, 
               'pineapple': 0.45}
    ...
    def defineConstants(self):
        ...
        fruits = {ToontownGlobals.ToontownCentral: 'apple', ToontownGlobals.DonaldsDock: 'orange', 
