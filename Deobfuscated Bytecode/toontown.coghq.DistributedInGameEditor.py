...
class DistributedInGameEditor(DistributedObject.DistributedObject, Level.Level, InGameEditorElement):
    ...
    def insertEntity(self, entType, parentEntId=None, callback=None):
        ...
        removeAction = (
         self.editMgrEntity.entId, 'removeEntity', {'entId': 'REPLACEME'})
        ...
        old2new = [
         ...
         (self.editMgrEntity.entId, 'requestNewEntity',
          {'entType': entType, 'parentEntId': parentEntId, 
    ...
    def doRemoveEntity(self, entId):
        ...
        new2old = [
         setEntCreateHandler,
         (self.editMgrEntity.entId, 'requestNewEntity',
          {'entType': self.getEntityType(entId), 'parentEntId': parentEntId, 
             'username': self.editUsername})]
        self.setUndoableAttribEdit(old2new, new2old)
    ...
    def duplicateSelectedEntity(self):
        ...
        old2new = [
         setEntCreateHandler,
         (self.editMgrEntity.entId, 'requestNewEntity',
          {'entType': self.getEntityType(selectedEntId), 'parentEntId': parentEntId, 
             'username': self.editUsername})]
        self.setUndoableAttribEdit(old2new, new2old)
