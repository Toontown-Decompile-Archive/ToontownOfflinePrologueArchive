...
# Embedded file name: toontown.reborn.GavelObstacle
...
class GavelObstacle(FSM.FSM):
    notify = DirectNotifyGlobal.directNotify.newCategory('GavelObstacle')

    def __init__(self, parent):
        FSM.FSM.__init__(self, 'GavelObstacle')
        self.parent = parent
        self.index = None
        self.avId = 0
    ...
    def attachColTube(self):
        ...
        collNode = CollisionNode('headSphere-%s' % id(self))
        ...
        tube2.setTangible(0)
        handleCollNode = CollisionNode('gavelHandle-%s' % id(self))
    ...
    def __touchedGavel(self, entry):
        ...
        self.parent.touchedGavel(self, entry)

    def __touchedGavelHandle(self, entry):
        self.notify.debug('__touchedGavelHandle')
        self.parent.touchedGavelHandle(self, entry)