...
# Embedded file name: otp.margins.WhisperPopup
...
class WhisperPopup(MarginPopup, ClickablePopup):
    ...
    def updateContents(self):
        ...
        balloon, frame = NametagGlobals.speechBalloon2d.generate(self.text, self.font, textColor=fgColor, balloonColor=bgColor, wordWrap=self.WORDWRAP)
