...
# Embedded file name: toontown.toonbase.TTLocalizer_French
# Compiled at: 2014-04-30 09:53:54
import string, time
from toontown.toonbase.TTLocalizer_french_Property import *
...
lGagShop = 'Gag Shop'
lClothingShop = 'En tant que magasin de marchandises s\xc3\xa8ches'
lPetShop = 'Pet Shop'
lBack = 'Retour'
lCancel = 'Annuler'
lClose = 'Fermer'
...
ACog = 'un Cog'
TheCogs = 'les Cogs'
ASkeleton = 'un Squelecog'
Skeleton = 'Squelecog'
SkeletonP = 'Squelecogs'
...
CogCFOs = 'Directeurs Financiers'
ACogCFO = 'un Directeur Financier'
CogCJ = 'Juge en Chef'
CogCJs = 'Juges en Chef'
ACogCJ = 'un Juge en Chef'
CogCEO = 'Directeur'
CogCEOs = 'Directeurs'
ACogCEO = 'un Directeur'
...
GlobalStreetNames = {20000: (
         'vers la', 'sur la', 'terrasse du Tourbillon'), 
   1000: (
        'vers le', 'sur le', 'Terrain de jeux'), 
   1100: (
        'vers le', 'sur le', 'Boulevard de la Bernache'), 
   1200: (
        'vers la', 'sur la', 'Rue des R\xc3\xa9cifs'), 
   1300: (
        "vers l'", "sur l'", 'All\xc3\xa9e des Mar\xc3\xa9es'), 
   2000: (
        'vers le', 'sur le', 'Terrain de jeux'), 
   2100: (
        'vers la', 'sur la', 'Rue B\xc3\xa9ta'), 
   2200: (
        "vers l'", "sur l'", 'Avenue des Fondus'), 
   2300: (
        'vers la', 'sur la', 'Place des Blagues'), 
   3000: (
        'vers le', 'sur le', 'Terrain de jeux'), 
   3100: (
        'vers le', 'sur le', 'Chemin du Marin'), 
   3200: (
        'vers la', 'sur la', 'Rue de la Neige fondue'), 
   3300: (
        'vers la', 'sur la', 'Place Polaire'), 
   4000: (
        'vers le', 'sur le', 'Terrain de jeux'), 
   4100: (
        "vers l'", "sur l'", 'Avenue du Contralto'), 
   4200: (
        'vers le', 'sur le', 'Boulevard du Baryton'), 
   4300: (
        'vers la', 'sur la', 'Terrasse des T\xc3\xa9nors'), 
   5000: (
        'vers le', 'sur le', 'Terrain de jeux'), 
   5100: (
        'vers la', 'sur la', 'Rue des Ormes'), 
   5200: (
        'vers la', 'sur la', 'Rue des \xc3\x89rables'), 
   5300: (
        'vers la', 'sur la', 'Rue du Ch\xc3\xaane'), 
   9000: (
        'vers le', 'sur le', 'Terrain de jeux'), 
   9100: (
        'vers le', 'sur le', 'Boulevard de la Berceuse'), 
   9200: (
        '', '', 'Place de la Couette'), 
   10000: (
         'vers le', 'au', 'QG Chefbot'), 
   10100: (
         'vers le', 'dans le', 'hall du QG des Chefbots'), 
   10200: (
         '\xc3\xa0', 'dans', 'Le Clubhouse'), 
   10500: (
         '\xc3\xa0', 'dans', "Les trois premiers \xc3\xa0 l'avant"), 
   10600: (
         '\xc3\xa0', 'dans', 'Les six du milieu'), 
   10700: (
         '\xc3\xa0', 'dans', 'Les neuf du fond'), 
   11000: (
         'vers la', 'sur la', 'cour du QG Vendibot'), 
   11100: (
         'vers le', 'dans le', 'hall du QG Vendibot'), 
   11200: (
         "vers l'", "\xc3\xa0 l'", 'usine Vendibot'), 
   11500: (
         "vers l'", "\xc3\xa0 l'", 'usine Vendibot'), 
   12000: (
         'vers le', 'au', 'QG Caissbot'), 
   12100: (
         'vers le', 'dans le', 'hall du QG Caissbot'), 
   12500: (
         '', '', 'Fabrique \xc3\xa0 Sous Caissbot'), 
   12600: (
         '', '', 'Fabrique \xc3\xa0 Euros Caissbot'), 
   12700: (
         '', '', 'Fabrique \xc3\xa0 Lingots Caissbot'), 
   13000: (
         'vers le', 'au', 'QG Loibot'), 
   13100: (
         'vers le', 'dans le', 'hall du QG Loibot'), 
   13200: (
         'vers le', 'au', 'hall du bureau du Procureur'), 
   13300: (
         'vers le', 'au', 'bureau Loibot A'), 
   13400: (
         'vers le', 'au', 'bureau Loibot B'), 
   13500: (
         'vers le', 'au', 'bureau Loibot C'), 
   13600: (
         'vers le', 'au', 'bureau Loibot D'), 
   14000: (
         'to the', 'in the', 'Sewer Entrance'), 
   14100: (
         'to the', 'in the', 'Sewer to Toontown centre'), 
   19000: (
         'to', 'in', 'Courtyard'), 
   19100: (
         'to the', 'in the', 'Cog Hall Lobby'), 
   21000: (
         'vers le', 'sur le', 'Terrain de jeux'), 
   21300: (
         'vers la', 'sur la', 'Rue du Ch\xc3\xaane'), 
...
GolfZone = ('\xc3\xa0', 'dans', lGolfZone)
Factory = 'Usine'
...
QuestsDefaultGreeting = ('Bonjour, _avName_!', 'Oh\xc3\xa9, _avName_!', 'Coucou, _avName_!', 'Eh, _avName_!', 'Bienvenue, _avName_!', 'Salut, _avName_!', 'Comment \xc3\xa7a va, _avName_?', 'Quoi de neuf, _avName_?')
QuestsDefaultIncomplete = ('Comment est-ce que ce d\xc3\xa9fi se pr\xc3\xa9sente, _avName_?', 'On dirait que tu as encore du travail \xc3\xa0 faire pour ce d\xc3\xa9fi!', 'Continue \xc3\xa0 bien travailler, _avName_!', 'Essaie de finir ce d\xc3\xa9fi. Je sais que tu peux le faire!', 'Essaie de terminer ce d\xc3\xa9fi, nous comptons sur toi!', 'Continue \xc3\xa0 travailler sur ce d\xc3\xa9fitoon!')
QuestsDefaultIncompleteProgress = ("Tu es au bon endroit, mais tu dois d'abord finir ton d\xc3\xa9fitoon.", 'Quand tu auras termin\xc3\xa9 ton d\xc3\xa9fitoon, reviens ici.', 'Reviens quand tu auras termin\xc3\xa9 ton d\xc3\xa9fitoon.')
QuestsDefaultIncompleteWrongNPC = ('Joli travail pour ce d\xc3\xa9fitoon. Tu devrais aller voir _toNpcName_._where_', 'On dirait que tu as presque fini ton d\xc3\xa9fitoon. Va voir _toNpcName_._where_.', 'Va voir _toNpcName_ pour finir ton d\xc3\xa9fitoon._where_')
QuestsDefaultComplete = ('Bon travail! Voil\xc3\xa0 ta r\xc3\xa9compense...', 'Super boulot, _avName_! Prends cette r\xc3\xa9compense...', 'Excellent boulot, _avName_! Voil\xc3\xa0 ta r\xc3\xa9compense...')
QuestsDefaultLeaving = ('Salut!', 'Au revoir!', 'Bon vent, _avName_!', 'A plus, _avName_!', 'Bonne chance!', 'Amuse-toi bien \xc3\xa0 Toontown!', 'A plus tard!')
QuestsDefaultReject = ('Bonjour.', "Puis-je t'aider ?", 'Comment \xc3\xa7a va?', 'Bien le bonjour.', 'Je suis un peu occup\xc3\xa9 l\xc3\xa0, _avName_.', 'Oui?', 'Salut, _avName_!', 'Bienvenue, _avName_!', 'H\xc3\xa9, _avName_! Comment \xc3\xa7a va?', 'Sais-tu que tu peux ouvrir ton journal de bord en appuyant sur la touche F8?', "Tu peux utiliser ta carte pour te t\xc3\xa9l\xc3\xa9porter jusqu'au terrain de jeux!", 'Tu peux devenir ami(e) avec les autres joueurs en cliquant sur eux.', 'Tu peux en savoir plus sur un  ' + Cog + ' en cliquant sur lui.', 'Trouve des tr\xc3\xa9sors sur les terrains de jeux pour remplir ton rigolm\xc3\xa8tre.', 'Les immeubles ' + Cog + " sont dangereux! N'y va pas tout seul!", 'Lorsque tu perds un combat, les ' + Cogs + ' prennent tous tes gags.', 'Pour avoir plus de gags, joue aux jeux du tramway!', 'Tu peux accumuler des rigolpoints en effectuant des d\xc3\xa9fitoons.', 'Chaque d\xc3\xa9fitoon te vaudra une r\xc3\xa9compense.', "Certaines r\xc3\xa9compenses te permettent d'avoir plus de gags.", 'Si tu gagnes un combat, ton d\xc3\xa9fitoon est cr\xc3\xa9dit\xc3\xa9 pour chaque ' + Cog + ' vaincu.', 'Si tu regagnes un b\xc3\xa2timent ' + Cog + ", retourne \xc3\xa0 l'int\xc3\xa9rieur pour recevoir un remerciement sp\xc3\xa9cial de la part de son propri\xc3\xa9taire!", 'Si tu appuies sur la touche "page pr\xc3\xa9c\xc3\xa9dente", tu peux regarder vers le haut!', "Si tu appuies sur la touche de tabulation, tu peux voir diff\xc3\xa9rents points de vue de ce qui t'entoure!", "Pour montrer \xc3\xa0 tes amis ce que tu penses, entre un '.' avant ta pens\xc3\xa9e.", 'Si un ' + Cog + " est assomm\xc3\xa9, il lui est plus difficile d'\xc3\xa9viter les objets qui tombent.", 'Chaque type de b\xc3\xa2timent ' + Cog + ' a un aspect diff\xc3\xa9rent.', "Tu obtiens plus de r\xc3\xa9compenses d'habilet\xc3\xa9 si tu vaincs des " + Cogs + ' aux plus hauts \xc3\xa9tages des b\xc3\xa2timents.')
QuestsDefaultTierNotDone = ("Bonjour, _avName_! Tu dois terminer tes d\xc3\xa9fitoons commenc\xc3\xa9s avant d'en obtenir un autre.", 'Salut! Tu dois terminer les d\xc3\xa9fitoons sur lesquels tu es en train de travailler pour en obtenir un nouveau.', 'Oh\xc3\xa9, _avName_! Pour que je puisse te donner un autre d\xc3\xa9fitoon, tu dois finir ceux que tu as d\xc3\xa9j\xc3\xa0.')
QuestsDefaultQuest = None
QuestsDefaultVisitQuestDialog = ("J'ai entendu dire que _toNpcName_ te cherchait._where_", 'Arr\xc3\xaate-toi voir _toNpcName_ quand tu pourras._where_', 'Va donc voir _toNpcName_ la prochaine fois que tu passes par l\xc3\xa0-bas._where_', 'Si tu peux, arr\xc3\xaate-toi dire bonjour \xc3\xa0 _toNpcName_._where_', '_toNpcName_ va te donner ton prochain d\xc3\xa9fitoon._where_')
...
TheBrrrghTrackQuestDict = {GREETING: '', 
   QUEST: "Maintenant tu es pr\xc3\xaat(e).\x07Sors et fais un tour avant de d\xc3\xa9cider quelle s\xc3\xa9rie tu voudras choisir.\x07Choisis bien, parce que c'est ta derni\xc3\xa8re s\xc3\xa9rie.\x07Quand tu auras d\xc3\xa9cid\xc3\xa9, reviens me voir.", 
...
QuestDialog_3225 = {QUEST: "Oh, merci pour ta visite, _avName_!\x07Les Cogs du quartier ont effray\xc3\xa9 mon livreur.\x07Je n'ai personne pour livrer cette salade \xc3\xa0 _toNpcName_!\x07Peux-tu le faire pour moi? Merci beaucoup!_where_"}
QuestDialog_2910 = {QUEST: 'D\xc3\xa9j\xc3\xa0 de retour ?\x07Super travail avec le ressort.\x07Le dernier article est un contrepoids.\x07Va donc voir _toNpcName_ et ram\xc3\xa8ne tout ce que tu peux._where_'}
QuestDialogDict = {160: {GREETING: '', 
         QUEST: 'OK, maintenant je crois que nous sommes pr\xc3\xaats pour quelque chose de plus compliqu\xc3\xa9.\x07Tu dois vaincre 3 Chefbots.', 
   ...
   161: {GREETING: '', 
         QUEST: 'OK, maintenant je crois que nous sommes pr\xc3\xaats pour quelque chose de plus compliqu\xc3\xa9.\x07Tu dois vaincre 3 Loibots.', 
         INCOMPLETE_PROGRESS: 'Les ' + Cogs + ' sont dans les rues, dans les tunnels.', 
         ...
         LEAVING: QuestsDefaultLeaving}, 
   162: {GREETING: '', 
         QUEST: 'OK, maintenant je crois que nous sommes pr\xc3\xaats pour quelque chose de plus compliqu\xc3\xa9.\x07Tu dois vaincre 3 Caissbots.', 
         INCOMPLETE_PROGRESS: 'Les ' + Cogs + ' sont dans les rues, dans les tunnels.', 
         ...
         LEAVING: QuestsDefaultLeaving}, 
   163: {GREETING: '', 
         QUEST: 'OK, maintenant je crois que nous sommes pr\xc3\xaats pour quelque chose de plus compliqu\xc3\xa9.\x07Tu dois vaincre 3 Vendibots.', 
         INCOMPLETE_PROGRESS: 'Les ' + Cogs + ' sont dans les rues, dans les tunnels.', 
         ...
         COMPLETE: QuestsDefaultComplete, 
         LEAVING: QuestsDefaultLeaving}, 
   164: {QUEST: "Il semble que tu as besoin de nouveaux gags.\x07Va voir Flippy, peut-\xc3\xaatre pourra-t-il t'aider._where_"}, 
   165: {QUEST: "Salut!\x07On dirait que tu as besoin de t'entra\xc3\xaener \xc3\xa0 utiliser tes gags.\x07Chaque fois que tu atteins un Cog avec l'un de tes gags, ton exp\xc3\xa9rience augmente.\x07Quand tu auras assez d'exp\xc3\xa9rience, tu pourras utiliser un gag encore meilleur.\x07Va t'entra\xc3\xaener \xc3\xa0 utiliser tes gags en battant 4 Cogs."}, 
   166: {QUEST: "Bien jou\xc3\xa9 pour avoir battu ces Cogs.\x07Tu sais, les Cogs sont de quatre sortes diff\xc3\xa9rentes.\x07Il y a les Loibots, les Caissbots, les Vendibots et les Chefbots.\x07Tu peux les distinguer par leurs couleurs et leurs \xc3\xa9tiquettes.\x07Pour t'entra\xc3\xaener va battre 4 Chefbots."}, 
   167: {QUEST: "Bien jou\xc3\xa9 pour avoir battu ces Cogs.\x07Tu sais, les Cogs sont de quatre sortes diff\xc3\xa9rentes.\x07Il y a les Loibots, les Caissbots, les Vendibots et les Chefbots.\x07Tu peux les distinguer par leurs couleurs et leurs \xc3\xa9tiquettes.\x07Pour t'entra\xc3\xaener va battre 4 Loibots."}, 
   168: {QUEST: "Bien jou\xc3\xa9 pour avoir battu ces Cogs.\x07Tu sais, les Cogs sont de quatre sortes diff\xc3\xa9rentes.\x07Il y a les Loibots, les Caissbots, les Vendibots et les Chefbots.\x07Tu peux les distinguer par leurs couleurs et leurs \xc3\xa9tiquettes.\x07Pour t'entra\xc3\xaener va battre 4 Vendibots."}, 
   169: {QUEST: "Bien jou\xc3\xa9 pour avoir battu ces Cogs.\x07Tu sais, les Cogs sont de quatre sortes diff\xc3\xa9rentes.\x07Il y a les Loibots, les Caissbots, les Vendibots et les Chefbots.\x07Tu peux les distinguer par leurs couleurs et leurs \xc3\xa9tiquettes.\x07Pour t'entra\xc3\xaener va battre 4 Caissbots."}, 
   170: {QUEST: "Bon travail, maintenant tu connais la diff\xc3\xa9rence entre les 4 sortes de Cogs.\x07Je crois que tu peux commencer \xc3\xa0 t'entra\xc3\xaener pour ta troisi\xc3\xa8me s\xc3\xa9rie de gags.\x07Va parler \xc3\xa0_toNpcName_ pour choisir ta prochaine s\xc3\xa9rie de gags - il peut te donner des conseils avis\xc3\xa9s._where_"}, 
   171: {QUEST: "Bon travail, maintenant tu connais la diff\xc3\xa9rence entre les 4 sortes de Cogs.\x07Je crois que tu peux commencer \xc3\xa0 t'entra\xc3\xaener pour ta troisi\xc3\xa8me s\xc3\xa9rie de gags.\x07Va parler \xc3\xa0_toNpcName_ pour choisir ta prochaine s\xc3\xa9rie de gags - il peut te donner des conseils avis\xc3\xa9s._where_"}, 
   172: {QUEST: "Bon travail, maintenant tu connais la diff\xc3\xa9rence entre les 4 sortes de Cogs.\x07Je crois que tu peux commencer \xc3\xa0 t'entra\xc3\xaener pour ta troisi\xc3\xa8me s\xc3\xa9rie de gags.\x07Va parler \xc3\xa0_toNpcName_ pour choisir ta prochaine s\xc3\xa9rie de gags - elle peut te donner des conseils avis\xc3\xa9s._where_"}, 
   175: {GREETING: '', 
         QUEST: "Est-ce que tu savais que tu as une maison Toon \xc3\xa0 toi?\x07Clarabelle la vache s'occupe d'un catalogue par t\xc3\xa9l\xc3\xa9phone ou tu peux commander des meubles pour d\xc3\xa9corer ta maison.\x07Tu peux aussi y acheter des mots de Chat rapide, des v\xc3\xaatements et d'autres choses amusantes!\x07Je vais dire \xc3\xa0 Clarabelle de t'envoyer ton premier catalogue maintenant.\x07Tu recevras un catalogue avec les nouveaux articles chaque semaine!\x07Rentre a la maison et appelle Clarabelle avec ton t\xc3\xa9l\xc3\xa9phone.", 
         INCOMPLETE_PROGRESS: 'Rentre \xc3\xa0 la maison et appelle Clarabelle avec ton t\xc3\xa9l\xc3\xa9phone.', 
         COMPLETE: "J'esp\xc3\xa8re que tu t'amuses en commandant des choses chez Clarabelle!\x07Je viens tout juste de red\xc3\xa9corer ma maison. Elle est toontastique!\x07Continue \xc3\xa0 relever les d\xc3\xa9fitoons pour avoir plus de r\xc3\xa9compenses!", 
         LEAVING: QuestsDefaultLeaving}, 
   400: {GREETING: '', 
         QUEST: "Le lancer et l'\xc3\xa9claboussure sont super, mais tu auras besoin de plus de gags pour battre les Cogs de plus haut niveau.\x07Lorsque tu fais \xc3\xa9quipe avec d'autres Toons contre les Cogs, vous pouvez combiner vos attaques pour faire encore plus de d\xc3\xa9g\xc3\xa2ts.\x07Essayez diff\xc3\xa9rentes combinaisons de gags pour voir ce qui marche le mieux.\x07Pour ta prochaine s\xc3\xa9rie, choisis entre tapage et toonique.\x07Tapage est particulier parce que lorsqu'il frappe, il endommage tous les Cogs.\x07Toonique te permet de soigner les autres Toons lors d'un combat.\x07Lorsque tu es pr\xc3\xaat(e) \xc3\xa0 te d\xc3\xa9cider, reviens ici faire ton choix.", 
         ...
         COMPLETE: "Bonne d\xc3\xa9cision. Maintenant tu dois t'entra\xc3\xaener avant de pouvoir utiliser ces gags.\x07Tu dois effectuer une s\xc3\xa9rie de d\xc3\xa9fitoons pour t'entra\xc3\xaener.\x07Chaque d\xc3\xa9fi te donnera une seule image de ton animation d'attaque avec les gags.\x07Lorsque tu auras les 15 images, tu pourras faire le dernier d\xc3\xa9fi d'entra\xc3\xaenement qui te permettra d'utiliser tes nouveaux gags.\x07Tu peux suivre tes progr\xc3\xa8s dans ton journal de bord.", 
         LEAVING: QuestsDefaultLeaving}, 
   ...
   1041: {QUEST: "Salut! Qu'est-ce qui t'am\xc3\xa8ne ?\x07Tout le monde utilise son trou portable pour voyager dans Toontown.\x07Tu peux te t\xc3\xa9l\xc3\xa9porter vers tes contacts en utilisant la liste d'contacts, ou vers n'importe quel quartier en utilisant la carte du journal de bord.\x07Bien entendu, tu dois d'abord gagner le droit de le faire!\x07Disons que je peux activer ton acc\xc3\xa8s \xc3\xa0 Toontown centre par t\xc3\xa9l\xc3\xa9portation si tu aides un de mes contacts.\x07On dirait que les Cogs font du d\xc3\xa9sordre sur l'avenue des Fondus. Va voir _toNpcName_._where_"}, 
   1042: {QUEST: "Salut! Qu'est-ce qui t'am\xc3\xa8ne ?\x07Tout le monde utilise son trou portable pour voyager dans Toontown.\x07Tu peux te t\xc3\xa9l\xc3\xa9porter vers tes contacts en utilisant la liste d'contacts, ou vers n'importe quel quartier en utilisant la carte du journal de bord.\x07Bien entendu, tu dois d'abord gagner le droit de le faire!\x07Disons que je peux activer ton acc\xc3\xa8s \xc3\xa0 Toontown centre par t\xc3\xa9l\xc3\xa9portation si tu aides un de mes contacts.\x07On dirait que les Cogs font du d\xc3\xa9sordre sur l'avenue des Fondus. Va voir _toNpcName_._where_"}, 
   1043: {QUEST: "Salut! Qu'est-ce qui t'am\xc3\xa8ne ?\x07Tout le monde utilise son trou portable pour voyager dans Toontown.\x07Tu peux te t\xc3\xa9l\xc3\xa9porter vers tes contacts en utilisant la liste d'contacts, ou vers n'importe quel quartier en utilisant la carte du journal de bord.\x07Bien entendu, tu dois d'abord gagner le droit de le faire!\x07Disons que je peux activer ton acc\xc3\xa8s \xc3\xa0 Toontown centre par t\xc3\xa9l\xc3\xa9portation si tu aides un de mes contacts.\x07On dirait que les Cogs font du d\xc3\xa9sordre sur l'avenue des Fondus. Va voir _toNpcName_._where_"}, 
   1044: {QUEST: "Oh, merci de passer par ici. J'ai vraiment besoin d'aide.\x07Comme tu peux voir, je n'ai pas de clients.\x07Mon livre de recettes secret est perdu et personne ne vient plus dans mon restaurant.\x07La derni\xc3\xa8re fois que je l'ai vu, c'\xc3\xa9tait avant que ces Cogs ne prennent mon b\xc3\xa2timent.\x07Est-ce que tu peux m'aider \xc3\xa0 retrouver quatre de mes c\xc3\xa9l\xc3\xa8bres recettes?", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Est-ce que tu as pu retrouver mes recettes?'}, 
   1045: {QUEST: "Merci beaucoup!\x07D'ici peu, j'aurai retrouv\xc3\xa9 toutes mes recettes et je pourrai rouvrir mon restaurant.\x07Oh, j'ai une petite note ici pour toi - quelque chose \xc3\xa0 propos de l'acc\xc3\xa8s par t\xc3\xa9l\xc3\xa9portation ?\x07C'est \xc3\xa9crit, merci d'avoir aid\xc3\xa9 mon ami et d'avoir livr\xc3\xa9 ceci au quartier g\xc3\xa9n\xc3\xa9ral des Toons. \x07Eh bien, merci vraiment - au revoir!", 
          LEAVING: '', 
          COMPLETE: "Ah oui, c'est \xc3\xa9crit que tu as \xc3\xa9t\xc3\xa9 d'une grande aide \xc3\xa0 de braves gens de l'avenue des Fondus.\x07Et que tu as besoin d'un acc\xc3\xa8s par t\xc3\xa9l\xc3\xa9portation \xc3\xa0 Toontown centre.\x07Bon, c'est comme si c'\xc3\xa9tait fait.\x07Maintenant tu peux revenir au terrain de jeux par t\xc3\xa9l\xc3\xa9portation depuis presque partout dans Toontown.\x07Ouvre simplement ta carte et clique sur Toontown centre."}, 
   1046: {QUEST: "Les Caissbots ont vraiment ennuy\xc3\xa9 la Caisse d'\xc3\xa9pargne Dr\xc3\xb4le d'argent.\x07Va donc y faire un tour et vois si tu peux faire quelque chose._where_"}, 
   1047: {QUEST: "Les Caissbots se sont introduits dans la banque et ont vol\xc3\xa9 nos machines.\x07S'il te pla\xc3\xaet, reprends 5 machines \xc3\xa0 calculer aux Caissbots.\x07Pour t'\xc3\xa9viter de faire des allers et retours, rapporte-les toutes en une seule fois.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Tu cherches encore des machines \xc3\xa0 calculer ?'}, 
   1048: {QUEST: 'Oh l\xc3\xa0 l\xc3\xa0! >Merci d\'avoir trouv\xc3\xa9 nos machines \xc3\xa0 calculer.\x07Hmm... Elles ont l\'air un peu ab\xc3\xaem\xc3\xa9es.\x07Dis donc, pourrais-tu les amener \xc3\xa0 _toNpcName_ \xc3\xa0 son magasin, "Machines \xc3\xa0 chatouilles", dans cette rue ?\x07Voir si elle peut les r\xc3\xa9parer.', 
          LEAVING: ''}, 
   1049: {QUEST: "Qu'est-ce que c'est ? Des machines \xc3\xa0 calculer cass\xc3\xa9es?\x07Des Caissbots dis-tu?\x07Bon, regardons \xc3\xa7a...\x07Mouais, les pignons sont cass\xc3\xa9s, mais je n'en vends pas...\x07Tu sais ce qui pourrait marcher - des pignons de Cog, des gros, de gros Cogs...\x07Des pignons de Cog de niveau 3 devraient faire l'affaire. J'en aurai besoin de 2 pour chaque machine, donc 10 au total.\x07Rapporte-les moi tous ensemble et je ferai la r\xc3\xa9paration!", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Souviens-toi, j'ai besoin de 10 pignons pour r\xc3\xa9parer les machines."}, 
   1053: {QUEST: "Ah oui, \xc3\xa7a devrait bien faire l'affaire.\x07Tout est r\xc3\xa9par\xc3\xa9 maintenant, gratuitement.\x07Rapporte-les \xc3\xa0 Dr\xc3\xb4le d'argent, et dis-leur bonjour de ma part.", 
          LEAVING: '', 
          COMPLETE: "Toutes les machines \xc3\xa0 calculer sont r\xc3\xa9par\xc3\xa9es?\x07Joli travail. Je crois bien que j'ai quelque chose par l\xc3\xa0 pour te r\xc3\xa9compenser..."}, 
   1054: {QUEST: "_toNpcName_ a besoin d'aide pour ses voitures de clown._where_"}, 
   1055: {QUEST: "Bon sang! Je n'arrive pas \xc3\xa0 trouver les pneus de cette voiture de clown!\x07Tu crois que tu pourrais m'aider ?\x07Je crois que Bob Fondu les a lanc\xc3\xa9s dans la mare du terrain de jeux de Toontown centre.\x07Si tu vas sur les pontons, de l\xc3\xa0 tu peux essayer de rep\xc3\xaacher les pneus.", 
          GREETING: 'Youhouu!', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Tu as du mal \xc3\xa0 rep\xc3\xaacher les 4 pneus?'}, 
   1056: {QUEST: "Fanta-super-tastique! Maintenant je vais pouvoir remettre en marche cette vieille voiture de clown!\x07H\xc3\xa9, je croyais que j'avais une pompe par ici pour gonfler ces pneus...\x07C'est peut-\xc3\xaatre _toNpcName_ qui l'a emprunt\xc3\xa9e ?\x07Tu peux aller lui demander de me la rendre ?_where_", 
          LEAVING: ''}, 
   1057: {QUEST: 'Salut!\x07Une pompe \xc3\xa0 pneus tu dis?\x07Je vais te dire - tu me nettoies les rues de quelques-uns de ces Cogs de haut niveau...\x07Et je te donne la pompe \xc3\xa0 pneus.', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "C'est tout ce que tu peux faire ?"}, 
   1058: {QUEST: 'Bon travail - je savais que tu pouvais le faire.\x07Voil\xc3\xa0 la pompe. Je suis certain que_toNpcName_ sera content de la r\xc3\xa9cup\xc3\xa9rer.', 
          LEAVING: '', 
          GREETING: '', 
          COMPLETE: "Youpiii! Maintenant \xc3\xa7a va marcher!\x07Et dis donc, merci de m'avoir aid\xc3\xa9.\x07Tiens, prends \xc3\xa7a."}, 
   1059: {QUEST: '_toNpcName_ est \xc3\xa0 court de fournitures. Tu peux peut-\xc3\xaatre lui donner un coup de main ?_where_'}, 
   1060: {QUEST: "Merci d'\xc3\xaatre pass\xc3\xa9 par ici!\x07Ces Cogs ont vol\xc3\xa9 mon encre je n'en ai presque plus.\x07 Pourrais-tu me p\xc3\xaacher de l'encre de seiche dans la mare ?\x07Tu n'as qu'\xc3\xa0 rester sur un ponton pr\xc3\xa8s de la mare pour p\xc3\xaacher.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: '{Tu as des probl\xc3\xa8mes pour p\xc3\xaacher ?'}, 
   1061: {QUEST: "Super - merci pour l'encre!\x07Tu sais quoi, et si tu nous d\xc3\xa9barrassais de quelques Gratte-papiers...\x07Je ne serais plus en panne d'encre aussi rapidement.\x07Tu dois vaincre 6 Gratte-papiers dans Toontown centre pour avoir ta r\xc3\xa9compense.", 
          LEAVING: '', 
   ...
   1062: {QUEST: "Super - merci pour l'encre!\x07Tu sais quoi, et si tu nous d\xc3\xa9barrassais de quelques Pique-au-sang...\x07Je ne serais plus en panne d'encre aussi rapidement.\x07Tu dois vaincre 6 Pique-au-sang dans Toontown centre pour avoir ta r\xc3\xa9compense.", 
          LEAVING: '', 
          COMPLETE: 'Merci! Laisse-moi te r\xc3\xa9compenser pour ton aide.', 
   ...
   1063: {QUEST: "Salut, merci d'\xc3\xaatre l\xc3\xa0.\x07Un Cog a vol\xc3\xa9 un paquet tr\xc3\xa8s important juste sous mon nez.\x07Peux-tu le r\xc3\xa9cup\xc3\xa9rer ? Je crois que c'\xc3\xa9tait un Cog de niveau 3...\x07Donc, tu dois vaincre des Cogs de niveau 3 jusqu'\xc3\xa0 ce que tu retrouves mon paquet.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu n'as pas retrouv\xc3\xa9 le paquet, hein ?"}, 
   1067: {QUEST: "C'est \xc3\xa7a, tr\xc3\xa8s bien!\x07Oh, l'adresse est toute tach\xc3\xa9e...\x07Tout ce que j'arrive \xc3\xa0 lire, c'est Docteur... - le reste est brouill\xc3\xa9.\x07C'est peut-\xc3\xaatre pour_toNpcName_? Peux-tu lui porter ?_where_", 
          LEAVING: ''}, 
   1068: {QUEST: "Je n'attendais pas de paquet. C'est peut-\xc3\xaatre pour le Dr E. Phorique ?\x07Mon assistant doit aller le voir aujourd'hui, je me charge de lui remettre.\x07En attendant, est-ce que tu voudrais bien d\xc3\xa9barrasser ma rue de quelques Cogs?\x07Tu dois vaincre 10 Cogs dans Toontown centre.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Mon assistant n'est pas encore revenu."}, 
   1069: {QUEST: "Le Dr. E. Phorique dit qu'il n'attendait pas de paquet non plus.\x07Malheureusement, un Caissbot l'a vol\xc3\xa9 \xc3\xa0 mon assistant alors qu'il revenait.\x07Pourrais-tu essayer de le r\xc3\xa9cup\xc3\xa9rer ?", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu n'as pas retrouv\xc3\xa9 le paquet, hein ?"}, 
   1070: {QUEST: "Le Dr. E. Phorique dit qu'il n'attendait pas de paquet non plus.\x07Malheureusement, un Vendibot l'a vol\xc3\xa9 \xc3\xa0 mon assistant alors qu'il revenait.\x07Je suis d\xc3\xa9sol\xc3\xa9, mais il va falloir que tu retrouves ce Vendibot pour le r\xc3\xa9cup\xc3\xa9rer.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu n'as pas retrouv\xc3\xa9 le paquet, hein ?"}, 
   1071: {QUEST: "Le Dr. E. Phorique dit qu'il n'attendait pas de paquet non plus.\x07Malheureusement, un Chefbot l'a vol\xc3\xa9 \xc3\xa0 mon assistant alors qu'il revenait.\x07Pourrais-tu essayer de le r\xc3\xa9cup\xc3\xa9rer ?", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu n'as pas retrouv\xc3\xa9 le paquet, hein ?"}, 
   1072: {QUEST: "Super - tu l'as retrouv\xc3\xa9!\x07Tu devrais peut-\xc3\xaatre essayer _toNpcName_, cela pourrait \xc3\xaatre pour lui._where_", 
          LEAVING: ''}, 
   1073: {QUEST: "Oh, merci de m'avoir apport\xc3\xa9 mes paquets.\x07Juste une seconde, j'en attendais deux. Pourrais-tu v\xc3\xa9rifier avec _toNpcName_ voir s'il a l'autre ?", 
          INCOMPLETE: 'Est-ce que tu as trouv\xc3\xa9 mon autre paquet ?', 
          LEAVING: ''}, 
   1074: {QUEST: "Il a dit qu'il y avait un autre paquet ? Les Cogs l'ont peut-\xc3\xaatre aussi vol\xc3\xa9.\x07Tu dois vaincre des Cogs jusqu'\xc3\xa0 ce que tu trouves le second paquet.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu n'as pas retrouv\xc3\xa9 le paquet, hein ?"}, 
   1075: {QUEST: "Finalement je crois qu'il y avait un second paquet!\x07Va vite le porter \xc3\xa0 _toNpcName_ avec mes excuses.", 
          COMPLETE: 'Eh, mon paquet est l\xc3\xa0!\x07Puisque tu es un Toon aussi serviable, cela devrait aider.', 
          LEAVING: ''}, 
   1076: {QUEST: "Il y a un probl\xc3\xa8me au Ornithorynques 14 carats.\x07_toNpcName_ serait sans doute content d'avoir de l'aide._where_"}, 
   1077: {QUEST: "Merci d'\xc3\xaatre venu - les Cogs ont vol\xc3\xa9 tous mes poissons dor\xc3\xa9s.\x07Je crois que les Cogs veulent les vendre pour se faire de l'argent facilement.\x07Ces 5 poissons ont \xc3\xa9t\xc3\xa9 mes seuls compagnons dans cette petite boutique depuis tant d'ann\xc3\xa9es...\x07Si tu pouvais me les retrouver, je t'en serais vraiment reconnaissant.\x07Je suis certain qu'un des Cogs a mes poissons.\x07Tu dois vaincre des Cogs jusqu'\xc3\xa0 ce que tu trouves mes poissons dor\xc3\xa9s.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "S'il te pla\xc3\xaet, ram\xc3\xa8ne-moi mes poissons."}, 
   1078: {QUEST: "Oh, tu as mes poissons!\x07Eh? Qu'est-ce que c'est que \xc3\xa7a?\x07Aah, ce sont bien les Cogs, apr\xc3\xa8s tout.\x07Je ne comprends rien \xc3\xa0 ce re\xc3\xa7u. Peux-tu l'emmener \xc3\xa0 _toNpcName_ voir s'il peut le lire ?_where_", 
          INCOMPLETE: "Qu'est-ce que _toNpcName_ a dit \xc3\xa0 propos du re\xc3\xa7u?", 
          LEAVING: ''}, 
   1079: {QUEST: "Mmm, laisse-moi voir ce re\xc3\xa7u.\x07...Ah oui, il dit qu'un poisson dor\xc3\xa9 a \xc3\xa9t\xc3\xa9 vendu \xc3\xa0 un Laquaistic.\x07\xc3\x87a n'a pas l'air de dire ce qui est arriv\xc3\xa9 aux 4 autres poissons.\x07Tu devrais peut-\xc3\xaatre essayer de trouver ce Laquaistic.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Je ne crois pas que je puisse t'aider \xc3\xa0 grand-chose d'autre.\x07Pourquoi n'essaies-tu pas de trouver ce poisson dor\xc3\xa9?"}, 
   1092: {QUEST: "Mmm, laisse-moi voir ce re\xc3\xa7u.\x07...Ah oui, il dit qu'un poisson dor\xc3\xa9 a \xc3\xa9t\xc3\xa9 vendu \xc3\xa0 un Gardoseille.\x07\xc3\x87a n'a pas l'air de dire ce qui est arriv\xc3\xa9 aux 4 autres poissons.\x07Tu devrais peut-\xc3\xaatre essayer de trouver ce Gardoseille.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Je ne crois pas que je puisse t'aider \xc3\xa0 grand-chose d'autre.\x07Pourquoi n'essaies-tu pas de trouver ce poisson dor\xc3\xa9?"}, 
   1080: {QUEST: "Oh, Dieu merci! Tu as trouv\xc3\xa9 Oscar - c'est mon pr\xc3\xa9f\xc3\xa9r\xc3\xa9.\x07Qu'est-ce que c'est, Oscar ? Hein, hein...ils ont quoi? ... Ils sont ?\x07Oscar dit que les 4 autres se sont \xc3\xa9chapp\xc3\xa9s dans la mare du terrain de jeux.\x07Peux-tu aller me les chercher ?\x07Tu n'as qu'\xc3\xa0 les p\xc3\xaacher dans la mare.", 
          LEAVING: '', 
          COMPLETE: 'Ahh, je suis si content! Avoir retrouv\xc3\xa9 mes petits camarades!\x07Tu m\xc3\xa9rites une belle r\xc3\xa9compense pour cela!', 
          INCOMPLETE_PROGRESS: 'Tu as des probl\xc3\xa8mes pour trouver ces poissons?'}, 
   1081: {QUEST: "_toNpcName_ a l'air d'\xc3\xaatre dans une situation difficile. Elle serait s\xc3\xbbrement contente d'avoir de l'aide._where_"}, 
   1082: {QUEST: "J'ai renvers\xc3\xa9 de la colle \xc3\xa0 s\xc3\xa9chage rapide, et je suis coll\xc3\xa9e - compl\xc3\xa8tement coll\xc3\xa9e!\x07Si seuleument je trouvais une fa\xc3\xa7on de m'en sortir...\x07Cela me donne une id\xc3\xa9e, si tu veux bien.\x07Va vaincre quelques Vendibots et ram\xc3\xa8ne-moi de l'huile.", 
          LEAVING: '', 
          GREETING: '', 
          INCOMPLETE_PROGRESS: "Peux-tu m'aider \xc3\xa0 me d\xc3\xa9coller ?"}, 
   1083: {QUEST: "Bon, l'huile a fait un peu d'effet, mais je ne peux toujours pas bouger.\x07Qu'est-ce qui pourrait bien m'aider ? C'est difficile \xc3\xa0 dire.\x07Cela me donne une id\xc3\xa9e on peut au moins essayer.\x07Va vaincre quelques Loibots et ram\xc3\xa8ne-moi de la graisse.", 
          LEAVING: '', 
          GREETING: '', 
          INCOMPLETE_PROGRESS: "Peux-tu m'aider \xc3\xa0 me d\xc3\xa9coller ?"}, 
   1084: {QUEST: "Non, \xc3\xa7a n'a rien fait. Ce n'est vraiment pas dr\xc3\xb4le.\x07J'ai pourtant mis de la graisse partout.\x07\xc3\x87a me donne une id\xc3\xa9e, avant que j'oublie.\x07Va vaincre quelques Caissbots et rapporte de l'eau pour l'humecter.", 
          LEAVING: '', 
          GREETING: '', 
          COMPLETE: 'Hourrah, je suis lib\xc3\xa9r\xc3\xa9e de cette colle rapide.\x07Comme r\xc3\xa9compense, je te donne ce cadeau.\x07Tu peux rire un peu plus longtemps lorsque tu es en train de te battre, et puis...\x07Oh, non! Je suis de nouveau coll\xc3\xa9e l\xc3\xa0!', 
          INCOMPLETE_PROGRESS: "Peux-tu m'aider \xc3\xa0 me d\xc3\xa9coller ?"}, 
   1085: {QUEST: "_toNpcName_ est en train de faire des recherches sur les Cogs.\x07Va lui parler si tu veux l'aider._where_"}, 
   1086: {QUEST: "C'est cela, je fais une \xc3\xa9tude sur les Cogs.\x07Je veux savoir ce qui les fait tiquer.\x07Cela m'aiderait certainement si tu pouvais me trouver des pignons de Cogs.\x07Assure-toi qu'il s'agit de Cogs de niveau 2 au minimum, qu'ils soient assez gros pour \xc3\xaatre examin\xc3\xa9s.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Tu ne peux pas trouver assez de pignons?'}, 
   1089: {QUEST: "OK, regardons un peu \xc3\xa7a. Ce sont d'excellents sp\xc3\xa9cimens!\x07Mmmm...\x07OK, voil\xc3\xa0 mon rapport. Emm\xc3\xa8ne-le tout de suite au quartier g\xc3\xa9n\xc3\xa9ral des Toons.", 
   ...
   1091: {QUEST: "J'ai entendu dire que le quartier g\xc3\xa9n\xc3\xa9ral des Toons travaille sur une sorte de d\xc3\xa9tecteur de Cogs.\x07Il te permettra de voir o\xc3\xb9 sont les Cogs afin de les rep\xc3\xa9rer plus facilement.\x07La page des Cogs dans ton journal de bord en est la cl\xc3\xa9.\x07En battant assez de Cogs, tu pourras te r\xc3\xa9gler sur leurs signaux et d\xc3\xa9tecter leur emplacement.\x07Continue \xc3\xa0 vaincre des Cogs, afin d'\xc3\xaatre pr\xc3\xaat.", 
          COMPLETE: 'Bon travail! Tu pourras probablement utiliser ceci...', 
          LEAVING: ''}, 
   401: {GREETING: '', 
         QUEST: 'Tu peux maintenant choisir la prochaine s\xc3\xa9rie de gags que tu veux apprendre.\x07Prends ton temps pour te d\xc3\xa9cider, et reviens quand tu auras choisi.', 
         INCOMPLETE_PROGRESS: 'Pense bien \xc3\xa0 ta d\xc3\xa9cision avant de choisir.', 
         INCOMPLETE_WRONG_NPC: 'Pense bien \xc3\xa0 ta d\xc3\xa9cision avant de choisir.', 
         COMPLETE: 'Une sage d\xc3\xa9cision...', 
         LEAVING: QuestsDefaultLeaving}, 
   2201: {QUEST: 'Ces faux-jetons de Cogs font encore des leurs.\x07_toNpcName_ vient de signaler un autre objet disparu. Va voir si tu peux r\xc3\xa9gler cela._where_'}, 
   2202: {QUEST: "Salut, _avName_. Dieu merci, tu es l\xc3\xa0. Un Radino \xc3\xa0 l'air m\xc3\xa9chant \xc3\xa9tait l\xc3\xa0 \xc3\xa0 l'instant et il est parti avec une chambre \xc3\xa0 air.\x07Je crains qu'ils ne l'utilisent pour leurs sombres desseins.\x07S'il te pla\xc3\xaet, essaie de le retrouver et ram\xc3\xa8ne-la moi.", 
          LEAVING: '', 
   ...
   2203: {QUEST: 'Les Cogs sont en train de mettre la banque sens dessus dessous.\x07Va voir le Capitaine Carl et vois ce que tu peux faire._where_'}, 
   2204: {QUEST: "Bienvenue \xc3\xa0 bord, moussaillon.\x07Grrr! Ces fripons de Cogs ont cass\xc3\xa9 mon monocle et je n'arrive plus \xc3\xa0 compter la monnaie sans lui.\x07Garde les pieds sur terre et porte cette ordonnance au Dr. Queequeg puis rapporte m'en un nouveau._where_", 
          GREETING: '', 
          LEAVING: ''}, 
   2205: {QUEST: "Qu'est-ce que c'est ?\x07Oh, je voudrais bien pr\xc3\xa9parer cette ordonnance mais les Cogs ont chapard\xc3\xa9 mes r\xc3\xa9serves.\x07Si tu peux reprendre la monture \xc3\xa0 un Laquaistic je pourrai probablement t'aider.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'D\xc3\xa9sol\xc3\xa9. Pas de monture du Laquaistic, pas de monocle.'}, 
   2206: {QUEST: 'Excellent!\x07Une seconde...\x07Ton ordonnance est pr\xc3\xaate. Emm\xc3\xa8ne tout de suite ce monocle au Capitaine Carl._where_', 
          GREETING: '', 
          LEAVING: '', 
          COMPLETE: 'Hisse et ho!\x07Tu vas finir par gagner du galon apr\xc3\xa8s tout.\x07Et voil\xc3\xa0.'}, 
   2207: {QUEST: 'Barbara Bernache a un Cog dans son magasin!\x07Il vaudrait mieux que tu y ailles tout de suite._where_'}, 
   2208: {QUEST: '\xc3\x87a alors! Tu viens de le rater, mon chou.\x07Il y avait un Frappedos ici. Il a pris ma grande perruque blanche.\x07Il a dit que c\'\xc3\xa9tait pour son chef et quelque chose \xc3\xa0 propos de "jurisprudence".\x07Si tu pouvais me la rapporter, je t\'en serais toujours reconnaissante.', 
          LEAVING: '', 
          GREETING: '', 
          INCOMPLETE_PROGRESS: "Tu ne l'as toujours pas trouv\xc3\xa9?\x07Il est grand avec une t\xc3\xaate pointue.", 
          COMPLETE: "Tu l'as trouv\xc3\xa9!?!?\x07Tu es vraiment un ange!\x07Tu as bien m\xc3\xa9rit\xc3\xa9 ceci..."}, 
   2209: {QUEST: "Ginette se pr\xc3\xa9pare pour un voyage important.\x07Va y faire un tour et vois ce que tu peux faire pour l'aider._where_"}, 
   2210: {QUEST: "Tu peux m'aider.\x07Le quartier g\xc3\xa9n\xc3\xa9ral des Toons m'a demand\xc3\xa9 de faire un voyage pour voir si je peux trouver d'o\xc3\xb9 viennent les Cogs.\x07J'aurais besoin de quelques affaires pour mon bateau mais je n'ai pas beaucoup de bonbons.\x07Va et ram\xc3\xa8ne-moi du lest de chez Ernest. Il faudra que tu lui rendes un service pour l'avoir._where_", 
          GREETING: 'Salut, _avName_', 
          LEAVING: ''}, 
   2211: {QUEST: "Comme \xc3\xa7a, Ginette veut du lest, n'est-ce pas?\x07Elle me doit encore de l'argent pour le dernier boisseau.\x07Je te le donnerai si tu peux faire partir cinq Microchefs de ma rue.", 
          INCOMPLETE_PROGRESS: "Non, idiot! J'ai dit CINQ Microchefs...", 
          GREETING: 'Que puis-je faire pour toi?', 
          LEAVING: ''}, 
   2212: {QUEST: 'Un march\xc3\xa9 est un march\xc3\xa9.\x07Voil\xc3\xa0 ton lest pour cette pingre de Ginette._where_', 
          GREETING: 'Eh bien, regarde ce qui arrive l\xc3\xa0...', 
          LEAVING: ''}, 
   2213: {QUEST: "Excellent travail. Je savais qu'il serait raisonnable.\x07Ensuite il me faudra une carte marine de chez Art.\x07Je ne crois pas avoir beaucoup de cr\xc3\xa9dit l\xc3\xa0-bas non plus il faudra que tu t'arranges avec lui._where_", 
          GREETING: '', 
          LEAVING: ''}, 
   2214: {QUEST: "Oui, j'ai la carte marine que veut Ginette.\x07Et tu l'auras en \xc3\xa9change d'un petit travail.aJ'essaie de construire un astrolabe pour naviguer dans les \xc3\xa9toiles.aJ'aurais besoin de trois pignons de Cog pour le construire.\x07Reviens quand tu les auras trouv\xc3\xa9s.", 
          INCOMPLETE_PROGRESS: 'Alors ils arrivent ces pignons de Cogs?', 
          GREETING: 'Bienvenue!', 
          LEAVING: 'Bonne chance!'}, 
   2215: {QUEST: "Ooh! Ces pignons feront tr\xc3\xa8s bien l'affaire.\x07Voil\xc3\xa0 la carte. Donne-la \xc3\xa0 Ginette avec mes compliments._where_", 
          GREETING: '', 
          LEAVING: '', 
          COMPLETE: "Bon, on y est presque. Je suis pr\xc3\xaate \xc3\xa0 prendre la mer!\x07Je t'emm\xc3\xa8nerais avec moi si tu n'avais pas un teint si vert. Prends plut\xc3\xb4t ceci."}, 
   901: {QUEST: "Si tu es d'accord, Ahab a besoin d'aide, chez lui..._where_"}, 
   2902: {QUEST: "Tu es la nouvelle recrue ?\x07Bien, bien. Tu peux peut-\xc3\xaatre m'aider.\x07Je suis en train de construire un crabe g\xc3\xa9ant pr\xc3\xa9fabriqu\xc3\xa9 pour d\xc3\xa9router les Cogs.\x07Je pourrais quand m\xc3\xaame utiliser une manille. Va voir G\xc3\xa9rard et rapportes-en une, s'il te pla\xc3\xaet._where_"}, 
   2903: {QUEST: "Salut!\x07Oui, j'ai entendu parler du crabe g\xc3\xa9ant qu'Ahab est en train de fabriquer.\x07La meilleure manille que j'aie est un peu sale quand m\xc3\xaame.\x07Sois sympa, passe chez un blanchisseur avant de la d\xc3\xa9poser._where_", 
          LEAVING: 'Merci!'}, 
   2904: {QUEST: 'Tu dois \xc3\xaatre la personne que G\xc3\xa9rard a envoy\xc3\xa9e.\x07Je crois que je peux faire \xc3\xa7a assez vite.\x07Juste une minute...\x07Et voil\xc3\xa0. Comme neuf!\x07Tu salueras Ahab de ma part._where_'}, 
   2905: {QUEST: "Ah, c'est exactement ce que je cherchais.\x07Pendant que tu es l\xc3\xa0, je vais aussi avoir besoin d'un tr\xc3\xa8s gros ressort d'horloge.\x07Va donc chez Crochet voir s'il en a un._where_"}, 
   2906: {QUEST: "Un gros ressort, hein ?\x07Je suis d\xc3\xa9sol\xc3\xa9 mais le plus gros ressort que j'aie est quand m\xc3\xaame plut\xc3\xb4t petit.\x07Je pourrais peut-\xc3\xaatre en fabriquer un avec des ressorts de g\xc3\xa2chette de pistolet \xc3\xa9clabousseur.\x07Apporte-moi trois de ces gags et je vais voir ce que je peux faire."}, 
   2907: {QUEST: 'Regardons \xc3\xa7a...\x07G\xc3\xa9nial. Vraiment g\xc3\xa9nial.\x07Quelquefois je me surprends moi-m\xc3\xaame.\x07Et voil\xc3\xa0 : un gros ressort pour Ahab!_where_', 
          LEAVING: 'Bonne route!'}, 
   2911: {QUEST: 'Je serais tr\xc3\xa8s content de pouvoir aider, _avName_.\x07Malheureusement, les rues ne sont plus s\xc3\xbbres.\x07Va donc \xc3\xa9liminer quelques Cogs Caissbots et on pourra parler.', 
          INCOMPLETE_PROGRESS: 'Je crois que tu peux rendre les rues encore plus s\xc3\xbbres.'}, 
   2916: {QUEST: "Oui, j'ai un contrepoids que je pourrais donner \xc3\xa0 Ahab.\x07Je crois que ce serait plus s\xc3\xbbr si tu pouvais vaincre deux Vendibots d'abord.", 
          INCOMPLETE_PROGRESS: 'Pas encore. Tu dois vaincre plus de Vendibots.'}, 
   2921: {QUEST: "Hmmm, je pensais que je pourrais me d\xc3\xa9barrasser d'un poids.\x07Je me sentirais bien mieux s'il n'y avait pas autant de Cogs Chefbots \xc3\xa0 r\xc3\xb4der par ici.\x07Va donc en vaincre six et reviens me voir.", 
          INCOMPLETE_PROGRESS: "Je crois qu'on n'est toujours pas en s\xc3\xa9curit\xc3\xa9..."}, 
   2925: {QUEST: "\xc3\x87a y est ?\x07Bon, je suppose qu'on est suffisamment en s\xc3\xa9curit\xc3\xa9 maintenant.\x07Voil\xc3\xa0 le contrepoids pour Ahab._where_"}, 
   2926: {QUEST: "Bon, c'est tout.\x07Voyons si \xc3\xa7a marche.\x07Hmmm, il y a un petit probl\xc3\xa8me.\x07Je n'ai plus de courant parce que ce b\xc3\xa2timent Cog bloque mon capteur solaire.\x07Peux-tu le reprendre pour moi?", 
   ...
   3200: {QUEST: "Je viens d'avoir un appel de _toNpcName_.\x07Ce n'est pas son jour. Tu pourrais peut-\xc3\xaatre l'aider.!\x07Va y faire un tour et vois ce dont il a besoin._where_"}, 
   3201: {QUEST: "Oh, merci d'\xc3\xaatre l\xc3\xa0!\x07J'ai besoin de quelqu'un pour emporter cette nouvelle cravate en soie \xc3\xa0 _toNpcName_.\x07Est-ce que tu peux faire \xc3\xa7a pour moi?_where_"}, 
   3203: {QUEST: "Oh, \xc3\xa7a doit \xc3\xaatre la cravate que j'ai command\xc3\xa9e! Merci!\x07Elle va avec un costume \xc3\xa0 rayures que je viens de finir, juste l\xc3\xa0.\x07H\xc3\xa9, qu'est ce qui est arriv\xc3\xa9 \xc3\xa0 ce costume ?\x07Oh non! Les Cogs ont d\xc3\xbb voler mon nouveau costume!\x07Tu dois vaincre des Cogs jusqu'\xc3\xa0 ce que tu trouves mon costume, et que tu me le rapportes.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu n'as pas encore trouv\xc3\xa9 mon costume ? Je suis certain que les Cogs l'ont pris!", 
          COMPLETE: "Youpii! Tu as trouv\xc3\xa9 mon nouveau costume!\x07Tu vois, je t'avais dit que les Cogs l'avaient! Voil\xc3\xa0 ta r\xc3\xa9compense..."}, 
   3204: {QUEST: "_toNpcName_ vient d'appeler pour signaler un vol.\x07Pourquoi n'irais-tu pas voir si tu peux arranger l'affaire ?_where_"}, 
   3205: {QUEST: "Bonjour, _avName_! Tu es l\xc3\xa0 pour m'aider ?\x07Je viens de chasser un Pique-au-sang de mon magasin. Houlala! C'\xc3\xa9tait effrayant.\x07Mais maintenant je ne trouve plus mes ciseaux! Je suis certain que ce Pique-au-sang les a pris.\x07Trouve-le, et ram\xc3\xa8ne-moi mes ciseaux.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Tu cherches encore mes ciseaux?', 
          COMPLETE: 'Mes ciseaux! Merci beaucoup! Voil\xc3\xa0 ta r\xc3\xa9compense...'}, 
   3206: {QUEST: "On dirait que _toNpcName_ a des probl\xc3\xa8mes avec des Cogs.\x07Va voir si tu peux l'aider._where_"}, 
   3207: {QUEST: "Oh\xc3\xa9, _avName_! Merci d'\xc3\xaatre venu!\x07Une bande de Charabieurs est arriv\xc3\xa9e et a vol\xc3\xa9 une pile de cartes postales sur mon comptoir.\x07S'il te pla\xc3\xaet, sors vaincre tous ces Charabieurs et rapporte-moi mes cartes postales!", 
   ...
   3208: {QUEST: 'Nous avons eu des plaintes des r\xc3\xa9sidents r\xc3\xa9cemment \xc3\xa0 propos des Cassepieds.\x07Essaie de vaincre 10 Cassepieds pour aider tes camarades Toons du Jardin de Daisy.'}, 
   3209: {QUEST: "Merci d'avoir battu ces Cassepieds!\x07Mais maintenant ce sont les T\xc3\xa9l\xc3\xa9vendeurs qui sont incontr\xc3\xb4lables.\x07Va vaincre 10 T\xc3\xa9l\xc3\xa9vendeurs au Jardin de Daisy et reviens ici pour ta r\xc3\xa9compense."}, 
   3247: {QUEST: 'Nous avons eu des plaintes des r\xc3\xa9sidents r\xc3\xa9cemment \xc3\xa0 propos des Pique-au-sang.\x07Essaie de vaincre 20 Pique-au-sang pour aider tes camarades Toons du Jardin de Daisy.'}, 
   3210: {QUEST: "Oh non, la Fleur qui mouille, rue des \xc3\x89rables, n'a plus de fleurs!\x07Emm\xc3\xa8ne-leur dix de tes fleurs \xc3\xa0 \xc3\xa9clabousser pour les aider.\x07V\xc3\xa9rifie que tu as bien 10 fleurs \xc3\xa0 \xc3\xa9clabousser dans ton inventaire d'abord.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "J'ai besoin de 10 fleurs \xc3\xa0 \xc3\xa9clabousser. Tu n'en as pas assez!"}, 
   3211: {QUEST: "Oh, merci beaucoup! Ces fleurs \xc3\xa0 \xc3\xa9clabousser vont nous tirer d'embarras.\x07Mais j'ai peur des Cogs qui sont dehors.\x07Peux-tu m'aider et vaincre quelques-uns de ces Cogs?\x07Reviens me voir apr\xc3\xa8s avoir vaincu 20 Cogs dans cette rue.", 
   ...
   3212: {QUEST: "_toNpcName_ a besoin d'aide pour chercher quelque chose qu'elle a perdu.\x07Va la voir et vois ce que tu peux faire._where_"}, 
   3213: {QUEST: "Salut, _avName_. Peux-tu m'aider ?\x07Je crois que j'ai \xc3\xa9gar\xc3\xa9 mon stylo. Je pense que les Cogs l'ont peut-\xc3\xaatre pris.\x07Va vaincre des Cogs pour retrouver le stylo qu'ils m'ont vol\xc3\xa9.", 
          INCOMPLETE_PROGRESS: "Tu n'as pas encore trouv\xc3\xa9 mon stylo?"}, 
   3214: {QUEST: "Oui, c'est mon stylo! Merci beaucoup!\x07Mais apr\xc3\xa8s ton d\xc3\xa9part, j'ai r\xc3\xa9alis\xc3\xa9 que mon encrier manquait aussi.\x07Va vaincre des Cogs pour retrouver mon encrier.", 
          INCOMPLETE_PROGRESS: 'Je cherche encore mon encrier!'}, 
   3215: {QUEST: "Super! Maintenant j'ai retrouv\xc3\xa9 mon stylo et mon encrier!\x07Mais tu ne devineras jamais!\x07Mon bloc-notes a disparu! Ils ont d\xc3\xbb le voler aussi!\x07Va vaincre des Cogs pour retrouver mon bloc-notes vol\xc3\xa9, puis reviens pour ta r\xc3\xa9compense.", 
          INCOMPLETE_PROGRESS: 'Tu as des nouvelles de mon bloc-notes?'}, 
   3216: {QUEST: "C'est mon bloc-notes! Youpii! Ta r\xc3\xa9compense est...\x07H\xc3\xa9! Mais o\xc3\xb9 est-elle ?\x07J'avais ta r\xc3\xa9compense l\xc3\xa0, dans le coffre de mon bureau. Mais le coffre entier a disparu!\x07Incroyable! Ces Cogs ont vol\xc3\xa9 ta r\xc3\xa9compense!\x07Va vaincre des Cogs pour retrouver mon coffre.\x07Quand tu me le ram\xc3\xa8neras, je te donnerai ta r\xc3\xa9compense.", 
   ...
   3217: {QUEST: 'Nous avons fait quelques \xc3\xa9tudes sur les m\xc3\xa9canismes des Vendibots.\x07Nous devons encore \xc3\xa9tudier certaines pi\xc3\xa8ces de plus pr\xc3\xa8s.\x07Apporte-nous un pignon de Cafteur.\x07Tu peux en attraper un quand le Cog explose.'}, 
   3218: {QUEST: "Bon travail! Maintenant, nous avons besoin d'un pignon de Passetout pour faire la comparaison.\x07Ces pignons sont plus difficiles \xc3\xa0 attraper, ne te d\xc3\xa9courage pas."}, 
   3219: {QUEST: "Super! Maintenant on n'a plus besoin que d'un pignon en plus.\x07Cette fois, il nous faut un pignon de Secousse-cousse.\x07Tu devras peut-\xc3\xaatre chercher \xc3\xa0 l'int\xc3\xa9rieur des b\xc3\xa2timents Vendibots pour trouver cette sorte de Cogs.\x07Quand tu en auras attrap\xc3\xa9 un, rapporte-le pour recevoir ta r\xc3\xa9compense."}, 
   3244: {QUEST: 'Nous avons fait quelques \xc3\xa9tudes sur les m\xc3\xa9canismes des Loibots.\x07Nous devons encore \xc3\xa9tudier certaines pi\xc3\xa8ces de plus pr\xc3\xa8s.\x07Apporte-nous un pignon de Charognard.\x07Tu peux en attraper un quand le Cog explose.'}, 
   3245: {QUEST: "Bon travail! Maintenant nous avons besoin d'un pignon de Frappedos pour faire la comparaison.\x07Ces pignons sont plus difficiles \xc3\xa0 attraper, ne te d\xc3\xa9courage pas."}, 
   3246: {QUEST: "Super! Encore un pignon et c'est bon.\x07Cette fois, il nous faut un pignon de Tournegris.\x07Quand tu en auras attrap\xc3\xa9 un, rapporte-le pour avoir ta r\xc3\xa9compense."}, 
   3220: {QUEST: "Je viens d'apprendre que _toNpcName_ te cherchait.\x07Pourquoi ne vas-tu pas voir ce qu'elle veut ?_where_"}, 
   3221: {QUEST: "Oh\xc3\xa9, _avName_! Et voil\xc3\xa0!\x07J'ai entendu dire que tu \xc3\xa9tais expert(e) en \xc3\xa9claboussures.\x07J'ai besoin de quelqu'un pour montrer l'exemple \xc3\xa0 tous les Toons du Jardin de Daisy.\x07Utilise tes attaques par \xc3\xa9claboussure pour vaincre un groupe de Cogs.\x07Encourage tes contacts \xc3\xa0 utiliser aussi les \xc3\xa9claboussures.\x07Lorque tu auras vaincu 20 Cogs, reviens ici pour ta r\xc3\xa9compense!"}, 
   3222: {QUEST: "C'est le moment de faire preuve de ta Toonma\xc3\xaetrise.\x07Si tu r\xc3\xa9ussis \xc3\xa0 reprendre un certain nombre de b\xc3\xa2timents aux Cogs, tu gagneras le droit \xc3\xa0 trois qu\xc3\xaates.\x07D'abord, tu dois prendre deux b\xc3\xa2timents aux Cogs.\x07N'h\xc3\xa9site pas \xc3\xa0 demander l'aide de tes contacts."}, 
   3223: {QUEST: 'Super travail pour ces b\xc3\xa2timents!\x07Maintenant tu dois prendre deux b\xc3\xa2timents de plus.\x07Ces immeubles doivent faire au moins deux \xc3\xa9tages.'}, 
   3224: {QUEST: 'Fantastique!\x07Maintenant tu dois prendre deux b\xc3\xa2timents de plus.\x07Ces immeubles doivent faire au moins trois \xc3\xa9tages.\x07Quand tu auras fini, reviens chercher ta r\xc3\xa9compense!', 
          COMPLETE: "Tu as r\xc3\xa9ussi, _avName_!\x07Tu as fait preuve d'une excellente Toonma\xc3\xaetrise.", 
          GREETING: ''}, 
   3225: {QUEST: "_toNpcName_ dit qu'elle a besoin d'aide.\x07Va voir si tu peux lui donner un coup de main ?_where_"}, 
   3235: {QUEST: "Oh, c'est la salade que j'ai command\xc3\xa9e!\x07Merci de me l'avoir apport\xc3\xa9e.\x07Tous ces Cogs ont d\xc3\xbb effrayer le livreur habituel de _toNpcName_ encore une fois.\x07Tu pourrais nous rendre service et vaincre quelques-uns des Cogs qui tra\xc3\xaenent par ici?\x07Va vaincre 10 Cogs dans le Jardin de Daisy et reviens voir _toNpcName_.", 
          INCOMPLETE_PROGRESS: "Tu es en train de vaincre des Cogs pour moi?\x07C'est super!! Continue comme \xc3\xa7a!", 
          COMPLETE: "Oh, merci beaucoup d'avoir vaincu ces Cogs!\x07Maintenant je vais peut-\xc3\xaatre pouvoir reprendre mon programme habituel de livraisons.\x07Ta r\xc3\xa9compense est...", 
          INCOMPLETE_WRONG_NPC: 'Va raconter \xc3\xa0 _toNpcName_ tous les Cogs que tu as vaincus._where_'}, 
   3236: {QUEST: 'Il y a beaucoup trop de Loibots par ici.\x07Tu peux faire ta part de travail!\x07Va vaincre 3 b\xc3\xa2timents Loibot.'}, 
   3237: {QUEST: 'Super travail pour ces b\xc3\xa2timents Loibot!\x07Mais maintenant il y a beaucoup trop de Vendibots!\x07Va vaincre 3 b\xc3\xa2timents Vendibot, puis reviens chercher ta r\xc3\xa9compense.'}, 
   3238: {QUEST: 'Oh non! Un Cog Circulateur a vol\xc3\xa9 la cl\xc3\xa9 du Jardin de Daisy!\x07Va voir si tu peux la retrouver.\x07Souviens-toi que les Circulateurs ne se trouvent que dans les b\xc3\xa2timents Vendibot.'}, 
   3239: {QUEST: "Tu as bien trouv\xc3\xa9 une cl\xc3\xa9, mais ce n'est pas la bonne!\x07Nous avons besoin de la cl\xc3\xa9 du Jardin de Daisy.\x07Continue de chercher! Un Cog Circulateur l'a encore!"}, 
   3242: {QUEST: 'Oh non! Un Cog Avocageot a vol\xc3\xa9 la cl\xc3\xa9 du Jardin de Daisy!\x07Va voir si tu peux la retrouver.\x07Souviens-toi que les Avocageots ne se trouvent que dans les b\xc3\xa2timents Loibot.'}, 
   3243: {QUEST: "Tu as bien trouv\xc3\xa9 une cl\xc3\xa9, mais ce n'est pas la bonne!\x07Nous avons besoin de la cl\xc3\xa9 du Jardin de Daisy.\x07Continue de chercher! Un Cog Avocageot l'a encore!"}, 
   3240: {QUEST: "_toNpcName_ vient de me dire qu'un Avocageot lui a vol\xc3\xa9 un sac de graines pour oiseaux.\x07Va vaincre des Avocageots jusqu'\xc3\xa0 ce que tu retrouves les graines pour oiseaux de Piaf, et rapporte-les lui.\x07Les Avocageots ne se trouvent que dans les b\xc3\xa2timents Loibot._where_", 
          COMPLETE: "Oh, merci beaucoup d'avoir retrouv\xc3\xa9 mes graines pour oiseaux!\x07Ta r\xc3\xa9compense est...", 
          INCOMPLETE_WRONG_NPC: 'Bien, tu as retrouv\xc3\xa9 ces graines pour oiseaux!\x07Maintenant apporte-les \xc3\xa0 _toNpcName_._where_'}, 
   3241: {QUEST: 'Certains des b\xc3\xa2timents des Cogs deviennent beaucoup trop hauts.\x07Va voir si tu peux r\xc3\xa9duire de hauteur certains des immeubles les plus hauts.\x07Reprends 5 immeubles de 3 \xc3\xa9tages ou plus et reviens ici pour ta r\xc3\xa9compense.'}, 
   3250: {QUEST: "Lima, la d\xc3\xa9tective de la rue du Ch\xc3\xaane, a entendu parler d'un quartier g\xc3\xa9n\xc3\xa9ral Vendibot. \x07Va donc la voir et aide-la \xc3\xa0 enqu\xc3\xaater."}, 
   3251: {QUEST: "Il y a quelque chose de bizarre par ici.\x07Il y a tant de Vendibots!\x07J'ai entendu dire qu'ils ont install\xc3\xa9 leur propre quartier g\xc3\xa9n\xc3\xa9ral au bout de cette rue.\x07Va au bout de la rue voir ce qu'il en est.\x07Trouve des Cogs Vendibots dans leur quartier g\xc3\xa9n\xc3\xa9ral, vaincs-en 5 et reviens me le dire."}, 
   3252: {QUEST: "OK, annonce la couleur\x07Qu'est-ce que tu dis?\x07Ah, le quartier g\xc3\xa9n\xc3\xa9ral des Vendibots?? Oh non!!! Il faut faire quelque chose.\x07Nous devons le dire au Juge Ticot - il saura quoi faire.\x07Va le voir tout de suite et dis-lui ce que tu as trouv\xc3\xa9. Il est juste au bout de la rue."}, 
   3253: {QUEST: "Oui, puis-je t'aider ? Je suis tr\xc3\xa8s occup\xc3\xa9.\x07Hein ? Un quartier g\xc3\xa9n\xc3\xa9ral Cog?\x07Hein ? Sottises. \xc3\x87a n'est pas possible.\x07Tu dois te tromper. C'est grotesque.\x07Hein ? Ne discute pas avec moi.\x07Ok, alors ram\xc3\xa8ne des preuves.\x07Si les Vendibots sont vraiment en train de construire ce quartier g\xc3\xa9n\xc3\xa9ral Cog, les Cogs du quartier auront des plans sur eux.\x07Les Cogs adorent la paperasserie, tu le savais?\x07Va vaincre des Vendibots par l\xc3\xa0-bas jusqu'\xc3\xa0 ce que tu trouves des plans.\x07Rapporte-les moi, alors je te croirai peut-\xc3\xaatre."}, 
   3254: {QUEST: "Encore toi, hein ? Des plans? Tu les as?\x07Laisse-moi regarder \xc3\xa7a! Hmmm... Une usine ?\x07Ce doit \xc3\xaatre l\xc3\xa0 qu'ils fabriquent les Vendibots... Et qu'est-ce que c'est que \xc3\xa7a?\x07Oui, exactement ce que je pensais. Je le savais depuis le d\xc3\xa9part.\x07Ils sont en train de construire un quartier g\xc3\xa9n\xc3\xa9ral des Cogs Vendibots.\x07Ce n'est pas bon signe. Je dois passer quelques appels. Tr\xc3\xa8s occup\xc3\xa9. Au revoir!\x07Hein ? Oh oui, retourne ces plans \xc3\xa0 la d\xc3\xa9tective Lima.\x07Elle saura les lire mieux que quiconque.", 
          COMPLETE: "Qu'a dit le Juge Ticot ?\x07On avait raison ? Oh non. Regardons ces plans.\x07Hmmm... On dirait que les Vendibots ont install\xc3\xa9 une usine avec l'outillage pour construire des Cogs.\x07\xc3\x87a a l'air tr\xc3\xa8s dangereux. N'y va pas tant que tu n'as pas plus de rigolpoints.\x07Quand tu auras plus de rigolpoints, nous en aurons beaucoup \xc3\xa0 apprendre sur le quartier g\xc3\xa9n\xc3\xa9ral des Vendibots.\x07Pour l'instant, bon travail, voil\xc3\xa0 ta r\xc3\xa9compense."}, 
   3255: {QUEST: "_toNpcName_ est en train d'enqu\xc3\xaater sur le quartier g\xc3\xa9n\xc3\xa9ral des Vendibots.\x07Va voir si tu peux donner un coup de main._where_"}, 
   3256: {QUEST: "_toNpcName_ est en train d'enqu\xc3\xaater sur le quartier g\xc3\xa9n\xc3\xa9ral des Vendibots.\x07Va voir si tu peux donner un coup de main._where_"}, 
   3257: {QUEST: "_toNpcName_ est en train d'enqu\xc3\xaater sur le quartier g\xc3\xa9n\xc3\xa9ral des Vendibots.\x07Va voir si tu peux lui donner un coup de main._where_"}, 
   3258: {QUEST: "Personne ne sait au juste ce que les Cogs sont en train de faire dans leur nouveau quartier g\xc3\xa9n\xc3\xa9ral.\x07J'ai besoin que tu nous ram\xc3\xa8nes des informations venant directement d'eux.\x07Si nous pouvons trouver quatre notes de service internes des Vendibots \xc3\xa0 l'int\xc3\xa9rieur de leur quartier g\xc3\xa9n\xc3\xa9ral, cela mettrait un peu les choses au clair.\x07Ram\xc3\xa8ne-moi la premi\xc3\xa8re note de service que tu pourras afin qu'on en sache un peu plus."}, 
   3259: {QUEST: 'Super! Voyons ce que dit cette note de service...\x07"A l\'attention des Vendibots :\x07Je serai dans mon bureau tout en haut des Tours Vendibot pour faire monter en grade les Cogs. \x07Lorsque vous aurez gagn\xc3\xa9 suffisamment de m\xc3\xa9rites, montez me voir par l\'ascenseur du hall.\x07La pause est termin\xc3\xa9e - tout le monde au travail!"\x07Sign\xc3\xa9, Vice-Pr\xc3\xa9sident des Vendibots"\x07Aah.... Flippy sera content de voir \xc3\xa7a. Je lui envoie \xc3\xa7a tout de suite.\x07Va chercher une seconde note de service et rapporte-la moi.'}, 
   3260: {QUEST: 'Oh, bien, tu es de retour. Voyons ce que tu as trouv\xc3\xa9....\x07"A l\'attention des Vendibots :\x07Les Tours Vendibot ont \xc3\xa9t\xc3\xa9 \xc3\xa9quip\xc3\xa9es d\'un nouveau syst\xc3\xa8me de s\xc3\xa9curit\xc3\xa9 pour emp\xc3\xaacher les Toons de p\xc3\xa9n\xc3\xa9trer \xc3\xa0 l\'int\xc3\xa9rieur.\x07Les Toons qui seront attrap\xc3\xa9s dans les Tours Vendibot seront retenus pour interrogatoire.\x07Veuillez en discuter dans le hall autour d\'un ap\xc3\xa9ritif.\x07Sign\xc3\xa9, Le Circulateur "\x07Tr\xc3\xa8s int\xc3\xa9ressant... Je communique l\'information imm\xc3\xa9diatement.\x07S\'il te pla\xc3\xaet, rapporte-moi une troisi\xc3\xa8me note de service.'}, 
   3261: {QUEST: 'Excellent travail, _avName_! Que dit cette note de service ?\x07"A l\'attention des Vendibots :\x07Les Toons sont parvenus \xc3\xa0 trouver une fa\xc3\xa7on d\'infiltrer les Tours Vendibot.\x07Je vous appellerai ce soir pendant le d\xc3\xaener pour vous donner des d\xc3\xa9tails.\x07Sign\xc3\xa9, T\xc3\xa9l\xc3\xa9vendeur"\x07Hmmm... Je me demande comment les Toons se sont infiltr\xc3\xa9s....\x07Rapporte-moi une note de service suppl\xc3\xa9mentaire et je crois que nous aurons assez d\'informations pour l\'instant.', 
          COMPLETE: 'Je savais que tu pouvais le faire! OK, voil\xc3\xa0 ce que dit la note de service....\x07"A l\'attention des Vendibots :\x07J\'ai d\xc3\xa9je\xc3\xbbn\xc3\xa9 avec M. Hollywood hier.\x07Il dit que le Vice-Pr\xc3\xa9sident est tr\xc3\xa8s occup\xc3\xa9 en ce moment.\x07Il ne prendra de rendez-vous qu\'avec les Cogs qui m\xc3\xa9ritent une promotion.\x07J\'allais oublier, Passetout joue au golf avec moi dimanche.\x07Sign\xc3\xa9, Cafteur"\x07Bon... _avName_, voil\xc3\xa0 qui est bien utile.\x07Voil\xc3\xa0 ta r\xc3\xa9compense.'}, 
   3262: {QUEST: "_toNpcName_ a de nouvelles informations \xc3\xa0 propos de l'usine du quartier g\xc3\xa9n\xc3\xa9ral Vendibot.\x07Va donc voir ce que c'est._where_"}, 
   3263: {GREETING: 'Salut, mon pote!', 
          QUEST: "Je suis Zucchini l'entra\xc3\xaeneur, mais tu peux simplement m'appeler Coach Z.\x07Je mets la gomme sur le squash et les \xc3\xa9tirements, si tu vois ce que je veux dire.\x07\xc3\x89coute, les Vendibots ont termin\xc3\xa9 une \xc3\xa9norme usine qui sort des Vendibots 24 heures sur 24.\x07Prends une \xc3\xa9quipe de potes Toons et va me r\xc3\xa9duire cette usine \xc3\xa0 n\xc3\xa9ant!\x07A l'int\xc3\xa9rieur du quartier g\xc3\xa9n\xc3\xa9ral Vendibot, cherche le tunnel qui m\xc3\xa8ne \xc3\xa0 l'usine puis monte par l'ascenseur de l'usine.\x07V\xc3\xa9rifie que tu as fait le plein de gags, de rigolpoints et que tu as quelques Toons costauds comme guides.\x07Va vaincre le contrema\xc3\xaetre dans l'usine pour ralentir la progression des Vendibots.\x07Ce sera une vraie s\xc3\xa9ance d'entra\xc3\xaenement, si tu vois ce que je veux dire.", 
          LEAVING: 'A plus, mon pote!', 
          COMPLETE: 'H\xc3\xa9 mon pote, bon boulot pour cette usine!\x07On dirait que tu as trouv\xc3\xa9 un morceau de costume de Cog.\x07Il doit venir de la cha\xc3\xaene de fabrication des Cogs.\x07\xc3\x87a peut \xc3\xaatre pratique. Continue \xc3\xa0 en ramasser quand tu as du temps de libre.\x07Peut-\xc3\xaatre que si tu r\xc3\xa9cup\xc3\xa8res un costume de Cog complet, \xc3\xa7a pourrait \xc3\xaatre utile \xc3\xa0 quelque chose....'}, 
   4001: {GREETING: '', 
          QUEST: 'Tu peux maintenant choisir la prochaine s\xc3\xa9rie de gags que tu veux apprendre.\x07Prends ton temps pour te d\xc3\xa9cider, et reviens quand tu auras choisi.', 
          INCOMPLETE_PROGRESS: 'Pense bien \xc3\xa0 ta d\xc3\xa9cision avant de choisir.', 
          INCOMPLETE_WRONG_NPC: 'Pense bien \xc3\xa0 ta d\xc3\xa9cision avant de choisir.', 
   ...
   4201: {GREETING: 'Salut!', 
          QUEST: "Je suis tr\xc3\xa8s emb\xc3\xaat\xc3\xa9 au sujet d'une vague de vols d'instruments.\x07Je fais une enqu\xc3\xaate parmi mes confr\xc3\xa8res commer\xc3\xa7ants.\x07Je vais peut-\xc3\xaatre pouvoir trouver une constante qui me permettra de r\xc3\xa9soudre ce cas.\x07Va voir Tina et demande-lui un inventaire des concertinas._where_"}, 
   4202: {QUEST: "Oui, j'ai parl\xc3\xa9 \xc3\xa0 Tom ce matin.\x07J'ai l'inventaire ici.\x07Tu vas lui apporter tout de suite, ok?_where_"}, 
   4203: {QUEST: 'Super! Et de un...\x07Maintenant va chercher celui de Yuki._where_'}, 
   4204: {QUEST: "Oh! L'inventaire!\x07J'avais compl\xc3\xa8tement oubli\xc3\xa9.\x07Je parie que je peux le faire le temps que tu aies vaincu 10 Cogs.\x07Repasse apr\xc3\xa8s \xc3\xa7a et je promets que ce sera pr\xc3\xaat.", 
          INCOMPLETE_PROGRESS: "31, 32... OUPS!\x07Tu m'as fait perdre mon compte!", 
          GREETING: ''}, 
   4205: {QUEST: "Ah, et voil\xc3\xa0.\x07Merci de m'avoir laiss\xc3\xa9 un peu de temps.\x07Emm\xc3\xa8ne \xc3\xa7a \xc3\xa0 Tom et dis-lui bonjour de ma part._where_"}, 
   4206: {QUEST: 'Hmm, tr\xc3\xa8s int\xc3\xa9ressant.\x07\xc3\x87a commence \xc3\xa0 ressembler \xc3\xa0 quelque chose.\x07OK, le dernier inventaire est celui de Fifi._where_'}, 
   4207: {QUEST: "Inventaire ?\x07Comment est-ce que je pourrais faire un inventaire sans formulaire ?\x07Va voir Cl\xc3\xa9ment de sol et demande-lui s'il en a un pour moi._where_", 
          INCOMPLETE_PROGRESS: 'Alors, ce formulaire ?'}, 
   4208: {QUEST: "Ah \xc3\xa7a oui j'ai un formulaire d'inventaire!\x07Mais c'est pas gratuit, tu vois.\x07Je vais te dire. Je te le vends pour une tarte \xc3\xa0 la cr\xc3\xa8me enti\xc3\xa8re.", 
          GREETING: 'Allez, mon petit!', 
          LEAVING: 'Chouette...', 
          INCOMPLETE_PROGRESS: "Une seule tranche c'est pas assez.\x07J'ai faim, mon petit! Je veux la tarte TOUTE ENTI\xc3\x88RE."}, 
   4209: {GREETING: '', 
          QUEST: 'Mmmm...\x07Super bon!\x07Voil\xc3\xa0 ton formulaire pour Fifi._where_'}, 
   4210: {GREETING: '', 
          QUEST: "Merci. \xc3\x87a va bien m'aider.\x07Voyons...violons: 2\x07\xc3\x87a y est! Et voil\xc3\xa0!", 
          COMPLETE: 'Bon travail, _avName_!\x07Je suis s\xc3\xbbr de pouvoir attraper ces voleurs maintenant.\x07On va pouvoir creuser cette affaire!'}, 
   4211: {QUEST: 'Dis donc, le Dr Tefaispasdebile appelle toutes les cinq minutes. Tu pourrais aller voir quel est son probl\xc3\xa8me ?_where_'}, 
   4212: {QUEST: "Houlala! Je suis content que le quartier g\xc3\xa9n\xc3\xa9ral des Toons ait fini par envoyer quelqu'un.\x07\xc3\x87a fait des jours que je n'ai pas vu un client.\x07Ce sont ces satan\xc3\xa9s Gobechiffres qui sont partout.\x07Je crois qu'ils enseignent une mauvaise hygi\xc3\xa8ne buccale \xc3\xa0 nos r\xc3\xa9sidents.\x07Va donc en vaincre dix et nous verrons si les affaires reprennent.", 
          INCOMPLETE_PROGRESS: 'Toujours pas de patients. Mais continue!'}, 
   4213: {QUEST: "Tu sais apr\xc3\xa8s tout peut-\xc3\xaatre que ce n'\xc3\xa9tait pas les Gobechiffres.\x07Peut-\xc3\xaatre que ce sont simplement les Caissbots en g\xc3\xa9n\xc3\xa9ral.\x07D\xc3\xa9barrasse-nous de vingt d'entre eux et j'esp\xc3\xa8re que quelqu'un viendra au moins pour un bilan de sant\xc3\xa9.", 
          INCOMPLETE_PROGRESS: 'Je sais que vingt \xc3\xa7a fait beaucoup. Mais je suis certain que \xc3\xa7a va rapporter des tonnes.'}, 
   4214: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Je ne comprends rien du tout!\x07Toujours pas un SEUL client.\x07Peut-\xc3\xaatre qu'on devrait remonter jusqu'\xc3\xa0 la source.\x07Essaie de reprendre un b\xc3\xa2timent Cog Caissbot.\x07\xc3\x87a devrait faire l'affaire...", 
          INCOMPLETE_PROGRESS: "Oh, s'il te pla\xc3\xaet! Juste un tout petit b\xc3\xa2timent...", 
          COMPLETE: "Toujours personne.\x07Mais tu vois, maintenant que j'y pense.\x07Je n'avais pas non plus de clients avant l'invasion des Cogs!\x07Je te remercie quand m\xc3\xaame beaucoup pour ton aide.\x07Cela devrait te rendre service."}, 
   4215: {QUEST: "Anna a d\xc3\xa9sesp\xc3\xa9r\xc3\xa9ment besoin de quelqu'un pour l'aider.\x07Pourquoi ne vas-tu pas voir ce que tu peux faire ?_where_"}, 
   4216: {QUEST: "Merci d'\xc3\xaatre l\xc3\xa0 aussi vite!\x07On dirait que les Cogs sont partis avec les tickets de croisi\xc3\xa8re de plusieurs de mes clients.\x07Yuki a dit qu'elle avait vu un Passetout sortir d'ici avec des tickets plein les mains.\x07Va voir si tu peux retrouver le ticket pour l'Alaska de Jack B\xc3\xbbcheron.", 
          INCOMPLETE_PROGRESS: "Ces Passetouts pourraient \xc3\xaatre n'importe o\xc3\xb9 maintenant..."}, 
   4217: {QUEST: "Oh, super. Tu l'as trouv\xc3\xa9!\x07Puisque je peux compter sur toi, va le porter \xc3\xa0 Jack pour moi, tu veux bien ?_where_"}, 
   4218: {QUEST: "Tralala!\x07Alaska, me voil\xc3\xa0!\x07Je ne peux plus supporter ces Cogs infernaux.\x07Dis donc, je crois qu'Anna a encore besoin de toi._where_"}, 
   4219: {QUEST: "Ouais, tu as devin\xc3\xa9.\x07J'aurais besoin que tu secoues ces satan\xc3\xa9s Passetouts pour r\xc3\xa9cup\xc3\xa9rer le ticket de Tabatha pour la f\xc3\xaate du Jazz.\x07Tu sais comment \xc3\xa7a marche...", 
          INCOMPLETE_PROGRESS: "Il y en a d'autres qui r\xc3\xb4dent..."}, 
   4220: {QUEST: 'Adorable!\x07Tu peux lui emmener \xc3\xa7a pour moi aussi?_where_'}, 
   4221: {GREETING: '', 
          LEAVING: 'Sois sympa...', 
          QUEST: "Super, mon petit!\x07Maintenant je suis \xc3\xa0 la f\xc3\xaate, _avName_.\x07Avant de partir, tu ferais mieux d'aller voir Anna Banane encore une fois..._where_"}, 
   4222: {QUEST: "C'est la derni\xc3\xa8re fois, je te promets!\x07Maintenant tu vas chercher le ticket de Barry pour le concours de chant.", 
          INCOMPLETE_PROGRESS: 'Allez, _avName_.\x07Barry compte sur toi.'}, 
   4223: {QUEST: '\xc3\x87a devrait redonner le sourire \xc3\xa0 Barry._where_'}, 
   4224: {GREETING: '', 
          LEAVING: '', 
          QUEST: 'Bonjour, Bonjour, BONJOUR!\x07Super!\x07Je suis s\xc3\xbbr que les gars et moi on a va ramasser le gros lot cette ann\xc3\xa9e.\x07Anna demande que tu repasses la voir pour r\xc3\xa9cup\xc3\xa9rer ta r\xc3\xa9compense._where_\x07Au revoir, au revoir, AU REVOIR!', 
          COMPLETE: "Merci pour toute ton aide, _avName_.\x07Tu es vraiment un atout pour nous \xc3\xa0 Toontown.\x07En parlant d'atouts..."}, 
   902: {QUEST: "Va donc voir L\xc3\xa9o.\x07Il a besoin de quelqu'un pour porter un message._where_"}, 
   4903: {QUEST: "Pote!\x07Mes castagnettes sont toutes ternies et j'ai un grand spectacle ce soir. \x07Emporte-les donc \xc3\xa0 Carlos voir s'il peut me les faire reluire._where_"}, 
   4904: {QUEST: "Voui, y\xc3\xa9 crois que y\xc3\xa9 peux r\xc3\xa9luire \xc3\xa7a.\x07M\xc3\xa9 y\xc3\xa9 b\xc3\xa9zoin d'encre de seiche bleue.", 
   ...
   4905: {QUEST: "Voui! Souperr!\x07Ah\xc3\xb3ra y\xc3\xa9 b\xc3\xa9zoin d'un peu de temps pour r\xc3\xa9luire \xc3\xa7a.\x07Tou p\xc3\xa9 aller r\xc3\xa9coup\xc3\xa9rer un b\xc3\xa2timent de oun \xc3\xa9tage pendant qu\xc3\xa9 y\xc3\xa9 trravaille ?", 
          GREETING: '\xc2\xa1Hol\xc3\xa0!', 
          LEAVING: '\xc2\xa1Adi\xc3\xb3s!', 
          INCOMPLETE_PROGRESS: 'Oun pitite minute...'}, 
   4906: {QUEST: 'Trr\xc3\xa8s bien!\x07Voil\xc3\xa0 les castagnettes pour L\xc3\xa9o._where_'}, 
   4907: {GREETING: '', 
          QUEST: 'Super, mon petit!\x07Elles sont superbes!\x07Maintenant j\'ai besoin que tu me rapportes une copie des paroles de "Un No\xc3\xabl toon" de chez \xc3\x89lise._where_'}, 
   4908: {QUEST: "Hol\xc3\xa0 par ici!\x07Hmmm, je n'ai pas de copie de cette chanson.\x07Si tu me laisses un peu de temps je pourrai la retranscrire de m\xc3\xa9moire.\x07Pourquoi tu n'irais pas faire un tour et reprendre un b\xc3\xa2timent de deux \xc3\xa9tages pendant que j'\xc3\xa9cris?"}, 
   4909: {QUEST: 'Je suis d\xc3\xa9sol\xc3\xa9e.\x07Ma m\xc3\xa9moire est un peu floue.\x07Si tu vas reprendre un b\xc3\xa2timent de trois \xc3\xa9tages, je suis s\xc3\xbbre que ce sera fait quand tu reviendras...'}, 
   4910: {QUEST: "\xc3\x87a y est!\x07D\xc3\xa9sol\xc3\xa9e d'avoir mis si longtemps.\x07Rapporte-\xc3\xa7a \xc3\xa0 L\xc3\xa9o._where_", 
          GREETING: '', 
          COMPLETE: 'G\xc3\xa9nial, mon petit!\x07Mon concert va casser la baraque!\x07A propos de casser, tu pourras utiliser \xc3\xa7a sur quelques Cogs...'}, 
   5247: {QUEST: "Le quartier est assez chaud...\x07Tu pourrais avoir besoin d'apprendre quelques nouveaux trucs.\x07_toNpcName_ m'a appris tout ce que je sais, il peut peut-\xc3\xaatre t'aider aussi._where_"}, 
   5248: {GREETING: 'Ahh, oui.', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu as l'air d'avoir des difficult\xc3\xa9s avec cette mission.", 
          QUEST: "Aah, bienvenue, nouvel apprenti.\x07Je sais tout ce qu'on peut savoir \xc3\xa0 propos du jeu de tartes.\x07Mais avant qu'on ne commence ton entra\xc3\xaenement, une petite d\xc3\xa9monstration s'impose.\x07Va donc faire un tour et vaincre dix des plus gros Cogs."}, 
   5249: {GREETING: 'Mmmmm.', 
          QUEST: "Excellent!\x07Maintenant tu vas nous montrer ce que tu sais faire \xc3\xa0 la p\xc3\xaache.\x07J'ai fait tomber trois d\xc3\xa9s en peluche dans la mare hier.\x07Va-les p\xc3\xaacher et rapporte-les moi.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "On dirait que tu n'es pas si habile avec la canne et le moulinet."}, 
   5250: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Aah! Ces d\xc3\xa9s auront l'air super, accroch\xc3\xa9s au r\xc3\xa9troviseur de ma bagnole!\x07Maintenant, montre-moi que tu peux distinguer tes ennemis les uns des autres.\x07Reviens quand tu auras repris deux des plus grands b\xc3\xa2timents Loibot.", 
          INCOMPLETE_PROGRESS: 'Est-ce que tu as des difficult\xc3\xa9s avec ces b\xc3\xa2timents?'}, 
   5258: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Aah! Ces d\xc3\xa9s auront l'air super, accroch\xc3\xa9s au r\xc3\xa9troviseur de ma bagnole!\x07Maintenant, montre-moi que tu peux distinguer tes ennemis les uns des autres.\x07Reviens quand tu auras repris deux des plus grands b\xc3\xa2timents Chefbot.", 
          INCOMPLETE_PROGRESS: 'Est-ce que tu as des difficult\xc3\xa9s avec ces b\xc3\xa2timents?'}, 
   5259: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Aah! Ces d\xc3\xa9s auront l'air super, accroch\xc3\xa9s au r\xc3\xa9troviseur de ma bagnole!\x07Maintenant, montre-moi que tu peux distinguer tes ennemis les uns des autres.\x07Reviens quand tu auras repris deux des plus grands b\xc3\xa2timents Caissbot.", 
          INCOMPLETE_PROGRESS: 'Est-ce que tu as des difficult\xc3\xa9s avec ces b\xc3\xa2timents?'}, 
   5260: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Aah! Ces d\xc3\xa9s auront l'air super, accroch\xc3\xa9s au r\xc3\xa9troviseur de ma bagnole!\x07Maintenant, montre-moi que tu peux distinguer tes ennemis les uns des autres.\x07Reviens quand tu auras repris deux des plus grands b\xc3\xa2timents Vendibot.", 
          INCOMPLETE_PROGRESS: 'Est-ce que tu as des difficult\xc3\xa9s avec ces b\xc3\xa2timents?'}, 
   5200: {QUEST: 'Ces faux-jetons de Cogs font encore des leurs.\x07_toNpcName_ vient de signaler un autre objet disparu. Va voir si tu peux r\xc3\xa9gler cela._where_'}, 
   5201: {GREETING: '', 
          QUEST: "Salut, _avName_. Je sais que je devrais te remercier d'\xc3\xaatre venu.\x07Un groupe de ces Chasset\xc3\xaates est venu et a vol\xc3\xa9 mon ballon de foot.\x07Le chef m'a dit que je devais faire des \xc3\xa9conomies et me l'a arrach\xc3\xa9!\x07Peux-tu me rapporter mon ballon ?", 
          LEAVING: '', 
   ...
   5261: {GREETING: '', 
          QUEST: "Salut, _avName_. Je sais que je devrais te remercier d'\xc3\xaatre l\xc3\xa0.\x07Un groupe de ces Bifaces est venu et a vol\xc3\xa9 mon ballon de foot.\x07Le chef m'a dit que je devais faire des \xc3\xa9conomies et me l'a arrach\xc3\xa9!\x07Peux-tu me rapporter mon ballon ?", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Est-ce que tu as retrouv\xc3\xa9 mon ballon de foot ?', 
          COMPLETE: "Youpiii! Tu l'as trouv\xc3\xa9! Tiens, prends ta r\xc3\xa9compense..."}, 
   5262: {GREETING: '', 
          QUEST: "Salut, _avName_. Je sais que je devrais te remercier d'\xc3\xaatre l\xc3\xa0.\x07Un groupe de ces Sacasous est venu et a vol\xc3\xa9 mon ballon de foot.\x07Le chef m'a dit que je devais faire des \xc3\xa9conomies et me l'a arrach\xc3\xa9!\x07Peux-tu me rapporter mon ballon ?", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Est-ce que tu as retrouv\xc3\xa9 mon ballon de foot ?', 
          COMPLETE: "Youpiii! Tu l'as trouv\xc3\xa9! Tiens, prends ta r\xc3\xa9compense..."}, 
   5263: {GREETING: '', 
          QUEST: "Salut, _avName_. Je sais que je devrais te remercier d'\xc3\xaatre l\xc3\xa0.\x07Un groupe de ces Tournegris est venu et a vol\xc3\xa9 mon ballon de foot.\x07Le chef m'a dit que je devais faire des \xc3\xa9conomies et me l'a arrach\xc3\xa9!\x07Peux-tu me rapporter mon ballon ?", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Est-ce que tu as retrouv\xc3\xa9 mon ballon de foot ?', 
          COMPLETE: "Youpiii! Tu l'as trouv\xc3\xa9! Tiens, prends ta r\xc3\xa9compense..."}, 
   5202: {QUEST: "Le Glagla a \xc3\xa9t\xc3\xa9 envahi par des Cogs parmi les plus robustes qu'on ait vus.\x07Tu auras probablement besoin d'emporter plus de gags l\xc3\xa0-bas.\x07J'ai entendu dire que _toNpcName_ pourrait te pr\xc3\xaater un grand sac pour emporter plus de gags._where_"}, 
   5203: {GREETING: 'Eh? Tu es dans mon \xc3\xa9quipe de luge ?', 
          QUEST: "Qu'est-ce que c'est ? Tu veux un sac?\x07J'en avais un par l\xc3\xa0...peut-\xc3\xaatre qu'il est dans ma luge ?\x07Mais c'est que... Je n'ai pas vu ma luge depuis la grande course!\x07Peut-\xc3\xaatre qu'un de ces Cogs l'a prise ?", 
   ...
   5204: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Est-ce que c'est ma luge ? Je ne vois pas de sac par ici.\x07Je crois que Boris Tourne \xc3\xa9tait dans l'\xc3\xa9quipe...c'est peut-\xc3\xaatre lui qui l'a?_where_"}, 
   5205: {GREETING: 'Oooh, ma t\xc3\xaate!', 
          LEAVING: '', 
          QUEST: "Hein ? Ted qui? Un sac?\x07Ah, peut-\xc3\xaatre qu'il \xc3\xa9tait dans notre \xc3\xa9quipe ?\x07J'ai tellement mal \xc3\xa0 la t\xc3\xaate que je n'arrive plus \xc3\xa0 r\xc3\xa9fl\xc3\xa9chir.\x07Pourrais-tu aller me p\xc3\xaacher des gla\xc3\xa7ons dans la mare gel\xc3\xa9e pour ma t\xc3\xaate ?", 
          INCOMPLETE_PROGRESS: 'A\xc3\xafe, ma t\xc3\xaate me fait mal! Tu as de la glace ?'}, 
   5206: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Aah, ma t\xc3\xaate va beaucoup mieux!\x07Alors tu cherches le sac de Ted, hein ?\x07Je crois qu'il a atterri sur la t\xc3\xaate de Sam Simiesque apr\xc3\xa8s l'accident._where_"}, 
   5207: {GREETING: 'H\xc3\xa9-ho!', 
          LEAVING: '', 
          QUEST: "Quoi c'est \xc3\xa7a un sac? Qui c'est \xc3\xa7a Bouris?\x07Moi avoir peur b\xc3\xa2timents! Toi battre b\xc3\xa2timents, moi te donner sac!", 
          INCOMPLETE_PROGRESS: 'Encore b\xc3\xa2timents! Moi encore peur!', 
          COMPLETE: "Ooooh! Moi t'aime!"}, 
   5208: {GREETING: '', 
          LEAVING: 'Hein!', 
          QUEST: "Ooooh! Moi t'aime!\x07Va Atelier de ski. Sac l\xc3\xa0-bas."}, 
   5209: {GREETING: 'Pote!', 
          LEAVING: "'plus!", 
          QUEST: 'Bon sang, ce Sam Simiesque est fou!\x07Si tu es aussi malade que Sam, je te donne ton sac.\x07Va d\xc3\xa9molir des Cogs pour ton sac, mon pote! Salut!', 
          INCOMPLETE_PROGRESS: "Es-tu certain(e) d'\xc3\xaatre au point ? Va donc d\xc3\xa9molir plus de Cogs.", 
          COMPLETE: "Ouah! T'es vachement chouette! C'est un sacr\xc3\xa9 tas de Cogs que tu as bousill\xc3\xa9s!\x07Voil\xc3\xa0 ton sac!"}, 
   5210: {QUEST: "_toNpcName_ aime quelqu'un du quartier en secret.\x07Si tu l'aides, elle pourrait te donner une belle r\xc3\xa9compense._where_"}, 
   5211: {GREETING: 'Bouhouhou.', 
          QUEST: "J'ai pass\xc3\xa9 toute la nuit derni\xc3\xa8re \xc3\xa0 \xc3\xa9crire une lettre au chien que j'aime.\x07Mais avant que je puisse l'envoyer, un de ces m\xc3\xa9chants Cogs avec un bec me l'a d\xc3\xa9rob\xc3\xa9e.\x07Peux-tu me la rapporter ?", 
          LEAVING: 'Bouhouhou.', 
          INCOMPLETE_PROGRESS: "S'il te pla\xc3\xaet, retrouve ma lettre."}, 
   5264: {GREETING: 'Bouhouhou.', 
          QUEST: "J'ai pass\xc3\xa9 toute la nuit derni\xc3\xa8re \xc3\xa0 \xc3\xa9crire une lettre au chien que j'aime.\x07Mais avant que je puisse l'envoyer, un de ces m\xc3\xa9chants Cogs avec un aileron me l'a d\xc3\xa9rob\xc3\xa9e.\x07Peux-tu me la rapporter ?", 
          LEAVING: 'Bouhouhou.', 
          INCOMPLETE_PROGRESS: "S'il te pla\xc3\xaet, retrouve ma lettre."}, 
   5265: {GREETING: 'Bouhouhou.', 
          QUEST: "J'ai pass\xc3\xa9 toute la nuit derni\xc3\xa8re \xc3\xa0 \xc3\xa9crire une lettre au chien que j'aime.\x07Mais avant que je puisse l'envoyer, un de ces m\xc3\xa9chants Cogs Circulateurs me l'a d\xc3\xa9rob\xc3\xa9e.\x07Peux-tu me la rapporter ?", 
          LEAVING: 'Bouhouhou.', 
          INCOMPLETE_PROGRESS: "S'il te pla\xc3\xaet, retrouve ma lettre."}, 
   5266: {GREETING: 'Bouhouhou.', 
          QUEST: "J'ai pass\xc3\xa9 toute la nuit derni\xc3\xa8re \xc3\xa0 \xc3\xa9crire une lettre au chien que j'aime.\x07Mais avant que je puisse l'envoyer, un de ces m\xc3\xa9chants Cogs Attactics me l'a d\xc3\xa9rob\xc3\xa9e.\x07Peux-tu me la rapporter ?", 
          LEAVING: 'Bouhouhou.', 
          INCOMPLETE_PROGRESS: "S'il te pla\xc3\xaet, retrouve ma lettre."}, 
   5212: {QUEST: "Oh, merci d'avoir retrouv\xc3\xa9 ma lettre!\x07S'il te pla\xc3\xaet, peux-tu la remettre au plus beau chien du quartier ?", 
          GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu n'as pas remis ma lettre, n'est-ce pas?"}, 
   5213: {GREETING: 'Charm\xc3\xa9, certainement.', 
          QUEST: "Je ne peux pas m'occuper de ta lettre, tu vois.\x07Tous mes chiots m'ont \xc3\xa9t\xc3\xa9 pris!\x07Si tu les ram\xc3\xa8nes, peut-\xc3\xaatre qu'on pourra parler.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Mes pauvres petits chiots!'}, 
   5214: {GREETING: '', 
          LEAVING: 'Youhouuu!', 
          QUEST: "Merci de m'avoir rapport\xc3\xa9 mes petits choux.\x07Regardons cette lettre maintenant...Mmmm, il semblerait que j'ai une autre admiratrice secr\xc3\xa8te.\x07Il est temps de rendre visite \xc3\xa0 mon cher ami Carl.\x07Tu l'aimeras beaucoup, c'est certain._where_"}, 
   5215: {GREETING: 'H\xc3\xa9, h\xc3\xa9...', 
          LEAVING: 'Reviens, oui, oui.', 
          INCOMPLETE_PROGRESS: "Il y en a encore des gros par ici. Reviens nous voir quand il n'y en aura plus.", 
          QUEST: "Qui est-ce qui t'envoie ? On aime pas trop les b\xc3\xaacheurs, non...\x07Mais on aime encore moins les Cogs...\x07D\xc3\xa9barrasse-nous donc des gros et on t'aidera, oui on t'aidera."}, 
   5216: {QUEST: "On t'avait bien dit qu'on t'aiderait.\x07Tu peux emmener cette bague \xc3\xa0 la fille.", 
          GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Tu as encore la bague ???', 
          COMPLETE: "Oh, tu es un amour!!! Merci!!!\x07Oh, et j'ai quelque chose de sp\xc3\xa9cial pour toi aussi."}, 
   ...
   5218: {GREETING: '', 
          ...
          QUEST: "A l'aide!!! A l'aide!!! Je n'en peux plus!\x07Ces Circulateurs me rendent dingue!!!"}, 
   5219: {GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Ce n'est pas possible qu'il n'y ait que \xc3\xa7a. Je viens d'en voir un!!!", 
          QUEST: "Oh, merci, mais maintenant ce sont les Attactics!!!\x07Il faut que tu m'aides!!!"}, 
   5220: {GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Non, non, il y en avait un juste l\xc3\xa0!', 
          QUEST: 'Je r\xc3\xa9alise maintenant que ce sont les Usuriers!!!\x07Je croyais que tu allais me sauver!!!'}, 
   5221: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Tu sais quoi, peut-\xc3\xaatre finalement que ce ne sont pas du tout les Cogs!!!\x07Pourrais-tu demander \xc3\xa0 Ga\xc3\xablle de me pr\xc3\xa9parer une potion calmante ? \xc3\x87a m'aiderait peut-\xc3\xaatre...._where_"}, 
   5222: {LEAVING: '', 
          QUEST: "Oh, ce Harry, c'est quelqu'un!\x07Je vais concocter quelque chose qui le remettra sur pied!\x07Bon, on dirait que je n'ai plus de moustaches de sardine...\x07Sois un ange et cours \xc3\xa0 la mare m'en attraper.", 
          INCOMPLETE_PROGRESS: 'Tu les as, ces moustaches de sardine ?'}, 
   5223: {QUEST: 'OK. Merci, mon ange.\x07Voil\xc3\xa0, maintenant porte \xc3\xa7a \xc3\xa0 Harry. \xc3\x87a devrait le calmer tout de suite.', 
          GREETING: '', 
          LEAVING: '', 
   ...
   5224: {GREETING: '', 
          ...
          QUEST: "Oh merci mon Dieu tu es de retour!\x07Donne-moi la potion, vite!!!\x07Glou, glou, glou...\x07Berk, c'est d\xc3\xa9go\xc3\xbbtant!!\x07Mais tu sais quoi? Je me sens bien plus calme. Maintenant que j'ai les id\xc3\xa9es claires, je r\xc3\xa9alise que...\x07C'est les Avocageots qui me rendaient malade pendant tout ce temps!!!", 
          COMPLETE: "Bon sang! Maintenant je peux me d\xc3\xa9tendre!\x07J'ai s\xc3\xbbrement quelque chose \xc3\xa0 te donner. Oh, prends \xc3\xa7a!"}, 
   5225: {QUEST: "Depuis l'incident avec le pain de navets, Phil \xc3\x89lectrique est furieux apr\xc3\xa8s _toNpcName_.\x07Tu pourrais peut-\xc3\xaatre aider Paul \xc3\xa0 les r\xc3\xa9concilier ?_where_"}, 
   5226: {QUEST: "Ouais, tu as sans doute entendu dire que Phil \xc3\x89lectrique est furieux contre moi...\x07J'essayais juste d'\xc3\xaatre gentil avec ce pain de navets.\x07Peut-\xc3\xaatre que tu pourrais le remettre de bonne humeur.\x07Phil a horreur de ces Cogs Caissbots, surtout leurs b\xc3\xa2timents.\x07Si tu reprends des b\xc3\xa2timents Caissbot, \xc3\xa7a pourrait aider.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Peut-\xc3\xaatre quelques b\xc3\xa2timents de plus?'}, 
   5227: {QUEST: "C'est formidable! Va dire \xc3\xa0 Phil ce que tu as fait._where_"}, 
   5228: {QUEST: "Oh il a fait \xc3\xa7a?\x07Ce Paul croit qu'il peut s'en tirer comme \xc3\xa7a, hein ?\x07Il m'a cass\xc3\xa9 ma dent, oui, avec son fichu pain de navets!\x07Peut-\xc3\xaatre que si tu amenais ma dent au Dr Marmotter, il pourrait la r\xc3\xa9parer.", 
          GREETING: 'Mmmmrrphh.', 
          LEAVING: 'Grrr, grrr.', 
   ...
   5229: {GREETING: '', 
          ...
          QUEST: "Ah oui, cette dent est en mauvais \xc3\xa9tat, c'est s\xc3\xbbr.\x07Je peux peut-\xc3\xaatre faire quelque chose, mais \xc3\xa7a va mettre un moment.\x07Tu pourrais peut-\xc3\xaatre profiter de ce temps-l\xc3\xa0 pour d\xc3\xa9barrasser les rues de quelques Cogs Caissbots?\x07Ils effraient mes clients."}, 
   5267: {GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Je suis encore en train de travailler sur la dent. \xc3\x87a va \xc3\xaatre un peu plus long.', 
          QUEST: "Ah oui, cette dent est en mauvais \xc3\xa9tat, c'est s\xc3\xbbr.\x07Je peux peut-\xc3\xaatre faire quelque chose, mais \xc3\xa7a va mettre un moment.\x07Tu pourrais peut-\xc3\xaatre profiter de ce temps-l\xc3\xa0 pour d\xc3\xa9barrasser les rues de quelques Cogs Vendibots?\x07Ils effraient mes clients."}, 
   5268: {GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Je suis encore en train de travailler sur la dent. \xc3\x87a va \xc3\xaatre un peu plus long.', 
          QUEST: "Ah oui, cette dent est en mauvais \xc3\xa9tat, c'est s\xc3\xbbr.\x07Je peux peut-\xc3\xaatre faire quelque chose, mais \xc3\xa7a va mettre un moment.\x07Tu pourrais peut-\xc3\xaatre profiter de ce temps-l\xc3\xa0 pour d\xc3\xa9barrasser les rues de quelques Cogs Loibots?\x07Ils effraient mes clients."}, 
   5269: {GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Je suis encore en train de travailler sur la dent. \xc3\x87a va \xc3\xaatre un peu plus long.', 
          QUEST: "Ah oui, cette dent est en mauvais \xc3\xa9tat, c'est s\xc3\xbbr.\x07Je peux peut-\xc3\xaatre faire quelque chose, mais \xc3\xa7a va mettre un moment.\x07Tu pourrais peut-\xc3\xaatre profiter de ce temps-l\xc3\xa0 pour d\xc3\xa9barrasser les rues de quelques Cogs Chefbots?\x07Ils effraient mes clients."}, 
   5230: {GREETING: '', 
          QUEST: "Je suis content que tu sois revenu!\x07J'ai arr\xc3\xaat\xc3\xa9 d'essayer de r\xc3\xa9parer cette vieille dent, et j'ai fait une nouvelle dent en or pour Phil \xc3\xa0 la place.\x07Malheureusement un Pillard me l'a d\xc3\xa9rob\xc3\xa9e.\x07Tu peux peut-\xc3\xaatre le rattraper si tu cours.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu l'as retrouv\xc3\xa9e, cette dent ?"}, 
   5270: {GREETING: '', 
          QUEST: "Je suis content que tu sois revenu(e)!\x07J'ai arr\xc3\xaat\xc3\xa9 d'essayer de r\xc3\xa9parer cette vieille dent, et j'ai fait une nouvelle dent en or pour Phil \xc3\xa0 la place.\x07Malheureusement un Gros Blochon me l'a d\xc3\xa9rob\xc3\xa9e.\x07Tu peux peut-\xc3\xaatre le rattraper si tu cours.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu l'as retrouv\xc3\xa9e, cette dent ?"}, 
   5271: {GREETING: '', 
          QUEST: "Je suis content que tu sois revenu(e)!\x07J'ai arr\xc3\xaat\xc3\xa9 d'essayer de r\xc3\xa9parer cette vieille dent, et j'ai fait une nouvelle dent en or pour Phil \xc3\xa0 la place.\x07Malheureusement M. Hollywood me l'a d\xc3\xa9rob\xc3\xa9e.\x07Tu peux peut-\xc3\xaatre le rattraper si tu cours.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu l'as retrouv\xc3\xa9e, cette dent ?"}, 
   5272: {GREETING: '', 
          QUEST: "Je suis content que tu sois revenu(e)!\x07J'ai arr\xc3\xaat\xc3\xa9 d'essayer de r\xc3\xa9parer cette vieille dent, et j'ai fait une nouvelle dent en or pour Phil \xc3\xa0 la place.\x07Malheureusement un Chouffleur me l'a d\xc3\xa9rob\xc3\xa9e.\x07Tu peux peut-\xc3\xaatre le rattraper si tu cours.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu l'as retrouv\xc3\xa9e, cette dent ?"}, 
   5231: {QUEST: 'Super, voil\xc3\xa0 la dent!\x07Pourquoi ne filerais-tu pas chez Phil pour lui porter ?', 
          GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Je parie que Phil serait content de voir sa nouvelle dent.'}, 
   5232: {QUEST: "Oh, merci.\x07Mmmrrrphhhh\x07\xc3\x87a a l'air de quoi, hein ?\x07OK, tu peux dire \xc3\xa0 Paul que je lui pardonne.", 
          LEAVING: '', 
          GREETING: ''}, 
   5233: {QUEST: "Oh, bonne nouvelle.\x07Je savais bien que ce vieux Phil ne pourrait pas rester f\xc3\xa2ch\xc3\xa9 contre moi.\x07Pour prouver ma bonne volont\xc3\xa9, je lui ai fait cuire ce pain de pommes de pin.\x07Pourrais-tu lui porter, s'il te pla\xc3\xaet ?", 
          GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Presse-toi donc. Le pain de pommes de pin est meilleur chaud.', 
          COMPLETE: "Oh, qu'est-ce que c'est que \xc3\xa7a? Pour moi?\x07Gromp, gromp...\x07A\xc3\xaf\xc3\xaf\xc3\xafa\xc3\xaf\xc3\xafe! Ma dent! Ce Paul Poulemouill\xc3\xa9e!\x07Oh, apr\xc3\xa8s tout ce n'est pas ta faute. Voil\xc3\xa0, prends \xc3\xa7a pour ta peine."}, 
   903: {QUEST: 'Tu dois te pr\xc3\xa9parer \xc3\xa0 voir _toNpcName_ le vieillard du blizzard pour ton test final._where_'}, 
   5234: {GREETING: '', 
          QUEST: 'Aha, te revoil\xc3\xa0.\x07Avant de commencer, nous devons manger.\x07Apporte-nous du fromage grumeleux pour notre bouillon.\x07Le fromage grumeleux ne se trouve que sur les Cogs Gros Blochons.', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Nous avons encore besoin de fromage grumeleux.'}, 
   5278: {GREETING: '', 
          QUEST: 'Aha, te revoil\xc3\xa0.\x07Avant de commencer, nous devons manger.\x07Apporte-nous du caviar pour notre bouillon.\x07Le caviar ne se trouve que dans les Cogs M. Hollywood.', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Nous avons encore besoin de caviar.'}, 
   5235: {GREETING: '', 
          QUEST: "Un homme ordinaire mange avec une cuill\xc3\xa8re ordinaire.\x07Un Cog a pris ma cuill\xc3\xa8re ordinaire, donc je ne peux tout simplement pas manger.\x07Ram\xc3\xa8ne-moi ma cuill\xc3\xa8re, je crois qu'un Pillard l'a prise.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "J'ai tout simplement besoin de ma cuill\xc3\xa8re."}, 
   5279: {GREETING: '', 
          QUEST: "Un homme ordinaire mange avec une cuill\xc3\xa8re ordinaire.\x07Un Cog a pris ma cuill\xc3\xa8re ordinaire, donc je ne peux tout simplement pas manger.\x07Ram\xc3\xa8ne-moi ma cuill\xc3\xa8re, je crois qu'un Chouffleur l'a prise.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "J'ai tout simplement besoin de ma cuill\xc3\xa8re."}, 
   5236: {GREETING: '', 
          QUEST: "Merci beaucoup.\x07Slurp, slurp...\x07Ahhh, maintenant tu dois attraper un crapaud parlant. Essaie d'en p\xc3\xaacher dans la mare.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'O\xc3\xb9 est ce crapaud parlant ?'}, 
   5237: {GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu n'as pas encore gagn\xc3\xa9 ton dessert.", 
          QUEST: "Oh, c'est vraiment un crapaud parlant. Donne-le moi.\x07Qu'est-ce que tu dis, crapaud?\x07Couac.\x07Couac.\x07Le crapaud a parl\xc3\xa9. Nous avons besoin de dessert.\x07Rapporte-nous des c\xc3\xb4nes de glace de chez _toNpcName_.\x07Le crapaud aime la glace aux haricots rouges pour une raison inconnue._where_"}, 
   5238: {GREETING: '', 
          QUEST: "Alors c'est le vieillard du blizzard qui t'envoie. Je dois dire qu'on vient de tomber en rupture de stock de c\xc3\xb4nes de glace aux haricots rouges.\x07Tu vois, un groupe de Cogs est venu et les a tous emport\xc3\xa9s.\x07Ils ont dit qu'ils \xc3\xa9taient pour M. Hollywood ou quelque chose comme \xc3\xa7a.\x07Je serais ravi si tu pouvais me les rapporter.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'As-tu d\xc3\xa9j\xc3\xa0 trouv\xc3\xa9 tous mes c\xc3\xb4nes de glace ?'}, 
   5280: {GREETING: '', 
          QUEST: "Alors c'est le vieillard du blizzard qui t'envoie. Je dois dire qu'on vient de tomber en rupture de stock de c\xc3\xb4nes de glace aux haricots rouges.\x07Tu vois, un groupe de Cogs est venu et les a tous emport\xc3\xa9s.\x07Ils ont dit qu'ils \xc3\xa9taient pour le Gros Blochon ou quelque chose comme \xc3\xa7a.\x07Je serais ravi si tu pouvais me les rapporter.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'As-tu trouv\xc3\xa9 tous mes c\xc3\xb4nes de glace ?'}, 
   5239: {QUEST: "Merci de m'avoir rapport\xc3\xa9 mes c\xc3\xb4nes de glace!\x07En voil\xc3\xa0 un pour Allan Bic.", 
          GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Tu ferais mieux de porter cette glace \xc3\xa0 Allan Bic avant qu'elle ne fonde."}, 
   5240: {GREETING: '', 
          QUEST: "Tr\xc3\xa8s bien. Et voil\xc3\xa0 mon petit crapaud...\x07Slurp, slurp...\x07OK, maintenant nous sommes presque pr\xc3\xaats.\x07Si tu pouvais juste m'apporter de la poudre pour s\xc3\xa9cher mes mains.\x07Je pense que ces Cogs Chouffleurs ont quelquefois de la poudre dans leurs perruques.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'As-tu trouv\xc3\xa9 de la poudre ?'}, 
   5281: {GREETING: '', 
          QUEST: "Tr\xc3\xa8s bien. Et voil\xc3\xa0 mon petit crapaud...\x07Slurp, slurp...\x07OK, maintenant nous sommes presque pr\xc3\xaats.\x07Si tu pouvais juste m'apporter de la poudre pour s\xc3\xa9cher mes mains.\x07Je crois que ces Cogs M. Hollywood ont quelquefois de la poudre pour se poudrer le nez.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'As-tu trouv\xc3\xa9 de la poudre ?'}, 
   5241: {QUEST: "OK.\x07Comme je l'ai d\xc3\xa9j\xc3\xa0 dit, pour bien lancer une tarte, tu ne dois pas la lancer avec la main...\x07...mais avec ton \xc3\xa2me.\x07Je ne sais pas ce que cela veut dire, alors je vais m'asseoir et r\xc3\xa9fl\xc3\xa9chir pendant que tu r\xc3\xa9cup\xc3\xa8res des b\xc3\xa2timents.\x07Reviens quand tu as termin\xc3\xa9 ton d\xc3\xa9fi.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Ton d\xc3\xa9fi n'est pas termin\xc3\xa9."}, 
   5242: {GREETING: '', 
          QUEST: "Bien que je ne sache toujours pas de quoi je suis en train de parler, tu es vraiment quelqu'un de valeur.\x07Je te donne un dernier d\xc3\xa9fi...\x07Le crapaud parlant voudrait une petite amie.\x07Trouve un autre crapaud parlant. Le crapaud a parl\xc3\xa9.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'O\xc3\xb9 est cet autre crapaud parlant ?', 
          COMPLETE: "Houlala! Je suis fatigu\xc3\xa9 par tous ces efforts. Je dois me reposer maintenant.\x07Tiens, prends ta r\xc3\xa9compense et va t'en."}, 
   5243: {QUEST: 'Pierre Lasueur commence \xc3\xa0 empester dans la rue.\x07Peux-tu essayer de le convaincre de prendre une douche par exemple ?_where_'}, 
   5244: {GREETING: '', 
          QUEST: "Oui, je crois que je dois commencer \xc3\xa0 transpirer pas mal.\x07Mmmm, peut-\xc3\xaatre que si je pouvais r\xc3\xa9parer ce tuyau qui fuit dans ma douche...\x07Je crois qu'un pignon de l'un de ces tous petits Cogs ferait l'affaire.\x07Va trouver un pignon de Microchef et on va essayer.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'O\xc3\xb9 est ce pignon que tu \xc3\xa9tais parti chercher ?'}, 
   5245: {GREETING: '', 
          QUEST: 'Ouaip, on dirait que \xc3\xa7a va.\x07Mais je me sens seul quand je prends ma douche...\x07Pourrais-tu aller me p\xc3\xaacher un canard en plastique pour me tenir compagnie ?', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Alors ce canard?'}, 
   5246: {QUEST: "Le canard en plastique est g\xc3\xa9nial, mais...\x07Tous ces b\xc3\xa2timents tout autour me rendent nerveux.\x07Je me sentirais beaucoup plus d\xc3\xa9tendu s'il y avait moins de b\xc3\xa2timents.", 
          LEAVING: '', 
   ...
   5251: {QUEST: "S\xc3\xa9bastien Toutseul est cens\xc3\xa9 faire un concert ce soir.\x07J'ai entendu dire qu'il pourrait avoir des probl\xc3\xa8mes avec son mat\xc3\xa9riel._where_"}, 
   5252: {GREETING: '', 
          QUEST: "Oh ouais! S\xc3\xbbr que j'aurais besoin d'aide.\x07Ces Cogs sont arriv\xc3\xa9s et ont piqu\xc3\xa9 tout mon mat\xc3\xa9riel pendant que je d\xc3\xa9chargeais la camionnette.\x07Tu pourrais me donner un coup de main pour retrouver mon micro?", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'H\xc3\xa9 mon pote, je ne peux pas chanter sans micro.'}, 
   5253: {GREETING: '', 
          QUEST: "Ouais, c'est bien mon micro.\x07Merci de me l'avoir rapport\xc3\xa9, mais...\x07J'ai vraiment besoin de mon clavier pour chatouiller les touches.\x07Je crois qu'un de ces Attactics a pris mon clavier.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Alors, mon clavier ?'}, 
   5273: {GREETING: '', 
          QUEST: "Ouais, c'est bien mon micro.\x07Merci de me l'avoir rapport\xc3\xa9, mais...\x07J'ai vraiment besoin de mon clavier pour chatouiller les touches.\x07Je crois qu'un de ces Circulateurs a pris mon clavier.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Alors, mon clavier ?'}, 
   5274: {GREETING: '', 
          QUEST: "Ouais, c'est bien mon micro.\x07Merci de me l'avoir rapport\xc3\xa9, mais...\x07J'ai vraiment besoin de mon clavier pour chatouiller les touches.\x07Je crois qu'un de ces Usuriers a pris mon clavier.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Alors, mon clavier ?'}, 
   5275: {GREETING: '', 
          QUEST: "Ouais, c'est bien mon micro.\x07Merci de me l'avoir rapport\xc3\xa9, mais...\x07J'ai vraiment besoin de mon clavier pour chatouiller les touches.\x07Je crois qu'un de ces Avocageots a pris mon clavier.", 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Alors, mon clavier ?'}, 
   5254: {GREETING: '', 
          QUEST: "Tout va bien! Maintenant je peux travailler.\x07Si seulement ils n'avaient pas pris mes chaussures \xc3\xa0 plate-forme...\x07Je parie que mes chaussures sont s\xc3\xbbrement aux pieds d'un M Hollywood.", 
          LEAVING: '', 
          COMPLETE: "Tout va bien! Je suis pr\xc3\xaat maintenant.\x07Vous \xc3\xaates tous pr\xc3\xaats \xc3\xa0 mettre le feu dans le Glagla ce soir ?\x07Eh? O\xc3\xb9 sont-ils?\x07OK, prends \xc3\xa7a et ram\xc3\xa8ne-moi des fans, d'accord?", 
          INCOMPLETE_PROGRESS: 'Je ne peux pas faire mon spectacle pieds nus, si?'}, 
   5282: {GREETING: '', 
          QUEST: "Tout va bien! Maintenant je peux travailler.\x07Si seulement ils n'avaient pas pris mes chaussures \xc3\xa0 plate-forme...\x07Je parie que mes chaussures sont aux pieds d'un Gros Blochon.", 
          LEAVING: '', 
          COMPLETE: "Tout va bien! Je suis pr\xc3\xaat maintenant.\x07Vous \xc3\xaates tous pr\xc3\xaats \xc3\xa0 mettre le feu dans le Glagla ce soir ?\x07Eh? O\xc3\xb9 sont-ils?\x07OK, prends \xc3\xa7a et ram\xc3\xa8ne-moi des fans, d'accord?", 
          INCOMPLETE_PROGRESS: 'Je ne peux pas faire mon spectacle pieds nus, si?'}, 
   5283: {GREETING: '', 
          QUEST: "Tout va bien! Maintenant je peux travailler.\x07Si seulement ils n'avaient pas pris mes chaussures \xc3\xa0 plate-forme...\x07Je parie que mes chaussures sont aux pieds d'un Pillard.", 
          LEAVING: '', 
          COMPLETE: "Tout va bien! Je suis pr\xc3\xaat maintenant.\x07Vous \xc3\xaates tous pr\xc3\xaats \xc3\xa0 mettre le feu dans le Glagla ce soir ?\x07Eh? O\xc3\xb9 sont-ils?\x07OK, prends \xc3\xa7a et ram\xc3\xa8ne-moi des fans, d'accord?", 
          INCOMPLETE_PROGRESS: 'Je ne peux pas faire mon spectacle pieds nus, si?'}, 
   5284: {GREETING: '', 
          QUEST: "Tout va bien! Maintenant je peux travailler.\x07Si seulement ils n'avaient pas pris mes chaussures \xc3\xa0 plate-forme...\x07Je parie que mes chaussures sont aux pieds d'un Chouffleur.", 
          LEAVING: '', 
          COMPLETE: "Tout va bien! Je suis pr\xc3\xaat maintenant.\x07Vous \xc3\xaates tous pr\xc3\xaats \xc3\xa0 mettre le feu dans le Glagla ce soir ?\x07Eh? O\xc3\xb9 sont-ils?\x07OK, prends \xc3\xa7a et ram\xc3\xa8ne-moi des fans, d'accord?", 
          INCOMPLETE_PROGRESS: 'Je ne peux pas faire mon spectacle pieds nus, si?'}, 
   5255: {QUEST: "On dirait que tu as besoin de plus de rigolpoints.\x07Peut-\xc3\xaatre que tu pourrais passer un march\xc3\xa9 avec _toNpcName_.\x07V\xc3\xa9rifie que c'est fait par \xc3\xa9crit..._where_"}, 
   5256: {GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Un march\xc3\xa9 est un march\xc3\xa9.', 
          QUEST: "Alors comme \xc3\xa7a tu cherches des rigolpoints, hein ?\x07J'ai un march\xc3\xa9 pour toi!\x07Occupe-toi simplement de quelques Cogs Chefbots pour moi...\x07Et je te garantis que tu n'y perdras pas."}, 
   5276: {GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Un march\xc3\xa9 est un march\xc3\xa9.', 
          QUEST: "Alors comme \xc3\xa7a tu cherches des rigolpoints, hein ?\x07J'ai un march\xc3\xa9 pour toi!\x07Occupe-toi simplement de quelques Cogs Loibots pour moi...\x07Et je te garantis que tu n'y perdras pas."}, 
   5257: {GREETING: '', 
          LEAVING: '', 
          COMPLETE: "OK, mais je suis s\xc3\xbbr de t'avoir dit de ramasser des Cogs Loibots.\x07Bon, si tu le dis, mais tu m'es redevable.", 
          INCOMPLETE_PROGRESS: 'Je ne crois pas que tu aies fini.', 
          QUEST: "Tu dis que c'est fait ? Tu as vaincu tous les Cogs?\x07Tu as d\xc3\xbb mal comprendre, notre march\xc3\xa9 portait sur des Cogs Vendibots.\x07Je suis certain de t'avoir dit de me vaincre des Cogs Vendibots."}, 
   5277: {GREETING: '', 
          LEAVING: '', 
          COMPLETE: "OK, mais je suis s\xc3\xbbr de t'avoir dit de ramasser des Cogs Loibots.\x07Bon, si tu le dis, mais tu m'es redevable.", 
          INCOMPLETE_PROGRESS: 'Je ne crois pas que tu aies fini.', 
          QUEST: "Tu dis que c'est fait ? Tu as vaincu tous les Cogs?\x07Tu as d\xc3\xbb mal comprendre, notre march\xc3\xa9 portait sur des Cogs Caissbots.\x07Je suis certain de t'avoir dit de me vaincre des Cogs Caissbots."}, 
   5301: {QUEST: "Je ne peux pas t'aider pour les rigolpoints, mais peut-\xc3\xaatre que _toNpcName_ pourra t'arranger.\x07Attention: il est un peu caract\xc3\xa9riel..._where_"}, 
   5302: {GREETING: '', 
          LEAVING: '', 
          COMPLETE: "Je t'ai dit quoi?!?!\x07Merci bien! Voil\xc3\xa0 ton rigolpoint!", 
          INCOMPLETE_PROGRESS: "Salut!\x07Qu'est-ce que tu fais encore l\xc3\xa0?!", 
          QUEST: "Un rigolpoint? Je ne crois pas!\x07Sans probl\xc3\xa8me, mais il va d'abord falloir que tu me d\xc3\xa9barrasses de quelques-uns de ces fichus Loibots."}, 
   5303: {QUEST: lTheBrrrgh + " est envahi de Cogs tr\xc3\xa8s dangereux.\x07Si j'\xc3\xa9tais toi, j'irais l\xc3\xa0-bas avec plus de gags.\x07J'ai entendu dire que _toNpcName_ peut te faire un grand sac si tu n'as pas peur de marcher._where_"}, 
   5304: {GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Il devrait y avoir plein de Loibots par l\xc3\xa0-bas.\x07Alors, vas-y!', 
          QUEST: "Un sac plus grand?\x07Je pourrais s\xc3\xbbrement t'en coudre un en vitesse.\x07Mais je vais avoir besoin de fil.\x07Des Loibots m'ont vol\xc3\xa9 le mien hier matin."}, 
   5305: {GREETING: 'Coucou!', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Va donc chercher quelques Cogs de plus.\x07La couleur n'a pas encore pris.", 
          QUEST: "En voil\xc3\xa0 du beau fil!\x07Bon, ce n'est pas ma couleur pr\xc3\xa9f\xc3\xa9r\xc3\xa9e.\x07\xc3\x89coute-moi bien...\x07Tu vas l\xc3\xa0-bas et tu bousilles quelques-uns des Cogs les plus costauds...\x07Et pendant ce temps-l\xc3\xa0, je vais teindre ton fil."}, 
   5306: {GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Ils doivent bien \xc3\xaatre quelque part par l\xc3\xa0...', 
          QUEST: "Voil\xc3\xa0, le fil est teint. Mais nous avons un petit probl\xc3\xa8me.\x07Je n'arrive pas \xc3\xa0 trouver mes aiguilles \xc3\xa0 tricoter.\x07La derni\xc3\xa8re fois que je les ai vues, c'\xc3\xa9tait pr\xc3\xa8s de la mare."}, 
   5307: {GREETING: '', 
          LEAVING: 'Merci beaucoup!', 
          INCOMPLETE_PROGRESS: "Rome ne s'est pas tricot\xc3\xa9 en un jour!", 
          QUEST: 'Ce sont bien mes aiguilles.\x07Pendant que je tricote, va faire un peu de nettoyage de Cogs dans ces grands b\xc3\xa2timents.', 
          COMPLETE: 'Excellent travail!\x07Et en parlant de bon travail...\x07Voil\xc3\xa0 ton nouveau sac!'}, 
   5308: {GREETING: '', 
          LEAVING: '', 
          QUEST: "J'ai entendu dire que _toNpcName_ a des probl\xc3\xa8mes avec la justice.\x07Est-ce que tu pourrais aller le voir et lui demander?_where_"}, 
   5309: {GREETING: 'Je suis content de te voir...', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'D\xc3\xa9p\xc3\xaache-toi! La rue en est envahie!', 
          QUEST: "Les Loibots ont vraiment pris le pouvoir dans le quartier.\x07J'ai bien peur qu'ils ne me tra\xc3\xaenent en justice.\x07Tu pourrais pas les faire d\xc3\xa9gager de cette rue?"}, 
   5310: {GREETING: '', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: 'Je crois que je les entends qui viennent me chercher...', 
          QUEST: 'Merci. Je me sens un peu mieux.\x07 Mais il y a autre chose...\x07Est-ce que tu pourrais passer chez _toNpcName_ pour me trouver un alibi?_where_'}, 
   5311: {GREETING: 'HOUAAA!!!', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: "Je ne peux pas l'aider si tu n'en trouves pas!", 
          QUEST: "Un alibi?! G\xc3\xa9nial!\x07Tu n'en as pas une autre comme \xc3\xa7a?\x07Je parie qu'un Avocageot aurait..."}, 
   5312: {GREETING: 'Enfin!', 
          LEAVING: '', 
          INCOMPLETE_PROGRESS: '', 
          COMPLETE: "Houlala! Je suis vraiment soulag\xc3\xa9 d'avoir \xc3\xa7a.\x07Voil\xc3\xa0 ta r\xc3\xa9compense...", 
   ...
   6202: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Oh, un client! Super! Que puis-je faire pour toi?\x07Comment \xc3\xa7a, que peux-tu faire pour moi? OH! Tu n'es pas un client.\x07Je m'en souviens maintenant. Tu es l\xc3\xa0 pour m'aider avec ces affreux Cogs.\x07Eh bien, ton aide me sera certainement bien utile, m\xc3\xaame si tu n'es pas un client.\x07Si tu nettoies un peu les rues, je te r\xc3\xa9serve un petit quelque chose.", 
          ...
          COMPLETE: "Bon boulot avec ces Cogs, _avName_.\x07Tu es vraiment s\xc3\xbbr(e) que tu n'as pas besoin d'\xc3\xa9lectricit\xc3\xa9? \xc3\x87a pourrait t'\xc3\xaatre utile...\x07Non ? OK, comme tu voudras.\x07Quoi? Ah oui, je me souviens. Et voil\xc3\xa0. \xc3\x87a te sera s\xc3\xbbrement utile contre ces m\xc3\xa9chants Cogs.\x07Continue \xc3\xa0 bien travailler!"}, 
   6206: {QUEST: "Eh bien, _avName_, je n'ai rien pour toi pour le moment.\x07Attends! Je crois que Susan Sieste cherchait de l'aide. Pourquoi n'irais-tu pas la voir ?_where_"}, 
   6207: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Je ne serai jamais riche avec ces satan\xc3\xa9s Cogs qui ruinent mes affaires!\x07Il faut que tu m'aides, _avName_.\x07Nettoie quelques b\xc3\xa2timents Cog pour le bien de tout le voisinage et je te rendrai plus riche.", 
          INCOMPLETE_PROGRESS: 'Pauvre de moi! Tu ne peux pas te d\xc3\xa9barrasser de ces b\xc3\xa2timents?', 
          COMPLETE: "A moi la fortune! Je vois \xc3\xa7a d'ici!\x07Je passerai tout mon temps \xc3\xa0 la p\xc3\xaache. Maintenant, laisse-moi t'enrichir un peu.\x07Et voil\xc3\xa0!"}, 
   6211: {QUEST: "H\xc3\xa9 _avName_! J'ai entendu dire que Linda Kapok te cherchait.\x07Tu devrais passer lui rendre visite._where_"}, 
   6212: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Bonjour! Waouh, ce que je suis contente de te voir!\x07J'ai pass\xc3\xa9 mon temps \xc3\xa0 r\xc3\xa9parer ce r\xc3\xa9pondeur pendant mon temps libre mais il me manque des pi\xc3\xa8ces.\x07J'ai besoin de trois tiges suppl\xc3\xa9mentaires et celles des Pince Menus ont l'air de bien marcher.\x07Pourrais-tu m'en trouver quelques-unes?", 
          INCOMPLETE_PROGRESS: 'Toujours en train de chercher ces tiges?'}, 
   6213: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Oh, ces tiges iront tr\xc3\xa8s bien.\x07C'est dr\xc3\xb4le. J'\xc3\xa9tais s\xc3\xbbre d'avoir une courroie de rechange quelque part mais je n'arrive pas \xc3\xa0 la trouver.\x07Pourrais-tu m'en rapporter une de chez Sacasous, s'il te pla\xc3\xaet ? Merci!", 
          INCOMPLETE: "Non, je ne peux pas t'aider avant d'avoir cette courroie."}, 
   6214: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Voil\xc3\xa0, c'est \xc3\xa7a. Maintenant \xc3\xa7a devrait marcher comme sur des roulettes.\x07O\xc3\xb9 sont pass\xc3\xa9es mes pinces? Je ne peux pas fixer \xc3\xa7a sans mes pinces.\x07Peut-\xc3\xaatre qu'une tenaille de Radino ferait l'affaire ?\x07Si tu vas m'en chercher une, je te donnerai un petit quelque chose qui t'aidera contre les Cogs.", 
          INCOMPLETE_PROGRESS: 'Toujours pas de tenaille, hein ? Continue \xc3\xa0 chercher.', 
          COMPLETE: "G\xc3\xa9nial! Maintenant il ne me reste plus qu'\xc3\xa0 fixer tout \xc3\xa7a.\x07\xc3\x87a a l'air de marcher maintenant. Me voil\xc3\xa0 de retour aux affaires!\x07Euh, sauf que nous n'avons pas de t\xc3\xa9l\xc3\xa9phone. Mais merci quand m\xc3\xaame de ton aide.\x07Je pense que \xc3\xa7a t'aidera contre les Cogs. Bonne chance!"}, 
   6221: {QUEST: "J'ai entendu dire que Rocco avait besoin d'aide. Va voir ce que tu peux faire pour lui._where_"}, 
   6222: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Yo! Tu tombes \xc3\xa0 pic. Moi, \xc3\xa7a va pas mieux.\x07Ouais, j'aurais besoin d'un coup de main avec ces Cogs. Ils sont tout le temps l\xc3\xa0, \xc3\xa0 essayer de me donner des le\xc3\xa7ons.\x07Si tu pouvais mettre hors d'\xc3\xa9tat de nuire certains de ces Chefbots, je f'rais en sorte que t'aies pas perdu ton temps.", 
          INCOMPLETE_PROGRESS: "Eh, _avName_, qu'est-ce que tu fiches?\x07Faut qu'tu fasses la chasse \xc3\xa0 ces Chefbots. On a un accord, tu te rappelles?\x07Rocco tient toujours sa parole.", 
          COMPLETE: "Yo, _avName_! Toi, t'es OK pour moi.\x07Ces Chefbots ils font moins les malins maintenant, pas vrai?\x07Eh voil\xc3\xa0! Un bon petit coup de boost. Maintenant, \xc3\xa9vite les ennuis, t'entends?"}, 
   6231: {QUEST: "Place de la couette, Plume a entendu des rumeurs \xc3\xa0 propos du quartier g\xc3\xa9n\xc3\xa9ral Caissbot.\x07Va y faire un tour et vois si tu peux l'aider._where_"}, 
   6232: {GREETING: '', 
          LEAVING: '', 
          QUEST: "J'ai entendu dire qu'il se passait de dr\xc3\xb4les de choses.\x07Bon, c'est peut-\xc3\xaatre un coup des puces mais il se passe quelque chose de toute fa\xc3\xa7on.\x07Tous ces Caissbots!\x07IJe pense qu'ils ont install\xc3\xa9 un nouveau quartier g\xc3\xa9n\xc3\xa9ral tout pr\xc3\xa8s de la Place de la Couette.\x07P.J. conna\xc3\xaet bien le coin.\x07Va voir _toNpcName_ _where_ Demande-lui s'il a entendu quelque chose.", 
          INCOMPLETE_PROGRESS: "Tu n'as pas encore vu P.J.? Qu'est-ce qui t'en emp\xc3\xaache ?\x07Ah, ces satan\xc3\xa9es puces!"}, 
   6233: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Salut _avName_, o\xc3\xb9 vas-tu?\x07Un quartier g\xc3\xa9n\xc3\xa9ral Caissbot ?? Je n'ai rien vu.\x07Tu pourrais aller au bout de la place de la Couette et voir si c'est vrai?\x07Trouve quelques Caissbots dans leur quartier g\xc3\xa9n\xc3\xa9ral, bats-en quelques-uns et reviens me le dire.", 
          INCOMPLETE_PROGRESS: "Pas encore trouv\xc3\xa9 le QG? Tu dois y aller, vaincre des Caissbots et voir ce qui s'y passe."}, 
   6234: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Quoi?! Il y a D\xc3\x89JA un QG Caissbot ?\x07Tu ferais mieux d'aller tout de suite le dire \xc3\xa0 Plume!\x07Qui aurait pu deviner qu'il y aurait un QG Cog \xc3\xa0 deux pas de sa rue ?", 
          INCOMPLETE_PROGRESS: "Qu'est-ce que Plume t'a dit ? Tu ne l'as pas encore vu?"}, 
   6235: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Je suis impatient de savoir ce que P.J. a dit.\x07Hmm... on a besoin de plus d'informations sur cette affaire de Cogs mais je dois me d\xc3\xa9barrasser de ces puces!\x07Je sais! TOI, tu peux essayer d'en savoir plus!\x07Va vaincre des Caissbots au QG jusqu'\xc3\xa0 ce que tu trouves des plans. Apr\xc3\xa8s, tu reviens me voir!", 
          INCOMPLETE_PROGRESS: 'Toujours pas de plans? Continue \xc3\xa0 chercher les Cogs!\x07Ils doivent avoir des plans!', 
          COMPLETE: "Tu as les plans?\x07G\xc3\xa9nial! Voyons voir ce qu'ils disent.\x07Je vois... Les Caissbots ont construit une Fabrique \xc3\xa0 Sous pour fabriquer des euros Cog.\x07\xc3\x87a doit \xc3\xaatre PLEIN de Caissbots. On devrait essayer d'en savoir plus.\x07Peut-\xc3\xaatre que si tu avais un d\xc3\xa9guisement... Hmmm... attends! Je crois que j'ai une pi\xc3\xa8ce de costume de Cog quelque part par l\xc3\xa0....\x07La voil\xc3\xa0! Prends-la en r\xc3\xa9compense de tes efforts! Merci encore de ton aide!"}, 
   6241: {QUEST: "La comtesse te cherchait partout! S'il te pla\xc3\xaet, va lui rendre visite, comme \xc3\xa7a elle arr\xc3\xaatera d'appeler._where_"}, 
   6242: {GREETING: '', 
          LEAVING: '', 
          QUEST: "_avName_, je compte sur toi pour m'aider!\x07Tu vois, ces Cogs font tellement de bruit que je ne peux tout simplement pas me concentrer.\x07Je n'arr\xc3\xaate pas de perdre le compte de mes moutons!\x07Si tu fais diminuer ce bruit, je t'aiderai aussi! Tu peux compter l\xc3\xa0-dessus!\x07Bon, o\xc3\xb9 en \xc3\xa9tais-je ? C'est \xc3\xa7a, cent trente-six, cent trente-sept...", 
          INCOMPLETE_PROGRESS: "Quatre cent quarante-deux... quatre cent quarante-trois...\x07Quoi? Tu es d\xc3\xa9j\xc3\xa0 de retour ? Mais il y a toujours trop de bruit!\x07Ah non, j'ai encore perdu le compte.\x07 Un...deux...trois...", 
          COMPLETE: "Cinq cent quatre-vingt-treize... cinq cent quatre-vingt-quatorze..\x07Hello! Ah, je savais que je pouvais compter sur toi! C'est beaucoup plus calme maintenant.\x07Et voil\xc3\xa0, pour tous ces Gobechiffres.\x07Le nombre ? Maintenant il faut que je recommence \xc3\xa0 compter depuis le d\xc3\xa9but! Un...deux...."}, 
   6251: {QUEST: 'Ce pauvre p\xc3\xa8re San a cass\xc3\xa9 son zipper et maintenant il ne peut plus livrer ses clients. Ton aide lui sera certainement utile._where_'}, 
   6252: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Oh, bonjour _avName_. Tu es l\xc3\xa0 pour m'aider \xc3\xa0 faire mes livraisons?\x07C'est g\xc3\xa9nial! Avec ce zipper cass\xc3\xa9, c'est difficile de se d\xc3\xa9placer.\x07Voyons voir... OK, \xc3\xa7a devrait \xc3\xaatre facile. Ron Chonneau a command\xc3\xa9 une cithare la semaine derni\xc3\xa8re.\x07Pourrais-tu la lui apporter ? _where_", 
          INCOMPLETE_PROGRESS: 'Ah, salut! Tu as oubli\xc3\xa9 quelque chose ? Ron Chonneau attend sa cithare.'}, 
   6253: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Ma cithare! Enfin! Bon sang, je suis impatient d'en jouer.\x07Va dire au p\xc3\xa8re San que je le remercie, tu veux?", 
          INCOMPLETE_PROGRESS: "Merci encore pour la cithare. Le p\xc3\xa8re San n'a pas d'autres livraisons pour toi?"}, 
   6254: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Quelle rapidit\xc3\xa9! Quelle est la prochaine livraison sur ma liste ?\x07Bon. Mike Mac a command\xc3\xa9 une surfaceuse. Quel dr\xc3\xb4le de type.\x07Tu peux la lui apporter, s'il te pla\xc3\xaet ?_where_", 
          INCOMPLETE_PROGRESS: 'Cette surfaceuse est pour Mike Mac._where_'}, 
   6255: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Super! La surfaceuse que j'avais command\xc3\xa9e!\x07Maintenant, si seulement il n'y avait pas autant de Cogs dans les environs, je pourrais avoir le temps de m'en servir.\x07Sois sympa et occupe-toi de certains de ces Caissbots pour moi, tu veux?", 
          INCOMPLETE_PROGRESS: "Ces Caissbots r\xc3\xa9sistent, hein ? Avec eux, pas facile d'essayer ma surfaceuse."}, 
   6256: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Excellent! Maintenant je peux essayer ma surfaceuse.\x07S'il te pla\xc3\xaet, dis au p\xc3\xa8re San que je viendrai la semaine prochaine passer ma prochaine commande.", 
   ...
   6257: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Alors, est-ce que Mike Mac a \xc3\xa9t\xc3\xa9 content de sa surfaceuse ? G\xc3\xa9nial.\x07A qui le tour ? Ah, Olivier Daure a command\xc3\xa9 un coussin z\xc3\xa8bre.\x07Le voil\xc3\xa0! Pourrais-tu faire un saut chez lui, s'il te pla\xc3\xaet ?_where_", 
          INCOMPLETE_PROGRESS: "Je crois qu'Olivier Daure a besoin de ce coussin pour m\xc3\xa9diter."}, 
   6258: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Ah, mon coussin, enfin. Maintenant je peux m\xc3\xa9diter.\x07Comment se concentrer avec un tel vacarme ? Tous ces Cogs!\x07Comme tu es l\xc3\xa0, peut-\xc3\xaatre que tu pourrais t'occuper de certains de ces Cogs?\x07Apr\xc3\xa8s \xc3\xa7a je pourrai utiliser mon coussin en paix.", 
          INCOMPLETE_PROGRESS: 'Il y a toujours tellement de bruit avec ces Cogs! Comment se concentrer ?'}, 
   6259: {GREETING: '', 
          LEAVING: '', 
          QUEST: "La paix et le calme, enfin. Merci, _avName_.\x07S'il te pla\xc3\xaet, va dire au p\xc3\xa8re San que je suis tr\xc3\xa8s content. OMMM....", 
          INCOMPLETE_PROGRESS: "Le p\xc3\xa8re San t'as appel\xc3\xa9. Tu devrais aller voir ce qu'il veut."}, 
   6260: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Je suis heureux de voir qu'Olivier Daure est content de son coussin z\xc3\xa8bre.\x07Oh, ces zinnias viennent juste d'arriver pour Eva Sandor-Mir.\x07Comme tu as l'air d'\xc3\xaatre un livreur z\xc3\xa9l\xc3\xa9, peut-\xc3\xaatre que tu pourrais les lui apporter ?_where_", 
          INCOMPLETE_PROGRESS: 'Ces zinnias vont faner si tu ne les livres pas rapidement.'}, 
   6261: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Quels jolis zinnias! Ca c'est s\xc3\xbbr, le p\xc3\xa8re San s'y conna\xc3\xaet en livraison.\x07Oh, eh bien, je suppose que c'est TOI qui fais les livraisons, _avName_. Tu remercieras le p\xc3\xa8re San pour moi!", 
          INCOMPLETE_PROGRESS: "N'oublie pas de remercier le p\xc3\xa8re San pour les zinnias!"}, 
   6262: {GREETING: '', 
          LEAVING: '', 
          QUEST: 'Te voil\xc3\xa0 de retour, _avName_. Tu es sacr\xc3\xa9ment rapide.\x07Voyons... Quelle est la prochaine livraison sur ma liste ? Des disques de Zydeco pour Th\xc3\xa9r\xc3\xa8se Eveill\xc3\xa9._where_', 
          INCOMPLETE_PROGRESS: 'Je suis s\xc3\xbbr que Th\xc3\xa9r\xc3\xa8se Eveill\xc3\xa9 attend ses disques de Zydeco.'}, 
   6263: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Des disques de Zydeco? Je ne me rappelle pas avoir command\xc3\xa9 de disques de Zydeco.\x07Oh, je parie que c'est Lou Laberceuse qui les a command\xc3\xa9s._where_", 
          INCOMPLETE_PROGRESS: 'Non, ces disques de Zydeco sont pour Lou Laberceuse._where_'}, 
   6264: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Ah, enfin, mes disques de Zydeco! Je pensais que le p\xc3\xa8re San avait oubli\xc3\xa9.\x07Pourrais-tu lui apporter cette courgette ? Il trouvera bien quelqu'un qui en veut une. Merci!", 
          INCOMPLETE_PROGRESS: "Oh, j'ai d\xc3\xa9j\xc3\xa0 plein de courgettes. Apporte-la au p\xc3\xa8re San."}, 
   6265: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Une courgette ? Hmm. Eh bien, je trouverai s\xc3\xbbrement quelqu'un qui en voudra.\x07OK, nous avons presque fini ma liste. Plus qu'une livraison \xc3\xa0 faire.\x07B\xc3\xa9b\xc3\xa9 MacDougal a command\xc3\xa9 un costume zazou._where_", 
          INCOMPLETE_PROGRESS: 'Si tu ne livres pas ce costume zazou \xc3\xa0 B\xc3\xa9b\xc3\xa9 MacDougal,\x07 il va \xc3\xaatre tout froiss\xc3\xa9.'}, 
   6266: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Il \xc3\xa9tait une fois... oh! Tu n'es pas l\xc3\xa0 pour \xc3\xa9couter une histoire, hein ?\x07Tu es l\xc3\xa0 pour me livrer mon costume zazou? Super! Waouh, c'est quelque chose.\x07Eh, tu pourrais transmettre un message au p\xc3\xa8re San pour moi? J'aurais besoin de boutons de manchette en zircon pour aller avec le costume. Merci!", 
          INCOMPLETE_PROGRESS: 'Tu as transmis mon message au p\xc3\xa8re San ?', 
          COMPLETE: "Des boutons de manchette en zircon, hein ? Eh bien, je vais voir ce que je peux faire pour lui.\x07Bon, tu m'as \xc3\xa9t\xc3\xa9 d'une aide pr\xc3\xa9cieuse et je ne peux pas te laisser partir sans rien.\x07Voici un GROS coup de boost pour t'aider \xc3\xa0 zapper ces Cogs!"}, 
   6271: {QUEST: "Dave Bigleau a des probl\xc3\xa8mes et tu peux peut-\xc3\xaatre l'aider. Pourquoi ne pas passer \xc3\xa0 sa boutique ?_where_"}, 
   6272: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Quoi? Hein ? Oh, j'ai d\xc3\xbb m'endormir.\x07Tu sais, ces b\xc3\xa2timents Cog sont remplis de machines qui me donnent vraiment sommeil.\x07Je les entends ronronner toute la journ\xc3\xa9e et...\x07Hein ? Ah, ouais, d'accord. Si tu pouvais te d\xc3\xa9barrasser de certains de ces b\xc3\xa2timents Cog, je pourrais rester \xc3\xa9veill\xc3\xa9.", 
          INCOMPLETE_PROGRESS: "Zzzzz...hein ? Oh, c'est toi, _avName_.\x07D\xc3\xa9j\xc3\xa0 de retour ? Je faisais juste une petite sieste.\x07Reviens quand tu en auras fini avec ces b\xc3\xa2timents.", 
          COMPLETE: 'Quoi? Je me suis juste assoupi une minute.\x07Maintenant que ces b\xc3\xa2timents Cog ont disparu, je peux enfin me d\xc3\xa9tendre.\x07Merci de ton aide, _avName_.\x07A plus tard! Je crois que je vais faire un petit somme.'}, 
   6281: {QUEST: 'Va voir Teddy Blaireau. Il a un boulot pour toi._where_'}, 
   6282: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Qu'est-ce que tu dis? Non, je n'ai pas de goulot pour toi.\x07Oh, un boulot! Pourquoi ne pas l'avoir dit plus t\xc3\xb4t ? Il faudrait que tu parles plus fort.\x07Avec ces Cogs, ce n'est pas facile d'hiberner. Si tu ram\xc3\xa8nes un peu de calme au Pays des R\xc3\xaaves,\x07je te donnerai un petit quelque chose.", 
          INCOMPLETE_PROGRESS: "Tu as vaincu les bogs? Quels bogs?\x07Oh, les Cogs! Pourquoi ne pas l'avoir dit plus t\xc3\xb4t ?\x07Hmm, il y a encore pas mal de bruit. Pourquoi ne pas en vaincre quelques autres?", 
          COMPLETE: "Tu t'es bien amus\xc3\xa9? Hein ? Oh!\x07Tu as fini! Super. C'est sympa de ta part de donner un coup de main comme \xc3\xa7a.\x07J'ai trouv\xc3\xa9 \xc3\xa7a dans la pi\xc3\xa8ce du fond mais \xc3\xa7a ne m'est d'aucune utilit\xc3\xa9.\x07Peut-\xc3\xaatre que tu pourras en faire quelque chose. A plus, _avName_!"}, 
   6291: {QUEST: "Les Cogs ont p\xc3\xa9n\xc3\xa9tr\xc3\xa9 dans la Banque du Doudou d'Or! Va voir Laurent Lauronpat et vois si tu peux l'aider."}, 
   6292: {QUEST: "Ah ces satan\xc3\xa9s Caissbots! Ils ont vol\xc3\xa9 mes lampes de lecture!\x07J'en ai besoin tout de suite. Tu peux aller les chercher ?\x07Si tu me rapportes mes lampes de lecture, je pourrai peut-\xc3\xaatre t'aider \xc3\xa0 rencontrer le Vice-Pr\xc3\xa9sident.\x07Fais vite!", 
          INCOMPLETE_PROGRESS: 'Il me faut ces lampes. Continue de les chercher!', 
          COMPLETE: 'Te voil\xc3\xa0 revenu! Et tu as mes lampes!\x07Je ne peux pas te remercier comme il le faudrait mais je peux te donner \xc3\xa7a.'}, 
   7201: {QUEST: "Nina Lamparo te cherchait, _avName_. Elle a besoin d'aide._where_"}, 
   7202: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Ah! Je suis si contente de te voir, _avName_. J'aurais bien besoin d'aide!\x07Ces fichus Cogs ont chass\xc3\xa9 les livreurs et je n'ai plus aucun lit en stock.\x07Peux-tu aller voir Am\xc3\xa9d\xc3\xa9 Brouilletoitoutseul et me rapporter un lit ?_where_", 
          INCOMPLETE_PROGRESS: "Am\xc3\xa9d\xc3\xa9 n'avait pas de lit ? J'\xc3\xa9tais s\xc3\xbbre qu'il en avait un.", 
          COMPLETE: ''}, 
   7203: {GREETING: '', 
          LEAVING: '', 
          QUEST: 'Un lit ? Bien s\xc3\xbbr, en voil\xc3\xa0 un de pr\xc3\xaat.\x07Apporte-le-lui pour boi, tu veux? Tu as compris? Pour \x07" BOIS "? Hi-hi!\x07Tr\xc3\xa8s dr\xc3\xb4le, non ? Eh bien, am\xc3\xa8ne-le quand m\xc3\xaame l\xc3\xa0-bas s\'il te pla\xc3\xaet.', 
          INCOMPLETE_PROGRESS: 'Est-ce que le lit a plu \xc3\xa0 Nina?', 
          COMPLETE: ''}, 
   7204: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Ce lit ne convient pas. Il est beaucoup trop ordinaire.\x07Va voir s'il a quelque chose de plus fantaisie, tu veux?\x07Je suis s\xc3\xbbre que \xc3\xa7a ne te prendra qu'une minute.", 
          INCOMPLETE_PROGRESS: "Je suis s\xc3\xbbre qu'Am\xc3\xa9d\xc3\xa9 a un lit plus fantaisie.", 
          COMPLETE: ''}, 
   7205: {GREETING: '', 
          LEAVING: '', 
          QUEST: "On n'est pas tomb\xc3\xa9 pile avec ce lit, hein ? J'en ai un ici qui devrait faire l'affaire.\x07Mais il y a un petit probl\xc3\xa8me - il faut d'abord l'assembler.\x07Pendant que je m'en charge avec mon marteau, pourrais-tu te d\xc3\xa9barrasser de certains des Cogs, l\xc3\xa0-dehors?\x07Ces affreux Cogs ruinent mon travail.\x07Reviens quand tu auras fini et le lit sera pr\xc3\xaat.", 
          INCOMPLETE_PROGRESS: "Je n'ai pas tout \xc3\xa0 fait fini d'assembler le lit.\x07Quand tu en auras fini avec les Cogs, il sera pr\xc3\xaat.", 
          COMPLETE: ''}, 
   7206: {GREETING: '', 
          LEAVING: '', 
          QUEST: 'Salut _avName_!\x07Tu as fait du sacr\xc3\xa9 bon boulot avec ces Cogs.\x07Le lit est pr\xc3\xaat. Pourrais-tu le livrer pour moi?\x07Maintenant que tous ces Cogs sont partis, les affaires vont reprendre!', 
          INCOMPLETE_PROGRESS: 'Je pense que Nina attend la livraison de ce lit.', 
          COMPLETE: "Quel joli lit!\x07Maintenant mes clients vont \xc3\xaatre contents. Merci, _avName_.\x07Tiens, ceci pourra peut-\xc3\xaatre t'\xc3\xaatre utile. Quelqu'un l'a laiss\xc3\xa9 ici."}, 
   7209: {QUEST: "Va voir Ros\xc3\xa9e de Lune. Elle a besoin d'aide._where_"}, 
   7210: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Oh! Comme je suis contente de te voir, _avName_. J'ai vraiment besoin d'aide!\x07Je n'ai pas eu mon compte de sommeil depuis bien longtemps. Tu vois, les Cogs m'ont vol\xc3\xa9 mon dessus-de-lit.\x07Tu pourrais faire un saut voir si Ed n'aurait rien dans les tons bleus?_where_", 
          INCOMPLETE_PROGRESS: "Qu'est-ce qu'Ed a dit \xc3\xa0 propos de ce dessus-de-lit bleu?", 
          COMPLETE: ''}, 
   7211: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Alors comme \xc3\xa7a, Ros\xc3\xa9e veut un dessus-de-lit, hein ?\x07De quelle couleur ? BLEU?!\x07Eh bien, je vais devoir le fabriquer sp\xc3\xa9cialement pour elle. Tout ce que j'ai, c'est du rouge.\x07Tu sais quoi? Si tu vas t'occuper de certains des Cogs l\xc3\xa0-dehors, je fabriquerai un dessus-de-lit bleu sp\xc3\xa9cialement pour elle.\x07Des dessus-de-lit bleus... et puis quoi encore ?", 
          INCOMPLETE_PROGRESS: "Je travaille toujours sur ce dessus-de-lit bleu, _avName_. Continue de t'occuper de ces Cogs!", 
          COMPLETE: ''}, 
   7212: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Content de te revoir. J'ai quelque chose pour toi!\x07Voil\xc3\xa0 le dessus-de-lit et il est bleu. Elle va l'adorer.", 
          INCOMPLETE_PROGRESS: 'Est-ce que Ros\xc3\xa9e a aim\xc3\xa9 le dessus-de-lit ?', 
          COMPLETE: ''}, 
   7213: {GREETING: '', 
          LEAVING: '', 
          QUEST: "C'est mon dessus-de-lit ? Non, \xc3\xa7a ne va pas.\x07C'est un tissu \xc3\x89COSSAIS! Qui pourrait dormir avec un motif aussi CRIARD?\x07Tu vas devoir le rapporter et m'en ramener un autre.\x07Je suis s\xc3\xbbre qu'il en a d'autres.", 
          INCOMPLETE_PROGRESS: "Il est hors de question que j'accepte un dessus-de-lit \xc3\xa9cossais. Va voir ce qu'Ed peut faire.", 
          COMPLETE: ''}, 
   7214: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Quoi? Elle n'aime pas l'\xc3\x89COSSAIS?\x07Hmm... Voyons ce que nous avons par ici.\x07\xc3\x87a va prendre un certain temps. Pourquoi tu n'irais pas t'occuper de quelques Cogs pendant que j'essaie de trouver autre chose ?\x07J'aurai trouv\xc3\xa9 quand tu reviendras.", 
          INCOMPLETE_PROGRESS: 'Je suis toujours en train de chercher un autre dessus-de-lit. Comment \xc3\xa7a se passe avec les Cogs?', 
          COMPLETE: ''}, 
   7215: {GREETING: '', 
          LEAVING: '', 
          QUEST: "H\xc3\xa9, bon travail avec ces Cogs!\x07Et voil\xc3\xa0, il est bleu et il n'est pas \xc3\xa9cossais.\x07Reste \xc3\xa0 esp\xc3\xa9rer qu'elle aime le cachemire.\x07Apporte ce dessus-de-lit \xc3\xa0 Ros\xc3\xa9e.", 
          INCOMPLETE_PROGRESS: "C'est tout ce que j'ai pour toi pour l'instant.\x07S'il te pla\xc3\xaet, va apporter ce dessus-de-lit \xc3\xa0 Ros\xc3\xa9e.", 
          COMPLETE: "Oh! Que c'est joli! Le cachemire me va vraiment bien.\x07Il est temps pour moi de prendre un peu de repos! A plus tard, _avName_.\x07Quoi? Tu es encore l\xc3\xa0? Tu ne vois pas que j'essaie de dormir ?\x07Tiens, prends \xc3\xa7a et laisse-moi me reposer. Je dois \xc3\xaatre \xc3\xa0 faire peur!"}, 
   7218: {QUEST: "Daphn\xc3\xa9 Puis\xc3\xa9 aurait bien besoin d'un coup de main._where_"}, 
   7219: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Oh, _avName_, je suis contente de te voir! Les Cogs ont pris mes oreillers.\x07Pourrais-tu aller voir si Pierrot en a?_where_\x07Je suis s\xc3\xbbre qu'il peut m'aider.", 
          INCOMPLETE_PROGRESS: 'Est-ce que Pierrot a des oreillers pour moi ?', 
          COMPLETE: ''}, 
   7220: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Salut! Daphn\xc3\xa9 a besoin d'oreillers, hein ? Eh bien, tu as frapp\xc3\xa9 \xc3\xa0 la bonne porte, partenaire!\x07Il y a plus d'oreillers ici que d'\xc3\xa9pines sur un cactus.\x07Et voil\xc3\xa0, _avName_. Apporte-les \xc3\xa0 Daphn\xc3\xa9, avec mes compliments.\x07Toujours heureux de donner un coup de main \xc3\xa0 une demoiselle.", 
          INCOMPLETE_PROGRESS: 'Ces oreillers sont-ils assez doux pour cette jeune dame ?', 
          COMPLETE: ''}, 
   7221: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Tu as les oreillers! G\xc3\xa9nial!\x07Eh, attends une seconde! Ces oreillers sont affreusement mous.\x07Beaucoup trop mous pour moi. J'ai besoin d'oreillers plus durs.\x07Ram\xc3\xa8ne-les \xc3\xa0 Pierrot et vois ce qu'il a d'autre. Merci.", 
          INCOMPLETE_PROGRESS: "Non! Trop mous. Demande d'autres oreillers \xc3\xa0 Pierrot.", 
          COMPLETE: ''}, 
   7222: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Trop mous, hein ? Eh bien, laisse-moi voir ce que j'ai d'autre....\x07Hmm... Il me semblait que j'avais un bon paquet d'oreillers durs. O\xc3\xb9 sont-ils pass\xc3\xa9s?\x07Oh! Je me rappelle. Je pensais les renvoyer, donc ils sont \xc3\xa0 l'entrep\xc3\xb4t.\x07Pourquoi tu ne nettoierais pas quelques b\xc3\xa2timents Cog l\xc3\xa0-dehors pendant que je les sors de l'entrep\xc3\xb4t, partenaire ?", 
          INCOMPLETE_PROGRESS: "Dur, dur les b\xc3\xa2timents Cog. C'est pas comme ces oreillers.\x07Continue \xc3\xa0 chercher.", 
          COMPLETE: ''}, 
   7223: {GREETING: '', 
          LEAVING: '', 
          QUEST: "D\xc3\xa9j\xc3\xa0 de retour ? Eh bien, c'est parfait. Tu vois, j'ai trouv\xc3\xa9 les oreillers que Daphn\xc3\xa9 voulait.\x07Maintenant, va les lui apporter. Ils sont tellement durs qu'on s'y casserait les dents!", 
          INCOMPLETE_PROGRESS: "Ouais, ces oreillers sont bien durs. J'esp\xc3\xa8re qu'ils plairont \xc3\xa0 Daphn\xc3\xa9.", 
          COMPLETE: "Je savais bien que Pierrot aurait des oreillers plus durs.\x07Ah oui, ils sont parfaits. Bien durs, juste comme je les aime.\x07Tu aurais besoin de cette pi\xc3\xa8ce de costume de Cog? Tu n'as qu'\xc3\xa0 la prendre."}, 
   7226: {QUEST: 'Passe voir Sandie Marchand. Elle a perdu son pyjama._where_'}, 
   7227: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Je n'ai plus de pyjama! Je ne le trouve plus!\x07Qu'est-ce que je vais faire ? Oh! Je sais!\x07Va voir Big Mama. Elle aura s\xc3\xbbrement un pyjama pour moi._where_", 
          INCOMPLETE_PROGRESS: 'Est-ce que Big Mama a un pyjama pour moi?', 
          COMPLETE: ''}, 
   7228: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Te voil\xc3\xa0, petit Toon! Big Mama a les plus beaux pyjamas des Bahamas.\x07Oh, quelque chose pour Sandie Marchand, hein ? Bon, voyons voir ce que j'ai.\x07Voil\xc3\xa0 un petit quelque chose. Maintenant elle peut dormir en toute \xc3\xa9l\xc3\xa9gance!\x07Voudrais-tu courir le lui apporter pour moi? Je ne peux pas quitter la boutique pour l'instant.\x07Merci, _avName_. A plus tard!", 
          INCOMPLETE_PROGRESS: 'Tu dois apporter ce pyjama \xc3\xa0 Sandie._where_', 
          COMPLETE: ''}, 
   7229: {GREETING: '', 
          LEAVING: '', 
          QUEST: "C'est Big Mama qui me l'envoie ? Oh...\x07Est-ce qu'elle n'a pas de pyjama avec des pieds?\x07Je porte toujours des pyjamas avec des pieds. Comme tout le monde, non ?\x07Ram\xc3\xa8ne celui-l\xc3\xa0 et demande-lui de m'en trouver un avec des pieds.", 
          INCOMPLETE_PROGRESS: "Mon pyjama doit avoir des pieds. Va voir si Big Mama peut m'aider.", 
          COMPLETE: ''}, 
   7230: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Des pieds? Laisse-moi r\xc3\xa9fl\xc3\xa9chir....\x07Attends un peu! J'ai ce qu'il te faut!\x07Ta-dam! Un pyjama avec des pieds. Une jolie grenouill\xc3\xa8re bleue avec des pieds. La meilleure de toutes les \xc3\xaeles.\x07S'il te pla\xc3\xaet, va-la-lui porter, tu veux? Merci!", 
          INCOMPLETE_PROGRESS: 'Est-ce que Sandie a aim\xc3\xa9 la grenouill\xc3\xa8re bleue ?', 
          COMPLETE: ''}, 
   7231: {GREETING: '', 
          LEAVING: '', 
          QUEST: "OK, elle a EFFECTIVEMENT des pieds, mais je ne peux pas porter une grenouill\xc3\xa8re bleue!\x07Demande \xc3\xa0 Big Mama si elle n'a pas une autre couleur.", 
          INCOMPLETE_PROGRESS: "Je suis s\xc3\xbbre que Big Mama a une grenouill\xc3\xa8re d'une autre couleur.", 
          COMPLETE: ''}, 
   7232: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Quel dommage. C'est la seule grenouill\xc3\xa8re que j'aie.\x07Oh, j'ai une id\xc3\xa9e. Va demander \xc3\xa0 Tartine. Elle aura peut-\xc3\xaatre des pyjamas avec des pieds._where_", 
          INCOMPLETE_PROGRESS: "Non, ce sont les seuls pyjamas que j'aie. Va voir si Tartine en a._where_", 
          COMPLETE: ''}, 
   7233: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Des pyjamas avec des pieds? Bien s\xc3\xbbr.\x07Qu'est-ce que tu veux dire, il est bleu? Elle n'aime pas le bleu?\x07Oh, alors l\xc3\xa0, c'est plus compliqu\xc3\xa9. Tiens, essaie \xc3\xa7a.\x07Il n'est pas bleu et il A des pieds.", 
          INCOMPLETE_PROGRESS: "Moi j'adore la couleur puce, pas toi?\x07J'esp\xc3\xa8re que Sandie l'aimera....", 
          COMPLETE: ''}, 
   7234: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Non, il n'est pas bleu mais personne avec mon teint ne peut porter de couleur puce.\x07Absolument impossible. Retourne l\xc3\xa0-bas et rapporte-le! Va voir ce que Tartine a d'autre.", 
          INCOMPLETE_PROGRESS: "Tartine doit avoir d'autres pyjamas. La couleur puce, hors de question pour moi!", 
          COMPLETE: ''}, 
   7235: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Pas de puce non plus. Hmm....\x07Par ma barbe, je sais que j'en ai d'autres.\x07Il va me falloir un moment pour les trouver. Faisons un march\xc3\xa9.\x07Je cherche d'autres grenouill\xc3\xa8res si tu te d\xc3\xa9barrasses de quelques b\xc3\xa2timents Cog. Ils sont vraiment g\xc3\xaanants.\x07La grenouill\xc3\xa8re sera pr\xc3\xaate quand tu reviendras, _avName_.", 
   ...
   7236: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Tu as fait de l'excellent travail avec ces Cogs! Merci!\x07J'ai trouv\xc3\xa9 cette grenouill\xc3\xa8re pour Sandie, j'esp\xc3\xa8re que \xc3\xa7a lui plaira.\x07Apporte-la-lui. Merci.", 
          INCOMPLETE_PROGRESS: 'Sandie attend sa grenouill\xc3\xa8re, _avName_.', 
          COMPLETE: "Une grenouill\xc3\xa8re fuchsia! Parr-fait!\x07Ah, maintenant je suis parfaitement bien. Voyons voir....\x07Oh, je suppose que je devrais te donner quelque chose pour te remercier de ton aide.\x07Peut-\xc3\xaatre que ceci te sera utile. Quelqu'un l'a laiss\xc3\xa9 ici."}, 
   7239: {QUEST: "Va voir Emma Scara. Elle demande de l'aide._where_"}, 
   7240: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Ces satan\xc3\xa9s Cogs ont pris ma cr\xc3\xa8me antirides!\x07Mes clients DOIVENT absolument avoir de la cr\xc3\xa8me antirides quand je m'occupe d'eux.\x07Va voir Honor\xc3\xa9 et demande-lui s'il a toujours ma recette sp\xc3\xa9ciale en stock._where_", 
          INCOMPLETE_PROGRESS: "Je refuse de m'occuper de quelqu'un qui n'a pas de cr\xc3\xa8me antirides.\x07Va voir si Honor\xc3\xa9 en a."}, 
   7241: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Oh, cette Emma n'est pas facile. Elle ne se contente pas de ma recette habituelle.\x07Ce qui veut dire que je vais avoir besoin de corail chou-fleur, mon ingr\xc3\xa9dient sp\xc3\xa9cial ultrasecret. Mais je n'en ai pas en stock.\x07Pourrais-tu aller m'en p\xc3\xaacher dans l'\xc3\xa9tang? D\xc3\xa8s que tu auras le corail, je pr\xc3\xa9parerai un m\xc3\xa9lange de cr\xc3\xa8me pour Emma.", 
          INCOMPLETE_PROGRESS: "J'ai besoin de corail chou-fleur pour pr\xc3\xa9parer ma cr\xc3\xa8me antirides."}, 
   7242: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Waouh, quel beau corail chou-fleur!\x07Ok, voyons voir... Un peu de ceci et une petite gicl\xc3\xa9e de cela... Et maintenant, une cuiller\xc3\xa9e d'algues.\x07H\xc3\xa9, o\xc3\xb9 sont les algues? On dirait que je suis aussi \xc3\xa0 court d'algues.\x07Peux-tu faire un saut \xc3\xa0 l'\xc3\xa9tang et me ramasser une belle algue gluante ?", 
          INCOMPLETE_PROGRESS: "Plus un brin d'algue gluante dans cette boutique.\x07Impossible de pr\xc3\xa9parer la cr\xc3\xa8me sans algue."}, 
   7243: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Oooh! Voil\xc3\xa0 une algue gluante \xc3\xa0 souhait, _avName_.\x07Maintenant, je vais juste \xc3\xa9craser quelques perles dans le mortier avec le pilon.\x07Hum, o\xc3\xb9 est mon pilon ? A quoi sert un mortier sans un pilon ?\x07Je parie que ce fichu Usurier l'a pris quand il est venu ici!\x07Il faut que tu m'aides \xc3\xa0 le trouver! Il se dirigeait vers le QG Caissbot!", 
          INCOMPLETE_PROGRESS: 'Je ne peux tout simplement pas \xc3\xa9craser mes perles sans un pilon.\x07Fichus Usuriers!'}, 
   7244: {GREETING: '', 
          LEAVING: '', 
          QUEST: "Parfait! Tu as mon pilon!\x07Maintenant on va pouvoir travailler. \xc3\x89craser \xc3\xa7a... Touiller un peu et...\x07\xc3\x87a y est! Va dire \xc3\xa0 Emma que c'est de la bonne cr\xc3\xa8me, fra\xc3\xaechement pr\xc3\xa9par\xc3\xa9e.", 
          INCOMPLETE_PROGRESS: "Tu devrais apporter cette cr\xc3\xa8me \xc3\xa0 Emma tant qu'elle est encore fra\xc3\xaeche.\x07C'est une cliente tr\xc3\xa8s difficile.", 
          COMPLETE: "Honor\xc3\xa9 n'avait pas un pot de cr\xc3\xa8me antirides plus gros que \xc3\xa7a? Non ?\x07Eh bien, je suppose qu'il faudra simplement que j'en recommande quand je n'en aurai plus.\x07A un de ces quatre, _avName_.\x07Quoi? Tu es toujours l\xc3\xa0? Tu ne vois pas que j'essaie de travailler ?\x07Tiens, prends \xc3\xa7a."}, 
   11000: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Si tu es int\xc3\xa9ress\xc3\xa9 par les pi\xc3\xa8ces de d\xc3\xa9guisement de Loibot, tu devrais aller voir _toNpcName_.\x07J'ai entendu dire qu'il a grand besoin d'aide pour ses recherches m\xc3\xa9t\xc3\xa9orologiques._where_"}, 
   11001: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Oui, oui. J'ai des pi\xc3\xa8ces de d\xc3\xa9guisement de Loibot.\x07Mais elles sont sans int\xc3\xa9r\xc3\xaat pour moi.\x07Mes recherches portent sur les fluctuations de la temp\xc3\xa9rature ambiante de Toontown.\x07J'\xc3\xa9changerais volontiers des pi\xc3\xa8ces de d\xc3\xa9guisement contre des sondes de temp\xc3\xa9rature Cog.\x07Tu peux commencer par aller voir %s." % GlobalStreetNames[2100][-1], 
           INCOMPLETE_PROGRESS: 'Est-ce que tu as essay\xc3\xa9 de chercher sur %s?' % GlobalStreetNames[2100][-1], 
           COMPLETE: "Ah, parfait!\x07C'est ce que je craignais...\x07Oh, oui! Voil\xc3\xa0 ta pi\xc3\xa8ce de d\xc3\xa9guisement."}, 
   11002: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Pour obtenir d'autres pi\xc3\xa8ces de d\xc3\xa9guisement de Loibot, tu devrais retourner voir _toNpcName_.\x07J'ai entendu dire qu'il avait besoin d'assistants de recherche._where_"}, 
   11003: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Plus de pi\xc3\xa8ces de d\xc3\xa9guisement de Loibot?\x07Bon, si tu insistes...\x07mais j'ai besoin d'une autre sonde de temp\xc3\xa9rature Cog.\x07Cette fois-ci, va sur %s." % GlobalStreetNames[2200][-1], 
           INCOMPLETE_PROGRESS: 'Tu cherches bien sur %s ?' % GlobalStreetNames[2200][-1], 
           COMPLETE: 'Merci!\x07Voil\xc3\xa0 ta pi\xc3\xa8ce de d\xc3\xa9guisement.'}, 
   11004: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Si tu as besoin de pi\xc3\xa8ces de d\xc3\xa9guisement Loibot suppl\xc3\xa9mentaires, tu devrais retourner voir _toNpcName_.\x07Apparemment, il a toujours besoin d'aide pour ses recherches m\xc3\xa9t\xc3\xa9orologiques._where_"}, 
   11005: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Tu sais te montrer utile!\x07Est-ce que tu peux aller jeter un oeil sur %s?' % GlobalStreetNames[2300][-1], 
           INCOMPLETE_PROGRESS: ' Tu es bien en train de chercher sur %s ?' % GlobalStreetNames[2300][-1], 
           COMPLETE: "Hmmm, je n'aime pas trop \xc3\xa7a...\x07mais voici ta pi\xc3\xa8ce de d\xc3\xa9guisement..."}, 
   11006: {GREETING: '', 
           LEAVING: '', 
           QUEST: ' Qui-tu-sais a besoin de relev\xc3\xa9s de temp\xc3\xa9rature suppl\xc3\xa9mentaires.\x07Passe le voir si tu veux une autre pi\xc3\xa8ce de d\xc3\xa9guisement._where_'}, 
   11007: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Encore toi?\x07Tu as vraiment envie de travailler...\x07La prochaine destination, c'est %s." % GlobalStreetNames[1100][-1], 
           INCOMPLETE_PROGRESS: 'Est-ce que tu as essay\xc3\xa9 de chercher sur %s?' % GlobalStreetNames[1100][-1], 
           COMPLETE: "Bon! On dirait que tu t'en sors plut\xc3\xb4t bien!\x07Ta pi\xc3\xa8ce de d\xc3\xa9guisement..."}, 
   11008: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Si tu as envie d'une autre pi\xc3\xa8ce de d\xc3\xa9guisement de Loibot..._where_"}, 
   11009: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Content de te trouver ici!\x07Maintenant, j'ai besoin de relev\xc3\xa9s sur %s." % GlobalStreetNames[1200][-1], 
           INCOMPLETE_PROGRESS: 'Tu cherches bien sur %s ?' % GlobalStreetNames[1200][-1], 
           COMPLETE: "Merci beaucoup!\x07Tu n'es probablement pas loin d'avoir tout ton d\xc3\xa9guisement..."}, 
   11010: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Je crois que _toNpcName_ a encore du travail pour toi._where_'}, 
   11011: {GREETING: '', 
           LEAVING: '', 
           QUEST: ' Content de te revoir, _avName_!\x07Est-ce que tu peux faire un relev\xc3\xa9 sur %s?' % GlobalStreetNames[1300][-1], 
           INCOMPLETE_PROGRESS: 'Est-ce que tu as essay\xc3\xa9 de chercher sur %s?' % GlobalStreetNames[1300][-1], 
           COMPLETE: "Super boulot!\x07Voici ta r\xc3\xa9compense. Tu l'as bien m\xc3\xa9rit\xc3\xa9e!"}, 
   11012: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Tu sais ce qu'il faut faire._where_"}, 
   11013: {GREETING: '', 
           LEAVING: '', 
           QUEST: '_avName_, mon ami!\x07Est-ce que tu pourrais aller \xc3\xa0 %s et me trouver une autre sonde de temp\xc3\xa9rature?' % GlobalStreetNames[5100][-1], 
           INCOMPLETE_PROGRESS: 'Est-ce que tu es vraiment en train de chercher sur %s?' % GlobalStreetNames[5100][-1], 
           COMPLETE: 'Excellent!\x07Gr\xc3\xa2ce \xc3\xa0 ton aide, mes recherches avancent tr\xc3\xa8s vite!\x07Voici ta r\xc3\xa9compense.'}, 
   11014: {GREETING: '', 
           LEAVING: '', 
           QUEST: '_toNpcName_ a parl\xc3\xa9 de toi.aOn dirait que tu as fait une sacr\xc3\xa9e impression!_where_'}, 
   11015: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Content de te revoir!\x07Je t'attendais.\x07Le prochain relev\xc3\xa9 dont j'ai besoin, c'est sur %s." % GlobalStreetNames[5200][-1], 
           INCOMPLETE_PROGRESS: 'Tu cherches bien sur %s ?' % GlobalStreetNames[5200][-1], 
           COMPLETE: 'Merci!\x07Voici ta r\xc3\xa9compense.'}, 
   11016: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Si tu as besoin de terminer ton d\xc3\xa9guisement de Loibot...\x07_toNpcName_ peut t'aider._where_"}, 
   11017: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Salut, jeune chercheur!\x07Nous avons encore besoin de relev\xc3\xa9s de %s.' % GlobalStreetNames[5300][-1], 
           INCOMPLETE_PROGRESS: 'Est-ce que tu as essay\xc3\xa9 de chercher sur %s?' % GlobalStreetNames[5300][-1], 
           COMPLETE: 'Excellent travail!\x07Voil\xc3\xa0 ton machin de Loibot...'}, 
   11018: {GREETING: '', 
           LEAVING: '', 
           QUEST: "_toNpcName_ a un autre travail pour toi.\x07Si tu n'en as pas assez de le voir..._where_"}, 
   11019: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Bon, tr\xc3\xa8s bien.\x07Tu te sens d'attaque pour aller chercher autre chose?\x07Cette fois-ci, essaie %s." % GlobalStreetNames[4100][-1], 
           INCOMPLETE_PROGRESS: 'Tu es bien en train de chercher sur %s ?' % GlobalStreetNames[4100][-1], 
           COMPLETE: 'Et un de plus!\x07Quelle efficacit\xc3\xa9!'}, 
   11020: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Tu es toujours \xc3\xa0 la recherche de pi\xc3\xa8ces de d\xc3\xa9guisement de Loibot?_where_'}, 
   11021: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Tu as sans doute d\xc3\xa9j\xc3\xa0 devin\xc3\xa9...\x07mais j'ai besoin de relev\xc3\xa9s de %s." % GlobalStreetNames[4200][-1], 
           INCOMPLETE_PROGRESS: 'Tu cherches bien sur %s ?' % GlobalStreetNames[4200][-1], 
           COMPLETE: 'On y est presque!\x07Et voil\xc3\xa0...'}, 
   11022: {GREETING: '', 
           LEAVING: '', 
           QUEST: "J'ai presque honte de le dire, mais..._where_"}, 
   11023: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Qu'est-ce que tu penses de %s? Est-ce que tu crois que tu pourrais aller chercher une sonde l\xc3\xa0-bas aussi?" % GlobalStreetNames[4300][-1], 
   ...
   11025: {GREETING: '', 
           ...
           COMPLETE: "Bon travail!\x07Je crois qu'on se rapproche..."}, 
   11026: {GREETING: '', 
           LEAVING: '', 
           QUEST: '_toNpcName_ a une derni\xc3\xa8re mission pour toi._where_'}, 
   11027: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'D\xc3\xa9j\xc3\xa0 de retour?\x07Le dernier relev\xc3\xa9 est sur %s.' % GlobalStreetNames[9200][-1], 
           INCOMPLETE_PROGRESS: 'Tu cherches bien sur %s ?' % GlobalStreetNames[9200][-1], 
           COMPLETE: "\xc3\x87a y est enfin!\x07Maintenant, tu vas pouvoir t'introduire dans le bureau du Procureur et ramasser des convocations du jury.\x07Bonne chance et merci pour ton aide!"}, 
   12000: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'If you are interested in Bossbot disguise parts you should visit _toNpcName_._where_'}, 
   12001: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Oui, je peux te trouver des pi\xc3\xa8ces de Chefbot.\x07Mais tu devras m'aider \xc3\xa0 terminer ma collection de Chefbot.\x07Va d\xc3\xa9fier un Laquaistic.", 
           INCOMPLETE_PROGRESS: "Tu n'as pas trouv\xc3\xa9 de Laquaistic ? Quel dommage&nbsp;!", 
           COMPLETE: "Tu n'as pas \xc3\xa9t\xc3\xa9 recal\xc3\xa9 j'esp\xc3\xa8re ?\x07Voici ta premi\xc3\xa8re pi\xc3\xa8ce de d\xc3\xa9guisement."}, 
   12002: {GREETING: '', 
           LEAVING: '', 
           QUEST: "_toNpcName_ a encore besoin d'aide, si \xc3\xa7a te dit._where_"}, 
   12003: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Une autre pi\xc3\xa8ce de d\xc3\xa9guisement ?\x07Absolument...\x07mais seulement si tu parviens \xc3\xa0 vaincre un Gratte-papier.', 
           INCOMPLETE_PROGRESS: 'Les Gratte-papiers sont dans les rues.', 
           COMPLETE: "Un vrai jeu d'enfant !\x07Voici ta seconde pi\xc3\xa8ce de d\xc3\xa9guisement."}, 
   12004: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Il y a vraiment un seul endroit o\xc3\xb9 trouver des pi\xc3\xa8ces de Chefbot._where_'}, 
   12005: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Maintenant j'ai besoin d'un B\xc3\xa9niouioui...", 
           INCOMPLETE_PROGRESS: 'Les B\xc3\xa9niouiouis sont dans les rues.', 
           COMPLETE: "Super, l'ami, tu es bon.\x07Voici ta troisi\xc3\xa8me pi\xc3\xa8ce de d\xc3\xa9guisement."}, 
   12006: {GREETING: '', 
           LEAVING: '', 
           QUEST: "_toNpcName_ a d'autres pi\xc3\xa8ces pour toi..."}, 
   12007: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Si tu triomphes d'un Microchef, je te donnerai une autre pi\xc3\xa8ce de d\xc3\xa9guisement.", 
           INCOMPLETE_PROGRESS: 'Va voir dans %s' % GlobalStreetNames[1100][-1], 
           COMPLETE: "Tu t'es bien d\xc3\xa9fendu !\x07Voici ta quatri\xc3\xa8me pi\xc3\xa8ce de d\xc3\xa9guisement."}, 
   12008: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Rends-toi dans..._where_'}, 
   12009: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Je suis \xc3\xa0 la recherche d'un Touptisseur maintenant...", 
           INCOMPLETE_PROGRESS: 'Des probl\xc3\xa8mes ? Va voir dans %s' % GlobalStreetNames[3100][-1], 
           COMPLETE: 'Quelle terrible d\xc3\xa9faite !\x07Voici ta cinqui\xc3\xa8me pi\xc3\xa8ce de d\xc3\xa9guisement.'}, 
   12010: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Je pense que tu sais o\xc3\xb9 aller maintenant..._where_'}, 
   12011: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Prochain sur ma liste : un Chasset\xc3\xaate.', 
           INCOMPLETE_PROGRESS: 'Tu auras peut-\xc3\xaatre plus de chance en allant faire un tour dans les b\xc3\xa2timents.', 
           COMPLETE: "Je vois que tu n'as eu aucun mal \xc3\xa0 en trouver un.\x07Voici ta sixi\xc3\xa8me pi\xc3\xa8ce de d\xc3\xa9guisement."}, 
   12012: {GREETING: '', 
           LEAVING: '', 
           QUEST: '_toNpcName_ a besoin de plus de Chefbots.'}, 
   12013: {GREETING: '', 
           LEAVING: '', 
           QUEST: "A pr\xc3\xa9sent, j'ai besoin que tu me d\xc3\xa9niches un Attactic.", 
           INCOMPLETE_PROGRESS: 'Tu auras peut-\xc3\xaatre plus de chance en allant faire un tour dans les b\xc3\xa2timents.', 
           COMPLETE: 'Tu fais un excellent chasseur !\x07Voici ta septi\xc3\xa8me pi\xc3\xa8ce de d\xc3\xa9guisement.'}, 
   12014: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Si tu souhaites obtenir plus de pi\xc3\xa8ces de d\xc3\xa9guisement, va dans..._where_'}, 
   12015: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Et maintenant, le coup de gr\xc3\xa2ce : le Gros Blochon !', 
           INCOMPLETE_PROGRESS: 'Va voir dans %s' % GlobalStreetNames[10000][-1], 
           COMPLETE: 'Je savais que je pouvais compter sur toi pour...\x07peu importe !\x07Voici une autre pi\xc3\xa8ce de d\xc3\xa9guisement.'}, 
   12016: {GREETING: '', 
           LEAVING: '', 
           QUEST: '_toNpcName_ \xc3\xa9tait \xc3\xa0 ta recherche...'}, 
   12017: {GREETING: '', 
           LEAVING: '', 
           QUEST: "A pr\xc3\xa9sent, j'aimerais que tu t'attaques \xc3\xa0 l'un des nouveaux Cogs Chefbot, qui sont plus dangereux.", 
           INCOMPLETE_PROGRESS: 'Va voir dans %s' % GlobalStreetNames[10000][-1], 
           COMPLETE: "Ils sont plus forts qu'ils en ont l'air, hein&nbsp;?\x07Enfin, je te dois quand m\xc3\xaame une pi\xc3\xa8ce de d\xc3\xa9guisement."}, 
   12018: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Pourrais-tu aller faire un tour \xc3\xa0..._where_'}, 
   12019: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Ces Cogs version 2.0 sont tr\xc3\xa8s int\xc3\xa9ressants.\x07S'il te pla\xc3\xaet, va en attaquer un autre.", 
           INCOMPLETE_PROGRESS: 'Va voir dans %s' % GlobalStreetNames[10000][-1], 
           COMPLETE: 'Merci !\x07Une autre pi\xc3\xa8ce de d\xc3\xa9guisement pour toi.'}, 
   12020: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Si tu peux, arr\xc3\xaate-toi et va voir _toNpcName_.'}, 
   12021: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Je me demande s'ils peuvent se r\xc3\xa9g\xc3\xa9n\xc3\xa9rer...", 
           INCOMPLETE_PROGRESS: 'Va voir dans %s' % GlobalStreetNames[10000][-1], 
           COMPLETE: "J'imagine que non.\x07Voici ta pi\xc3\xa8ce de d\xc3\xa9guisement..."}, 
   12022: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Tu sais..._where_'}, 
   12023: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Peut-\xc3\xaatre que ce ne sont pas des Chefbots du tout...', 
           INCOMPLETE_PROGRESS: 'Va voir dans %s' % GlobalStreetNames[10000][-1], 
           COMPLETE: 'Finalement, je crois bien que ce sont des Chefbots.\x07Choisis une autre pi\xc3\xa8ce de d\xc3\xa9guisement.'}, 
   12024: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Tu sais sans doute d\xc3\xa9j\xc3\xa0 ce que je vais te dire...'}, 
   12025: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Peut-\xc3\xaatre que d'une certaine mani\xc3\xa8re, ils sont parents avec les Skelecogs...", 
           INCOMPLETE_PROGRESS: 'Va voir dans %s' % GlobalStreetNames[10000][-1], 
           COMPLETE: 'Ce fut peu concluant...\x07Voici ta pi\xc3\xa8ce de d\xc3\xa9guisement.'}, 
   12026: {GREETING: '', 
           LEAVING: '', 
           QUEST: "S'il te pla\xc3\xaet, retourne voir _toNpcName_."}, 
   12027: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Je ne suis toujours pas convaincu qu'il ne s'agit pas d'une esp\xc3\xa8ce de Skelecog...", 
           INCOMPLETE_PROGRESS: 'Va voir dans %s' % GlobalStreetNames[10000][-1], 
           COMPLETE: 'Peut-\xc3\xaatre pas.\x07Voici une autre pi\xc3\xa8ce de d\xc3\xa9guisement.'}, 
   12028: {GREETING: '', 
           LEAVING: '', 
           QUEST: "C'est sans doute l'endroit o\xc3\xb9 tu as le moins envie d'aller, mais..."}, 
   12029: {GREETING: '', 
           LEAVING: '', 
           QUEST: "Ces nouveaux Cogs me laissent vraiment perplexe.\x07Pourrais-tu aller en attaquer un autre, s'il te pla\xc3\xaet&nbsp;?", 
           INCOMPLETE_PROGRESS: 'Va voir dans %s' % GlobalStreetNames[10000][-1], 
           COMPLETE: 'Vraiment fascinant.\x07Une pi\xc3\xa8ce de d\xc3\xa9guisement pour te remercier de tes efforts.'}, 
   12030: {GREETING: '', 
           LEAVING: '', 
           QUEST: '_toNpcName_  commence \xc3\xa0 sonner comme un disque ray\xc3\xa9 ...'}, 
   12031: {GREETING: '', 
           LEAVING: '', 
           QUEST: "J'ai presque trouv\xc3\xa9 ce que sont ces Cogs.\x07Juste encore un...", 
           INCOMPLETE_PROGRESS: 'Va voir dans %s' % GlobalStreetNames[10000][-1], 
           COMPLETE: "Oui, je crois que je suis sur la bonne voie.\x07Ah oui.\x07\xc3\x87a, c'est pour toi..."}, 
   12032: {GREETING: '', 
           LEAVING: '', 
           QUEST: 'Tu dois aller raconter tout \xc3\xa7a \xc3\xa0 Flippy...', 
           INCOMPLETE_PROGRESS: 'Flippy se trouve dans Toon Hall', 
           COMPLETE: 'Une nouvelle esp\xc3\xa8ce de Cog !\x07Bon travail !\x07Voici ta derni\xc3\xa8re pi\xc3\xa8ce de d\xc3\xa9guisement.'}}
ChatGarblerDog = [
 'ouaf',
 'ouarf',
 'rrrgh']
...
AvatarPanelStopIgnoring = "Arr\xc3\xaate d'ignorer"
...
AvatarPanelGroupMember = 'D\xc3\xa9j\xc3\xa0 dans le groupe'
...
ReportPanelBody = 'Cette fonction permet d\'envoyer un rapport complet \xc3\xa0 un mod\xc3\xa9rateur. Au lieu d\'envoyer un rapport, tu peux opter pour l\'une des options suivantes&nbsp;:\n\n - Te t\xc3\xa9l\xc3\xa9porter dans un autre district\n - Utiliser " Ignorer " sur le panneau de commande du Toon\n\nSouhaites-tu vraiment signaler %s \xc3\xa0 un mod\xc3\xa9rateur ?'
ReportPanelBodyFriends = "Cette fonction permet d'envoyer un rapport complet \xc3\xa0 un mod\xc3\xa9rateur. Au lieu d'envoyer un rapport, tu peux opter pour l'une des options suivantes&nbsp;:\n\n - Te t\xc3\xa9l\xc3\xa9porter dans un autre district \n - Rompre votre amiti\xc3\xa9\n\n Souhaites-tu vraiment signaler %s \xc3\xa0 un mod\xc3\xa9rateur ?\n\n(Cela rompra \xc3\xa9galement votre amiti\xc3\xa9)"
ReportPanelCategoryBody = 'Tu es sur le point de signaler %s. Un mod\xc3\xa9rateur sera alert\xc3\xa9 de ta plainte et prendra les mesures appropri\xc3\xa9es envers toute personne ayant enfreint nos r\xc3\xa8gles. S\xc3\xa9lectionne la raison pour laquelle tu signales %s:'
ReportPanelBodyPlayer = "Cette fonction est en cours de d\xc3\xa9veloppement et sera bient\xc3\xb4t disponible. En attendant, tu peux :\n\n - Te rendre dans DXD pour rompre votre amiti\xc3\xa9.\n - Raconter ce qui s'est pass\xc3\xa9 \xc3\xa0 un parent."
ReportPanelCategoryLanguage = 'Propos grossiers'
ReportPanelCategoryPii = "Partage ou demande d'informations personnelles"
ReportPanelCategoryRude = 'Impoli ou m\xc3\xa9chant'
ReportPanelCategoryName = 'Mauvais nom'
ReportPanelConfirmations = ('Tu es sur le point de signaler que %s a utilis\xc3\xa9 des propos obsc\xc3\xa8nes, sectaires ou sexuellement explicites.', "Tu es sur le point de signaler que %s n'est pas prudent, et donne ou demande un num\xc3\xa9ro de t\xc3\xa9l\xc3\xa9phone, une adresse, un nom de famille, une adresse e-mail, un mot de passe ou un nom de compte.", 'Tu es sur le point de signaler que %s tyrannise, harc\xc3\xa8le ou manifeste un comportement extr\xc3\xaame pour perturber le jeu.', "Tu es sur le point de signaler que %s a cr\xc3\xa9\xc3\xa9 un nom qui n'est pas conforme aux R\xc3\xa8gles du jeu de Toontown Offline.")
ReportPanelWarning = "Nous prenons les rapports tr\xc3\xa8s au s\xc3\xa9rieux. Ton rapport sera examin\xc3\xa9 par un mod\xc3\xa9rateur, qui prendra les mesures appropri\xc3\xa9es envers toute personne ayant enfreint nos r\xc3\xa8gles. S'il s'av\xc3\xa8re que ton compte a lui-m\xc3\xaame enfreint les r\xc3\xa8gles, ou si tu fais de faux signalements ou utilises la fonction \xc2\xab&nbsp;Signaler un joueur&nbsp;\xc2\xbb de mani\xc3\xa8re abusive, un mod\xc3\xa9rateur pourrait prendre des mesures contre ton compte. Es-tu s\xc3\xbbr de vouloir signaler ce joueur&nbsp;?"
ReportPanelThanks = "Merci. Ton rapport a \xc3\xa9t\xc3\xa9 envoy\xc3\xa9 \xc3\xa0 un mod\xc3\xa9rateur qui se chargera de son examen. Tu n'as pas besoin de nous contacter \xc3\xa0 nouveau concernant cet incident. L'\xc3\xa9quipe charg\xc3\xa9e de la mod\xc3\xa9ration prendra les mesures qui s'imposent \xc3\xa0 l'encontre de tout joueur ayant enfreint nos r\xc3\xa8gles."
ReportPanelRemovedFriend = "Nous avons automatiquement supprim\xc3\xa9 %s de ta Liste d'amis."
ReportPanelAlreadyReported = "Tu as d\xc3\xa9j\xc3\xa0 signal\xc3\xa9 %s durant cette session. Un mod\xc3\xa9rateur se chargera d'examiner ton pr\xc3\xa9c\xc3\xa9dent rapport."
IgnorePanelTitle = 'Ignorer un joueur'
IgnorePanelAddIgnore = 'Veux-tu ignorer %s pour le reste de cette session ?'
IgnorePanelIgnore = 'A pr\xc3\xa9sent, tu ignores %s.'
IgnorePanelRemoveIgnore = "Veux-tu arr\xc3\xaater d'ignorer %s ?"
IgnorePanelEndIgnore = "Tu n'ignores plus %s."
IgnorePanelAddFriendAvatar = "%s est ton ami(e). Tu ne peux pas l'ignorer tant que vous \xc3\xaates amis. %s (%s) est ton ami(e). Tu ne peux pas l'ignorer tant que vous \xc3\xaates amis."
...
PetTrickStrings = {0: 'Saute', 
   ...
   5: 'Danse', 
   6: 'Parle'}
PetMoodAdjectives = {'neutral': 'neutre', 
...
TeleportPanelBusyShard = '%(avName)s se trouve dans un district qui affiche complet. Jouer dans un district complet peut consid\xc3\xa9rablement ralentir les performances de jeu. Es-tu s\xc3\xbbr de vouloir changer de district ?'
...
CountryClubBossTaunt = 'Je suis le Pr\xc3\xa9sident du Club.'
CountryClubBossBattleTaunt = "Tu dois t'adresser au Pr\xc3\xa9sident du Club."
ForcedLeaveCountryClubAckMsg = "Le Pr\xc3\xa9sident du Club a \xc3\xa9t\xc3\xa9 vaincu avant que tu n'arrives jusqu'\xc3\xa0 lui. Tu n'as pas r\xc3\xa9cup\xc3\xa9r\xc3\xa9 d'actions."
ToonHealJokes = [
 [
 ...
 [
  ...
  "D'un sale temps."],
 [
  'A quoi reconna\xc3\xaet-on un motard heureux?',
...
CheesyEffectDescriptions = [
 ...
 (
  'A plat', 'tu seras en deux dimensions'),
 (
...
SuitMicromanager = 'Micro\x03chef'
...
SuitTelemarketer = 'T\xc3\xa9l\xc3\xa9\x03vendeur'
...
SuitAttackTaunts = {'Audit': [
   ...
   'Legalese': [
              ...
              "Toontown Offline n'est pas l\xc3\xa9galement responsable des opinions exprim\xc3\xa9es dans cette attaque.", 
...
ElevatorLeaderOff = 'Seul ton chef peut d\xc3\xa9cider du moment o\xc3\xb9 descendre.'
...
KnockKnockContestJokes = {2100: {44: [
             'Tank',
...
SharedChatterGoodbyes = [
 ...
 'Eh bien, au revoir. A bient\xc3\xb4t, %!',
...
ChipChatter = (
 ...
 [
  ...
  'Les trous de golf dot\xc3\xa9s de volcans sont les plus difficiles pour moi.'],
 [
  'Nous allons dans le' + lTheBrrrgh + 'pour jouer avec %s.' % Pluto,
  'Nous rendrons visite \xc3\xa0 %s et pourrons le r\xc3\xa9parer.' % Donald,
  'Je crois que je vais aller me baigner dans' + lDonaldsDock + '.',
  "Oh, j'ai un peu sommeil. Je pense que je vais aller au Pays des R\xc3\xaaves."])
DaleChatter = (
 [
  'Je suis content de te voir % !',
 ...
 [
  ...
  'Les glands sont d\xc3\xa9licieux. Go\xc3\xbbte.',
  'Ces moulins \xc3\xa0 vent sont difficiles aussi.'],
 [
  'Hihihi' + Pluto + 'est un compagnon de jeu amusant.',
  "D'accord, r\xc3\xa9parons %s." % Donald,
  'Une baignade. Quelle id\xc3\xa9e rafra\xc3\xaechissante&nbsp;!',
  'Je suis de plus en plus fatigu\xc3\xa9 et ferais bien une petite sieste.'])
GoofyChatter = (
 [
 ...
 [
  ...
  'A la succursale du Glagla de ma boutique \xc3\xa0 gags, les lunettes hypnotiques sont en vente pour seulement 1 bonbon!',
  'La boutique \xc3\xa0 gags de Dingo propose les meilleurs blagues, astuces et chatouilles de tout Toontown!',
  'A la boutique \xc3\xa0 gags de Dingo, chaque tarte \xc3\xa0 la cr\xc3\xa8me est garantie faire rire ou tes bonbons te seront rembours\xc3\xa9s!'],
 [
  'Je vais au Pays musical voir ' + Minnie + '!',
...
GoofySpeedwayChatter = (
 ...
 [
  ...
  'A la succursale du Glagla de ma boutique \xc3\xa0 gags, les lunettes hypnotiques sont en vente pour seulement 1 bonbon!',
  'La boutique \xc3\xa0 gags de Dingo propose les meilleurs blagues, astuces et chatouilles de tout Toontown!',
  'A la boutique \xc3\xa0 gags de Dingo, chaque tarte \xc3\xa0 la cr\xc3\xa8me est garantie de te faire rire ou tes bonbons te seront rembours\xc3\xa9s !'],
 [
...
FriendInviterPlayerFriendInfo = 'Un ami \xc3\xa0 travers le r\xc3\xa9seau Toontown Offline'
...
FriendInviterToonAlready = '%s est d\xc3\xa9j\xc3\xa0 ton ami Toon.'
FriendInviterPlayerAlready = '%s est d\xc3\xa9j\xc3\xa0 ton ami de jeu.'
FriendInviterStopBeingToonFriends = "Cesser d'\xc3\xaatre ami Toon"
FriendInviterStopBeingPlayerFriends = "Cesser d'\xc3\xaatre ami de jeu"
FriendInviterEndFriendshipToon = "Es-tu s\xc3\xbbr de vouloir cesser d'\xc3\xaatre ami Toon avec %s ?"
FriendInviterEndFriendshipPlayer = "Es-tu s\xc3\xbbr de vouloir cesser d'\xc3\xaatre ami de jeu avec %s ?"
FriendInviterRemainToon = '\n(Tu resteras n\xc3\xa9anmoins ami Toon avec %s)'
FriendInviterRemainPlayer = '\n(Tu resteras n\xc3\xa9anmoins ami de jeu avec %s)'
...
TeaserTricks = " Entra\xc3\xaene ton Doudou\xc3\xa0 faire des tourspour\nqu'il t'aide dans les combats !"
TeaserGardening = 'Plante des fleurs, des statues et des arbres\n\xc3\xa0 gags pour embellir ta propri\xc3\xa9t\xc3\xa9.'
...
TeaserTricks = "Entra\xc3\xaene ton Doudou \xc3\xa0 faire des tours\npour t'aider dans le combat !"
TeaserSpecies = 'Cr\xc3\xa9e des Toons singe, cheval et ours, et joue avec !'
TeaserFishing = 'Collectionne toutes les esp\xc3\xa8ces de poissons !'
TeaserGolf = 'Joue sur des terrains de golf compl\xc3\xa8tement dingues !'
...
LauncherPhaseNames = {0: 'Initialisation', 
   1: 'Panda', 
   2: 'Moteur', 
   3: 'Faire un Toon', 
   3.5: 'Toontoriel', 
...
LauncherStartingMessage = 'Lancement de Toontown Offline...'
...
AvatarChoiceSubscribersOnly = 'D\xc3\xa9sactiv\xc3\xa9e'
...
PartiesPageTitle = 'F\xc3\xaates'
PartiesPageHostTab = 'Organiser'
PartiesPageInvitedTab = 'Invitations'
PartiesPageTitleHost = 'Ma prochaine f\xc3\xaate'
PartiesPageTitleInvited = 'Invitations pour la f\xc3\xaate'
MapPageTitle = 'Carte'
...
OptionsPageTextToSpeechOnLabel = 'Synth\xc3\xa8se vocale activ\xc3\xa9e.'
OptionsPageTextToSpeechOffLabel = 'Synth\xc3\xa8se vocale d\xc3\xa9sactiv\xc3\xa9e.'
OptionsPageTextToSpeechNotAvailableMacLabel = "Synth\xc3\x88se vocale n'est pas disponible pour les Macs."
OptionsPageTextToSpeechNotInstalledLabel = "Synth\xc3\x88se vocale a besoin d'eSpeak."
OptionsPageGetEspeak = 'T\xc3\xa9l\xc3\xa9charger'
...
UnknownFish = '???'
FishingRod = 'Canne %s'
FishingRodNameDict = {0: 'Brindille', 
   1: 'Bambou', 
   2: 'Bois dur', 
   3: 'Acier', 
   4: 'Or'}
...
BattleGlobalNPCTracks = [
 ...
 'Toons marquent',
 'Cogs ratent']
BattleGlobalAvPropStrings = (('Plume', 'M\xc3\xa9gaphone', 'Tube de rouge \xc3\xa0 l\xc3\xa8vres', 'Canne en bambou', 'Poussi\xc3\xa8re de f\xc3\xa9e', 'Balles de jonglage', 'Plongeon'), ('Peau de banane', 'R\xc3\xa2teau', 'Billes', 'Sable mouvant', 'Trappe', 'TNT', 'Chemin de fer'), ('Billet de 1 euro', 'Petit aimant', 'Billet de 5 euros', 'Gros aimant', 'Billet de 10 euros', 'Lunettes hypnotiques', 'Pr\xc3\xa9sentation'), ('Sonnette de v\xc3\xa9lo', 'Sifflet', 'Clairon', 'Klaxon', "Trompe d'\xc3\xa9l\xc3\xa9phant", 'Corne de brume', 'Chanteuse d\xe2\x80\x99op\xc3\xa9ra'), ('Petit g\xc3\xa2teau', 'Tranche de tarte aux fruits', 'Tranche de tarte \xc3\xa0 la cr\xc3\xa8me', 'Tarte aux fruits enti\xc3\xa8re', 'Tarte \xc3\xa0 la cr\xc3\xa8me enti\xc3\xa8re', "G\xc3\xa2teau d'anniversaire", 'G\xc3\xa2teau de mariage'), ('Fleur \xc3\xa0 \xc3\xa9clabousser', "Verre d'eau", 'Pistolet \xc3\xa0 eau', "Bouteille d'eau gazeuse", "Lance d'incendie", "Nuage d'orage", 'Geyser'), ('Pot de fleurs', 'Sac de sable', 'Enclume', 'Gros poids', 'Coffre-fort', 'Piano \xc3\xa0 queue', 'Toontanic'))
BattleGlobalAvPropStringsSingular = (('une plume', 'un m\xc3\xa9gaphone', 'un tube de rouge \xc3\xa0 l\xc3\xa8vres', 'une canne en bambou', 'de la poussi\xc3\xa8re de f\xc3\xa9e', 'un jeu de balles de jonglage', 'un Plongeon'), ('une peau de banane', 'un r\xc3\xa2teau', 'un jeu de billes', 'un peu de sable mouvant', 'une trappe', 'du TNT', 'un Chemin de fer'), ('un billet de 1 euro', 'un petit aimant', 'un billet de 5 euros', 'un gros aimant', 'un billet de 10 euros', 'une paire de lunettes hypnotiques', 'une Pr\xc3\xa9sentation'), ('une sonnette de v\xc3\xa9lo', 'un sifflet', 'un clairon', 'un klaxon', "une trompe d'\xc3\xa9l\xc3\xa9phant", 'une corne de brume', 'une Chanteuse d\xe2\x80\x99op\xc3\xa9ra'), ('un petit g\xc3\xa2teau', 'une tranche de tarte aux fruits', 'une tranche de tarte \xc3\xa0 la cr\xc3\xa8me', 'une tarte aux fruits enti\xc3\xa8re', 'une tarte \xc3\xa0 la cr\xc3\xa8me enti\xc3\xa8re', "un g\xc3\xa2teau d'anniversaire", 'un G\xc3\xa2teau de mariage'), ('une fleur \xc3\xa0 \xc3\xa9clabousser', "un verre d'eau", 'un pistolet \xc3\xa0 eau', "une bouteille d'eau gazeuse", "une lance d'incendie", "un nuage d'orage", 'un Geyser'), ('un pot de fleurs', 'un sac de sable', 'une enclume', 'un gros poids', 'un coffre-fort', 'un piano \xc3\xa0 queue', 'le Toontanic'))
BattleGlobalAvPropStringsPlural = (('Plumes', 'M\xc3\xa9gaphones', 'Tubes de rouge \xc3\xa0 l\xc3\xa8vres', 'Cannes en bambou', 'Poussi\xc3\xa8res de f\xc3\xa9e', 'jeux de balles de jonglage', 'Plongeons'), ('Peaux de bananes', 'R\xc3\xa2teaux', 'jeux de billes', 'morceaux de sable mouvant', 'Trappes', 'b\xc3\xa2tons de TNT', 'Chemins de fer'), ('Billets de 1 euro', 'Petits aimants', 'Billets de 5 euros', 'Gros aimants', 'Billets de 10 euros', 'Paires de lunettes hypnotiques', 'Pr\xc3\xa9sentations'), ('Sonnettes de v\xc3\xa9lo', 'Sifflets', 'Clairons', 'Klaxons', "Trompes d'\xc3\xa9l\xc3\xa9phants", 'Cornes de brume', 'Chanteuses d\xe2\x80\x99op\xc3\xa9ra'), ('Petits g\xc3\xa2teaux', 'Tranches de tarte aux fruits', 'Tranches de tarte \xc3\xa0 la cr\xc3\xa8me', 'Tartes aux fruits enti\xc3\xa8res', 'Tartes \xc3\xa0 la cr\xc3\xa8me enti\xc3\xa8res', "G\xc3\xa2teaux d'anniversaire", 'G\xc3\xa2teaux de mariage'), ('Fleurs \xc3\xa0 \xc3\xa9clabousser', "Verres d'eau", 'Pistolets \xc3\xa0 eau', "Bouteilles d'eau gazeuse", "Lances d'incendie", "Nuages d'orage", 'Geysers'), ('Pots de fleurs', 'Sacs de sable', 'Enclumes', 'Gros poids', 'Coffres-forts', 'Pianos \xc3\xa0 queue', 'Paquebots'))
...
StarringIn = 'En...'
if config.GetBool('want-tto-text', False):
    ...
    HeadingToYourEstate = 'Ta propri\xc3\xa9t\xc3\xa9'
    HeadingToEstate = 'La propri\xc3\xa9t\xc3\xa9 de %s'
    HeadingToFriend = "La propri\xc3\xa9t\xc3\xa9 de l'ami(e) de %s"
    HeadingToPlayground = 'Le terrain de jeux'
...
TwoDGameInstructions = 'Echappe-toi de cette' + Cog + 'tanni\xc3\xa8re d\xc3\xa8s que possible. Utilise les fl\xc3\xa8ches du clavier pour courir/sauter et la touche Ctrl pour faire gicler un' + Cog + '. Ramasse' + Cog + 'les tr\xc3\xa9sors pour gagner encore plus de points.'
...
PhotoGameInstructions = "Prends des photos correspondant aux Toons apparaissant en bas. Oriente l'appareil photo avec la souris et fais un clic gauche pour prendre une photo. Appuie sur la touche Ctrl pour faire un zoom avant/arri\xc3\xa8re, et d\xc3\xa9place-toi avec les fl\xc3\xa8ches du clavier. Les photos les mieux class\xc3\xa9es rapportent le plus de points."
PhotoGameTitle = 'D\xc3\xa9lire photo'
PhotoGameFilm = 'FILM'
PhotoGameScore = 'Score par \xc3\xa9quipe : %s\n\nMeilleures photos: %s\n\nScore total : %s'
CogThiefGameTitle = Cog + ' Voleur'
CogThiefGameInstructions = 'Emp\xc3\xaache-le ' + Cogs + ' de voler nos tonneaux de gags ! Appuie sur la touche Ctrl pour lancer une tarte. Utilise les fl\xc3\xa8ches du clavier pour te d\xc3\xa9placer. Astuce : tu peux te d\xc3\xa9placer en diagonale.'
...
CopyrightedNames = ('Mickey', 'Mickey Mouse', 'Mickey Mouse', 'Minnie Mouse', 'Minnie', 'Minnie Mouse', 'Minnie Mouse', 'Donald', 'Donald Duck', 'Donald Duck', 'Pluto', 'Dingo')
NumToColor = [
 'Blanc', 
 'P\xc3\xaache', 
 'Rouge vif', 
...
STOREOWNER_GOODBYE = 'A plus tard!'
...
QuestScriptTutorialMickey_3 = 'Tom Tuteur va te parler des Cogs.\x07Je dois y aller!'
...
QuestScriptTutorialMinnie_3 = 'Tom Tuteur va te parler des Cogs.\x07Je dois y aller!'
...
QuestScriptTutorialBlocker_5 = 'Tr\xc3\xa8s bien!\x07L\xc3\xa0 o\xc3\xb9 tu vas, il y a plein de Toons \xc3\xa0 qui parler.'
...
QuestScriptTutorialBlocker_8 = 'Bonne chance! A plus tard!'
...
QuestScript120_1 = "Bien, tu as trouv\xc3\xa9 le tramway!\x07Au fait, as-tu rencontr\xc3\xa9 Bob le Banquier ?\x07Il aime bien les sucreries.\x07Pourquoi n'irais-tu pas te pr\xc3\xa9senter en lui emportant ce sucre d'orge comme cadeau?"
QuestScript120_2 = 'Bob le Banquier est dans la banque de Toontown.'
QuestScript121_1 = "Miam, merci pour ce sucre d'orge.\x07Dis donc, si tu peux m'aider, je te donnerai une r\xc3\xa9compense.\x07Ces Cogs ont vol\xc3\xa9 les cl\xc3\xa9s de mon coffre. Va battre des Cogs pour trouver une cl\xc3\xa9 vol\xc3\xa9e.\x07Quand tu auras trouv\xc3\xa9 une cl\xc3\xa9, ram\xc3\xa8ne-la moi."
QuestScript130_1 = "Bien, tu as trouv\xc3\xa9 le tramway!\x07Pendant qu'on y est, j'ai re\xc3\xa7u un paquet pour le Professeur Pete aujourd'hui.\x07\xc3\x87a doit \xc3\xaatre la nouvelle craie qu'il a command\xc3\xa9e.\x07Peux-tu lui apporter s'il te pla\xc3\xaet ?\x07Il est dans l'\xc3\xa9cole."
QuestScript131_1 = "Oh, merci pour la craie.\x07Quoi?!?\x07Ces Cogs ont vol\xc3\xa9 mon tableau. Va vaincre des Cogs pour retrouver le tableau qu'ils m'ont vol\xc3\xa9.\x07Quand tu l'auras trouv\xc3\xa9, ram\xc3\xa8ne-le moi."
QuestScript140_1 = "Bien, tu as trouv\xc3\xa9 le tramway!\x07Pendant qu'on y est, j'ai un ami, Larry le Libraire, qui est un rat de biblioth\xc3\xa8que.\x07J'ai pris ce livre pour lui la derni\xc3\xa8re fois que j'ai \xc3\xa9t\xc3\xa9 aux quais Donald.\x07Pourrais-tu lui apporter ? Il est \xc3\xa0 la biblioth\xc3\xa8que, d'habitude."
QuestScript141_1 = "Oh, oui, ce livre compl\xc3\xa8te presque ma collection.\x07Voyons \xc3\xa7a...\x07Ah, oh...\x07Mais o\xc3\xb9 est-ce que j'ai mis mes lunettes?\x07Je les avais juste avant que ces Cogs ne prennent mon b\xc3\xa2timent.\x07Va vaincre des Cogs pour retrouver les lunettes qu'ils m'ont vol\xc3\xa9es.\x07Quand tu les auras retrouv\xc3\xa9es, reviens me voir pour avoir une r\xc3\xa9compense."
QuestScript145_1 = "Je vois que tu n'as pas eu de probl\xc3\xa8mes avec le tramway!\x07\xc3\x89coute, les Cogs ont vol\xc3\xa9 notre brosse \xc3\xa0 tableaux.\x07Va dans les rues et combats les Cogs jusqu'a ce que tu retrouves la brosse.\x07Pour atteindre les rues, passe par un des tunnels comme celui-ci :"
QuestScript145_2 = "Quand tu auras retrouv\xc3\xa9 notre brosse, ramene-la ici.\x07N'oublie pas : si tu as besoin de gags, va faire un tour de tramway.\x07De meme, si tu as besoin de r\xc3\xa9cup\xc3\xa9rer des rigolpoints, ramasse des c\xc3\xb4nes de glace sur le terrain de jeu."
...
CashbotBossName = 'Directeur Financier'
LawbotBossName = 'Juge en Chef'
...
BossCogDoobersAway = {'s': 'Va! Et r\xc3\xa9alise cette vente!'}
...
BossCogAttackToons = "A l'attaque!!"
CagedToonDrop = [
...
CagedToonPrepareBattleTwo = "Attention, il essaie de s'enfuir!\x07Aidez-moi, tout le monde - montez jusque l\xc3\xa0 et arr\xc3\xaatez-le!"
CagedToonPrepareBattleThree = 'Youpi, je suis presque libre!\x07Maintenant vous devez attaquer le vice-pr\xc3\xa9sident des Cogs directement.\x07J\'ai tout un lot de tartes que vous pouvez utiliser!\x07Sautez en l\'air et touchez le fond de ma cage, je vous donnerai des tartes.\x07Appuyez sur la touche "Inser" pour lancer les tartes une fois que vous les avez!'
...
CagedToonThankYou = "C'est super d'\xc3\xaatre libre!\x07Merci pour toute votre aide!\x07Je suis \xc3\xa0 votre service.\x07Si jamais vous avez besoin d'aide pour un combat, vous pouvez m'appeler!\x07Cliquez simplement sur le bouton SOS pour m'appeler."
CagedToonPromotion = '\x07Dis donc - ce vice-pr\xc3\xa9sident Cog a laiss\xc3\xa9 derri\xc3\xa8re lui les papiers de ta promotion.\x07Je vais les envoyer pour toi en sortant, pour que tu aies ta promotion!'
CagedToonLastPromotion = '\x07Waou, tu as atteint le niveau %s sur ton costume de Cog!\x07Les Cogs ne montent pas en grade plus haut que \xc3\xa7a.\x07Tu ne peux plus monter ton costume de Cog en grade, mais tu peux \xc3\xa9videmment continuer \xc3\xa0 sauver des Toons!'
CagedToonHPBoost = '\x07Tu as sauv\xc3\xa9 beaucoup de Toons dans ce QG.\x07Le Conseil de Toontown a d\xc3\xa9cid\xc3\xa9 de te donner un autre rigolpoint. F\xc3\xa9licitations!'
CagedToonMaxed = "\x07Je vois que tu as un costume de Cog de niveau %s. Tr\xc3\xa8s impressionnant!\x07De la part du Conseil de Toontown, merci d'\xc3\xaatre revenu(e) sauver encore plus de Toons!"
CagedToonGoodbye = 'A la prochaine!'
CagedToonBattleThree = {10: 'Joli saut, %(toon)s. Voil\xc3\xa0 quelques tartes!', 
...
ResistanceToonCongratulations = "Tu y es arriv\xc3\xa9(e)! F\xc3\xa9licitations!\x07Tu es un membre de valeur de la R\xc3\xa9sistance!\x07Voici une phrase tr\xc3\xa8s sp\xc3\xa9ciale que tu peux utiliser en cas de situation difficile :\x07%s\x07Quand tu la prononces, %s.\x07Mais tu ne peux l'utiliser qu'une seule fois, alors choisis bien ton moment!"
...
ResistanceToonLastPromotion = '\x07Waouh, tu as atteint le niveau %s de ton costume de Cog!\x07Les Cogs ne vont jamais plus haut que ce niveau.\x07Tu ne peux plus rien ajouter \xc3\xa0 ton costume de Cog mais tu peux bien s\xc3\xbbr continuer \xc3\xa0 travailler pour la R\xc3\xa9sistance!'
ResistanceToonHPBoost = '\x07Tu as beaucoup fait pour la R\xc3\xa9sistance.\x07Le Conseil des Toons a d\xc3\xa9cid\xc3\xa9 de te donner un autre rigolpoint. F\xc3\xa9licitations!'
ResistanceToonMaxed = "\x07Je vois que tu as un costume de Cog de niveau %s. Tr\xc3\xa8s impressionnant!\x07De la part du Conseil des Toons, merci d'\xc3\xaatre revenu pour secourir encore plus de Toons!"
CashbotBossCogAttack = 'Attrapez-les!!!'
ResistanceToonWelcome = "\xc3\x87a y est, tu y es arriv\xc3\xa9! Suis-moi jusqu'au coffre-fort principal avant que le Directeur Financier ne nous trouve!"
...
ResistanceToonCraneInstructions3 = 'Attrape un coffre-fort avec un aimant et fais tomber le casque de s\xc3\xa9curit\xc3\xa9 du Directeur Financier.'
...
ClothingTypeNames = {1400: 'Chemise de Mathieu', 
   1401: 'Chemise de Jessica', 
   1402: 'Chemise de Marissa', 
   1600: 'Tenue Pi\xc3\xa8ge', 
   1601: 'Tenue Tapage', 
   1602: 'Tenue Leurre', 
   1603: 'Tenue Pi\xc3\xa8ge', 
   1604: 'Tenue Tapage', 
   1605: 'Tenue Leurre', 
   1606: 'Tenue Pi\xc3\xa8ge', 
   1607: 'Tenue Tapage', 
   1608: 'Tenue Leurre'}
SurfaceNames = ('Papier peint', 'Moulures', 'Rev\xc3\xaatement de sol', 'Lambris', 'Bordure')
WallpaperNames = {1000: 'Parchemin', 
   1100: 'Milan', 
   1200: 'Douvres', 
   1300: 'Victoria', 
   1400: 'Newport', 
...
FlooringNames = {1000: 'Parquet', 
   ...
   11000: 'Tr\xc3\xa8fle', 
   11010: 'Tr\xc3\xa8fle'}
MouldingNames = {1000: 'Noueux', 
   1010: 'Peint', 
   1020: 'Dent\xc3\xa9', 
   1030: 'Fleurs', 
   1040: 'Fleurs', 
   1050: 'Coccinelle'}
WainscotingNames = {1000: 'Peint', 
   1010: 'Panneau de bois', 
   1020: 'Bois'}
WindowViewNames = {10: 'Grand jardin', 
   20: 'Jardin sauvage', 
   30: 'Jardin grec', 
   40: 'Paysage urbain', 
   50: 'Far West', 
...
HDInTrashPickerLabel = 'A la poubelle'
...
HDHelpDict = {'DoneMoving': 'Terminer la d\xc3\xa9coration de la pi\xc3\xa8ce.', 
...
CatalogMembersOnly = 'R\xc3\xa9serv\xc3\xa9 aux membres\n  !'
CatalogSndOnText = 'Connect\xc3\xa9'
CatalogSndOffText = 'Non connect\xc3\xa9'
...
NPCToonNames = {20000: 'Tom Tuteur', 
   ...
   7008: 'Ima Cagedtoon', 
   7009: 'Jimmy Thelock', 
   14001: 'R\xc3\x89SISTANCE RANGER Rocky', 
   14002: 'R\xc3\x89SISTANCE RANGER Ruth', 
   14003: 'R\xc3\x89SISTANCE RANGER Reg', 
   14004: 'R\xc3\x89SISTANCE RANGER Randolph', 
   14005: 'R\xc3\x89SISTANCE RANGER Ridley', 
   14006: 'Logano', 
   14007: 'Sparky', 
   14008: 'Weird', 
   14009: 'Ned', 
   ...
   14011: 'Rocky', 
   14012: 'Jaquanza', 
   14013: 'Doctor Flippenbrains', 
   14014: 'Bear E. Funny', 
   14015: 'R\xc3\x89SISTANCE RANGER Ripley', 
   14016: 'R\xc3\x89SISTANCE RANGER Randy', 
   14017: 'R\xc3\x89SISTANCE RANGER Rupert', 
   14018: 'R\xc3\x89SISTANCE RANGER Roy', 
   14019: 'R\xc3\x89SISTANCE RANGER Rhett', 
   14020: 'R\xc3\x89SISTANCE RANGER Raven', 
   14021: 'R\xc3\x89SISTANCE RANGER Ralph', 
   14022: 'Doctor Surlee (2003)', 
   14024: 'Doctor Surlee (2008)', 
   14026: 'Doctor Surlee (2013)', 
   14029: 'Balthazar Picsou', 
   91913: 'Shockley', 
   91914: 'Sir Max', 
   91915: 'McQuack', 
   91916: 'Hawkheart'}
zone2TitleDict = {2513: (
   ...
   2516: (
        'Ecole de Toontown', ''), 
   2518: (
        'Biblioth\xc3\xa8que de Toontown', ''), 
   2519: (
        'Boutique \xc3\xa0 gags', ''), 
   2520: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   2521: (
        'Boutique de pr\xc3\xaat-\xc3\xa0-porter', ''), 
   2522: (
        'ANIMALERIE', ''), 
   2523: (
        'Vote pour Allan Bic!', ''), 
   2601: (
        'Tout-sourire - R\xc3\xa9parations dentaires', ''), 
   2602: (
        '', ''), 
   2603: (
        'Mineurs Pince-sans-rire', ''), 
   2604: (
        'Qui vivra, verrat', ''), 
   2605: (
        'Usine \xc3\xa0 pancartes de Toontown', ''), 
   2606: (
        '', ''), 
   2607: (
        'Haricots sauteurs', ''), 
   ...
   2611: (
        '', ''), 
   2616: (
        'Barbefolle - D\xc3\xa9guisements', ''), 
   2617: (
        'Cascades Comiques', ''), 
   2618: (
        'Nouba & Co', ''), 
   2621: (
        'Avions en papier', ''), 
   2624: (
        'Aux joyeux hooligans', ''), 
   2625: (
        'La maison du p\xc3\xa2t\xc3\xa9 rat\xc3\xa9', ''), 
   2626: (
        'Chez Jesse - R\xc3\xa9paration de blagues', ''), 
   2629: (
        'Le coin du rire', ''), 
   2632: (
        "L'\xc3\xa9cole des clowns", ''), 
   2633: (
        'Th\xc3\xa9-hier - Salon de th\xc3\xa9', ''), 
   2638: (
        'Th\xc3\xa9\xc3\xa2tre de Toontown', ''), 
   2639: (
        'Monnaie de singe', ''), 
   2643: (
        'Bouteilles en bo\xc3\xaete', ''), 
   2644: (
        'Farces farcies', ''), 
   2649: (
        'Magasin de jeux', ''), 
   ...
   2653: (
        '', ''), 
   2654: (
        'Le\xc3\xa7ons de rire', ''), 
   2655: (
        "Dr\xc3\xb4le d'argent - Caisse d'\xc3\xa9pargne", ''), 
   2656: (
        "Voitures de clown d'occasion", ''), 
   2657: (
        'Pirouettes de Pierrette', ''), 
   2659: (
        "L'univers des vibrateurs", ''), 
   2660: (
        'Machines \xc3\xa0 chatouilles', ''), 
   2661: (
        'Daffy Taffy', ''), 
   2662: (
        'Dr E. Phorique', ''), 
   ...
   2664: (
        'Les mimes marrants', ''), 
   2665: (
        'Le Man\xc3\xa8ge - Agence de voyages', ''), 
   2666: (
        'Bouteilles de gaz hilarant', ''), 
   2667: (
        'Au bon temps', ''), 
   2669: (
        'Chez Gaston - ballons pas folichons', ''), 
   2670: (
        'Fourchettes \xc3\xa0 soupe', ''), 
   2671: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   2701: (
        '', ''), 
   2704: (
        'Th\xc3\xa9\xc3\xa2tre de Toontown', ''), 
   2705: (
        'Tony Truant - Bruits en tout genre', ''), 
   2708: (
        'Colle bleue', ''), 
   2711: (
        'Bureau de poste de Toontown', ''), 
   2712: (
        'Caf\xc3\xa9 des gloussements', ''), 
   2713: (
        'Caf\xc3\xa9 du rire', ''), 
   2714: (
        'Th\xc3\xa9\xc3\xa2tre de Toontown', ''), 
   2716: (
        'Dr \xc3\x83le de soupe', ''), 
   2717: (
        'Bo\xc3\xaetes en bouteille', ''), 
   2720: (
        'Plaies et Bosses - R\xc3\xa9parations de voitures', ''), 
   2725: (
        '', ''), 
   2727: (
        'Bouteilles et bo\xc3\xaetes Selter', ''), 
   2728: (
        'Cr\xc3\xa8me de jour \xc3\xa9vanescente', ''), 
   2729: (
        'Ornithorynques 14 carats', ''), 
   2730: (
        'La gazette du rire', ''), 
   2731: (
        '', ''), 
   2732: (
        'Spaghettis et barbituriques', ''), 
   2733: (
        'Cerf-volants en fonte', ''), 
   2734: (
        'Tasses et soucoupes volantes', ''), 
   2735: (
        'Le P\xc3\xa9tard mouill\xc3\xa9', ''), 
   2739: (
        'R\xc3\xa9paration de fous rires', ''), 
   2740: (
        "P\xc3\xa9tards d'occasion", ''), 
   2741: (
        '', ''), 
   2742: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   ...
   2801: (
        'Coussins sonores', ''), 
   2802: (
        'Boulets de d\xc3\xa9molition gonflables', ''), 
   2803: (
        'Th\xc3\xa9\xc3\xa2tre de Toontown', ''), 
   2804: (
        'Dr. Faismarcher, chiropracteur', ''), 
   2805: (
        '', ''), 
   2809: (
        'Salle de gym Le Poids lent', ''), 
   2814: (
        'Th\xc3\xa9\xc3\xa2tre de Toontown', ''), 
   2818: (
        'Au p\xc3\xa2t\xc3\xa9 volant', ''), 
   2821: (
        '', ''), 
   2822: (
        'Sandwichs au poulet synth\xc3\xa9tique', ''), 
   2823: (
        'Glaces hilarantes', ''), 
   2824: (
        'Cin\xc3\xa9ma des blagues', ''), 
   2829: (
        'Balivernes', ''), 
   2830: (
        "Les piques d'Annick", ''), 
   2831: (
        'La maison du rire du professeur Tortillard', ''), 
   2832: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   2833: (
        '', ''), 
   2834: (
        'Salle des urgences des morts de rire', ''), 
   2836: (
        '', ''), 
   2837: (
        'Hardi - S\xc3\xa9minaires', ''), 
   2839: (
        'A la nouille am\xc3\xa8re', ''), 
   2841: (
        '', ''), 
   1506: (
        'Boutique \xc3\xa0 gags', ''), 
   ...
   1510: (
        'ANIMALERIE', ''), 
   1602: (
        "Gilets de sauvetage d'occasion", ''), 
   1604: (
        'Costumes de bain - Nettoyage \xc3\xa0 sec', ''), 
   1606: (
        "Crochet - R\xc3\xa9paration d'horloges", ''), 
   1608: (
        'Le Lof', ''), 
   1609: (
        "A l'app\xc3\xa2t rance", ''), 
   1612: (
        'Banque Sixsous', ''), 
   1613: (
        "La Pieuvre, cabinet d'avocats", ''), 
   1614: (
        'Toutes voiles devant - Boutique', ''), 
   1615: (
        "Yatch qu'\xc3\xa0 demander!", ''), 
   1616: (
        'Barbe Noire - Salon de beaut\xc3\xa9', ''), 
   1617: (
        'La mer \xc3\xa0 voir - Opticien', ''), 
   1619: (
        "L'\xc3\xa9corcaire - Chirurgie arboricole", ''), 
   1620: (
        'Babord-tribord', ''), 
   1621: (
        'Salle de gym La poupe', ''), 
   1622: (
        'Gymnote - Electricit\xc3\xa9 g\xc3\xa9n\xc3\xa9rale', ''), 
   1624: (
        'R\xc3\xa9paration de couteaux et de peignes', ''), 
   1626: (
        'La perche rare - Tenues de soir\xc3\xa9e', ''), 
   1627: (
        'La cabane de Sam Suffit', ''), 
   1628: (
        'Accordeur de thons', ''), 
   1629: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   1701: (
        "Ecole maternelle des p'tits loups", ''), 
   1703: (
        'Bar Accuda - Restaurant chinois', ''), 
   1705: (
        'Voiles \xc3\xa0 vendre', ''), 
   1706: (
        'La m\xc3\xa9duse m\xc3\xa9dus\xc3\xa9e', ''), 
   1707: (
        "C'est assez - Boutique de cadeaux", ''), 
   1709: (
        'G\xc3\xa9l\xc3\xa9e de m\xc3\xa9duse', ''), 
   1710: (
        'La belle bernache', ''), 
   1711: (
        'Restaurant de la pleine mer', ''), 
   1712: (
        'Salle de gymnote', ''), 
   1713: (
        'Chez Art - Cartes en tous genres', ''), 
   1714: (
        'Auberge du moulinet', ''), 
   1716: (
        'Maillots de bains pour sir\xc3\xa8nes', ''), 
   1717: (
        'Mi pacifique, mi raisin', ''), 
   1718: (
        'Soci\xc3\xa9t\xc3\xa9 de taxi le Naufrage', ''), 
   1719: (
        "Soci\xc3\xa9t\xc3\xa9 Je m'cache \xc3\xa0 l'eau", ''), 
   1720: (
        'Au requin malin', ''), 
   1721: (
        'Tout pour la mer', ''), 
   1723: (
        'Au royaume des algues', ''), 
   1724: (
        'Au m\xc3\xa9rou amoureux', ''), 
   1725: (
        "J'en pince pour toi - Crabes frais", ''), 
   1726: (
        'Bi\xc3\xa8re \xc3\xa0 flots', ''), 
   1727: (
        'Je rame pour vous', ''), 
   1728: (
        'Limules porte-bonheur', ''), 
   1729: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   1802: (
        'Les petits p\xc3\xa9ch\xc3\xa9s', ''), 
   1804: (
        'Salle de gym Les mollusques', ''), 
   1805: (
        'Un petit ver pour le d\xc3\xa9jeuner', ''), 
   1806: (
        'Toucoule - Chapelier', ''), 
   1807: (
        'Co\xc3\xbbte que soute', ''), 
   1808: (
        'App\xc3\xa2t si vite!', ''), 
   1809: (
        'Seaux rouill\xc3\xa9s', ''), 
   1810: (
        "L'ancre noire", ''), 
   1811: (
        'M\xc3\xa9rou tu vas chercher tout \xc3\xa7a?', ''), 
   1813: (
        'A m\xc3\xa2ts couverts, conseiller', ''), 
   1814: (
        'Le Ho Hisse', ''), 
   1815: (
        'Quoi de neuf dockteur ?', ''), 
   1818: (
        'Caf\xc3\xa9 des sept mers', ''), 
   1819: (
        'Au d\xc3\xaener des dockers', ''), 
   1820: (
        "L'hame\xc3\xa7on gob\xc3\xa9 - Farces et attrapes", ''), 
   1821: (
        'Chez Neptoon', ''), 
   1823: (
        'A la pomme de m\xc3\xa2t', ''), 
   1824: (
        'Au chien pas gai', ''), 
   1825: (
        'Le hareng sort! March\xc3\xa9 aux poissons', ''), 
   1826: (
        'Le placard de G\xc3\xa9rard', ''), 
   1828: (
        "Palais du lest d'Ernest", ''), 
   1829: (
        "Merlan l'enchanteur", ''), 
   1830: (
        'O sole et mio - Objets trouv\xc3\xa9s', ''), 
   1831: (
        'Une perle \xc3\xa0 domicile', ''), 
   1832: (
        'Sup\xc3\xa9rette La Go\xc3\xa9lette', ''), 
   1833: (
        "Costumes pour gaillards d'avant", ''), 
   1834: (
        'Tranchement ridicule!', ''), 
   1835: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   4503: (
        'Boutique \xc3\xa0 gags', ''), 
   ...
   4604: (
        'A quatre temps', ''), 
   4605: (
        "Fifi - Violons d'Ingres", ''), 
   4606: (
        'La case des castagnettes', ''), 
   4607: (
        'V\xc3\xaatements Toon branch\xc3\xa9s', ''), 
   4609: (
        'Dot, Raie, Mie - Pianos', ''), 
   4610: (
        'Attention refrain!', ''), 
   4611: (
        "Diapasons \xc3\xa0 l'unisson", ''), 
   4612: (
        'Dr. Tefaispasdebile - Dentiste', ''), 
   4614: (
        'On rase gratis pour une chanson', ''), 
   4615: (
        'Pizz\xc3\xa9ria chez Piccolo', ''), 
   4617: (
        'La mandoline joyeuse', ''), 
   4618: (
        'Salles des c\xc3\xa9sures', ''), 
   4619: (
        'En avant la musique!', ''), 
   4622: (
        'Oreillers \xc3\xa0 mentonni\xc3\xa8re', ''), 
   4623: (
        'B\xc3\xa9mols \xc3\xa0 la di\xc3\xa8se', ''), 
   4625: (
        'Tuba de dentifrice', ''), 
   4626: (
        'Notations', ''), 
   4628: (
        'Assurance accidentelle', ''), 
   4629: (
        'Riff - Assiettes en papier', ''), 
   4630: (
        'La musique est notre force', ''), 
   4631: (
        'Canto de vous conna\xc3\xaetre!', ''), 
   4632: (
        'Boutique de la danse des heures', ''), 
   4635: (
        'Le quotidien des cantatrices', ''), 
   4637: (
        'Pour la bonne mesure', ''), 
   4638: (
        'Boutique Hard Rock', ''), 
   4639: (
        'Les quatre saisons - Antiquit\xc3\xa9s', ''), 
   4641: (
        "L'actualit\xc3\xa9 du y\xc3\xa9y\xc3\xa9", ''), 
   4642: (
        'D. Tach\xc3\xa9 - Nettoyage \xc3\xa0 sec', ''), 
   4645: (
        'Club 88', ''), 
   4646: (
        '', ''), 
   4648: (
        'Le Toon siffleur - D\xc3\xa9m\xc3\xa9nageurs', ''), 
   4649: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   4652: (
        'Boutique des doubles-croches', ''), 
   4653: (
        '', ''), 
   4654: (
        'Haut perch\xc3\xa9 - Toitures', ''), 
   4655: (
        'La cl\xc3\xa9 de sol - Ecole de cuisine', ''), 
   4656: (
        '', ''), 
   4657: (
        'Quatuor du barbier', ''), 
   4658: (
        'Pianos en chute libre', ''), 
   4659: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   4701: (
        "L'eau de rose - Ecole de valse", ''), 
   4702: (
        ' Timbre de bois - Fournitures pour b\xc3\xbbcherons', ''), 
   4703: (
        'Gros Bizet \xc3\xa0 tous!', ''), 
   4704: (
        'Tina - Concerts de concertina', ''), 
   4705: (
        'Il est d\xc3\xa9j\xc3\xa0 cithare ?', ''), 
   4707: (
        "Studio d'effets sonores Doppler", ''), 
   4709: (
        "Pirouettes - Magasin d'alpinisme", ''), 
   4710: (
        'Polka tu routes si vite ? Auto-\xc3\xa9cole', ''), 
   4712: (
        'Mets un b\xc3\xa9mol! R\xc3\xa9paration de pneus', ''), 
   4713: (
        'Dos di\xc3\xa8se - V\xc3\xaatements de luxe pour hommes', ''), 
   4716: (
        'Harmonicas \xc3\xa0 quatre voix', ''), 
   4717: (
        'Sonate pas ta faute! Assurance automobile', ''), 
   4718: (
        'Chopins de bi\xc3\xa8re et autres ustensiles de cuisine', ''), 
   4719: (
        'Camping-cars Madrigal', ''), 
   4720: (
        'Le bon Toon', ''), 
   4722: (
        'Doublures pour ouvertures', ''), 
   4723: (
        'Bach \xc3\xa0 toi! Jeux et balan\xc3\xa7oires', ''), 
   4724: (
        '(Cale)sons blancs pour filles et gar\xc3\xa7ons', ''), 
   4725: (
        'Le barbier baryton', ''), 
   4727: (
        'Cordes vocales tress\xc3\xa9es', ''), 
   4728: (
        'Chante en sourdine!', ''), 
   4729: (
        "Librairie J'aime lyre", ''), 
   4730: (
        'Lettre \xc3\xa0 un pou', ''), 
   4731: (
        'Des Toons de bon ton', ''), 
   4732: (
        'Etude brute ? Troupe de th\xc3\xa9\xc3\xa2tre', ''), 
   4733: (
        '', ''), 
   4734: (
        '', ''), 
   4735: (
        'Soufflet pour accord\xc3\xa9ons', ''), 
   4736: (
        'Hyminent - Pr\xc3\xa9paratifs de mariage', ''), 
   4737: (
        'Harpe H\xc3\xb4nneur', ''), 
   4738: (
        'M\xc3\xa9canique cantique - Cadeaux', ''), 
   4739: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   4801: (
        "Cr\xc3\xaap'chignon", ''), 
   4803: (
        'Quelle Mezzo! Service de domestiques', ''), 
   4804: (
        'Ecole myxolidienne pour serveurs de barres', ''), 
   4807: (
        'Massage des Brahms et des jambes', ''), 
   4809: (
        "C'est une cata-strophe!", ''), 
   4812: (
        '', ''), 
   4817: (
        "Magasin d'animaux ternaires", ''), 
   4819: (
        'Chez Yuki - Uk\xc3\xa9l\xc3\xa9l\xc3\xa9s', ''), 
   4820: (
        '', ''), 
   4821: (
        'Chez Anna - Croisi\xc3\xa8res', ''), 
   4827: (
        'Montres Lamesure', ''), 
   4828: (
        'Ravel - R\xc3\xa9veils et horloges', ''), 
   4829: (
        'Chez Pachelbel - Obus pour canons et fugues', ''), 
   4835: (
        'Ursatz pour Kool Katz', ''), 
   4836: (
        'Reggae royal', ''), 
   4838: (
        'Ecole de kazoologie', ''), 
   4840: (
        'Coda Pop - Boissons musicales', ''), 
   4841: (
        'Lyre et Lyre', ''), 
   4842: (
        'Soci\xc3\xa9t\xc3\xa9 Lasyncope', ''), 
   4843: (
        '', ''), 
   4844: (
        'Moto - deux roues', ''), 
   4845: (
        "Les \xc3\xa9l\xc3\xa9gies \xc3\xa9l\xc3\xa9gantes d'Ellie", ''), 
   4848: (
        "De haute luth - Caisse d'\xc3\xa9pargne", ''), 
   4849: (
        '', ''), 
   4850: (
        "L'accord emprunt\xc3\xa9 - Pr\xc3\xaateur sur gages", ''), 
   4852: (
        'Flasques fleuries pour fl\xc3\xbbtes', ''), 
   4853: (
        'Chez L\xc3\xa9o - Garde-feu', ''), 
   4854: (
        'Chez Wagner - Vid\xc3\xa9os de violons voil\xc3\xa9s', ''), 
   4855: (
        'R\xc3\xa9seau de radeau-diffusion', ''), 
   4856: (
        '', ''), 
   4862: (
        'Les quadrilles quintessencielles de Quentin', ''), 
   4867: (
        'M. Costello - Kazoos \xc3\xa0 gogo', ''), 
   4868: (
        '', ''), 
   4870: (
        'Chez Ziggy - Zoo et Zigeunermusik', ''), 
   4871: (
        'Chez Harry - Harmonies harmonieuses', ''), 
   4872: (
        'Freddie Fastoche - Touches de piano', ''), 
   4873: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   5501: (
        'Boutique \xc3\xa0 gags', ''), 
   ...
   5505: (
        'ANIMALERIE', ''), 
   5601: (
        "L'\xc5\x93il de bouillon - Optom\xc3\xa9trie", ''), 
   5602: (
        'Eug\xc3\xa8ne Coulissant - Cravates', ''), 
   5603: (
        'Arr\xc3\xaate tes salades!', ''), 
   5604: (
        'Gai, gai, marions-les!', ''), 
   5605: (
        'Sols et meubles', ''), 
   ...
   5607: (
        'Bureau de composte', ''), 
   5608: (
        'Pop corn y\xc3\xa9y\xc3\xa9', ''), 
   5609: (
        'La baie au tr\xc3\xa9sor', ''), 
   5610: (
        "L'\xc5\x93il au beurre noir - Cours de boxe", ''), 
   5611: (
        'Les gags de la Taupe', ''), 
   5613: (
        'La meule \xc3\xa0 z\xc3\xa9ro - Barbier', ''), 
   5615: (
        'Chez Piaf - Graines pour oiseaux', ''), 
   5616: (
        'Auberge de la goutte', ''), 
   5617: (
        'Chez Parpaillon - Papillons', ''), 
   5618: (
        'Deux pois deux mesures', ''), 
   5619: (
        'Chez Jack - Haricots g\xc3\xa9ants', ''), 
   5620: (
        'Auberge du rateau', ''), 
   5621: (
        'La critique du Raisin pur', ''), 
   5622: (
        'La petite reine - claude - Bicyclettes', ''), 
   5623: (
        'Bains moussants pour oiseaux', ''), 
   5624: (
        'Ecoute ta m\xc3\xa8re', ''), 
   5625: (
        'Dur de la feuille', ''), 
   5626: (
   ...
   5701: (
        'Le bambou du tunnel', ''), 
   5702: (
        'Les rateaux de Jacquot', ''), 
   5703: (
        'Cynthia - Magasin de photosynth\xc3\xa8ses', ''), 
   5704: (
        "Citronelle Citron - Voitures d'occasion", ''), 
   5705: (
        'Meubles en herbe \xc3\xa0 puce', ''), 
   5706: (
        ' 14 carottes - Bijoutiers', ''), 
   5707: (
        'Fruit musical', ''), 
   5708: (
        'Sans soucis - Agence de voyages', ''), 
   5709: (
        'Astroturf - Tondeuses', ''), 
   5710: (
        'Gym des narcisses', ''), 
   5711: (
        'Bonneterie de jardin', ''), 
   5712: (
        'Statues squottes', ''), 
   5713: (
        'Buis clos', ''), 
   5714: (
        "Bouteilles d'eau de roche", ''), 
   5715: (
        'La Meule nouvelle', ''), 
   5716: (
        "Qui s'y frotte s'y pique - Pr\xc3\xaateur sur gages", ''), 
   5717: (
        'La fleur qui mouille', ''), 
   5718: (
        'Le ch\xc3\xa8vre-feuille - Animalerie', ''), 
   5719: (
        "Sauge d'une nuit d'\xc3\xa9t\xc3\xa9 - D\xc3\xa9tective priv\xc3\xa9", ''), 
   5720: (
        'La feuille de vigne - Pr\xc3\xaat-\xc3\xa0-porter masculin', ''), 
   5721: (
        'Routabaga 66 - Restaurant', ''), 
   5725: (
        "Boutique du grain d'orge", ''), 
   5726: (
        'Bert', ''), 
   5727: (
        "Le trou sans fond - Caisse d'\xc3\xa9pargne", ''), 
   5728: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   5802: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   ...
   5805: (
        'Le cerveau lent', ''), 
   5809: (
        "Dr\xc3\xb4le d'oiseau - Ecole de clowns", ''), 
   5810: (
        'Ca ne rom \xc3\xa0 rain!', ''), 
   5811: (
        'Auberge Inn', ''), 
   5815: (
        'Des racines & des herbes', ''), 
   5817: (
        'Pommes et oranges', ''), 
   5819: (
        'Pantalons vert citron', ''), 
   5821: (
        'Centre de squash', ''), 
   5826: (
        "Mat\xc3\xa9riel d'\xc3\xa9levage de fourmis", ''), 
   5827: (
        'Terre bon march\xc3\xa9', ''), 
   5828: (
        'Meubles Molasson', ''), 
   5830: (
        'Vide ton sac (de patates)', ''), 
   5833: (
        'Bar \xc3\xa0 salades', ''), 
   5835: (
        "S\xc3\xa9jour en pots chez l'habitant", ''), 
   5836: (
        'Salles de bain J. Boul\xc3\xa9e', ''), 
   5837: (
        "L'\xc3\xa9cole de la vigne", ''), 
   9501: (
        'Biblioth\xc3\xa8que des berceuses', ''), 
   9503: (
        'Bar du roupillon', ''), 
   9504: (
        'Boutique \xc3\xa0 gags', ''), 
   ...
   9508: (
        'ANIMALERIE', ''), 
   9601: (
        'Auberge des c\xc3\xa2lins', ''), 
   9602: (
        'Sommes au rabais', ''), 
   9604: (
        'Chez Ed - Edredons redondants', ''), 
   9605: (
        'Confection de bonnets de nuit', ''), 
   9607: (
        'Big Mama - Pyjamas des Bahamas', ''), 
   9608: (
        'Quand le chat dort, les souris dansent', ''), 
   9609: (
        'Roupillon pour trois ronds', ''), 
   9613: (
        'Th\xc3\xa9\xc3\xa2tre du pays des r\xc3\xaaves', ''), 
   9616: (
        'La veilleuse - Electricit\xc3\xa9 g\xc3\xa9n\xc3\xa9rale', ''), 
   9617: (
        "L'enfant do - Petites musiques de nuit", ''), 
   9619: (
        'Relax Max', ''), 
   9620: (
        'PJ - Service de taxi', ''), 
   9622: (
        'Horloges du sommeil', ''), 
   9625: (
        'Histoire en boucle - Salon de beaut\xc3\xa9', ''), 
   9626: (
        'Histoiries Dodo', ''), 
   9627: (
        'Le tipi endormi', ''), 
   9628: (
        'Sam Suffit - Calendriers', ''), 
   9629: (
        "A l'\xc3\xa9dredon d'argent", ''), 
   9630: (
        'Marchand de sable', ''), 
   9631: (
        "Temps d'arr\xc3\xaat - Horloger", ''), 
   9633: (
        'Th\xc3\xa9\xc3\xa2tre du pays des r\xc3\xa9ves', ''), 
   9634: (
        'Je ronfle, donc je suis', ''), 
   9636: (
        'Assurance pour insomniaques', ''), 
   9639: (
        "Maison de l'hibernation", ''), 
   9640: (
        'Nous meublons vos r\xc3\xaaves', ''), 
   9642: (
        'A la sciure de mon front', ''), 
   9643: (
        'Les yeux clos - Optom\xc3\xa9trie', ''), 
   9644: (
        "Combats d'oreillers nocturnes", ''), 
   9645: (
        'Auberge Viensmeborder', ''), 
   9647: (
        'Fais ton lit! Magasin de bricolage', ''), 
   9649: (
        'Bonnet blanc et blanc bonnet', ''), 
   9650: (
        'R\xc3\xa9parateur de soupirs', ''), 
   9651: (
        'La vie est un ronflement tranquille', ''), 
   9652: (
        'Quartier G\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   9703: (
        'Agence de voyages Vol de Nuit', ''), 
   9704: (
        'Animalerie du Hibou', ''), 
   9705: (
        "Garage de la Panne d'Oreiller", ''), 
   9706: (
        'Cabinet dentaire La Petite Souris', ''), 
   9707: (
        'Jardinerie de La B\xc3\xa2illerie', ''), 
   9708: (
        'Le Lys Douillet - Fleuriste', ''), 
   9709: (
        'Au Sommeil de Plomb - Plombier', ''), 
   9710: (
        "Rev'optique", ''), 
   9711: (
        'Service de r\xc3\xa9veil par t\xc3\xa9l\xc3\xa9phone', ''), 
   9712: (
        'Nous comptons les moutons pour vous!', ''), 
   9713: (
        'Roupille & Pionce, Avocats', ''), 
   9714: (
        'Croisi\xc3\xa8re de r\xc3\xaave - Accastillage', ''), 
   9715: (
        "Banque du Doudou d'Or", ''), 
   9716: (
        'Le Lit en Cath\xc3\xa9drale, farces at attrapes', ''), 
   9717: (
        'P\xc3\xa2tisserie du Croissant de Lune', ''), 
   9718: (
        'Sandwiches du Marchand de Sable', ''), 
   9719: (
        "Tout pour l'Oreiller", ''), 
   9720: (
        "Cours d'\xc3\xa9locution pour somnambules", ''), 
   9721: (
        'Tapis du Loir', ''), 
   9722: (
        'Les Yeux Ferm\xc3\xa9s - Spectacles en tous genres', ''), 
   9725: (
        'Pyjamas du Chat', ''), 
   9727: (
        'Ronfl\xc3\xa9, perdu', ''), 
   9736: (
        "Agence pour l'emploi M\xc3\xa9tiers de R\xc3\xaave", ''), 
   9737: (
        'Au Tutu qui dort - \xc3\x89cole de danse', ''), 
   9738: (
        'Maison Ronflon', ''), 
   9740: (
        "Le Sabre Nocturne - Salle d'armes", ''), 
   9741: (
        "A l'Acarien Vorace - Destructeur de nuisibles", ''), 
   9744: (
        'Cr\xc3\xa8me antirides Hicule', ''), 
   9752: (
        'Carburants Soporifiques', ''), 
   9753: (
        'Cr\xc3\xa8mes de Luna Glac\xc3\xa9es', ''), 
   9754: (
        'Randonn\xc3\xa9es \xc3\xa9questres - Poney de Nuit', ''), 
   9755: (
        'Cin\xc3\xa9ma La Ronflette', ''), 
   9756: (
        '', ''), 
   9759: (
        'Institut de beaut\xc3\xa9 du Bois - Dormant', ''), 
   3507: (
        'Boutique \xc3\xa0 gags', ''), 
   3508: (
        'Quartier g\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   ...
   3511: (
        'ANIMALERIE', ''), 
   3601: (
        'Aurore bor\xc3\xa9ale - Electricit\xc3\xa9 g\xc3\xa9n\xc3\xa9rale', ''), 
   3602: (
        'Bonnets de p\xc3\xa2ques', ''), 
   3605: (
        '', ''), 
   3607: (
        'Le vieillard du blizzard', ''), 
   3608: (
        'A en perdre la boule (de neige)!', ''), 
   3610: (
        'Sup\xc3\xa9rette Les Mirettes', ''), 
   3611: (
        'M. Lapin - Chasse-neige', ''), 
   3612: (
        "Conception d'igloos", ''), 
   3613: (
        'Glaces et miroirs', ''), 
   3614: (
        "Fabriquant de flocons d'avoine", ''), 
   3615: (
        'Omelettes norv\xc3\xa9giennes', ''), 
   3617: (
        'Voyages en ballon \xc3\xa0 air froid', ''), 
   3618: (
        'Boule de neige! Gestion de crise', ''), 
   3620: (
        'Atelier de ski', ''), 
   3621: (
        'Glacier La fonte des neiges', ''), 
   3622: (
        '', ''), 
   3623: (
        'Croque-monsieur', ''), 
   3624: (
        'Sandwichs froids', ''), 
   3625: (
        'Tante Ang\xc3\xa8le - Radiateurs', ''), 
   3627: (
        'Chenil St Bernard', ''), 
   3629: (
        'La soupe aux pois - Caf\xc3\xa9', ''), 
   3630: (
        'Agence de voyage Laglisse', ''), 
   3634: (
        'T\xc3\xa9l\xc3\xa9si\xc3\xa8ges rembourr\xc3\xa9s', ''), 
   3635: (
        "Bois de chauffage d'occasion", ''), 
   3636: (
        'Chair de poule bon march\xc3\xa9', ''), 
   3637: (
        'Les patins de Patricia', ''), 
   3638: (
        'H\xc3\xaatre ou ne pas h\xc3\xaatre', ''), 
   3641: (
        'Chez Tanguy - B\xc3\xa2teaux \xc3\xa0 dormir debout', ''), 
   3642: (
        "L'\xc5\x93il du cyclone - Opticien", ''), 
   3643: (
        'Chambre (froide) de danse', ''), 
   3644: (
        'Gla\xc3\xa7ons fondus', ''), 
   3647: (
        'Au pingouin sanguin - Magasin de smokings', ''), 
   3648: (
        'Glace instantan\xc3\xa9e', ''), 
   3649: (
        'Hambrrghers', ''), 
   3650: (
        'Articlit\xc3\xa9s', ''), 
   3651: (
        'Freddy Frigo - Saucisses congel\xc3\xa9es', ''), 
   3653: (
        'Bijoux glac\xc3\xa9s', ''), 
   3654: (
        'Quartier g\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   3702: (
        'Stockage hivernal', ''), 
   3703: (
        '', ''), 
   3705: (
        'Gla\xc3\xa7ons pour deux', ''), 
   3706: (
        'Babas au rhume', ''), 
   3707: (
        'Mon igloo est mon royaume', ''), 
   3708: (
        'Chez Pluto', ''), 
   3710: (
        'Restaurant en chute libre', ''), 
   3711: (
        '', ''), 
   3712: (
        'Au royaume du d\xc3\xa9luge', ''), 
   3713: (
        'Les dents qui claquent - Dentiste polaire', ''), 
   3715: (
        'Les bonnes soupes de Tante Artique', ''), 
   3716: (
        'Salage et poivrage des routes', ''), 
   3717: (
        'Juneau sais pas ce que vous voulez dire', ''), 
   3718: (
        'Inventeur de chambres \xc3\xa0 air', ''), 
   3719: (
        'Gla\xc3\xa7on en cornet', ''), 
   3721: (
        'Aux bonnes affaires glissantes', ''), 
   3722: (
        "Boutique d'apr\xc3\xa8s-ski", ''), 
   3723: (
        'Chez Tremblotte - globes des neiges', ''), 
   3724: (
        'La chronique des rhumeurs', ''), 
   3725: (
        'Alluge-toi un instant', ''), 
   3726: (
        'Couvertures solaires', ''), 
   3728: (
        'Chasse-neige \xc3\xa0 la pelle', ''), 
   3729: (
        '', ''), 
   3730: (
        'Achat et vente de bonhommes de neige', ''), 
   3731: (
        'Chemin\xc3\xa9es portatives', ''), 
   3732: (
        'Au nez gel\xc3\xa9', ''), 
   3734: (
        'Regards glac\xc3\xa9s - Optom\xc3\xa9trie', ''), 
   3735: (
        'Calottes glaciaires', ''), 
   3736: (
        'Cubes de glace bon march\xc3\xa9', ''), 
   3737: (
        'Restaurant de la pente', ''), 
   3738: (
        'Chaud devant!', ''), 
   3739: (
        'Quartier g\xc3\xa9n\xc3\xa9ral des Toons', ''), 
   3801: (
        lToonHQ, ''), 
   3806: (
        'Croisi\xc3\xa8res Tartiflette', ''), 
   3807: (
        "Nuages d'occasion", ''), 
   3808: (
        'G\xc3\xaete Gilet', ''), 
   3809: (
        'Glaces de d\xc3\xa9couverte', ''), 
   3810: (
        'Pelisses Municipales', ''), 
   3811: (
        "L'Ange Neige", ''), 
   3812: (
        'Chaussons pour chatons', ''), 
   3813: (
        'Apr\xc3\xa8s-skis biod\xc3\xa9gradables', ''), 
   3814: (
        'Pailles \xc3\xa0 gla\xc3\xa7ons', ''), 
   3815: (
        'Chalet Frisquet', ''), 
   3816: (
        'Au gui tout neuf', ''), 
   3817: (
        'Club Le Verglas', ''), 
   3818: (
        'La pelle des c\xc3\xaemes', ''), 
   3819: (
        'Ramonage et d\xc3\xa9givrage', ''), 
   3820: (
        'Blanchisserie de neige', ''), 
   3821: (
        "Sports d'hibernation", ''), 
   3823: (
        'Fondation des Pluies', ''), 
   3824: (
        'Froids les marrons!', ''), 
   3825: (
        'Chapeaux tout frais', ''), 
   ...
   3827: (
        'Couronnes de gui', ''), 
   3828: (
        'Le potager du bonhomme de neige', ''), 
   3829: (
        'Frigo D\xc3\xa9co', ''), 
   3830: (
        'Voyons Voir, d\xc3\xa9givrage de monocles', '')}
...
PetTrait2descriptions = {'hungerThreshold': (
                     'A toujours faim', 'A souvent faim', 'A quelquefois faim', 'A rarement faim'), 
   'boredomThreshold': (
                      "S'ennuie toujours", "S'ennuie souvent", "S'ennuie quelquefois", "S'ennuie rarement"), 
   'angerThreshold': (
                    'Toujours ronchon', 'Souvent ronchon', 'Quelquefois ronchon', 'Rarement ronchon'), 
   'forgetfulness': (
                   'Oublie toujours', 'Oublie souvent', 'Oublie quelquefois', 'Oublie rarement'), 
   'excitementThreshold': (
                         'Tr\xc3\xa8s calme', 'Plut\xc3\xb4t calme', 'Plut\xc3\xb4t excit\xc3\xa9', 'Tr\xc3\xa8s excit\xc3\xa9'), 
   'sadnessThreshold': (
                      'Toujours triste', 'Souvent triste', 'Quelquefois triste', 'Rarement triste'), 
   ...
   'playfulnessThreshold': (
                          'Rarement joueur', 'Quelquefois joueur', 'Souvent joueur', 'Toujours joueur'), 
   'lonelinessThreshold': (
                         'Toujours solitaire', 'Souvent solitaire', 'Quelquefois solitaire', 'Rarement solitaire'), 
   'fatigueThreshold': (
                      'Toujours fatigu\xc3\xa9', 'Souvent fatigu\xc3\xa9', 'Quelquefois fatigu\xc3\xa9', 'Rarement fatigu\xc3\xa9'), 
   'confusionThreshold': (
                        'Toujours perplexe', 'souvent perplexe', 'Quelquefois perplexe', 'Rarement perplexe'), 
   'surpriseThreshold': (
                       'Toujours surpris', 'souvent surpris', 'Quelquefois surpris', 'Rarement surpris'), 
   'affectionThreshold': (
...
TipDict = {TIP_NONE: (
            '',), 
   TIP_GENERAL: (
               'Pour v\xc3\xa9rifier rapidement les progr\xc3\xa8s de ton d\xc3\xa9fitoon, maintiens enfonc\xc3\xa9e la touche "Fin".', 'Pour v\xc3\xa9rifier rapidement ta page de gags, maintiens enfonc\xc3\xa9e la touche "Premi\xc3\xa8re page".', 'Pour ouvrir ta liste d\'contacts, appuie sur la touche "F7".', 'Pour ouvrir ou fermer ton journal de bord, appuie sur la touche "F8".', 'Pour regarder vers le haut, appuie sur la touche "Page pr\xc3\xa9c\xc3\xa9dente"; pour regarder vers le bas, appuie sur la touche "Page suivante".', 'Appuie sur la touche "Contr\xc3\xb4le" pour sauter.', 'Appuie sur la touche "F9" pour faire une capture d\'\xc3\xa9cran qui sera enregistr\xc3\xa9e dans le dossier Toontown de ton ordinateur.', "Tu peux changer ta r\xc3\xa9solution d'\xc3\xa9cran, r\xc3\xa9gler le son et d'autres options dans la page d'options du journal de bord.", 'Essaie les v\xc3\xaatements de tes contacts, qui sont dans les placards de leur maison.', 'Tu peux rentrer chez toi gr\xc3\xa2ce au bouton "Retour \xc3\xa0 la maison" sur ta carte.', 'Chaque fois que tu termines un d\xc3\xa9fitoon avec succ\xc3\xa8s, tes rigolpoints sont automatiquement ajout\xc3\xa9s.', "Tu peux voir la collection dans les boutiques de pr\xc3\xaat-\xc3\xa0-porter m\xc3\xaame sans ticket d'habillement.", "Les r\xc3\xa9compenses de certains d\xc3\xa9fitoons te permettent d'avoir plus de gags et de bonbons.", "Tu peux avoir jusqu'\xc3\xa0 50 contacts sur ta liste d'contacts.", "La r\xc3\xa9compense de certains d\xc3\xa9fitoons te permet de te t\xc3\xa9l\xc3\xa9porter jusqu'aux terrains de jeux de Toontown par la carte du journal de bord.", 'R\xc3\xa9cup\xc3\xa8re tes rigolpoints sur les terrains de jeux en ramassant des tr\xc3\xa9sors tels que des \xc3\xa9toiles et des cornets de glace.', 'Si tu as besoin de te soigner rapidement apr\xc3\xa8s un combat difficile, va chez toi et ramasse des cornets de glace.', 'Pour changer la visualisation de ton Toon, appuie sur la touche de tabulation.', 'Quelquefois tu peux trouver plusieurs d\xc3\xa9fitoons diff\xc3\xa9rents propos\xc3\xa9s pour la m\xc3\xaame r\xc3\xa9compense. Fais ton choix!', 'Trouver des contacts qui font le m\xc3\xaame d\xc3\xa9fitoon que toi est une mani\xc3\xa8re amusante de progresser dans le jeu.', "Tu n'as jamais besoin d'enregistrer ta progression dans Toontown. Les serveurs de Toontown enregistrent toutes les informations n\xc3\xa9cessaires en continu.", "Tu peux parler en chuchotant \xc3\xa0 d'autres Toons en cliquant sur eux ou en les s\xc3\xa9lectionnant dans ta liste d'contacts.", 'Certaines phrases du Chat rapide provoquent une \xc3\xa9motion anim\xc3\xa9e sur ton Toon.', 'Si tu te trouves dans une zone o\xc3\xb9 il y a trop de monde, tu peux essayer de changer de district. Va \xc3\xa0 la page des districts dans le journal de bord et choisis-en un autre.', "Si tu sauves activement des b\xc3\xa2timents, une \xc3\xa9toile de bronze, d'argent ou d'or s'affichera au-dessus de ton Toon.", "Si tu sauves assez de b\xc3\xa2timents pour avoir une \xc3\xa9toile au-dessus de la t\xc3\xaate, tu pourras trouver ton nom affich\xc3\xa9 sur le tableau d'un Quartier G\xc3\xa9n\xc3\xa9ral des Toons.", "Les b\xc3\xa2timents sauv\xc3\xa9s sont quelquefois recaptur\xc3\xa9s par les Cogs. La seule fa\xc3\xa7on de conserver ton \xc3\xa9toile est d'aller sauver plus de b\xc3\xa2timents.", 'Les noms de tes amis appara\xc3\xaetront en bleu.', "Essaie d'avoir toutes les esp\xc3\xa8ces de poisson de Toontown!", 'Chaque mare rec\xc3\xa8le diff\xc3\xa9rentes sortes de poissons. Essaie-les toutes!', "Lorsque ton seau de p\xc3\xaache est plein, tu peux vendre tes poissons aux vendeurs de l'animalerie sur les terrains de jeux.", "Tu peux vendre tes poissons au vendeur de l'animalerie, pr\xc3\xa8s des mares ou dans les animaleries m\xc3\xaame.", 'Les cannes \xc3\xa0 p\xc3\xaache plus solides attrapent de plus gros poissons mais requi\xc3\xa8rent plus de bonbons.', 'Tu peux acheter des cannes \xc3\xa0 p\xc3\xaache plus solides dans le catalogue.', "Les plus gros poissons valent plus de bonbons \xc3\xa0 l'animalerie.", "Les poissons plus rares valent plus de bonbons \xc3\xa0 l'animalerie.", 'Tu peux quelquefois trouver des sacs de bonbons en p\xc3\xaachant.', 'Certains d\xc3\xa9fitoons n\xc3\xa9cessitent de p\xc3\xaacher des objets dans les mares.', 'Les mares des terrains de jeux ont des poissons diff\xc3\xa9rents de ceux des mares des rues.', "Certains poissons sont vraiment rares. Continue \xc3\xa0 p\xc3\xaacher jusqu'\xc3\xa0 ce que tu les aies tous!", 'La mare que tu as chez toi contient des poissons qui ne peuvent pas \xc3\xaatre trouv\xc3\xa9s ailleurs.', 'A chaque fois que tu as attrap\xc3\xa9 10 esp\xc3\xa8ces, tu gagnes un troph\xc3\xa9e de p\xc3\xaache!', 'Tu peux voir quels poissons tu as p\xc3\xaach\xc3\xa9s dans ton journal de bord.', 'Certains troph\xc3\xa9es de p\xc3\xaache te valent une rigol-augmentation.', 'La p\xc3\xaache est une bonne fa\xc3\xa7on de gagner plus de bonbons.', "Adopte un Doudou au magasin d'animaux!", "Les magasins d'animaux ont de nouveaux Doudous \xc3\xa0 vendre tous les jours.", "Rends-toi dans les magasins d'animaux tous les jours pour voir quels nouveaux Doudous ils ont.", 'Dans les diff\xc3\xa9rents quartiers, il y a des Doudous diff\xc3\xa9rents \xc3\xa0 adopter.', 'Fais chauffer ton super moteur et mets un coup de turbo \xc3\xa0 ta rigo-limite.', 'Rends-toi dans le Circuit Dingo par le tunnel en forme de pneu qui se trouve dans Toontown Central.', 'Gagne des rigolpoints au Circuit Dingo.', 'Le Circuit Dingo a six pistes de course diff\xc3\xa9rentes.'), 
   TIP_STREET: (
              'Il existe quatre types de Cogs : les Loibots, les Caissbots, les Vendibots et les Chefbots.', 'Chaque s\xc3\xa9rie de gags est associ\xc3\xa9e \xc3\xa0 diff\xc3\xa9rents niveaux de pr\xc3\xa9cision et de d\xc3\xa9g\xc3\xa2ts.', 'Les gags de tapage affectent tous les Cogs mais r\xc3\xa9veillent les Cogs leurr\xc3\xa9s.', 'Battre les Cogs en ordre strat\xc3\xa9gique peut grandement augmenter tes chances de gagner les batailles.', 'La s\xc3\xa9rie de gags "toonique" te permet de soigner les autres Toons lors d\'une bataille.', "Les points d'exp\xc3\xa9rience des gags sont doubl\xc3\xa9s pendant une invasion de Cogs!", "Plusieurs Toons peuvent faire \xc3\xa9quipe et utiliser la m\xc3\xaame s\xc3\xa9rie de gags lors d'une bataille pour infliger plus de d\xc3\xa9g\xc3\xa2ts aux Cogs.", "Lors des batailles, les gags sont utilis\xc3\xa9s dans l'ordre affich\xc3\xa9 sur le menu des gags, de haut en bas.", "La rang\xc3\xa9e de points lumineux sur les ascenseurs des b\xc3\xa2timents des Cogs indiquent combien d'\xc3\xa9tages ils contiennent.", 'Clique sur un Cog pour avoir plus de d\xc3\xa9tails.', "L'utilisation de gags de haut niveau contre des Cogs de bas niveau ne donne pas de points d'exp\xc3\xa9rience.", "Un gag qui donnera de l'exp\xc3\xa9rience s'affiche sur fond bleu sur le menu des gags lors de la bataille.", "L'exp\xc3\xa9rience des gags est multipli\xc3\xa9e lorsqu'ils sont utilis\xc3\xa9s \xc3\xa0 l'int\xc3\xa9rieur des b\xc3\xa2timents des Cogs. Les \xc3\xa9tages les plus hauts ont des coefficients de multiplication plus grands.", "Lorsqu'un Cog est vaincu, chacun des Toons ayant particip\xc3\xa9 est cr\xc3\xa9dit\xc3\xa9 de la victoire sur ce Cog lorsque la bataille est termin\xc3\xa9e.", 'Chaque rue de Toontown a diff\xc3\xa9rents types et niveaux de Cogs.', "Il n'y a pas de Cogs sur les trottoirs.", "Dans les rues, tu peux entendre des blagues en t'approchant des portes lat\xc3\xa9rales.", "Certains d\xc3\xa9fitoons t'entra\xc3\xaenent \xc3\xa0 de nouvelles s\xc3\xa9ries de gags. Tu ne pourras choisir que six des sept s\xc3\xa9ries de gags, alors choisis bien!", "Les pi\xc3\xa8ges ne sont utiles que si toi ou tes contacts vous mettez d'accord pour utiliser les leurres lors d'une bataille.", 'Les leurres de plus haut niveau sont moins susceptibles de manquer leur cible.', 'Les gags de plus bas niveau ont une pr\xc3\xa9cision moindre contre les Cogs de haut niveau.', "Les Cogs ne peuvent plus attaquer une fois qu'ils ont \xc3\xa9t\xc3\xa9 leurr\xc3\xa9s lors d'un combat.", "Lorsque tes contacts et toi aurez repris un b\xc3\xa2timent aux Cogs, vos portraits seront affich\xc3\xa9s \xc3\xa0 l'int\xc3\xa9rieur du b\xc3\xa2timent en guise de r\xc3\xa9compense.", "L'utilisation d'un gag toonique sur un Toon qui a un rigolm\xc3\xa8tre au maximum ne donne pas d'exp\xc3\xa9rience toonique.", "Les Cogs sont bri\xc3\xa8vement assomm\xc3\xa9s lorsqu'ils sont frapp\xc3\xa9s par un gag. Cela augmente la chance que les autres gags du m\xc3\xaame tour le frappent.", "Les gags de chute ont de faibles chances d'atteindre leur but, mais la pr\xc3\xa9cision est accrue lorsque les Cogs ont auparavant \xc3\xa9t\xc3\xa9 frapp\xc3\xa9s par un autre gag lors du m\xc3\xaame tour.", 'Lorsque tu as vaincu suffisamment de Cogs, tu peux utiliser le d\xc3\xa9tecteur de Cogs en cliquant sur les ic\xc3\xb4nes du d\xc3\xa9tecteur sur la page de la galerie des Cogs dans ton journal de bord.', "Pendant une bataille, les tirets (-) et les X indiquent quel Cog tes \xc3\xa9quipiers sont en train d'attaquer.", 'Pendant une bataille, un voyant lumineux sur les Cogs indique leur \xc3\xa9tat de sant\xc3\xa9 : vert signifie en bonne sant\xc3\xa9, rouge au bord de la destruction.', 'Un maximum de quatre Toons peuvent combattre simultan\xc3\xa9ment.', "Dans la rue, les Cogs prendront plus facilement part \xc3\xa0 une bataille contre plusieurs Toons qu'\xc3\xa0 une bataille contre un seul Toon.", 'Les deux Cogs les plus difficiles de chaque type ne se trouvent que dans les b\xc3\xa2timents.', 'Les gags de chute ne fonctionnent jamais contre les Cogs leurr\xc3\xa9s.', 'Les Cogs ont tendance \xc3\xa0 attaquer le Toon qui leur a caus\xc3\xa9 le plus de d\xc3\xa9g\xc3\xa2ts.', 'Les gags de tapage ne donnent pas de bonus contre les Cogs leurr\xc3\xa9s.', "Si tu attends trop longtemps avant d'attaquer un Cog leurr\xc3\xa9, il se r\xc3\xa9veille. Les leurres de plus haut niveau durent plus longtemps.", 'Il y a des mares dans toutes les rues de Toontown. Certaines rues ont des esp\xc3\xa8ces de poissons uniques.'), 
   TIP_MINIGAME: (
                'Apr\xc3\xa8s avoir rempli ton pot de bonbons, tous les bonbons que tu gagnes aux jeux du tramway sont automatiquement vers\xc3\xa9s dans ta tirelire.', 'Tu peux utiliser les fl\xc3\xa8ches du clavier au lieu de la souris dans le jeu du tramway "Imite Minnie".', 'Dans le jeu du canon, tu peux utiliser les fl\xc3\xa8ches du clavier pour d\xc3\xa9placer ton canon et appuyer sur la touche "Contr\xc3\xb4le" pour tirer.', 'Dans le jeu des anneaux, des points suppl\xc3\xa9mentaires sont attribu\xc3\xa9s quand le groupe entier r\xc3\xa9ussit \xc3\xa0 nager dans les anneaux.', 'Un jeu parfait d\'"Imite Minnie" double tes points.', 'Dans le tir \xc3\xa0 la corde, tu re\xc3\xa7ois plus de bonbons si tu joues contre un Cog plus fort.', 'La difficult\xc3\xa9 des jeux du tramway varie selon les quartiers, Toontown centre a les plus faciles et le Pays des r\xc3\xaaves de Donald les plus difficiles.', "Certains jeux du tramway ne peuvent \xc3\xaatre jou\xc3\xa9s qu'en groupe."), 
   TIP_COGHQ: (
             "Tu dois terminer ton d\xc3\xa9guisement de Cog avant d'entrer dans le b\xc3\xa2timent du Chef.", 'Tu peux sauter sur les gardes du corps des Cogs pour les d\xc3\xa9sactiver temporairement.', "Tu dois faire enti\xc3\xa8rement ton d\xc3\xa9guisement Loibot avant d'aller voir le Juge.", 'Additionne les m\xc3\xa9rites Cogs par tes victoires sur les Cogs.', 'Tu obtiens plus de m\xc3\xa9rites avec des Cogs de plus haut niveau.', 'Lorsque tu as additionn\xc3\xa9 assez de m\xc3\xa9rites Cogs pour gagner une promotion, va voir le vice-pr\xc3\xa9sident des Vendibots !', 'Tu peux parler comme un Cog lorsque tu portes ton d\xc3\xa9guisement de Cog.', "Jusqu'\xc3\xa0 huit Toons peuvent faire \xc3\xa9quipe pour combattre le vice-pr\xc3\xa9sident des Vendibots.", 'Le vice-pr\xc3\xa9sident des Vendibots est tout en haut du quartier g\xc3\xa9n\xc3\xa9ral des Cogs.', "A l'int\xc3\xa9rieur des usines des Cogs, monte les escaliers pour arriver jusqu'au contrema\xc3\xaetre.", "Chaque fois que tu te bats dans l'usine, tu gagnes une pi\xc3\xa8ce de ton d\xc3\xa9guisement de Cog.", 'Tu peux visualiser le progr\xc3\xa8s de ton d\xc3\xa9guisement de Cog dans ton journal de bord.', 'Tu peux visualiser le progr\xc3\xa8s de tes m\xc3\xa9rites sur ta page de d\xc3\xa9guisements dans ton journal de bord.', "Assure-toi d'avoir suffisamment de gags et un rigolm\xc3\xa8tre au maximum avant d'aller voir le vice-pr\xc3\xa9sident.", 'Si tu as une promotion, ton d\xc3\xa9guisement de Cog est mis \xc3\xa0 jour.', "Tu dois vaincre le contrema\xc3\xaetre de l'usine pour r\xc3\xa9cup\xc3\xa9rer une pi\xc3\xa8ce du d\xc3\xa9guisement de Cog.", 'R\xc3\xa9cup\xc3\xa8re des Convocations du Jury en d\xc3\xa9fiant des Loibots.', "Tu re\xc3\xa7ois plus de M\xc3\xa9rites, d'euros Cog ou de Convocations du Jury en combattant des Cogs de plus haut niveau.", 'Quand tu as r\xc3\xa9cup\xc3\xa9r\xc3\xa9 assez de Convocations du Jury pour gagner une promotion, va voir le Juge  !', "Tu dois faire enti\xc3\xa8rement ton d\xc3\xa9guisement Loibot avant d'aller voir le Juge.", "Jusqu'\xc3\xa0 huit Toons peuvent combattre ensemble le Juge Loibot.", "Cela paie d'\xc3\xaatre perplexe : Les Cogs virtuels dans le QG Loibot ne t'accableront pas de Convocations du Jury.", ' Gagne des pi\xc3\xa8ces de costume de Caissbot comme r\xc3\xa9compense en terminant les d\xc3\xa9fitoons qui sont propos\xc3\xa9s dans le Pays des R\xc3\xaaves de Donald.', ' Les Caissbots fabriquent et font circuler leur argent, les euros Cogs, \xc3\xa0 partir de trois Fabriques \xc3\xa0 Sous - Pi\xc3\xa8ce, Euro et Lingot.', " Attends que le directeur financier soit \xc3\xa9tourdi avant de lui lancer un coffre dessus, ou il pourrait l'utiliser comme casque.\xc2\xa0Frapper le casque avec un autre coffre est la seule mani\xc3\xa8re de le faire\xc2\xa0tomber.", ' Gagne des pi\xc3\xa8ces de costume de Loibot comme r\xc3\xa9compense en terminant les d\xc3\xa9fitoons pour le professeur Flocon.', ' Ca paie de r\xc3\xa9soudre les probl\xc3\xa8mes\xc2\xa0: les Cogs virtuels du QG Loibot ne vont pas te r\xc3\xa9compenser avec des notices du jury.'), 
   TIP_ESTATE: (
              'Les Doudous peuvent comprendre certaines expressions de Chat rapide. Essaie-les!', 'Utilise le menu "Animaux familiers" du Chat rapide pour demander \xc3\xa0 ton Doudou de faire des tours.', 'Tu peux apprendre des tours aux Doudous avec les le\xc3\xa7ons du catalogue vachement branch\xc3\xa9 de Clarabelle.', 'R\xc3\xa9compense ton Doudou quand il fait des tours.', 'Si tu te rends chez un ami, ton Doudou viendra aussi.', 'Donne un bonbon \xc3\xa0 ton Doudou quand il a faim.', "Clique sur un Doudou pour afficher un menu gr\xc3\xa2ce auquel tu pourras le nourrir, le cajoler et l'appeler.", 'Les Doudous aiment la compagnie. Invite tes contacts \xc3\xa0 venir jouer!', 'Chaque Doudou a une personnalit\xc3\xa9 unique.', "Tu peux rapporter ton Doudou et en adopter un nouveau \xc3\xa0 l'animalerie.", 'Quand un Doudou fait un tour, les Toons qui sont aux alentours sont soign\xc3\xa9s.', "Les Doudous font leurs tours de mieux en mieux avec de l'entra\xc3\xaenement. Un peu de pers\xc3\xa9v\xc3\xa9rance!", 'Les tours plus avanc\xc3\xa9s des Doudous soignent plus vite les Toons.', 'Les Doudous exp\xc3\xa9riment\xc3\xa9s peuvent faire plus de tours avant de se fatiguer.', "Tu peux voir une liste des Doudous qui sont \xc3\xa0 proximit\xc3\xa9 dans ta liste d'contacts.", 'Ach\xc3\xa8te des fournitures dans le catalogue de Clarabelle pour d\xc3\xa9corer ta maison.', 'La tirelire de ta maison contient des bonbons suppl\xc3\xa9mentaires.', 'Le placard de ta maison contient des v\xc3\xaatements suppl\xc3\xa9mentaires.', 'Rends-toi dans la maison de ton ami et essaie ses v\xc3\xaatements.', 'Ach\xc3\xa8te de meilleures cannes \xc3\xa0 p\xc3\xaache dans le catalogue de Clarabelle.', 'Ach\xc3\xa8te de plus grandes tirelires dans le catalogue de Clarabelle.', 'Appelle Clarabelle avec le t\xc3\xa9l\xc3\xa9phone qui est dans ta maison.', 'Clarabelle vend un placard plus grand qui contient plus de v\xc3\xaatements.', "Fais de la place dans ton placard avant d'utiliser un ticket d'habillement.", 'Clarabelle vend tout ce dont tu as besoin pour d\xc3\xa9corer ta maison.', 'V\xc3\xa9rifie ta bo\xc3\xaete aux lettres pour trouver ta livraison apr\xc3\xa8s avoir command\xc3\xa9 chez Clarabelle.', "Les v\xc3\xaatements du catalogue de Clarabelle sont livr\xc3\xa9s dans l'heure.", "Le papier peint et le rev\xc3\xaatement de sol du catalogue de Clarabelle sont livr\xc3\xa9s dans l'heure.", 'Les meubles du catalogue de Clarabelle sont livr\xc3\xa9s un jour plus tard.', 'Stocke plus de meubles dans ton grenier.', 'Tu seras averti(e) par Clarabelle quand un nouveau catalogue sera pr\xc3\xaat.', 'Tu seras averti(e) par Clarabelle quand un nouveau catalogue sera pr\xc3\xaat.', 'Les nouveaux catalogues sont livr\xc3\xa9s chaque semaine.', 'Cherche les articles de vacances en \xc3\xa9dition limit\xc3\xa9e dans le catalogue.', 'Mets les meubles dont tu ne veux plus \xc3\xa0 la poubelle.', 'Certains poissons, comme le hareng saur, sont plus communs dans les propri\xc3\xa9t\xc3\xa9s des Toons.', 'Tu peux inviter tes contacts sur ta propri\xc3\xa9t\xc3\xa9 en utilisant le Chat rapide.', 'Est-ce que tu savais que la couleur de ta maison est assortie \xc3\xa0 celle de ton panneau Choisis un Toon ?'), 
   TIP_KARTING: (
               'Ach\xc3\xa8te un Roadster, un Utilitoon ou une Berline au Centre Auto Dingo.', "Customise ton kart avec des autocollants, des baguettes et plein d'autres d\xc3\xa9co au Centre Auto Dingo.", 'Gagne des tickets en faisant la course sur le Circuit Dingo.', 'Les tickets sont la seule monnaie accept\xc3\xa9e par le Centre Auto Dingo.', ' Tu dois d\xc3\xa9poser des tickets pour pouvoir faire la course.', 'Une page sp\xc3\xa9ciale de ton journal de bord te permet de customiser ton kart.', 'Une page sp\xc3\xa9ciale de ton journal de bord te permet de consulter tes scores sur chaque piste.', "Une page sp\xc3\xa9ciale de ton journal de bord te permet d'afficher tes troph\xc3\xa9es.", 'Le Colis\xc3\xa9e Tortill\xc3\xa9 est la piste la plus facile du Circuit Dingo.', ' Les Landes L\xc3\xa9g\xc3\xa8res est la piste qui a le plus de collines et de bosses du Circuit Dingo.', 'Le Boulevard du Blizzard est la piste la plus excitante du Circuit Dingo.'), 
   TIP_GOLF: (
            'Appuie sur la touche de tabulation pour obtenir une vue de dessus du terrain de golf.', "Appuie sur la fl\xc3\xa8che de d\xc3\xa9placement vers le haut pour t'orienter vers le trou.", "Faire un swing avec un club, c'est comme un peu comme lancer une tarte.")}
FishGenusNames = {0: 'Baudruche', 
   2: 'Poisson-chat', 
   4: 'Poisson-clown', 
   ...
   34: 'Raie tissante'}
FishSpeciesNames = {0: (
     'Poisson baudruche', 'Baudruche \xc3\xa0 air chaud', 'Baudruche m\xc3\xa9t\xc3\xa9o', 'Baudruche \xc3\xa0 eau', 'Baudruche rouge'), 
   2: (
     'Poisson-chat', 'Poisson-chat siamois', 'Poisson-chat piteau', 'Poisson-chat de goutti\xc3\xa8re', 'Poisson matou'), 
   4: (
     'Poisson-clown', 'Poisson-clown triste', 'Poisson-pitre', 'Poisson-cirque'), 
   6: (
     'Poisson surgel\xc3\xa9',), 
   8: (
     '\xc3\x89toile de mer', '\xc3\x89toile de mer lu', '\xc3\x89toile de mer s\xc3\xa9d\xc3\xa8s', '\xc3\x89toile de mer credi', '\xc3\x89toile de mer ciatous'), 
   10: (
      'Hareng saur',), 
   12: (
      'Poisson chien', 'Poisson-chien de tra\xc3\xaeneau', 'Poisson-chien-chien', 'Poisson dalmatien', 'Poisson chiot'), 
   14: (
      'Anguille douce', 'Anguille rette \xc3\xa9lectrique'), 
   16: (
      'Requin nourrice', 'Requin nourrice tique', 'Requin nourrice tourne'), 
   18: (
      'Crabe-roi', "Crabe roi d'Alaska", 'Vieux crabe roi'), 
   20: (
      'Poisson-lune', 'Poisson pleine lune', 'Poisson demi-lune', 'Poisson nouvelle lune', 'Poisson croissant de lune', 'Poisson \xc3\xa9quinoxe'), 
   22: (
      'Hippocampe', 'Hippocampe oscillant', 'Hippocampe percheron', 'Hippocampe oriental'), 
   24: (
      "Requin d'eau douce", 'Requin de baignoire', 'Requin de piscine', 'Requin olympique'), 
   26: (
      'Bar tabba', 'Bar amine', 'Bar ratin', 'Bar ricade', 'Bar sovie', 'Bar rac\xc3\xa9', 'Bar cadaire', 'Bar bouill\xc3\xa9'), 
   28: (
      'Truite coupe-gorge', 'Truite capitaine', 'Truite scorbut'), 
   30: (
      'Thon tonl\xc3\xa9on', 'Thon-clave', 'Thon-suret', 'Thon bola', 'Thon duras\xc3\xa9'), 
   32: (
      'M\xc3\xa9duse m\xc3\xa9dus\xc3\xa9e', 'Poisson-cacahu\xc3\xa8te', 'Poisson pan\xc3\xa9', 'Poisson fraise', 'Poisson raisin'), 
   34: (
      'Raie tissante',)}
CogPartNames = ('Cuisse gauche', 'Tibia gauche', 'Pied gauche', 'Cuisse droite', 'Tibia droit', 'Pied droit', '\xc3\x89paule gauche', '\xc3\x89paule droite', 'Poitrine', 'Compteur de sant\xc3\xa9', 'Bassin', 'Bras gauche', 'Avant-bras gauche', 'Main gauche', 'Bras droit', 'Avant-bras droit', 'Main droite')
CogPartNamesSimple = ('Haut du torse',)
FishFirstNames = ('', 'Ang\xc3\xa9line', 'Arctique', 'B\xc3\xa9b\xc3\xa9', 'Bermuda', 'Grand', 'Fontaine', 'Bubule', 'Buster', 'Candy', 'Capitaine', 'Ciboulette', 'Choupette', 'Corail', 'Docteur', 'Toussale', 'Empereur', 'M\xc3\xa2chefer', 'Gros', 'Filou', 'Palmyre', 'Polochon', 'Totoche', 'Doudou', 'Jack', 'Roi', "P'tit", 'Marin', 'Mamzelle', 'Monsieur', 'Pomme', 'Petit-Doigt', 'Prince', 'Princesse', 'Professeur', 'Bouboule', 'Reine', 'Mirage', 'Ray', 'Rosie', 'Robert', 'Poivre', 'Nicole', 'Sandy', '\xc3\x89caille', "Dent d'or", 'Sire', 'Sacha', 'Pantoufle', 'Chipeur', 'Mini', 'S\xc3\xa9bastien', "P'tit-Pois", '\xc3\x89toile', "Sucre d'orge", 'Super', 'Tigre', 'Microbe', 'Moustache')
FishLastPrefixNames = ('', 'Laplage', 'Noir', 'Bleu', 'Marcassin', 'Lavache', 'Minou', 'Aufond', 'Double', 'Est', 'Chichi', '\xc3\x89caille', 'Plat', 'Frais', 'G\xc3\xa9ant', 'Dorpur', 'Dor\xc3\xa9', 'Gris', 'Vert', 'Goinfre', 'Jacasse', 'Gel\xc3\xa9e', 'Dame', 'Cuir', 'Citron', 'Long', 'Nord', 'Oc\xc3\xa9an', 'Octo', 'Huile', 'Perle', 'Mousse', 'Rouge', 'Ruban', 'Fleuve', 'Roc', 'Rubis', 'Barre', 'Sel', 'Mer', 'Argent', 'Tuba', 'Semelle', 'Sud', 'H\xc3\xa9risse', 'Surf', 'Sabre', 'Tigre', 'Triple', 'Tropical', 'Thon', 'Coucou', 'Faible', 'Ouest', 'Blanc', 'Jaune')
FishLastSuffixNames = ('', 'balle', 'basse', 'ventre', 'punaise', 'vole', 'beurre', 'dents', 'botte', 'crabe', 'ronchon', 'tambour', 'palme', 'poisson', 'nette', 'nageoire', 'flou', 'grogne', 't\xc3\xaate', 'veste', 'saut', 'sardine', 'lune', 'bouche', 'mulet', 'cou', 'nez', 'perche', 'rauque', 'coureur', 'voile', 'requin', 'coquille', 'soie', 'bave', 'vif', 'pue', 'queue', 'crapaud', 'truite', 'eau')
CogPartNames = ('Cuisse gauche', 'Tibia gauche', 'Pied gauche', 'Cuisse droite', 'Tibia droit', 'Pied droit', '\xc3\x89paule gauche', '\xc3\x89paule droite', 'Poitrine', 'Compteur de sant\xc3\xa9', 'Bassin', 'Bras gauche', 'Avant-bras gauche', 'Main gauche', 'Bras droit', 'Avant-bras droit', 'Main droite')
CogPartNamesSimple = ('Haut du torse',)
...
ResistanceRestockMenu = 'A vos gags'
ResistanceRestockItem = 'A vos gags %s'
...
ResistanceEmote2 = NPCToonNames[9228] + ": Utilise ton nouvel \xc3\xa9moticone pour t'identifier aupr\xc3\xa8s des autres membres."
...
KartRace_TrackNames = {RaceGlobals.RT_Speedway_1: 'Stade Cinglette', 
...
KartDNA_KartNames = {0: 'Berline', 
   1: 'Roadster', 
   2: 'Utilitoon'}
KartDNA_AccNames = {1000: 'Filtre \xc3\xa0 air', 
...
KartRecordStrings = {RaceGlobals.Daily: 'quotidien', 
...
WitnessToonPrepareBattleTwo = "Oh non! Il n'y a que des Cogs dans le jury!\x07Vite, utilise les canons et tire sur des jur\xc3\xa9s Toons sur le banc des jur\xc3\xa9s.\x07Nous avons besoin de %d pour \xc3\xa9quilibrer la balance."
...
WitnessToonPrepareBattleThree = 'D\xc3\xa9p\xc3\xaache-toi de toucher la barre des t\xc3\xa9moins pour obtenir des preuves.\x07Appuie sur la touche \xc2\xabInser\xc2\xbb pour envoyer les preuves sur les avocats ou sur la d\xc3\xa9fense.'
WitnessToonCongratulations = 'Tu as r\xc3\xa9ussi! Merci pour cette d\xc3\xa9fense spectaculaire!\x07Prends ces papiers que le Juge a oubli\xc3\xa9s.\x07Avec \xc3\xa7a, tu pourras convoquer des Cogs \xc3\xa0 partir de ta page de Galerie de Cogs.'
WitnessToonLastPromotion = "\x07Wow, tu as atteint le niveau %s sur ton costume de Cog!\x07C'est la plus haute promotion que peuvent atteindre les Cogs.\x07Tu ne peux plus monter ton costume de Cog en grade, mais tu peux \xc3\xa9videmment continuer \xc3\xa0 travailler pour la r\xc3\xa9sistance!"
WitnessToonHPBoost = '\x07Tu as fait beaucoup de travail pour la r\xc3\xa9sistance.\x07Le Conseil des Toons a d\xc3\xa9cid\xc3\xa9 de te donner un autre rigolpoint. F\xc3\xa9licitations!'
WitnessToonMaxed = "\x07Je vois que tu as un costume de Cog de niveau %s. Tr\xc3\xa8s impressionnant!\x07Le Conseil des Toons te remercie d'\xc3\xaatre revenu d\xc3\xa9fendre encore plus de Toons!"
...
WitnessToonJuryWeightBonusSingular = {6: "C'est un cas difficile. Tu as %d jur\xc3\xa9 Toon. Par cons\xc3\xa9quent, tes preuves ont un bonus de poids de %d.", 
...
WitnessToonJuryWeightBonusPlural = {6: "C'est un cas difficile. Tu as %d jur\xc3\xa9s Toon. Par cons\xc3\xa9quent, tes preuves ont un bonus de poids de %d.", 
...
StatuaryToonCrossedArms = 'Statue Toon Autorit\xc3\xa9'
StatuaryToonThinking = 'Statue Toon \xc3\x89treinte'
StatuaryMeltingSnowman = 'Melting Snowman'
StatuaryGardenAccelerator = 'Engrais Pousse-Instantan\xc3\xa9e'
StatuaryLeakingFountain = 'Burgemeester Pis'
FlowerColorStrings = [
 'Rouge', 
 'Orange', 
 'Violet', 
 ...
 'Blanc', 
 'Vert']
FlowerSpeciesNames = {49: 'P\xc3\xa2querette', 
   50: 'Tulipe', 
   51: '\xc5\x92illet', 
   52: 'Lys', 
   53: 'Jonquille', 
   ...
   56: 'Rose'}
FlowerFunnyNames = {49: (
      "P\xc3\xa2querette d'\xc3\xa9cole", 'P\xc3\xa2querette paresseuse', "P\xc3\xa2querette d'\xc3\xa9t\xc3\xa9", 'P\xc3\xa2querette frisquette', 'P\xc3\xa2querette houpl\xc3\xa0l\xc3\xa0', 'P\xc3\xa2querette guillerette', 'P\xc3\xa2querette follette', 'P\xc3\xa2querette brumette'), 
   50: (
      'Unelipe', 'Tulipe', 'Trilipe'), 
   51: (
      '\xc5\x92illet myope', '\xc5\x92illet rapide', '\xc5\x92illet hybride', '\xc5\x92illet louche', '\xc5\x92illet mod\xc3\xa8le'), 
   52: (
      'Mugatine', 'Lys t\xc3\xa9ria', 'Lys tigri', 'Lys poire', 'Lys pique', 'Pneu-lys', 'Lys t\xc3\xa8re', 'Lys bis'), 
   53: (
      'Jonquirille', 'Jonquifolle', 'Jonquirafe', 'Jonquipasse'), 
   54: (
      'Pens\xc3\xa9e \xc3\xa0 rien', 'Chim-pens\xc3\xa9e', 'Pens\xc3\xa9e zy', 'Pensargarine', 'Pens\xc3\xa9e folle'), 
   55: (
      'P\xc3\xa9tugniagnian', 'R\xc3\xa9gitunia'), 
   56: (
      'Rose estivale', 'Rose des bl\xc3\xa9s', 'Rose colorante', 'Rose malodorante', 'Rose distill\xc3\xa9e')}
FlowerVarietyNameFormat = '%s %s'
FlowerUnknown = '????'
ShovelNameDict = {0: '\xc3\x89tain', 
   1: 'Bronze', 
   2: 'Argent', 
   3: 'Or'}
WateringCanNameDict = {0: 'Petit', 
   1: 'Moyen', 
   2: 'Grand', 
   3: '\xc3\x89norme'}
...
GardeningChooseToonStatue = 'Choisis le Toon dont tu veux cr\xc3\xa9er la statue.'
...
GardenTrophyNameDict = {0: 'Brouette', 
   1: 'Pelles', 
   2: 'Fleur', 
   3: 'Arrosoir', 
   4: 'Requin', 
...
TrolleyHolidayEnd = "Les Jeudis du Tramway est termin\xc3\xa9 pour aujourd'hui. A la semaine prochaine !"
...
GolfCourseNames = {0: "Partie d'\xc3\xa9chauffement", 
   1: 'Partie d\xe2\x80\x99entra\xc3\xaenement', 
   2: 'Parcours des Pros'}
GolfHoleNames = {0: 'Trou-en-Un', 
   1: 'Putt \xc3\xa0 choux', 
   2: 'Cul sec', 
   3: 'Ver de green', 
   4: 'Liens chauds', 
   5: 'Putter Pan', 
   ...
   14: 'Au Drive In', 
   15: 'Cours de Swing', 
   16: "Terrain d'entra\xc3\xaenement", 
   17: 'Second Souffle', 
   18: 'Trou-en-Un-2', 
   19: 'Putt \xc3\xa0 choux -2', 
   20: 'Cul sec-2', 
   21: 'Ver de green-2', 
   22: 'Liens chauds-2', 
   23: 'Putter Pan-2', 
   ...
   32: 'Au Drive In-2', 
   33: 'Cours de Swing-2', 
   34: "Terrain d'entra\xc3\xaenement-2", 
   35: 'Second Souffle-2'}
GolfHoleInOne = 'Trou-en-un'
GolfCondor = 'Condor'
GolfAlbatross = 'Albatros'
GolfEagle = 'Aigle'
GolfBirdie = 'Birdie'
GolfPar = 'Par'
GolfBogey = 'Boguey'
...
CoursesCompleted = 'Parcours termin\xc3\xa9s'
...
MultiPlayerCoursesCompleted = 'Parcours multijoueurs termin\xc3\xa9s'
TwoPlayerWins = 'Victoires \xc3\xa0 deux joueurs'
ThreePlayerWins = 'Victoires \xc3\xa0 trois joueurs'
FourPlayerWins = 'Victoires \xc3\xa0 quatre joueurs'
...
GolfCupDescriptions = [
 str(GolfGlobals.TrophiesPerCup) + ' Troph\xc3\xa9es remport\xc3\xa9s',
 str(GolfGlobals.TrophiesPerCup * 2) + ' Troph\xc3\xa9es remport\xc3\xa9s',
 str(GolfGlobals.TrophiesPerCup * 3) + ' Troph\xc3\xa9es remport\xc3\xa9s']
GolfAvReceivesHoleBest = '%(name)s a \xc3\xa9tabli un nouveau record\n de parcours au  %(hole)s !'
GolfAvReceivesCourseBest = '%(name)s a \xc3\xa9tabli un nouveau record\n de parcours au %(course)s !'
GolfAvReceivesCup = '%(name)s remporte la %(cup)s coupe ! Rigol-augmentation !'
GolfAvReceivesTrophy = '%(name)s remporte le %(award)s troph\xc3\xa9e !'
GolfRanking = 'Classement : \n'
GolfPowerBarText = '%(power)s%%'
GolfChooseTeeInstructions = 'Appuie sur la fl\xc3\xa8che gauche ou droite pour changer la position du tee.\nAppuie sur Ctrl pour s\xc3\xa9lectionner.'
...
GolferExited = '%s a quitt\xc3\xa9 le terrain de golf.'
GolfPowerReminder = 'Maintiens la touche Ctrl enfonc\xc3\xa9e plus longtemps pour \nEnvoyer la balle plus loin'
GolfPar = 'Par'
GolfHole = 'Trou'
GolfTotal = 'Total'
...
GolfPageTitleTrophy = 'Troph\xc3\xa9es de golf'
GolfPageCustomizeTab = 'Personnaliser'
GolfPageRecordsTab = 'Records'
GolfPageTrophyTab = 'Troph\xc3\xa9e'
GolfPageTickets = 'Tickets :'
GolfPageConfirmDelete = 'Effacer un accessoire&nbsp;?'
GolfTrophyTextDisplay = 'Troph\xc3\xa9e %(number)s : %(desc)s'
GolfCupTextDisplay = 'Coupe %(number)s : %(desc)s'
GolfCurrentHistory = 'Actuel %(historyDesc)s : %(num)s'
GolfTieBreakWinner = '%(name)s remporte le jeu d\xc3\xa9cisif al\xc3\xa9atoire !'
GolfSeconds = ' - %(time))2f secondes'
GolfTimeTieBreakWinner = '%(name)s remporte le jeu d\xc3\xa9cisif de temps de vis\xc3\xa9e total !!!'
RoamingTrialerWeekendStart = "Visiter Toontown va commencer ! Les joueurs libres peuvent \xc3\xa0 pr\xc3\xa9sent se rendre dans n'importe quel quartier !"
RoamingTrialerWeekendOngoing = "Bienvenue dans Visiter Toontown ! Les joueurs libres peuvent \xc3\xa0 pr\xc3\xa9sent se rendre dans n'importe quel quartier !"
RoamingTrialerWeekendEnd = 'Visiter Toontown est maintenant termin\xc3\xa9.'
MoreXpHolidayStart = "Bonne nouvelle ! L'exp\xc3\xa9rience exclusive de double gag Test Toon a commenc\xc3\xa9."
MoreXpHolidayOngoing = "Bienvenue ! L'exp\xc3\xa9rience exclusive de double gag Test Toon est en cours."
MoreXpHolidayEnd = "L'exp\xc3\xa9rience exclusive de double gag Test Toon est termin\xc3\xa9e. Merci de nous avoir aid\xc3\xa9 \xc3\xa0 tester des trucs !"
LogoutForced = "Tu as fait une erreur\n et as \xc3\xa9t\xc3\xa9 automatiquement d\xc3\xa9connect\xc3\xa9(e).\n Il se peut \xc3\xa9galement que ton compte soit gel\xc3\xa9.\n Sors et va faire une balade. C'est amusant."
CountryClubToonEnterElevator = '%s \na saut\xc3\xa9 dans la voiturette de golf.'
CountryClubBossConfrontedMsg = '%s se bat contre le Pr\xc3\xa9sident du Club !'
ElevatorBlockedRoom = 'Tous les adversaires doivent \xc3\xaatre vaincus.'
MolesLeft = 'Taupes restantes : %d'
MolesInstruction = '\xc3\x89crasement de taupes !\nSaute sur les taupes rouges !'
MolesFinished = '\xc3\x89crasement de taupe r\xc3\xa9ussi !'
MolesRestarted = '\xc3\x89crasement de taupe manqu\xc3\xa9 ! Recommence...'
BustACogInstruction = 'Retirer la balle de Cog !'
BustACogExit = 'Quitter pour le moment'
BustACogHowto = 'Comment jouer'
BustACogFailure = 'Temps expir\xc3\xa9 !'
BustACogSuccess = 'Bien jou\xc3\xa9 !'
GolfGreenGameScoreString = '\xc3\x89nigmes restantes : %s'
GolfGreenGamePlayerScore = 'R\xc3\xa9solu %s'
GolfGreenGameBonusGag = 'Tu as gagn\xc3\xa9 %s !'
GolfGreenGameGotHelp = '%s a r\xc3\xa9solu une \xc3\xa9nigme !'
GolfGreenGameDirections = "Lance les balles \xc3\xa0 l'aide de la souris\n\n\nSi tu parviens \xc3\xa0 regrouper trois balles de la m\xc3\xaame couleur, les balles tombent\n\n\nFais dispara\xc3\xaetre toutes les balles de Cog du tableau"
...
BossbotBossName = 'Directeur'
BossbotRTWelcome = 'Tes Toons auront besoin de diff\xc3\xa9rents d\xc3\xa9guisements.'
BossbotRTRemoveSuit = "Tout d'abord, enl\xc3\xa8ve les costumes de Cog"
BossbotRTFightWaiter = 'puis attaque les serveurs.'
BossbotRTWearWaiter = 'Bon travail ! A pr\xc3\xa9sent, enfile les v\xc3\xaatements du serveur.'
BossbotBossPreTwo1 = 'Pourquoi mets-tu autant de temps ?'
BossbotBossPreTwo2 = 'D\xc3\xa9p\xc3\xaache-toi et sers mon banquet !'
BossbotRTServeFood1 = 'H\xc3\xa9, sers les plats que je pose sur ces tapis d\xc3\xa9roulants.'
...
BossbotPhase4Speech1 = 'Si je veux que le travail soit bien fait\xc2\x85'
BossbotPhase4Speech2 = 'je le fais moi-m\xc3\xaame.'
BossbotRTPhase4Speech1 = "Bon travail ! A pr\xc3\xa9sent, \xc3\xa9clabousse le Directeur avec l'eau plac\xc3\xa9e sur les tables..."
...
BossbotPitcherAdvice = 'Utilise les fl\xc3\xa8ches droite et gauche pour pivoter.\nMaintiens la touche Ctrl pour augmenter la puissance.\nRel\xc3\xa2che la touche Ctrl pour tirer.'
BossbotGolfSpotLeave = 'Laisser balle de golf'
BossbotGolfSpotLeaving = 'Laisse balle de golf\nUtilise les fl\xc3\xa8ches droite et gauche pour pivoter.\nCtrl pour tirer.'
BossbotGolfSpotAdvice = ' '
BossbotRewardSpeech1 = 'Non ! Le Pr\xc3\xa9sident ne va pas appr\xc3\xa9cier.'
BossbotRewardSpeech2 = 'Arrrggghhh !!!'
BossbotRTCongratulations = 'Tu as r\xc3\xa9ussi. Tu a r\xc3\xa9trograd\xc3\xa9 le Directeur !\x07Tiens, prends ces Avis de licenciement oubli\xc3\xa9s par le Directeur.\x07Tu pourras les utiliser pour licencier les Cogs durant un combat.'
BossbotRTLastPromotion = '\x07Ouah, tu as atteint le niveau %s de costume de Cog !\x07Les Cogs ne peuvent pas monter plus en grade. \x07Tu ne peux plus mettre ton costume de Cog \xc3\xa0 niveau mais tu peux continuer de travailler pour la R\xc3\xa9sistance !'
BossbotRTHPBoost = '\x07Tu as fait beaucoup pour la R\xc3\xa9sistance.\x07Le Conseil des Toons a d\xc3\xa9cid\xc3\xa9 de te donner un autre rigolpoint. F\xc3\xa9licitations !'
BossbotRTMaxed = "\x07Je vois que tu as un costume de Cog de niveau %s. Tr\xc3\xa8s impressionnant !\x07Le Conseil des Toons te remercie de revenir pour d\xc3\xa9fendre d'autres Toons !"
GolfAreaAttackTaunt = 'Attention !'
OvertimeAttackTaunts = [
 'Il est temps de nous r\xc3\xa9organiser.',
 'R\xc3\xa9duisons les effectifs.']
...
IceGameInstructions = 'Rapproche-toi le plus possible du centre vers la fin de la seconde manche. Utilise les fl\xc3\xa8ches du clavier pour changer de direction et de puissance. Appuie sur la touche Ctrl pour propulser ton Toon. Touche les tonneaux pour remporter des points suppl\xc3\xa9mentaires et \xc3\xa9vite le TNT&nbsp;!'
IceGameInstructionsNoTnt = 'Rapproche-toi le plus possible du centre vers la fin de la seconde manche. Utilise les fl\xc3\xa8ches du clavier pour changer de direction et de puissance. Appuie sur la touche Ctrl pour propulser ton Toon. Touche les tonneaux pour remporter des points suppl\xc3\xa9mentaires.'
...
PicnicTableMenuTutorial = 'A quel jeu veux-tu apprendre \xc3\xa0 jouer ?'
PicnicTableMenuSelect = 'A quel jeu veux-tu jouer ?\nSe lever'
...
ChineseTutorialPrev = 'Page pr\xc3\xa9c\xc3\xa9dente'
ChineseTutorialNext = 'Page suivante'
ChineseTutorialDone = 'Termin\xc3\xa9'
ChinesePage1 = "Le but du jeu des dames chinoises est d'\xc3\xaatre le premier joueur \xc3\xa0 d\xc3\xa9placer toutes ses billes du triangle en bas du tableau vers le triangle en haut du tableau. Le premier joueur qui r\xc3\xa9ussit a gagn\xc3\xa9. \n"
ChinesePage2 = "Chacun \xc3\xa0 son tour, les joueurs d\xc3\xa9placent une bille de leur couleur. Celle-ci peut \xc3\xaatre plac\xc3\xa9e dans un trou adjacent ou sauter par-dessus d'autres billes. Les sauts doivent passer au-dessus d'une bille et atterrir dans un trou vide. Il est possible d'encha\xc3\xaener des sauts pour des mouvements plus longs."
CheckersPage1 = "Le but du jeu de dames est de coincer l'adversaire pour qu'il ne puisse plus bouger. Pour ce faire, tu peux capturer toutes ses pi\xc3\xa8ces ou les bloquer de mani\xc3\xa8re \xc3\xa0 ce qu'il soit coinc\xc3\xa9 et ne puisse plus bouger."
CheckersPage2 = "Chacun leur tour, les joueurs d\xc3\xa9placent une pi\xc3\xa8ce de leur couleur. Celle-ci peut \xc3\xaatre d\xc3\xa9plac\xc3\xa9e en diagonale ou vers l'avant. Elle peut uniquement avancer sur un carr\xc3\xa9 ne contenant pas de pi\xc3\xa8ce. Les r\xc3\xa8gles sont les m\xc3\xaames pour les dames, mais elles peuvent aller en arri\xc3\xa8re."
CheckersPage3 = "Pour capturer la pi\xc3\xa8ce d'un adversaire, tu dois sauter par-dessus en diagonale et te placer dans le carr\xc3\xa9 vide de l'autre c\xc3\xb4t\xc3\xa9. Si tu as la possibilit\xc3\xa9 de faire des sauts durant un tour, tu dois ex\xc3\xa9cuter l'un d'entre eux. Tu peux encha\xc3\xaener les sauts, dans la mesure o\xc3\xb9 tu utilises la m\xc3\xaame pi\xc3\xa8ce."
CheckersPage4 = "Une pi\xc3\xa8ce devient dame lorsqu'elle atteint la derni\xc3\xa8re rang\xc3\xa9e du tableau. Une pi\xc3\xa8ce qui vient de devenir dame doit attendre le prochain tour pour pouvoir sauter. En outre, les dames ont le droit de se d\xc3\xa9placer dans toutes les directions et peuvent changer de direction durant un saut."
...
MailNotifyNewItems = 'Tu as re\xc3\xa7u un e-mail !'
...
InviteAcceptPartyInvalid = 'La f\xc3\xaate a \xc3\xa9t\xc3\xa9 annul\xc3\xa9e.'
InviteAcceptAllOk = "L'h\xc3\xb4te a \xc3\xa9t\xc3\xa9 inform\xc3\xa9 de ta r\xc3\xa9ponse"
...
HolidayNamesInCalendar = {1: (
     'Summer Fireworks', 'Celebrate Summer with a fireworks show every hour in each playground!'), 
   2: (
     'New Year Fireworks', 'Happy New Year! Enjoy a fireworks show every hour in each playground!'), 
   3: (
     'Bloodsucker Invasion', 'Happy Halloween! Stop the Bloodsucker Cogs from invading Toontown!'), 
   4: (
     'Winter Holidays Decor', 'Celebrate the Winter Holidays with Toontastic trees and streetlights!'), 
   5: (
     'Skelecog Invasion', 'Stop the Skelecogs from invading Toontown!'), 
   6: (
     'Mr. Hollywood Invasion', 'Stop the Mr. Hollywood Cogs from invading Toontown!'), 
   7: (
     'Fish Bingo', 'Fish Bingo Wednesday! Everyone at the pond works together to complete the card before time runs out.'), 
   8: (
     'Toon Species Election', 'Vote on the new Toon species! Will it be Goat? Will it be Pig?'), 
   9: (
     'Black Cat Day', 'Happy Halloween! Create a Toontastic Black Cat Toon - Today Only!'), 
   13: (
      'Trick or Treat', 'Happy Halloween! Trick or treat throughout Toontown to get a nifty Halloween pumpkin head reward!'), 
   14: (
      'Grand Prix', 'Grand Prix Monday at Goofy Speedway! To win, collect the most points in three consecutive races!'), 
   17: (
      'Trolley Tracks', 'Trolley Tracks Thursday! Board any Trolley with two or more Toons to play.'), 
   19: (
      'Silly Saturdays', 'Saturdays are silly with Fish Bingo, Grand Prix, and Trolley Tracks throughout the day!'), 
   24: (
      'Ides of March', 'Beware the Ides of March! Stop the Backstabber Cogs from invading Toontown!'), 
   26: (
      'Halloween Decor', 'Celebrate Halloween as spooky trees and streetlights transform Toontown!')}
