...
RodFileDict = {0: 'phase_4/models/props/pole_treebranch-mod', 1: 'phase_4/models/props/pole_bamboo-mod', 
   2: 'phase_4/models/props/pole_wood-mod', 
   3: 'phase_4/models/props/pole_steel-mod', 
   4: 'phase_4/models/props/pole_gold-mod'}
RodPriceDict = {0: 0, 1: 400, 
   2: 800, 
   3: 1200, 
   4: 2000}
RodRarityFactor = {0: 1.0 / (GlobalRarityDialBase * 1), 1: 1.0 / (GlobalRarityDialBase * 0.975), 
...
FishFileDict = {-1: (4,
   ...
   8: (
     ...
     -35,
     20), 
   10: (4, 'holeyMackerel-zero', 'holeyMackerel-swim', 'holeyMackerel-swim', None, None, 0.4,
 0, 0), 
   12: (
      4,
      'dogFish-zero',
   ...
   34: (
      ...
      20)}
FISH_PER_BONUS = 10
TrophyDict = {0: (TTLocalizer.FishTrophyNameDict[0],), 1: (
     TTLocalizer.FishTrophyNameDict[1],), 
   2: (
     TTLocalizer.FishTrophyNameDict[2],), 
   3: (
     TTLocalizer.FishTrophyNameDict[3],), 
   4: (
     TTLocalizer.FishTrophyNameDict[4],), 
   5: (
     TTLocalizer.FishTrophyNameDict[5],), 
   6: (
     TTLocalizer.FishTrophyNameDict[6],)}
WEIGHT_MIN_INDEX = 0
WEIGHT_MAX_INDEX = 1
RARITY_INDEX = 2
ZONE_LIST_INDEX = 3
...
__fishDict = {0: (
     (1,
      ...
      1,
      (
       Anywhere, TTG.ToonFest, TTG.OutdoorZone)),
     (
      1,
      1,
      4,
   ...
   2: (
     ...
     (
      ...
      9,
      (
       TTG.ElmStreet, TTG.MapleStreet, TTG.DaisyGardens)),
     (
      5,
      11,
      4,
     ...
     (
      ...
      3,
      (
       TTG.DaisyGardens, TTG.MapleStreet, TTG.MyEstate)),
     (
      5,
      11,
      2,
   ...
   14: (
      (
       ...
       1,
       (
        TTG.DaisyGardens, TTG.MyEstate, Anywhere)),
      (2,
       6,
       3,
       (
   ...
   16: (
      ...
      (4,
       ...
       7,
       (
        TTG.BaritoneBoulevard, TTG.MinniesMelodyland)),
      (4,
       12,
       8,
       (
   ...
   22: (
      ...
      (
       ...
       5,
       (
        TTG.MyEstate, TTG.MapleStreet, TTG.DaisyGardens)),
      (
       14,
       20,
       7,
       (
        TTG.MyEstate, TTG.DaisyGardens, TTG.MapleStreet))), 
   24: (
      (
       9,
       11,
   ...
   28: (
      ...
      (4,
       ...
       6,
       (
        TTG.BarnacleBoulevard, TTG.DonaldsDock)),
      (4,
       10,
       7,
       (
   ...
   34: (
      (
       ...
       10,
       (
        TTG.DonaldsDreamland, TTG.MapleStreet, TTG.Sewer, TTG.SewerStreet, Anywhere)),)}
...
def generateFishingReport(numCasts=10000, hitRate=0.8):
    ...
    for pond, money in totalPondMoney.items():
        ...
        print (
         'pond: %s  totalMoney: %s profit: %s perCast: %s' % (pond,
          money,
          money - totalCastCost,
    ...
    for rod, money in totalRodMoney.items():
        ...
        print (
         'rod: %s totalMoney: %s castCost: %s profit: %s perCast: %s' % (rod,
          money,
          totalCastCost,
          money - totalCastCost,
