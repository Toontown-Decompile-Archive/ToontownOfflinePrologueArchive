...
scStructure = [
 [OTPLocalizer.SCMenuTesting,
  ...
  5405],
 [
  OTPLocalizer.SCMenuHello, {100: 0}, {101: 0}, {102: 0}, {103: 0}, {104: 0}, {105: 0},
  106,
  107,
  108],
 [
  OTPLocalizer.SCMenuBye, {200: 0}, {201: 0}, {202: 0},
  203,
  204,
  205,
  206,
 ...
 [
  ...
  [
   OTPLocalizer.SCMenuGood, {5700: 1},
   5701,
   5702,
   5703],
  [
   ...
   5801, {5802: 2}, {5803: 2}],
  [
   OTPLocalizer.SCMenuHappy, {300: 1}, {301: 1}, {302: 1}, {303: 1},
   304,
   305,
   306,
   307,
   ...
   311],
  [
   OTPLocalizer.SCMenuSad, {400: 2}, {401: 2},
   402,
   403,
   404,
   405,
 ...
 [
  ...
  807],
 [
  OTPLocalizer.SCMenuStinky, {900: 3}, {901: 3}, {902: 3}, {903: 3},
  904,
  905],
 [
...
class TTChatInputSpeedChat(DirectObject.DirectObject):
    ...
    def __init__(self, chatMgr):
        ...
        self.okButton = DirectButton(parent=self.emoteNoAccessPanel, image=okButtonImage, relief=None, text=OTPLocalizer.SCEmoteNoAccessOK, text_scale=0.05, text_pos=(0.0,
                                                                                                                                                                       -0.1), textMayChange=0, pos=(0.0,
                                                                                                                                                                                                    0.0,
                                                                                                                                                                                                    -0.2), command=self.handleEmoteNoAccessDone)
    ...
    def createSpeedChat(self):
        ...
        if config.GetBool('want-doomsday', False) or config.GetBool('want-election-buildup', False):
            structure.append([OTPLocalizer.SCMenuElection, 10100, 10101, 10102, 10103, 10104, 10105])
        if config.GetBool('want-doomsday-reborn', False) or config.GetBool('want-interim-election-buildup', False):
            structure.append([OTPLocalizer.SCMenuElection, 10100, 10101, 10102, 10110, 10111, 10105, 10112, 10113, 10114, 10115])
