...
import CogdoUtil, CogdoFlyingGameGlobals as Globals
...
class CogdoFlyingLegalEagle(DirectObject, FSM):
    ...
    def __init__(self, nest, index, suitDnaName='le'):
        ...
        self.defaultTransitions = {'Off': ['Roost'], 'Roost': [
                   'TakeOff', 'Off'], 
           'TakeOff': [
                     'LockOnToon', 'LandOnNest', 'Off'], 
           'LockOnToon': [
                        'RetreatToNest', 'ChargeUpAttack', 'Off'], 
           'ChargeUpAttack': [
                            'RetreatToNest', 'Attack', 'Off'], 
           'Attack': [
                    'RetreatToSky', 'Off'], 
           'RetreatToSky': [
                          'Cooldown', 'Off'], 
