...
class PublicPartyGui(DirectFrame):
    ...
    def createListAndLabel(self, typeString, numItems):
        ...
        strings = {'activities': TTLocalizer.EventsPageHostingTabActivityListTitle, 'parties': TTLocalizer.PartyGatePartiesListTitle}
    ...
    def refresh(self, partyInfoTupleList):
        ...
        for index, partyTuple in enumerate(sortedList):
            ...
            num = DirectLabel(relief=DGG.RIDGE, borderWidth=(0.01, 0.01), frameSize=(0.0,
             otherInfoWidth,
             -0.015,
             0.04), frameColor=self.normalFrameColor, text='%d' % numberOfGuests, text_align=TextNode.ALeft, text_scale=0.045, text_pos=(0.01,
                                                                                                                                         0,
                                                                                                                                         0), pos=(0.45,
                                                                                                                                                  0.0,
                                                                                                                                                  0.0))
            ...
            actLabel = DirectLabel(relief=DGG.RIDGE, borderWidth=(0.01, 0.01), frameSize=(0.0,
             otherInfoWidth,
             -0.015,
             0.04), frameColor=self.normalFrameColor, text='%d' % numActivities, text_align=TextNode.ALeft, text_scale=0.045, text_pos=(0.01,
                                                                                                                                        0,
                                                                                                                                        0), pos=actLabelPos)
            ...
            minLabel = DirectLabel(relief=DGG.RIDGE, borderWidth=(0.01, 0.01), frameSize=(0.0,
             otherInfoWidth,
             -0.015,
             0.04), frameColor=self.normalFrameColor, text='%d' % minLeft, text_align=TextNode.ALeft, text_scale=0.045, text_pos=(0.01,
                                                                                                                                  0,
                                                                                                                                  0), pos=minLabelPos)
    ...
    def fillActivityList(self, activityIds):
        ...
        for activityId in sortedList:
            ...
            if number > 1:
                text += ' X %d' % number
            item = DirectLabel(relief=None, text=text, text_align=TextNode.ACenter, text_scale=0.05, text_pos=(0.0,
                                                                                                               -0.15), geom_scale=0.3, geom_pos=Vec3(0.0, 0.0, 0.07), geom=PartyUtils.getPartyActivityIcon(self.activityIconsModel, PartyGlobals.ActivityIds.getString(activityId)))
