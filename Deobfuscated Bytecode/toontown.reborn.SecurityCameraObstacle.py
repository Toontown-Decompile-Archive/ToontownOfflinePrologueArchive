...
# Embedded file name: toontown.reborn.SecurityCameraObstacle
...
class SecurityCameraObstacle(NodePath):
    notify = DirectNotifyGlobal.directNotify.newCategory('SecurityCameraObstacle')
    laserFieldModels = ['phase_9/models/cogHQ/square_stomper']

    def __init__(self, parent):
        node = hidden.attachNewNode('SecurityCameraObstacle')
    ...
    def sendFail(self):
        self.battleStart()
        self.parent.sendUpdate('trapFire', [False])
