...
from toontown.fnaf.FNAFManager import FNAFManager
...
class ToontownClientRepository(OTPClientRepository.OTPClientRepository):
    ...
    def __handleAvatarChooserDone(self, avList, doneStatus):
        ...
        if not index and base.cr.choseScrooge and config.GetBool('want-prologue', False):
            index = 6
        for av in avList:
    ...
    def killClientPNMickey(self):
        self.disconnect()
        self.bootedIndex = 666
        self.bootedText = OTPLocalizer.CRBootedReasons.get(666)
        self.stopReaderPollTask()
        self.lostConnection()
    ...
    def dumpAllSubShardObjects(self):
        ...
        if isNotLive:
            ...
            ignoredClasses = ('MagicWordManager', 'TimeManager', 'DistributedDistrict',
                              ...
                              'AvatarFriendsManager', 'InGameNewsMgr', 'WhitelistMgr',
                              'TTCodeRedemptionMgr')
