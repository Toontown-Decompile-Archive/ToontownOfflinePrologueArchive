...
class CutScene(Entity):
    ...
    attribs = (('pos', Point3(0, 0, 0), 'pos'),
     ...
     (
      'effect',
      'irisInOut',
      'choice', {'choiceSet': ['nothing', 'irisInOut', 'letterBox']}),
     (
      'motion',
      'foo1',
      'choice', {'choiceSet': ['foo1']}),
     ('duration', 5.0, 'float'))
...
class Model(Nodepath):
    ...
    attribs = (
     ...
     (
      'goonHatType',
      'none',
      'choice', {'choiceSet': ['none', 'hardhat', 'security']}))
...
class VisibilityExtender(Entity):
    ...
    attribs = (
     ('event',
      None,
      'entId', {'output': 'bool'}), ('newZones', [], 'visZoneList'))
