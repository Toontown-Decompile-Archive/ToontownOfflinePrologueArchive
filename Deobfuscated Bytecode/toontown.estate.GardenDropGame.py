...
class GardenDropGame(DirectObject.DirectObject):
    ...
    def load(self):
        ...
        self.quitButton = DirectButton(parent=self.frame, relief=None, image=(gui2.find('**/QuitBtn_UP'), gui2.find('**/QuitBtn_DN'), gui2.find('**/QuitBtn_RLVR')), pos=(0.5,
                                                                                                                                                                          1.0,
                                                                                                                                                                          -0.42), scale=0.9, text='Exit Mini Game', text_font=ToontownGlobals.getSignFont(), text0_fg=(1,
                                                                                                                                                                                                                                                                       1,
                                                                                                                                                                                                                                                                       1,
                                                                                                                                                                                                                                                                       1), text1_fg=(1,
                                                                                                                                                                                                                                                                                     1,
    ...
    def addSprite(self, image, size=0.5, posX=0, posZ=0, found=0):
        nodeObj = DirectLabel(parent=self.frame, relief=None, image=image, pos=(posX, 0.0, posZ), scale=size, image_color=(1.0,
                                                                                                                           1.0,
                                                                                                                           1.0,
                                                                                                                           1))
