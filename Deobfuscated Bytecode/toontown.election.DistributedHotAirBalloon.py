...
class DistributedHotAirBalloon(DistributedObject, FSM):
    ...
    def enterWaiting(self, offset):
        ...
        self.balloonIdle = Sequence(Wait(0.3), self.balloon.posInterval(3, (-15, 33,
                                                                            1.5)), Wait(0.3), self.balloon.posInterval(3, (-15,
                                                                                                                           33,
                                                                                                                           1.1)))
    ...
    def enterElectionIdle(self, offset):
        ...
        self.balloonElectionIdle = Sequence(self.balloon.posInterval(3, (166.5, 64.0,
                                                                         52.0), blendType='easeInOut'), self.balloon.posInterval(3, (166.5,
                                                                                                                                     64.0,
                                                                                                                                     53.0), blendType='easeInOut'))
        self.balloonElectionIdle.loop()
        self.balloonElectionIdle.setT(offset)

    def enterElectionCrashing(self, offset):
        self.balloonElectionFall = Sequence(self.balloon.posHprInterval(17, (200.0,
                                                                             20.0,
                                                                             0.0), (105,
                                                                                    -5,
                                                                                    -5), blendType='easeInOut'), Func(self.balloon.hide))
    ...
    def enterOccupied(self, offset):
        if self.avId == base.localAvatar.doId:
            ...
            self.hopOnAnim = Sequence(Parallel(Func(base.localAvatar.b_setParent, ToontownGlobals.SPSlappysBalloon), Func(base.localAvatar.b_setAnimState, 'jump', 1.0)), base.localAvatar.posInterval(0.6, (0,
                                                                                                                                                                                                             0,
    ...
    def enterRideOver(self, offset):
        if self.avId == base.localAvatar.doId:
            base.localAvatar.disableAvatarControls()
            self.hopOffAnim = Sequence(Parallel(Func(base.localAvatar.b_setParent, ToontownGlobals.SPRender), Func(base.localAvatar.b_setAnimState, 'jump', 1.0)), Wait(0.3), base.localAvatar.posInterval(0.3, (-14,
                                                                                                                                                                                                                 25,
                                                                                                                                                                                                                 6)), base.localAvatar.posInterval(0.7, (-14,
                                                                                                                                                                                                                                                         20,
                                                                                                                                                                                                                                                         0)), Wait(0.3), Func(base.localAvatar.enableAvatarControls), Wait(0.3), Func(base.localAvatar.b_setAnimState, 'neutral'))
