...
MinTrickFatigue = 0.1
ScId2trickId = {21200: Tricks.JUMP, 21201: Tricks.BEG, 
...
TrickAnims = {Tricks.JUMP: 'jump', Tricks.BEG: ('toBeg', 'beg', 'fromBeg'), 
   ...
   Tricks.SPEAK: 'speak', 
   Tricks.BALK: 'neutral'}
TrickLengths = {Tricks.JUMP: 2.0, Tricks.BEG: 5.167, 
   ...
   Tricks.SPEAK: 0.75, 
   Tricks.BALK: 1.0}
TrickAccuracies = {Tricks.JUMP: 1.0, Tricks.BEG: 0.9, 
   Tricks.PLAYDEAD: 0.8, 
   Tricks.ROLLOVER: 0.7, 
   Tricks.BACKFLIP: 0.6, 
   Tricks.DANCE: 0.5, 
   Tricks.SPEAK: 0.4, 
   Tricks.BALK: 1.0}
TrickHeals = {Tricks.JUMP: (5, 10), Tricks.BEG: (6, 12), 
   ...
   Tricks.SPEAK: (11, 22), 
   Tricks.BALK: (0, 0)}
TrickSounds = {Tricks.BACKFLIP: 'phase_5/audio/sfx/backflip.ogg', Tricks.ROLLOVER: 'phase_5/audio/sfx/rollover.ogg', 
