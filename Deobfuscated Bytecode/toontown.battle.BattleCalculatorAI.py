...
# Embedded file name: toontown.battle.BattleCalculatorAI
...
class BattleCalculatorAI():
    ...
    def __calcToonAtkHit(self, attackIndex, atkTargets):
        ...
        if currAtk > 0 and atkTrack != HEAL:
            ...
            lure = atkTrack == LURE and (not attackAffectsGroup(atkTrack, atkLevel, attack[TOON_TRACK_COL]) and self.successfulLures.has_key(attack[TOON_TGT_COL]) or attackAffectsGroup(atkTrack, atkLevel, attack[TOON_TRACK_COL]))
        ...
        if randChoice < acc:
            ...
            attack[TOON_ACCBONUS_COL] = 1
        return (
         not attack[TOON_ACCBONUS_COL], atkAccResult)
        ...
        if not atkHit and atkTrack != HEAL:
            ...
            for currTarget in range(len(targetList)):
                ...
                if attackLevel == -1 and not atkTrack == FIRE:
                    ...
                    if battleSkip and atkTrack != HEAL:
