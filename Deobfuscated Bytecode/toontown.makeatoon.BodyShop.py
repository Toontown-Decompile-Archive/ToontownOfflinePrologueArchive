...
class BodyShop(StateData.StateData):
    ...
    def enter(self, toon, shopsVisited=[]):
        ...
        self.headStart = 0
        self.headChoice = ToonDNA.toonHeadTypesMAT.index(self.dna.head) - ToonDNA.getHeadStartIndexMAT(self.species)
        self.torsoStart = 0
        ...
        self.__swapTorso(0)
        self.__swapLegs(0)
        choicePool = [ToonDNA.toonHeadTypesMAT, torsoPool, ToonDNA.toonLegTypes]
    ...
    def getSpeciesStart(self):
        for species in ToonDNA.toonSpeciesTypesMAT:
            if species == self.dna.head[0]:
                self.species = species
                return ToonDNA.toonSpeciesTypesMAT.index(species)
    ...
    def load(self):
        ...
        self.speciesFrame = DirectFrame(parent=self.parentFrame, image=shuffleFrame, image_scale=halfButtonInvertScale, relief=None, pos=(0,
                                                                                                                                          0,
                                                                                                                                          -0.073), hpr=(0,
                                                                                                                                                        0,
                                                                                                                                                        0), scale=1.3, frameColor=(1,
                                                                                                                                                                                   1,
                                                                                                                                                                                   1,
                                                                                                                                                                                   1), text='Species', text_scale=0.0625, text_pos=(-0.001,
                                                                                                                                                                                                                                    -0.015), text_fg=(1,
                                                                                                                                                                                                                                                      1,
                                                                                                                                                                                                                                                      1,
                                                                                                                                                                                                                                                      1))
        self.speciesLButton = DirectButton(parent=self.speciesFrame, relief=None, image=(shuffleArrowUp,
         ...
         shuffleArrowDisabled), image_scale=halfButtonScale, image1_scale=halfButtonHoverScale, image2_scale=halfButtonHoverScale, pos=(-0.2,
                                                                                                                                        0,
                                                                                                                                        0), command=self.__swapSpecies, extraArgs=[-1])
        ...
        self.headFrame = DirectFrame(parent=self.parentFrame, image=shuffleFrame, image_scale=halfButtonInvertScale, relief=None, pos=(0,
                                                                                                                                       ...
                                                                                                                                       -0.3), hpr=(0,
                                                                                                                                                   ...
                                                                                                                                                   2), scale=0.9, frameColor=(1,
                                                                                                                                                                              1,
                                                                                                                                                                              1,
                                                                                                                                                                              1), text=TTLocalizer.BodyShopHead, text_scale=0.0625, text_pos=(-0.001,
                                                                                                                                                                                                                                              -0.015), text_fg=(1,
                                                                                                                                                                                                                                                                1,
                                                                                                                                                                                                                                                                1,
                                                                                                                                                                                                                                                                1))
        self.headLButton = DirectButton(parent=self.headFrame, relief=None, image=(shuffleArrowUp,
         ...
         shuffleArrowDisabled), image_scale=halfButtonScale, image1_scale=halfButtonHoverScale, image2_scale=halfButtonHoverScale, pos=(-0.2,
                                                                                                                                        0,
                                                                                                                                        0), command=self.__swapHead, extraArgs=[-1])
        ...
        self.bodyFrame = DirectFrame(parent=self.parentFrame, image=shuffleFrame, image_scale=halfButtonScale, relief=None, pos=(0,
                                                                                                                                 ...
                                                                                                                                 -0.5), hpr=(0,
                                                                                                                                             ...
                                                                                                                                             -2), scale=0.9, frameColor=(1,
                                                                                                                                                                         1,
                                                                                                                                                                         1,
                                                                                                                                                                         1), text=TTLocalizer.BodyShopBody, text_scale=0.0625, text_pos=(-0.001,
                                                                                                                                                                                                                                         -0.015), text_fg=(1,
                                                                                                                                                                                                                                                           1,
                                                                                                                                                                                                                                                           1,
                                                                                                                                                                                                                                                           1))
        self.torsoLButton = DirectButton(parent=self.bodyFrame, relief=None, image=(shuffleArrowUp,
         ...
         shuffleArrowDisabled), image_scale=halfButtonScale, image1_scale=halfButtonHoverScale, image2_scale=halfButtonHoverScale, pos=(-0.2,
                                                                                                                                        0,
                                                                                                                                        0), command=self.__swapTorso, extraArgs=[-1])
        ...
        self.legsFrame = DirectFrame(parent=self.parentFrame, image=shuffleFrame, image_scale=halfButtonInvertScale, relief=None, pos=(0,
                                                                                                                                       ...
                                                                                                                                       -0.7), hpr=(0,
                                                                                                                                                   ...
                                                                                                                                                   3), scale=0.9, frameColor=(1,
                                                                                                                                                                              1,
                                                                                                                                                                              1,
                                                                                                                                                                              1), text=TTLocalizer.BodyShopLegs, text_scale=0.0625, text_pos=(-0.001,
                                                                                                                                                                                                                                              -0.015), text_fg=(1,
                                                                                                                                                                                                                                                                1,
                                                                                                                                                                                                                                                                1,
                                                                                                                                                                                                                                                                1))
        self.legLButton = DirectButton(parent=self.legsFrame, relief=None, image=(shuffleArrowUp,
         ...
         shuffleArrowDisabled), image_scale=halfButtonScale, image1_scale=halfButtonHoverScale, image2_scale=halfButtonHoverScale, pos=(-0.2,
                                                                                                                                        0,
                                                                                                                                        0), command=self.__swapLegs, extraArgs=[-1])
        ...
        self.memberButton = DirectButton(relief=None, image=(upsellTex,
         upsellTex,
         upsellTex,
         upsellTex), image_scale=halfButtonScale, image1_scale=halfButtonHoverScale, image2_scale=halfButtonHoverScale, scale=0.9, pos=(0,
                                                                                                                                        0,
                                                                                                                                        -0.84), command=self.__restrictForward)
        self.parentFrame.hide()
        self.memberButton.hide()
    ...
    def __swapSpecies(self, offset):
        ...
        self.species = ToonDNA.toonSpeciesTypesMAT[self.speciesChoice]
        self.headList = ToonDNA.getHeadListMAT(self.species)
    ...
    def __updateHead(self):
        ...
        headIndex = ToonDNA.getHeadStartIndexMAT(self.species) + self.headChoice
        newHead = ToonDNA.toonHeadTypesMAT[headIndex]
    ...
    def changeBody(self):
        ...
        newHead = newChoice[0]
        newSpeciesIndex = ToonDNA.toonSpeciesTypesMAT.index(ToonDNA.getSpeciesMAT(newHead))
        newHeadIndex = ToonDNA.toonHeadTypesMAT.index(newHead) - ToonDNA.getHeadStartIndexMAT(ToonDNA.getSpeciesMAT(newHead))
        ...
        oldSpeciesIndex = ToonDNA.toonSpeciesTypesMAT.index(ToonDNA.getSpeciesMAT(oldHead))
        oldHeadIndex = ToonDNA.toonHeadTypesMAT.index(oldHead) - ToonDNA.getHeadStartIndexMAT(ToonDNA.getSpeciesMAT(oldHead))
