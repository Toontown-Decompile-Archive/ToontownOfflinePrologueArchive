...
from otp.nametag import NametagConstants, NametagGroup
...
class ToonStatueSelectionGUI(DirectFrame):
    ...
    def __init__(self, doneEvent, specialBoxActive=False):
        ...
        DirectFrame.__init__(self, relief=None, state='normal', geom=DGG.getDefaultDialogGeom(), geom_color=ToontownGlobals.GlobalDialogColor, geom_scale=(1.5,
                                                                                                                                                           ...
                                                                                                                                                           1.0), frameSize=(-1,
                                                                                                                                                                            ...
                                                                                                                                                                            1), pos=(0,
                                                                                                                                                                                     0,
                                                                                                                                                                                     0), text=instructions, text_wordwrap=18, text_scale=0.08, text_pos=instructionsPos)
            ...
            self.scrollList = DirectScrolledList(parent=self, relief=None, incButton_image=(gui.find('**/FndsLst_ScrollUp'),
             ...
             gui.find('**/FndsLst_ScrollUp')), decButton_relief=None, decButton_pos=(0.0,
                                                                                     ...
                                                                                     0.117), decButton_image1_color=Vec4(1.0, 1.0, 0.6, 1.0), decButton_image3_color=Vec4(1.0, 1.0, 0.6, 0.6), itemFrame_pos=(-0.17,
                                                                                                                                                                                                              0.0,
                                                                                                                                                                                                              0.06), itemFrame_relief=DGG.SUNKEN, itemFrame_frameSize=(-0.01,
                                                                                                                                                                                                                                                                       0.35,
                                                                                                                                                                                                                                                                       -0.35,
                                                                                                                                                                                                                                                                       0.04), itemFrame_frameColor=(0.85,
                                                                                                                                                                                                                                                                                                    0.95,
                                                                                                                                                                                                                                                                                                    1,
                                                                                                                                                                                                                                                                                                    1), itemFrame_borderWidth=(0.01,
                                                                                                                                                                                                                                                                                                                               0.01), numItemsVisible=8, itemFrame_scale=1.0, items=[])
            gui.removeNode()
    ...
    def __makeFFlist(self):
        playerAvatar = (
         base.localAvatar.doId, base.localAvatar.name, NametagGroup.CCNonPlayer)
    ...
    def makeFamilyButton(self, familyId, familyName, colorCode):
        fg = NametagConstants.NAMETAG_COLORS[colorCode][0][0]
