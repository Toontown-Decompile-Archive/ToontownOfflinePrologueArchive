...
class DistributedStartingBlock(DistributedObject.DistributedObject, FSM):
    ...
    defaultTransitions = {'Off': ['EnterMovie'], 'EnterMovie': [
                    'Off', 'Waiting', 'ExitMovie'], 
       'Waiting': [
                 'ExitMovie', 'Off'], 
       'ExitMovie': [
                   'Off', 'ExitMovie']}
    ...
    def makeGui(self):
        ...
        if hasattr(self, 'cancelButton'):
            ...
            self.cancelButton = DirectGui.DirectButton(relief=None, scale=0.67, pos=(1.16,
                                                                                     0,
                                                                                     -0.9), text=('', TTLocalizer.FishingExit, TTLocalizer.FishingExit), text_align=TextNode.ACenter, text_fg=Vec4(1, 1, 1, 1), text_shadow=Vec4(0, 0, 0, 1), text_pos=(0.0,
