...
class DistributedGolfHole(DistributedPhysicsWorld.DistributedPhysicsWorld, FSM, GolfHoleBase.GolfHoleBase):
    defaultTransitions = {'Off': ['Cleanup', 'ChooseTee', 'WatchTee'], 'ChooseTee': [
                   'Aim', 'Cleanup'], 
       'WatchTee': [
                  'WatchAim', 
                  'Cleanup', 
    ...
    def __init__(self, cr):
        ...
        if TTLocalizer.getLanguage() in ('castillian', 'japanese', 'german', 'portuguese',
                                         'french'):
                                                                                                                   ...
                                                                                                                   0.2), borderWidth=(0.02,
                                                                                                                                      0.02), scale=0.25, range=100, sortOrder=50, frameColor=(0.5,
                                                                                                                                                                                              ...
                                                                                                                                                                                              0.5), barColor=(1.0,
                                                                                                                                                                                                              0.0,
                                                                                                                                                                                                              0.0,
                                                                                                                                                                                                              1.0), text='', text_scale=0.26, text_fg=(1,
                                                                                                                                                                                                                                                       1,
                                                                                                                                                                                                                                                       1,
    ...
    def sendSwingInfo(self):
        ...
        if kickHimOut:
            ...
            if self.power < 15 and self.golfCourse.scores[localAvatar.doId][self.golfCourse.curHoleIndex] == 0:
                self.powerReminder = DirectLabel(text=TTLocalizer.GolfPowerReminder, text_shadow=(0,
                                                                                                  0,
                                                                                                  0,
                                                                                                  1), text_fg=VBase4(1, 1, 0.0, 1), text_align=TextNode.ACenter, relief=None, pos=(0,
                                                                                                                                                                                   0,
                                                                                                                                                                                   0.8), scale=0.12)
            return
    ...
    def updateWarning(self):
        ...
        if self.localMissedSwings == GolfGlobals.KICKOUT_SWINGS - 1:
            self.warningLabel = DirectLabel(parent=aspect2d, relief=None, pos=(0, 0,
                                                                               0), text_align=TextNode.ACenter, text=TTLocalizer.GolfWarningMustSwing, text_scale=0.12, text_font=ToontownGlobals.getSignFont(), text_fg=(1,
                                                                                                                                                                                                                          0.1,
                                                                                                                                                                                                                          0.1,
                                                                                                                                                                                                                          1), text_wordwrap=20)
    ...
    def enterAim(self):
        ...
        self.aimInstructions = DirectLabel(text=TTLocalizer.GolfAimInstructions, text_shadow=(0,
                                                                                              0,
                                                                                              0,
                                                                                              1), text_fg=VBase4(1, 1, 1, 1), text_align=TextNode.ACenter, relief=None, pos=(0,
                                                                                                                                                                             0,
                                                                                                                                                                             -0.8), scale=TTLocalizer.DGHaimInstructions)
        self.skyContact = 1
        self.localToonHitControl = False
        self._adjustCamera()
        return
    ...
    def enterChooseTee(self):
        ...
        self.teeInstructions = DirectLabel(text=TTLocalizer.GolfChooseTeeInstructions, text_fg=VBase4(1, 1, 1, 1), text_align=TextNode.ACenter, text_shadow=(0,
                                                                                                                                                             0,
                                                                                                                                                             0,
                                                                                                                                                             1), relief=None, pos=(0,
                                                                                                                                                                                   0,
                                                                                                                                                                                   -0.75), scale=TTLocalizer.DGHteeInstructions)
        self.powerBar.hide()
        return
    ...
    def createBall(self, avId, index=None):
        ...
        self.ballDict[avId] = {'golfBall': golfBall, 'golfBallGeom': golfBallGeom, 
    ...
    def doFlyOverMovie(self, avId):
        ...
        self.titleLabel = DirectLabel(parent=aspect2d, relief=None, pos=(0, 0, 0.8), text_align=TextNode.ACenter, text=title, text_scale=0.12, text_font=ToontownGlobals.getSignFont(), text_fg=(1,
                                                                                                                                                                                                 0.8,
                                                                                                                                                                                                 0.4,
                                                                                                                                                                                                 1))
