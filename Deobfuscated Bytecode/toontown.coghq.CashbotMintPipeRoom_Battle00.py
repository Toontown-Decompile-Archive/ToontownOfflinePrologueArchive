...
GlobalEntities = {1000: {'type': 'levelMgr', 'name': 'LevelMgr', 'comment': '', 
   ...
   10001: {'type': 'battleBlocker', 'name': '<unnamed>', 
           ...
           'cellId': 0, 
           'radius': 10.0}, 
   10003: {'type': 'battleBlocker', 'name': '<unnamed>', 
           'comment': '', 
           'parentEntId': 0, 
   ...
   10006: {'type': 'model', 'name': 'farRight', 
           ...
           'loadType': 'loadModel', 
           'modelPath': 'phase_10/models/cashbotHQ/pipes_C'}, 
   10008: {'type': 'model', 'name': 'nearLeft', 
           'comment': '', 
           'parentEntId': 10004, 
   ...
   10009: {'type': 'model', 'name': 'nearRight', 
           'comment': '', 
           'parentEntId': 10004, 
   ...
   10000: {'type': 'nodepath', 'name': 'cogs', 
           ...
           'scale': Vec3(1.0, 1.0, 1.0)}, 
   10002: {'type': 'nodepath', 'name': 'frontCogs', 
           'comment': '', 
           'parentEntId': 0, 
           'pos': Point3(-94.4453353882, 0.0, 0.0), 
           'hpr': Vec3(270.0, 0.0, 0.0), 
           'scale': Vec3(1.0, 1.0, 1.0)}, 
   10004: {'type': 'nodepath', 'name': 'props', 
           'comment': '', 
           'parentEntId': 0, 
           'pos': Point3(0.0, 0.0, 0.0), 
           'hpr': Vec3(0.0, 0.0, 0.0), 
           'scale': 1}, 
   10007: {'type': 'nodepath', 'name': 'leftCogs', 
           'comment': '', 
           'parentEntId': 0, 
           'pos': Point3(0.0, 40.9584655762, 0.0), 
           'hpr': Vec3(270.0, 0.0, 0.0), 
           'scale': Vec3(1.0, 1.0, 1.0)}, 
   10010: {'type': 'nodepath', 'name': 'rightCogs', 
           'comment': '', 
           'parentEntId': 0, 
