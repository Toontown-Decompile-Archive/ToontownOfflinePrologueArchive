...
GlobalEntities = {1000: {'type': 'levelMgr', 'name': 'LevelMgr', 'comment': '', 
   ...
   100001: {'type': 'goon', 'name': '<unnamed>', 
            ...
            'strength': 15, 
            'velocity': 4}, 
   100002: {'type': 'nodepath', 'name': 'pathmasta1', 
            'comment': '', 
            'parentEntId': 100000, 
            'pos': Point3(32.0525, 0.204516, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100003: {'type': 'nodepath', 'name': 'copy of pathmasta1', 
            'comment': '', 
            'parentEntId': 100000, 
            'pos': Point3(-28.2492, 5.56589, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100004: {'type': 'nodepath', 'name': 'copy of pathmasta1', 
            'comment': '', 
            'parentEntId': 100000, 
            'pos': Point3(-10.8179, 14.6481, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100005: {'type': 'nodepath', 'name': 'pathmastachild', 
            'comment': '', 
            'parentEntId': 100000, 
            'pos': Point3(-59.4987, 29.1448, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100000: {'type': 'pathMaster', 'name': '<unnamed>', 
            'comment': '', 
            'parentEntId': 0, 
