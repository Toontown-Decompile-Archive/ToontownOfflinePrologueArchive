...
class LauncherBase(DirectObject):
    ...
    def download(self, serverFilePath, localFilename, callback, callbackProgress):
        self.launcherMessage(self.Localizer.LauncherDownloadFile % {'name': self.currentPhaseName, 'current': self.currentPhaseIndex, 
    ...
    def extract(self, mfname, localFilename, destDir, callback):
        ...
        self.launcherMessage(self.Localizer.LauncherExtractingFile % {'name': self.currentPhaseName, 'current': self.currentPhaseIndex, 
           'total': self.numPhases})
    ...
    def patch(self, patchFile, patcheeFile, callback):
        ...
        self.launcherMessage(self.Localizer.LauncherPatchingFile % {'name': self.currentPhaseName, 'current': self.currentPhaseIndex, 
           'total': self.numPhases})
    ...
    def patchMultifile(self):
        self.launcherMessage(self.Localizer.LauncherCheckUpdates % {'name': self.currentPhaseName, 'current': self.currentPhaseIndex, 
           'total': self.numPhases})
    ...
    def scanForHacks(self):
        ...
        knownHacksRegistryKeys = {hackName[0]: [
                       [
