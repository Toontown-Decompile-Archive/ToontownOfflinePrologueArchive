...
GlobalEntities = {1000: {'type': 'levelMgr', 'name': 'LevelMgr', 'comment': '', 
   ...
   10001: {'type': 'battleBlocker', 'name': '<unnamed>', 
           ...
           'cellId': 0, 
           'radius': 15.0}, 
   10002: {'type': 'collisionSolid', 'name': '<unnamed>', 
           'comment': '', 
           'parentEntId': 100000, 
           ...
           'showSolid': 0, 
           'solidType': 'tube'}, 
   10003: {'type': 'collisionSolid', 'name': 'copy of <unnamed>', 
           'comment': '', 
           'parentEntId': 100000, 
   ...
   100002: {'type': 'model', 'name': 'copy of <unnamed>', 
            'comment': '', 
            'parentEntId': 100000, 
            ...
            'loadType': 'loadModel', 
            'modelPath': 'phase_11/models/lawbotHQ/LB_torch_lampB'}, 
   100003: {'type': 'model', 'name': 'copy of <unnamed> (2)', 
            'comment': '', 
            'parentEntId': 100000, 
            ...
            'loadType': 'loadModel', 
            'modelPath': 'phase_11/models/lawbotHQ/LB_torch_lampB'}, 
   100004: {'type': 'model', 'name': 'copy of <unnamed> (3)', 
            'comment': '', 
            'parentEntId': 100000, 
            ...
            'loadType': 'loadModel', 
            'modelPath': 'phase_11/models/lawbotHQ/LB_torch_lampB'}, 
   100005: {'type': 'model', 'name': 'copy of <unnamed> (4)', 
            'comment': '', 
            'parentEntId': 100000, 
   ...
   100006: {'type': 'model', 'name': 'copy of <unnamed> (5)', 
            'comment': '', 
            'parentEntId': 100000, 
            ...
            'loadType': 'loadModel', 
            'modelPath': 'phase_11/models/lawbotHQ/LB_pottedplantA'}, 
   100007: {'type': 'model', 'name': 'copy of <unnamed> (6)', 
            'comment': '', 
            'parentEntId': 100000, 
            ...
            'loadType': 'loadModel', 
            'modelPath': 'phase_11/models/lawbotHQ/LB_pottedplantA'}, 
   100008: {'type': 'model', 'name': 'copy of <unnamed> (5)', 
            'comment': '', 
            'parentEntId': 100000, 
            ...
            'loadType': 'loadModel', 
            'modelPath': 'phase_11/models/lawbotHQ/LB_pottedplantA'}, 
   100009: {'type': 'model', 'name': 'copy of <unnamed> (2)', 
            'comment': '', 
            'parentEntId': 100000, 
   ...
   100010: {'type': 'model', 'name': 'copy of <unnamed> (3)', 
            'comment': '', 
            'parentEntId': 100000, 
            ...
            'loadType': 'loadModel', 
            'modelPath': 'phase_11/models/lawbotHQ/LB_bookshelfA'}, 
   100011: {'type': 'model', 'name': 'copy of <unnamed> (4)', 
            'comment': '', 
            'parentEntId': 100000, 
            ...
            'loadType': 'loadModel', 
            'modelPath': 'phase_11/models/lawbotHQ/LB_bookshelfA'}, 
   100012: {'type': 'model', 'name': 'copy of <unnamed> (3)', 
            'comment': '', 
            'parentEntId': 100000, 
            ...
            'loadType': 'loadModel', 
            'modelPath': 'phase_11/models/lawbotHQ/LB_bookshelfA'}, 
   100013: {'type': 'model', 'name': 'copy of <unnamed> (4)', 
            'comment': '', 
            'parentEntId': 100000, 
            ...
            'loadType': 'loadModel', 
            'modelPath': 'phase_11/models/lawbotHQ/LB_bookshelfA'}, 
   100014: {'type': 'model', 'name': 'copy of <unnamed> (5)', 
            'comment': '', 
            'parentEntId': 100000, 
   ...
   10000: {'type': 'nodepath', 'name': 'cogs', 
           ...
           'hpr': Point3(270, 0, 0), 
           'scale': Vec3(1, 1, 1)}, 
   100000: {'type': 'nodepath', 'name': 'props', 
            'comment': '', 
            'parentEntId': 0, 
            'pos': Point3(0, 0, 0.05), 
            'hpr': Vec3(0, 0, 0), 
            'scale': 1}, 
   100015: {'type': 'nodepath', 'name': 'lights', 
            'comment': '', 
            'parentEntId': 0, 
            'pos': Point3(0, 0, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': 1}, 
   100017: {'type': 'nodepath', 'name': 'cameratarget1', 
            'comment': '', 
            'parentEntId': 100015, 
            'pos': Point3(-67.0138, 21.058, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100018: {'type': 'nodepath', 'name': 'copy of cameratarget1', 
            'comment': '', 
            'parentEntId': 100015, 
            'pos': Point3(-3.89516, 39.263, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100019: {'type': 'nodepath', 'name': 'copy of cameratarget1 (2)', 
            'comment': '', 
            'parentEntId': 100015, 
            'pos': Point3(-23.9228, 20.3744, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100020: {'type': 'nodepath', 'name': 'lights2', 
            'comment': '', 
            'parentEntId': 0, 
            'pos': Point3(0, 4.9793, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100022: {'type': 'nodepath', 'name': 'camtar1', 
            'comment': '', 
            'parentEntId': 100020, 
            'pos': Point3(16.2876, -35.7071, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100023: {'type': 'nodepath', 'name': 'copy of camtar1', 
            'comment': '', 
            'parentEntId': 100020, 
            'pos': Point3(-52.2915, -8.50529, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100024: {'type': 'nodepath', 'name': 'copy of camtar1 (2)', 
            'comment': '', 
            'parentEntId': 100020, 
            'pos': Point3(-52.2915, -37.5322, 0), 
            'hpr': Vec3(0, 0, 0), 
            'scale': Vec3(1, 1, 1)}, 
   100016: {'type': 'securityCamera', 'name': '<unnamed>', 
            'comment': '', 
            'parentEntId': 100015, 
            ...
            'trackTarget2': 100018, 
            'trackTarget3': 100019}, 
   100021: {'type': 'securityCamera', 'name': '<unnamed>', 
            'comment': '', 
            'parentEntId': 100020, 
