...
import PartyGlobals, PartyCogUtils
...
class PartyCogActivity(DirectObject):
    ...
    def _initArenaDoors(self):
        self._arenaDoors = (
         self.arena.find('**/doorL'), self.arena.find('**/doorR'))
    ...
    def showTotals(self, totals):
        newtotals = (
         totals[1] - totals[0] + PartyGlobals.CogActivityArenaLength / 2.0 * 3, totals[0] - totals[1] + PartyGlobals.CogActivityArenaLength / 2.0 * 3)
