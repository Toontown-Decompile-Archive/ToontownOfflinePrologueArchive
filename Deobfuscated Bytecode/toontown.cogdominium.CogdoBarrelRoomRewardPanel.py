...
class CogdoBarrelRoomRewardPanel(DirectFrame):
    ...
    def __init__(self):
        ...
        for i in xrange(CogdoBarrelRoomConsts.MaxToons):
            ...
            rewardLine['name'] = DirectLabel(parent=rewardLine['frame'], relief=None, text='', text_scale=TTLocalizer.RPtrackLabels, text_align=TextNode.ALeft, pos=(-0.4,
                                                                                                                                                                     0,
                                                                                                                                                                     0), text_pos=(0,
                                                                                                                                                                                   -0.02))
        ...
        for doId in base.cr.doId2do:
            ...
            if isinstance(toon, DistributedToon.DistributedToon):
                ...
                if doId == base.localAvatar.getDoId():
                    ...
                    self.rewardLines[RewardLineIndex]['frame'].setProp('borderWidth', (0.01,
                                                                                       0.01))
                    self.rewardLines[RewardLineIndex]['frame'].setProp('frameColor', (1,
                                                                                      1,
                                                                                      1,
                                                                                      0.5))
                RewardLineIndex += 1