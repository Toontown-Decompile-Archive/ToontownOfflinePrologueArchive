...
class TraitDistribution:
    ...
    Sz2MinMax = None
    TraitType = None
    TraitCutoffs = {TraitTypes.INCREASING: {TraitQuality.VERY_BAD: 0.1, TraitQuality.BAD: 0.25, 
                               TraitQuality.GOOD: 0.75, 
                               TraitQuality.VERY_GOOD: 0.9}, 
       TraitTypes.DECREASING: {TraitQuality.VERY_BAD: 0.9, TraitQuality.BAD: 0.75, 
...
class PetTraits:
    ...
    class StdIncDistrib(TraitDistribution):
        ...
        Sz2MinMax = {ToontownGlobals.ToontownCentral: (0.2, 0.65), ToontownGlobals.DonaldsDock: (0.3, 0.7), 
    ...
    class StdDecDistrib(TraitDistribution):
        ...
        Sz2MinMax = {ToontownGlobals.ToontownCentral: (0.35, 0.8), ToontownGlobals.DonaldsDock: (0.3, 0.7), 
    ...
    class ForgetfulnessDistrib(TraitDistribution):
        TraitType = TraitDistribution.TraitTypes.DECREASING
        Sz2MinMax = {ToontownGlobals.ToontownCentral: (0.0, 1.0), ToontownGlobals.DonaldsDock: (0.0, 0.9), 
    ...
    def getExtremeTraitDescriptions(self):
        descs = []
        TraitQuality = TraitDistribution.TraitQuality
        Quality2index = {TraitQuality.VERY_BAD: 0, TraitQuality.BAD: 1, 
           TraitQuality.GOOD: 2, 
