...
# Embedded file name: toontown.battle.Movie
# Compiled at: 2014-04-30 09:53:54
from toontown.toonbase.ToontownBattleGlobals import *
from BattleBase import *
from direct.interval.IntervalGlobal import *
from direct.showbase import DirectObject
import MovieFire, MovieSOS, MovieNPCSOS, MoviePetSOS
if config.GetBool('want-mini-server', False):
    import MovieHealOriginal as MovieHeal
else:
    import MovieHeal
import MovieTrap, MovieLure, MovieSound, MovieThrow, MovieSquirt, MovieDrop, MovieSuitAttacks, MovieToonVictory, PlayByPlayText, BattleParticles
from toontown.distributed import DelayDelete
import BattleExperience
from SuitBattleGlobals import *
from direct.directnotify import DirectNotifyGlobal
import RewardPanel, random, MovieUtil
...
class Movie(DirectObject.DirectObject):
    ...
    def playTutorialReward_1(self):
        self.tutRewardDialog_1 = TTDialog.TTDialog(text=TTLocalizer.MovieTutorialReward1, command=self.playTutorialReward_2, style=TTDialog.Acknowledge, fadeScreen=None, pos=(0.65,
                                                                                                                                                                               0,
                                                                                                                                                                               0.5), scale=0.8)
    ...
    def playTutorialReward_2(self, value):
        ...
        self.tutRewardDialog_2 = TTDialog.TTDialog(text=TTLocalizer.MovieTutorialReward2, command=self.playTutorialReward_3, style=TTDialog.Acknowledge, fadeScreen=None, pos=(0.65,
                                                                                                                                                                               0,
                                                                                                                                                                               0.5), scale=0.8)
