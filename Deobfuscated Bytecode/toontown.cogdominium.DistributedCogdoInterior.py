...
SUITE_DICT = {'s': 'tt_m_ara_crg_penthouse_sell', 'l': 'tt_m_ara_crg_penthouse_law', 'm': 'tt_m_ara_crg_penthouse_sell', 
   'c': 'tt_m_ara_crg_penthouse_sell'}
PAINTING_DICT = {'s': 'tt_m_ara_crg_paintingMoverShaker', 'l': 'tt_m_ara_crg_paintingLegalEagle', 
...
class DistributedCogdoInterior(DistributedObject.DistributedObject):
    ...
    def __playElevator(self, ts, name, callback):
        ...
        if self.floorModel:
            ...
            if self._wantBarrelRoom and self.barrelRoom.isLoaded() and self.currentFloor == 2 and self.FOType == 'l':
