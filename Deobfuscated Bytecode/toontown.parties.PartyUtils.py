...
def getPartyActivityIcon(activityIconsModel, activityName):
    activityIconsDict = {'PartyValentineDance': 'tt_t_ara_pty_iconDanceFloorValentine', 'PartyValentineDance20': 'tt_t_ara_pty_iconDanceFloorValentine', 
...
def formatDate(year, month, day):
    ...
    return TTLocalizer.PartyDateFormat % {'mm': monthString, 'dd': day, 
       'yyyy': year}
