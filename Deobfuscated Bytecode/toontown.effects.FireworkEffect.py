...
trailSfxNames = [
 'phase_4/audio/sfx/firework_whistle_01.ogg', 'phase_4/audio/sfx/firework_whistle_02.ogg']
    ...
    def getTrailEffectsIval(self):
        if not self.trailEffectsIval:
            ...
            if self.trailTypeId == FireworkTrailType.Default:
                ...
                if self.trailTypeId == FireworkTrailType.Polygonal:
                    r = 0.75
                    mColor = Vec4(1, 1, 1, 1)
                    ...
                    if self.trailTypeId == FireworkTrailType.Glow:
                        ...
                        if trailEffect:
                            ...
                            self.trailEffects.append(trailEffect)
                            self.trailEffectsIval.append(Func(trailEffect.startLoop))
            if self.trailTypeId == FireworkTrailType.GlowSparkle:
                glowEffect = Glow.getEffect()
                if glowEffect:
                    glowEffect.reparentTo(self.effectsNode)
                    glowEffect.setColorScale(Vec4(1, 1, 1, 1))
                ...
                if self.trailTypeId == FireworkTrailType.LongSparkle:
    ...
    def getBurstEffectsIval(self):
        if not self.burstEffectsIval:
            ...
            if self.burstTypeId == FireworkBurstType.Sparkles:
                ...
                if self.burstTypeId == FireworkBurstType.PeonyShell:
                    ...
                    if config.GetInt('toontown-sfx-setting', 1) >= 1:
                        ...
                        self.burstEffectsIval.append(rays.getTrack())
                        self.burstEffects.append(rays)
            if self.burstTypeId == FireworkBurstType.PeonyDiademShell:
                explosion = StarBurst.getEffect()
                if explosion:
                    explosion.reparentTo(self.effectsNode)
                    explosion.setEffectScale(self.scale)
                ...
                if self.burstTypeId == FireworkBurstType.ChrysanthemumShell:
                    ...
                    if sparkles:
                        ...
                        self.burstEffectsIval.append(sparkles.getTrack())
                        self.burstEffects.append(sparkles)
            if self.burstTypeId == FireworkBurstType.RingShell:
                ...
                if self.burstTypeId == FireworkBurstType.SaturnShell:
                    explosion = RingEffect.getEffect()
                    if explosion:
                        explosion.reparentTo(self.effectsNode)
                        explosion.setEffectScale(self.scale)
                    ...
                    if config.GetInt('toontown-sfx-setting', 1) >= 1:
                        ...
                        self.burstEffectsIval.append(rays.getTrack())
                        self.burstEffects.append(rays)
            if self.burstTypeId == FireworkBurstType.SkullBlast:
                ...
                if self.burstTypeId == FireworkBurstType.TrailExplosion:
