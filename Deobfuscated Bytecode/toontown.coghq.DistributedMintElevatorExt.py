...
class DistributedMintElevatorExt(DistributedElevatorExt.DistributedElevatorExt):
    ...
    def setMintId(self, mintId):
        self.mintId = mintId
        mintId2originId = {ToontownGlobals.CashbotMintIntA: 1, ToontownGlobals.CashbotMintIntB: 2, 
        ...
        signText = DirectGui.OnscreenText(text=TextEncoder.upper(TTLocalizer.GlobalStreetNames[mintId][-1]), font=ToontownGlobals.getSuitFont(), scale=TTLocalizer.DMEEsignText, fg=(0.87,
                                                                                                                                                                                     0.87,
                                                                                                                                                                                     0.87,
    ...
    def setMintInteriorZone(self, zoneId):
        if self.localToonOnBoard:
            ...
            doneStatus = {'loader': 'cogHQLoader', 'where': 'mintInterior', 'how': 'teleportIn', 
               'zoneId': zoneId, 
               'mintId': self.mintId, 
               'hoodId': hoodId}
