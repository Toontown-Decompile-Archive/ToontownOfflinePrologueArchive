...
# Embedded file name: toontown.coghq.CogNationCentralBossBattle
...
class CogNationCentralBossBattle(CogHQBossBattle.CogHQBossBattle):
    notify = DirectNotifyGlobal.directNotify.newCategory('CogNationCentralBossBattle')
