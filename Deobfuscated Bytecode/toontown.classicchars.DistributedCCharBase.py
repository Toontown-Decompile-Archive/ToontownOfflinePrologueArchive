...
import CCharChatter, CCharPaths, string, copy
    ...
    def handleHolidays(self):
        ...
        if hasattr(base.cr, 'newsManager') and base.cr.newsManager:
            ...
            if ToontownGlobals.CRASHED_LEADERBOARD in holidayIds:
                ...
                if ToontownGlobals.CIRCUIT_RACING_EVENT in holidayIds:
                    self.CCChatter = ToontownGlobals.CIRCUIT_RACING_EVENT
                else:
                    if ToontownGlobals.WINTER_CAROLING in holidayIds:
            ...
            if ToontownGlobals.WACKY_WINTER_CAROLING in holidayIds:
                self.CCChatter = ToontownGlobals.WACKY_WINTER_CAROLING
            else:
                if ToontownGlobals.WACKY_WINTER_DECORATIONS in holidayIds:
            ...
            if ToontownGlobals.APRIL_FOOLS_COSTUMES in holidayIds:
                ...
                if ToontownGlobals.SILLY_CHATTER_ONE in holidayIds:
            ...
            if ToontownGlobals.SILLY_CHATTER_THREE in holidayIds:
                self.CCChatter = ToontownGlobals.SILLY_CHATTER_THREE
            else:
                if ToontownGlobals.SILLY_CHATTER_FOUR in holidayIds:
            ...
            if ToontownGlobals.HALLOWEEN_COSTUMES in holidayIds:
                ...
                if ToontownGlobals.SPOOKY_COSTUMES in holidayIds:
