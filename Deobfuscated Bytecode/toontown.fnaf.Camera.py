...
class CameraBrowser(NodePath):
    ...
    def __init__(self, controls):
        ...
        self.titleCircle = OnscreenImage(image='phase_9/maps/rec.png', parent=self.title, pos=(-0.85,
                                                                                               0,
                                                                                               0.84), scale=0.07)
        self.exitButton = DirectButton(text='Close', text_fg=(1, 1, 1, 1), scale=0.07, pos=(0,
                                                                                            0,
                                                                                            -0.9), text_bg=(0,
                                                                                                            0,
                                                                                                            0,
                                                                                                            0.75), text_font=base.cogFont, command=self.controls.request, extraArgs=[
         'Flashlight'])
    ...
    def createCamera(self, index, pos, hpr, name):
        ...
        button = DirectFrame(parent=self.map, frameColor=(1, 1, 1, 0), frameSize=(-0.16,
                                                                                  0.29,
                                                                                  -0.15,
                                                                                  0.15), pos=pos, scale=0.2, state=DGG.NORMAL)
...
class CameraControls(FSM):
    ...
    def __init__(self):
        ...
        self.browser.hide()
        self.browserButton = DirectButton(text='Cameras', text_fg=(1, 1, 1, 1), scale=0.07, pos=(0,
                                                                                                 0,
                                                                                                 -0.9), text_bg=(0,
                                                                                                                 0,
                                                                                                                 0,
                                                                                                                 0.75), text_font=base.cogFont, command=self.request, extraArgs=[
         'Browser'])
        self.browserButton.hide()

    def load(self):
        self.leaveGameButton = DirectButton(text='Quit', text_fg=(1, 1, 1, 1), scale=0.07, pos=(-0.4,
                                                                                                0,
                                                                                                -0.9), text_bg=(0,
                                                                                                                0,
                                                                                                                0,
                                                                                                                0.75), text_font=base.cogFont, command=base.cr.fnafMgr.leaveMinigame)
