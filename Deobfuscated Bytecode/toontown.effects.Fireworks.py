...
colors = {WHITE: Vec4(1, 1, 1, 1), RED: Vec4(1, 0.2, 0.2, 1), BLUE: Vec4(0.2, 0.2, 1, 1), 
   ...
   CYAN: Vec4(0.2, 1, 1, 1)}
textures = {SNOWFLAKE: 'phase_8/models/props/snowflake_treasure', MUSICNOTE: 'phase_6/models/props/music_treasure', 
...
def shootFireworkCircleGeneric(x, y, z, color1, color2, amp, poolSize):
    ...
    f.setPos(x, y, z)
    sfxName = random.choice(('phase_4/audio/sfx/firework_explosion_01.ogg', 'phase_4/audio/sfx/firework_explosion_02.ogg',
...
style2shootFunc = {CIRCLE: shootFireworkCircle, CIRCLELARGE: shootFireworkCircleLarge, 
