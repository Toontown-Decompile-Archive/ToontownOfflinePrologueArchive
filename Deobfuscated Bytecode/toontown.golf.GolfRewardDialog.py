...
class GolfRewardDialog:
        ...
        if av and avId in self.avIdList:
            ...
            for trophyIndex in xrange(len(self.trophyList[playerIndex])):
                ...
                if wonTrophy:
                    ...
                    text = TTLocalizer.GolfAvReceivesTrophy % {'name': name, 'award': trophyName}
                    retval.append(text)
    ...
    def createRewardMovie(self, localAvId):
        ...
        def setTrophyLabelText(text, playerIndex, trophyIndex):
            ...
            self.trophy = GolfTrophy(level=self.trophyList[playerIndex][trophyIndex], parent=self.trophyLabel, pos=(1.3,
                                                                                                                    0,
                                                                                                                    -0.25))
        ...
        for rewardText in rewardTextList:
            if len(rewardTextList) > 0:
                var = (
                 rewardText, playerIndex, trophyIndex)
    ...
    def setup(self, localAvId):
        self.rewardBoard = DirectFrame(parent=aspect2d, relief=None, geom=DGG.getDefaultDialogGeom(), geom_color=ToontownGlobals.GlobalDialogColor, geom_scale=(1.75,
                                                                                                                                                                1,
                                                                                                                                                                0.6), pos=(0,
                                                                                                                                                                           0,
                                                                                                                                                                           -0.6))
        self.rewardLabel = DirectLabel(parent=self.rewardBoard, relief=None, pos=(0,
                                                                                  0,
                                                                                  0), text_align=TextNode.ACenter, text='', text_scale=0.05, text_wordwrap=30)
        self.rankLabel = DirectLabel(parent=self.rewardBoard, relief=None, pos=(0,
                                                                                0,
                                                                                0.17), text_align=TextNode.ACenter, text='', text_scale=0.06)
        self.trophyLabel = DirectLabel(parent=self.rewardBoard, relief=None, pos=(-0.7,
                                                                                  0,
                                                                                  0.05), text_align=TextNode.ALeft, text='', text_scale=0.06, text_wordwrap=20)
