...
import QuietZoneState, ZoneUtil
...
class Hood(StateData.StateData):
    ...
    def enter(self, requestStatus):
        ...
        self.titleText = OnscreenText.OnscreenText(hoodText, fg=self.titleColor, font=getSignFont(), pos=(0,
                                                                                                          -0.5), scale=TTLocalizer.HtitleText, drawOrder=0, mayChange=1)
